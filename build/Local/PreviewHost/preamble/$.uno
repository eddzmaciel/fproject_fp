...
: Property<T>
{
						...
						readonly bool _supportsOriginSetter;public UxProperty(Action<object, object> setter, Func<object> getter, Uno.UX.PropertyObject obj, string name, bool supportsOriginSetter)
...
public override Uno.UX.PropertyObject Object { get { return _obj; } }public override bool SupportsOriginSetter { get { return _supportsOriginSetter; } }public override void Set(T value, Uno.UX.IPropertyListener origin)
{
...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.56.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.100.5"), 12124)}, "C:\\Users\\Eddz-\\Documents\\Fuse\\MyFirstFuseProject\\MyFirstFuseProject.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("MyFirstFuseProject");
}
}
}
