...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Compiler\$.uno
// --------------------------------------------------------------------
...
{
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)CallerPackageNameAttribute__New1_fn, 0, true, CallerPackageNameAttribute_typeof(), 0));
}
...
{
    uStackFrame __("Uno.Compiler.CallerPackageNameAttribute", ".ctor()");
    ctor_();
}
