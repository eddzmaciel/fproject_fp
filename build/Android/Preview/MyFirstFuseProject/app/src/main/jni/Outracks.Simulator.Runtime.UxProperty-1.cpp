// This file was generated based on C:\Users\Eddz-\Documents\Fuse\MyFirstFuseProject\build\Android\Preview\preamble\$.uno.
...
static void UxProperty_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", type, (void*)UxProperty__New1_fn, 0, true, type, 5, ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()), ::g::Uno::Func_typeof()->MakeType(uObject_typeof()), ::g::Uno::UX::PropertyObject_typeof(), ::g::Uno::String_typeof(), ::g::Uno::Bool_typeof()));
}
...
// public UxProperty(Uno.Action<object, object> setter, Uno.Func<object> getter, Uno.UX.PropertyObject obj, string name, bool supportsOriginSetter) :44
...
// public override sealed T Get() :60
...
// public UxProperty New(Uno.Action<object, object> setter, Uno.Func<object> getter, Uno.UX.PropertyObject obj, string name, bool supportsOriginSetter) :44
...
{
    uStackFrame __("Outracks.Simulator.Runtime.UxProperty`1", "get_Object()");
    return *__retval = __this->_obj, void();
}

// public override sealed void Set(T value, Uno.UX.IPropertyListener origin) :54
...
{
    uStackFrame __("Outracks.Simulator.Runtime.UxProperty`1", "get_SupportsOriginSetter()");
    return *__retval = __this->_supportsOriginSetter, void();
}

// public UxProperty(Uno.Action<object, object> setter, Uno.Func<object> getter, Uno.UX.PropertyObject obj, string name, bool supportsOriginSetter) [instance] :44
...
// public UxProperty New(Uno.Action<object, object> setter, Uno.Func<object> getter, Uno.UX.PropertyObject obj, string name, bool supportsOriginSetter) [static] :44
