// This file was generated based on C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Backends\CPlusPlus\Uno\Memory.cpp.
...
static uBase::Array<uRefInfo<uObject**> >* _StrongRefs;
static uBase::Array<uRefInfo<uWeakObject**> >* _WeakRefs;
#ifdef DEBUG_DUMPS
...
//#endif
    ...
    _StrongRefs = new uBase::Array<uRefInfo<uObject**> >();
    _WeakRefs = new uBase::Array<uRefInfo<uWeakObject**> >();
...
void uBuildMemory(uType* type)
{
    ...
    {
#ifdef DEBUG_ARC
#define DEBUG_NAME ((uBase::String)type->FullName + "[" + (int)i + "]").CopyPtr(), // Leak
#else
#define DEBUG_NAME
#endif
        uFieldInfo& f = type->Fields[i];
