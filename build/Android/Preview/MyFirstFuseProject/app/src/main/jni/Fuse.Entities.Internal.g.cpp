...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.33.5\Internal\$.uno
// ---------------------------------------------------------------
...
{
    ::TYPES[0] = ::g::Fuse::Entities::Material_typeof();
    ::TYPES[1] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelNode_typeof());
    ::TYPES[2] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[3] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Content::Models::ModelNode_typeof());
    ::TYPES[4] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[5] = ::g::Fuse::Node_typeof();
    ::TYPES[6] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelDrawable_typeof());
    ::TYPES[7] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Content::Models::ModelDrawable_typeof());
    ::TYPES[8] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelParameter1_typeof()->MakeType(::g::Uno::Float4x4_typeof()));
    ::TYPES[9] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Content::Models::ModelParameter1_typeof()->MakeType(::g::Uno::Float4x4_typeof()));
    type->SetFields(0,
...
::g::Fuse::Entities::Entity* SceneGraphBuilder::CreateNode(::g::Uno::Content::Models::ModelNode* node, bool isRoot)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(node)->Children()), ::TYPES[1/*Uno.Collections.IEnumerable<Uno.Content.Models.ModelNode>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[2/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::Content::Models::ModelNode* child = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[3/*Uno.Collections.IEnumerator<Uno.Content.Models.ModelNode>*/]), &ret5), ret5);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(entity)->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), CreateNode(child, false));
    }

    ::g::Fuse::Entities::Transform3D* transform = TryCreateCompositTransform(node);

    if (transform != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(entity)->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), transform);
    else if (isRoot)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(entity)->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), CreateTransform());

    if (isRoot)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(entity)->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), CreateMeshRenderer(CreateMaterial()));

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(node->Drawables()), ::TYPES[6/*Uno.Collections.IEnumerable<Uno.Content.Models.ModelDrawable>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[2/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::Content::Models::ModelDrawable* dr = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[7/*Uno.Collections.IEnumerator<Uno.Content.Models.ModelDrawable>*/]), &ret6), ret6);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(entity)->Children()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Node>*/]), CreateMeshRenderer1(CreateMesh(dr)));
    }
...
::g::Uno::Float4x4 SceneGraphBuilder::MakeMatrix(uObject* transforms)
{
    ...
    for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(transforms), ::TYPES[8/*Uno.Collections.IEnumerable<Uno.Content.Models.ModelParameter<float4x4>>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[2/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::Content::Models::ModelParameter1* transform = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[9/*Uno.Collections.IEnumerator<Uno.Content.Models.ModelParameter<float4x4>>*/]), &ret7), ret7);
...
{
    ::TYPES[10] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Entities::Entity_typeof());
    ::TYPES[11] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::Entities::Entity_typeof());
    ::TYPES[12] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Entities::Entity_typeof());
    ::TYPES[13] = ::g::Fuse::Entities::Entity_typeof();
    ::TYPES[14] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::Entities::Entity_typeof());
    type->SetFields(0,
...
void SceneGraphBuilderVisitor::ctor_()
{
    ...
    _entities = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[10/*Uno.Collections.List<Fuse.Entities.Entity>*/]));
}
...
::g::Fuse::Entities::Entity* SceneGraphBuilderVisitor::Peek()
{
    ...
    return (uPtr(_entities)->Count() == 0) ? uCast< ::g::Fuse::Entities::Entity*>(NULL, ::TYPES[13/*Fuse.Entities.Entity*/]) : (::g::Uno::Collections::IListExtensions__Last_fn(::TYPES[14/*Uno.Collections.IListExtensions.Last<Fuse.Entities.Entity>*/], (uObject*)_entities, &ret3), ret3);
}
...
void SceneGraphBuilderVisitor::Pop()
{
    ...
    ::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[11/*Uno.Collections.IListExtensions.RemoveLast<Fuse.Entities.Entity>*/], (uObject*)_entities, &ret2);
}
