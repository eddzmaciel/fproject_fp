...
// C:\ProgramData\Uno\Packages\Uno.Net.Http\0.33.1\UriParsers\$.uno
// ----------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Uno.Net.Http\0.33.1\$.uno
// -----------------------------------------------------
...
static void HostInfoParser_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Uno.Net.Http\\0.33.1\\$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"C:\\Program...*/], 17);
    else
...
{
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    ::TYPES[5] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[6] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    type->SetInterfaces(
...
void HttpMessageHandler::ctor_()
{
    ...
    _pendingRequests = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>*/]));
...
void HttpMessageHandler::AbortPendingRequests()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Net::Http::HttpMessageHandlerRequest*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_pendingRequests), &ret4), ret4); enum2.MoveNext(::TYPES[6/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]); )
    {
        ::g::Uno::Net::Http::HttpMessageHandlerRequest* request = enum2.Current(::TYPES[6/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]);
...
void HttpMessageHandler::Dispose()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Net::Http::HttpMessageHandlerRequest*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_pendingRequests), &ret7), ret7); enum1.MoveNext(::TYPES[6/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]); )
    {
        ::g::Uno::Net::Http::HttpMessageHandlerRequest* request = enum1.Current(::TYPES[6/*Uno.Collections.List<Uno.Net.Http.HttpMessageHandlerRequest>.Enumerator*/]);
...
static void HttpMessageHandlerRequest_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Uno::Net::Http::Implementation::IHttpRequest_typeof();
    ...
    ::TYPES[14] = HttpMessageHandlerRequest__DispatchClosure1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[15] = ::g::Uno::Net::Http::Implementation::AndroidHttpRequest_typeof();
    ::TYPES[16] = ::g::Uno::Action1_typeof()->MakeType(HttpMessageHandlerRequest_typeof());
    ::TYPES[17] = ::g::Uno::Action2_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof());
    ::TYPES[18] = ::g::Uno::Action4_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof());
    type->SetInterfaces(
...
void HttpMessageHandlerRequest::Abort()
{
    ...
    ::g::Uno::Net::Http::Implementation::IHttpRequest::Abort(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    OnAborted();
}
...
void HttpMessageHandlerRequest::add_Aborted(uDelegate* value)
{
    ...
    Aborted1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Aborted1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_Aborted(uDelegate* value)
{
    ...
    Aborted1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Aborted1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::Dispose()
{
    ...
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_httpRequest), ::TYPES[9/*Uno.IDisposable*/]));
    _httpRequest = NULL;
...
void HttpMessageHandlerRequest::add_Done(uDelegate* value)
{
    ...
    Done1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Done1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_Done(uDelegate* value)
{
    ...
    Done1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Done1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::add_Error(uDelegate* value)
{
    ...
    Error1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Error1, value), ::TYPES[17/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/]);
}
...
void HttpMessageHandlerRequest::remove_Error(uDelegate* value)
{
    ...
    Error1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Error1, value), ::TYPES[17/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/]);
}

// private void FireSetHeadersReceived() [instance] :446
void HttpMessageHandlerRequest::FireSetHeadersReceived()
{
    uStackFrame __("Uno.Net.Http.HttpMessageHandlerRequest", "FireSetHeadersReceived()");
    State(3);
}
...
uArray* HttpMessageHandlerRequest::GetResponseContentByteArray()
{
    ...
    if ((State() < 4) || (State() > 5))
        return uArray::New(::TYPES[11/*byte[]*/], 0);

    uArray* ind2 = ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseContentByteArray(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    return (ind2 != NULL) ? ind2 : uArray::New(::TYPES[11/*byte[]*/], 0);
}
...
uString* HttpMessageHandlerRequest::GetResponseContentString()
{
    ...
    uString* ind1 = ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseContentString(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]));
...
uString* HttpMessageHandlerRequest::GetResponseHeader(uString* name)
{
    ...
    return ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseHeader(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]), name);
}
...
uString* HttpMessageHandlerRequest::GetResponseHeaders()
{
    ...
    return ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseHeaders(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]));
}
...
int HttpMessageHandlerRequest::GetResponseStatus()
{
    ...
    return ::g::Uno::Net::Http::Implementation::IHttpRequest::GetResponseStatus(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]));
}
...
void HttpMessageHandlerRequest::OnAborted()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[5/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure__Run_fn, HttpMessageHandlerRequest__DispatchClosure::New1(6, handler, this)));
}
...
void HttpMessageHandlerRequest::OnDone()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[5/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure__Run_fn, HttpMessageHandlerRequest__DispatchClosure::New1(5, handler, this)));
}
...
void HttpMessageHandlerRequest::OnError(uString* platformspesificErrorMessage)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[5/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure1__Run_fn, (HttpMessageHandlerRequest__DispatchClosure1__New1_fn(::TYPES[14/*Uno.Net.Http.HttpMessageHandlerRequest.DispatchClosure<string>*/], uCRef<int>(7), handler, this, platformspesificErrorMessage, &ret4), ret4)));
}
...
void HttpMessageHandlerRequest::OnHeadersReceived()
{
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[5/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)HttpMessageHandlerRequest__FireSetHeadersReceived_fn, this));
}
...
void HttpMessageHandlerRequest::OnProgress(int current, int total, bool hasTotal)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[5/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)HttpMessageHandlerRequest__ProgressClosure__Run_fn, HttpMessageHandlerRequest__ProgressClosure::New1(4, handler, this, current, total, hasTotal)));
}
...
void HttpMessageHandlerRequest::OnTimeout()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[5/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)HttpMessageHandlerRequest__DispatchClosure__Run_fn, HttpMessageHandlerRequest__DispatchClosure::New1(8, handler, this)));
}
...
void HttpMessageHandlerRequest::add_Progress(uDelegate* value)
{
    ...
    Progress1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Progress1, value), ::TYPES[18/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/]);
}
...
void HttpMessageHandlerRequest::remove_Progress(uDelegate* value)
{
    ...
    Progress1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Progress1, value), ::TYPES[18/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/]);
}
...
void HttpMessageHandlerRequest::SendAsync()
{
    ...
    _state = 2;
    ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    OnStateChanged();
}
...
void HttpMessageHandlerRequest::SendAsync1(uArray* data)
{
    ...
    else
    {
        ...
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync1(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]), data);
    }
...
void HttpMessageHandlerRequest::SendAsync2(uString* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[30/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[31/*"HEAD"*/])) || ::g::Uno::String::op_Equality(data, NULL)) || ::g::Uno::String::op_Equality(data, ::STRINGS[29/*""*/]))
        ...
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync2(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]), data);
...
void HttpMessageHandlerRequest::SetHeader(uString* name, uString* value)
{
    ...
    ::g::Uno::Net::Http::Implementation::IHttpRequest::SetHeader(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]), name, value);
}
...
void HttpMessageHandlerRequest::SetResponseType(int responseType)
{
    ...
    uPtr(uAs< ::g::Uno::Net::Http::Implementation::AndroidHttpRequest*>(_httpRequest, ::TYPES[15/*Uno.Net.Http.Implementation.AndroidHttpRequest*/]))->SetResponseType1(responseType);
}
...
void HttpMessageHandlerRequest::SetTimeout(int timeoutInMilliseconds)
{
    ...
    ::g::Uno::Net::Http::Implementation::IHttpRequest::SetTimeout(uInterface(uPtr(_httpRequest), ::TYPES[7/*Uno.Net.Http.Implementation.IHttpRequest*/]), timeoutInMilliseconds);
}
...
void HttpMessageHandlerRequest::add_StateChanged(uDelegate* value)
{
    ...
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(StateChanged1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_StateChanged(uDelegate* value)
{
    ...
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(StateChanged1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::add_Timeout(uDelegate* value)
{
    ...
    Timeout1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Timeout1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::remove_Timeout(uDelegate* value)
{
    ...
    Timeout1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Timeout1, value), ::TYPES[16/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
static void HttpStatusReasonPhrase_build(uType* type)
{
    ...
    ::TYPES[19] = ::g::Uno::Collections::IDictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    ::TYPES[20] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
uString* HttpStatusReasonPhrase::GetFromStatusCode(int statusCode)
{
    ...
    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Informational()), ::TYPES[19/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret6), ret6))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Success()), ::TYPES[19/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret7), ret7))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Redirection()), ::TYPES[19/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret8), ret8))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::ClientErrors()), ::TYPES[19/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret9), ret9))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::ServerErrors()), ::TYPES[19/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret10), ret10))
        return description;
...
{
    uStackFrame __("Uno.Net.Http.HttpMessageHandlerRequest.ProgressClosure", ".ctor(Uno.Net.Http.HttpRequestState,Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>,Uno.Net.Http.HttpMessageHandlerRequest,int,int,bool)");
    _action = action;
    _request = request;
    _current = current;
    _total = total;
...
// public sealed class UriScheme :1109
// {
// static UriScheme() :1109
static void UriScheme__cctor__fn(uType* __type)
{
    ::g::Uno::Collections::List* collection2;
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[79/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[80/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[81/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[82/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[83/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[84/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[85/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[86/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[87/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[88/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[89/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[90/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[91/*"news"*/]), collection1);
}
...
static void UriScheme_build(uType* type)
{
    ...
    ::STRINGS[86] = uString::Const("file");
    ::STRINGS[87] = uString::Const("prospero");
    ::STRINGS[88] = uString::Const("ws");
    ::STRINGS[89] = uString::Const("wss");
    ::STRINGS[90] = uString::Const("mailto");
    ::STRINGS[91] = uString::Const("news");
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[21] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof());
    type->SetFields(0,
...
// public generated UriScheme() [instance] :1109
void UriScheme::ctor_()
{
}

// public static Uno.Net.Http.UriSchemeType GetSchemeType(string scheme) [static] :1142
...
// public static bool IsHttpScheme(string scheme) [static] :1156
...
// public generated UriScheme New() [static] :1109
...
// public static Uno.Collections.Dictionary<string, int> get_DefaultPorts() [static] :1119
::g::Uno::Collections::Dictionary* UriScheme::DefaultPorts()
{
    ...
    {
        UriScheme::_defaultPorts() = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[21/*Uno.Collections.Dictionary<string, int>*/]));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[79/*"http"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[80/*"https"*/], uCRef<int>(443));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[81/*"ftp"*/], uCRef<int>(21));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[82/*"gopher"*/], uCRef<int>(70));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[84/*"telnet"*/], uCRef<int>(119));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[85/*"wais"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[86/*"file"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[87/*"prospero"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[90/*"mailto"*/], uCRef<int>(25));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[91/*"news"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[88/*"ws"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[89/*"wss"*/], uCRef<int>(443));
    }
...
static void UserInfoParser_build(uType* type)
{
    ...
    ::STRINGS[93] = uString::Const("The user name or password specified in uriString is not valid.");
    type->Reflection.SetFunctions(2,
...
uString* UserInfoParser::Parse(uString* uriString, int endIdx, int* idx)
{
    ...
    int end = ::g::Uno::String::IndexOf1(uPtr(uriString), ::STRINGS[92/*"@"*/], *idx);
    ...
    if (!UserInfoParser::IsValid(userInfo))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[93/*"The user na...*/]));
