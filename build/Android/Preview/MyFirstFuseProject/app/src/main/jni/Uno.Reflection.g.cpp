...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Reflection\$.uno
// ----------------------------------------------------------------------
...
{
    uStackFrame __("Uno.Reflection.CppField", "GetValue(object)");
...
{
    uStackFrame __("Uno.Reflection.CppField", "get_IsNull()");
    return *&__this == NULL;
}
...
{
    uStackFrame __("Uno.Reflection.CppField", "get_Name()");
...
{
    uStackFrame __("Uno.Reflection.CppField", "SetValue(object,object)");
...
{
    uStackFrame __("Uno.Reflection.CppField", "get_Null()");
    return NULL;
}
// }
...
{
    uStackFrame __("Uno.Reflection.CppFunction", "CreateDelegate(Uno.Type,object)");
...
{
    uStackFrame __("Uno.Reflection.CppFunction", "Invoke(object,object[])");
...
{
    uStackFrame __("Uno.Reflection.CppFunction", "get_Name()");
    return uPtr(*&__this)->Name;
}
...
{
    uStackFrame __("Uno.Reflection.CppFunction", "get_ParameterTypes()");
...
{
    uStackFrame __("Uno.Reflection.CppFunction", "get_Null()");
    return NULL;
}
// }
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "FindField(Uno.Type,string)");
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "FindFieldFromObject(object,string)");
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "FindFunction(Uno.Type,string,Uno.Type[])");
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "FindFunctionFromObject(object,string,Uno.Type[])");
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "GetFields(Uno.Type)");
    uPtr(type);
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "GetFunctions(Uno.Type)");
    uPtr(type);
...
{
    uStackFrame __("Uno.Reflection.CppReflection", "GetTypes()");
