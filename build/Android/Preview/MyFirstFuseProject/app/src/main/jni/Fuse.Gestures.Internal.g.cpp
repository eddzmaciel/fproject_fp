...
// C:\ProgramData\Uno\Packages\Fuse.Gestures\0.33.5\Internal\$.uno
// ---------------------------------------------------------------
...
static void EdgeSwiper_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[2] = ::g::Fuse::Motion::Simulation::SmoothSnap_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[3] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[4] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[5] = ::g::Uno::Action_typeof();
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::SampleFlags_typeof();
    ::TYPES[7] = ::g::Uno::Int_typeof();
    ::TYPES[8] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[9] = uObject_typeof();
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[11] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    ::TYPES[12] = ::g::Fuse::Input::PointerMovedHandler_typeof();
    ::TYPES[13] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
    ::TYPES[14] = ::g::Uno::Delegate_typeof();
    ::TYPES[15] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), ::g::Uno::Double_typeof());
    type->SetFields(0,
        ...
        ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(::g::Uno::Float_typeof()), offsetof(::g::Fuse::Gestures::Internal::EdgeSwiper, _pointBody1D), 0,
        ...
        ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof()), offsetof(::g::Fuse::Gestures::Internal::EdgeSwiper, _velocity), 0,
...
// private void MoveUser(float2 coord, [bool release]) :438
...
// private void OnLostCapture() :403
void EdgeSwiper__OnLostCapture_fn(EdgeSwiper* __this)
{
    __this->OnLostCapture();
}

// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) :453
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) :412
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) :490
...
// private void OnUpdated() :396
void EdgeSwiper__OnUpdated_fn(EdgeSwiper* __this)
{
    __this->OnUpdated();
}

// private float PrimaryValue(float2 v) :558
...
// public void Rooted(Fuse.Elements.Element e) :342
...
void EdgeSwiper::ctor_()
{
    ...
    _pointBody1D = (uObject*)((::g::Fuse::Motion::Simulation::SmoothSnap*)::g::Fuse::Motion::Simulation::SmoothSnap::CreateNormalized(::TYPES[2/*Fuse.Motion.Simulation.SmoothSnap<float>*/]));
    ...
    _down = -1;
    _velocity = ((::g::Fuse::Motion::Simulation::PointerVelocity*)::g::Fuse::Motion::Simulation::PointerVelocity::New1(::TYPES[3/*Fuse.Motion.Simulation.PointerVelocity<float2>*/]));
}

// private void CalcProgress() [instance] :550
...
// private void CheckNeedUpdated([bool off]) [instance] :378
void EdgeSwiper::CheckNeedUpdated(bool off)
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "CheckNeedUpdated([bool])");
    bool needUpdated = (_down == -1) && !::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_pointBody1D), ::TYPES[4/*Fuse.Motion.Simulation.Simulation*/]));
    ...
    if (needUpdated)
    {
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)EdgeSwiper__OnUpdated_fn, this), 0);
        _hasUpdated = true;
    }
    else if (off)
    {
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)EdgeSwiper__OnUpdated_fn, this), 0);
        _hasUpdated = false;
    }
}

// public void Disable() [instance] :371
void EdgeSwiper::Disable()
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "Disable()");
    ::g::Fuse::Motion::Simulation::DestinationSimulation::set_Destination_ex(uInterface(uPtr(_pointBody1D), ::TYPES[1/*Fuse.Motion.Simulation.DestinationSimulation<float>*/]), uCRef(0.0f));
...
// public void Enable() [instance] :365
void EdgeSwiper::Enable()
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "Enable()");
    ::g::Fuse::Motion::Simulation::DestinationSimulation::set_Destination_ex(uInterface(uPtr(_pointBody1D), ::TYPES[1/*Fuse.Motion.Simulation.DestinationSimulation<float>*/]), uCRef(1.0f));
    CheckNeedUpdated(false);
}

// private float2 FromWindow(float2 p) [instance] :430
...
// public bool get_IsEnabled() [instance] :359
bool EdgeSwiper::IsEnabled()
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "get_IsEnabled()");
    return (Progress() > 0.0) && ::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_pointBody1D), ::TYPES[4/*Fuse.Motion.Simulation.Simulation*/]));
}

// private bool IsWithinSwipeBounds(float2 windowPoint) [instance] :523
...
// private void MoveUser(float2 coord, [bool release]) [instance] :438
...
// private void OnLostCapture() [instance] :403
void EdgeSwiper::OnLostCapture()
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "OnLostCapture()");
    _down = -1;
    _isHardCapture = false;
    ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(_pointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), uCRef((float)Progress()));
    ::g::Fuse::Input::Pointer::ReleaseAllCaptures(this);
    CheckNeedUpdated(false);
}

// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :453
void EdgeSwiper::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    if (!_isHardCapture)
    {
        ...
        if (withinBounds)
        {
            if (uPtr(args)->TryHardCapture(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)EdgeSwiper__OnLostCapture_fn, this), _element))
                _isHardCapture = true;
            else
                OnLostCapture();
        }
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :412
void EdgeSwiper::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (uPtr(args)->TrySoftCapture(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)EdgeSwiper__OnLostCapture_fn, this), _element))
    {
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :490
void EdgeSwiper::OnPointerReleased(uObject* sender, ::g::Fuse::Input::PointerReleasedArgs* args)
{
    ...
    ::g::Fuse::Motion::Simulation::DestinationSimulation::set_Destination_ex(uInterface(uPtr(_pointBody1D), ::TYPES[1/*Fuse.Motion.Simulation.DestinationSimulation<float>*/]), uCRef((float)(on ? 1 : 0)));
    ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(_pointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), uCRef((float)Progress()));
    _down = -1;
    _isHardCapture = false;
    CheckNeedUpdated(false);
...
// private void OnUpdated() [instance] :396
void EdgeSwiper::OnUpdated()
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "OnUpdated()");
    float ret4;
    ::g::Fuse::Motion::Simulation::Simulation::Update(uInterface(uPtr(_pointBody1D), ::TYPES[4/*Fuse.Motion.Simulation.Simulation*/]), ::g::Fuse::Time::FrameInterval());
    Progress((double)(::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_pointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), &ret4), ret4));
    CheckNeedUpdated(true);
}

// private float PrimaryValue(float2 v) [instance] :558
...
void EdgeSwiper::add_ProgressChanged(uDelegate* value)
{
    ...
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ProgressChanged1, value), ::TYPES[15/*Uno.Action<object, double>*/]);
}
...
void EdgeSwiper::remove_ProgressChanged(uDelegate* value)
{
    ...
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ProgressChanged1, value), ::TYPES[15/*Uno.Action<object, double>*/]);
}

// public void Rooted(Fuse.Elements.Element e) [instance] :342
void EdgeSwiper::Rooted(::g::Fuse::Elements::Element* e)
{
    ...
    _element = e;
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), _element, uDelegate::New(::TYPES[11/*Fuse.Input.PointerPressedHandler*/], (void*)EdgeSwiper__OnPointerPressed_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _element, uDelegate::New(::TYPES[12/*Fuse.Input.PointerMovedHandler*/], (void*)EdgeSwiper__OnPointerMoved_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), _element, uDelegate::New(::TYPES[13/*Fuse.Input.PointerReleasedHandler*/], (void*)EdgeSwiper__OnPointerReleased_fn, this));
}
...
// public void Unrooted() [instance] :350
void EdgeSwiper::Unrooted()
{
    uStackFrame __("Fuse.Gestures.Internal.EdgeSwiper", "Unrooted()");
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), _element, uDelegate::New(::TYPES[11/*Fuse.Input.PointerPressedHandler*/], (void*)EdgeSwiper__OnPointerPressed_fn, this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _element, uDelegate::New(::TYPES[12/*Fuse.Input.PointerMovedHandler*/], (void*)EdgeSwiper__OnPointerMoved_fn, this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), _element, uDelegate::New(::TYPES[13/*Fuse.Input.PointerReleasedHandler*/], (void*)EdgeSwiper__OnPointerReleased_fn, this));
}
...
// public generated Point New() [static] :1307
...
// internal sealed class Swiper :854
// {
// static Swiper() :854
...
{
    ::TYPES[16] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Gestures::Internal::SwipeRegion_typeof());
    ::TYPES[3] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[9] = uObject_typeof();
    ::TYPES[5] = ::g::Uno::Action_typeof();
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::SampleFlags_typeof();
    ...
    type->SetFields(0,
        ...
        ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof()), offsetof(::g::Fuse::Gestures::Internal::Swiper, _velocity), 0,
...
// public void SetActivation(Fuse.Gestures.Internal.SwipeRegion region, bool on, [bool bypass]) :1181
...
// private Swiper(Fuse.Elements.Element elm) [instance] :860
void Swiper::ctor_(::g::Fuse::Elements::Element* elm)
{
    uStackFrame __("Fuse.Gestures.Internal.Swiper", ".ctor(Fuse.Elements.Element)");
    _attachCount = 1;
    _pointerRegions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[16/*Uno.Collections.List<Fuse.Gestures.Internal.SwipeRegion>*/]));
    _regions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[16/*Uno.Collections.List<Fuse.Gestures.Internal.SwipeRegion>*/]));
    _down = -1;
    _velocityThreshold = 300.0f;
    _velocity = ((::g::Fuse::Motion::Simulation::PointerVelocity*)::g::Fuse::Motion::Simulation::PointerVelocity::New1(::TYPES[3/*Fuse.Motion.Simulation.PointerVelocity<float2>*/]));
    _element = elm;
...
// public void AddRegion(Fuse.Gestures.Internal.SwipeRegion region) [instance] :900
...
// private void CheckNeedUpdated([bool off]) [instance] :937
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    if (needUpdated)
    {
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Swiper__OnUpdated_fn, this), 0);
        _hasUpdated = true;
    }
    else if (off)
    {
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Swiper__OnUpdated_fn, this), 0);
        _hasUpdated = false;
    }
}

// public void Detach() [instance] :882
void Swiper::Detach()
{
...
// private void EndInteraction() [instance] :981
...
// private float2 FromWindow(float2 p) [instance] :1028
...
// private void MoveUser(float2 coord, double elapsed, [bool release]) [instance] :1036
...
// private void OnLostCapture() [instance] :972
void Swiper::OnLostCapture()
{
    ...
    for (int i = 0; i < uPtr(_pointerRegions)->Count(); ++i)
        ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_pointerRegions), uCRef<int>(i), &ret4), ret4))->PointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), uCRef((float)uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_pointerRegions), uCRef<int>(i), &ret5), ret5))->Progress()));

    if (_pointerRegion != NULL)
        ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(uPtr(_pointerRegion)->PointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), uCRef((float)uPtr(_pointerRegion)->Progress()));

    EndInteraction();
}

// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :1050
    ...
    for (int i = 0; i < 2; ++i)
    {
        ...
        if (!_isHardCapture || _allowNewRegion)
        {
            ...
            else if ((selRegion != NULL) && (selRegion != _pointerRegion))
            {
                ...
                if (!_isHardCapture)
                {
                    if (!uPtr(args)->TryHardCapture(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Swiper__OnLostCapture_fn, this), _element))
                    {
                        OnLostCapture();
                        return;
                    }
                    ...
                    uPtr(_element)->BeginInteraction(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Swiper__OnLostCapture_fn, this));
                }
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :999
void Swiper::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (args->TrySoftCapture(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Swiper__OnLostCapture_fn, this), _element))
    {
        _down = uPtr(args)->PointIndex();
        _startCoord = FromWindow(args->WindowPoint());
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :1149
...
// private void OnRooted(Fuse.Elements.Element n) [instance] :917
void Swiper::OnRooted(::g::Fuse::Elements::Element* n)
{
    ...
    uPtr(_pointerRegions)->Clear();
    _element = n;
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), _element, uDelegate::New(::TYPES[11/*Fuse.Input.PointerPressedHandler*/], (void*)Swiper__OnPointerPressed_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), _element, uDelegate::New(::TYPES[13/*Fuse.Input.PointerReleasedHandler*/], (void*)Swiper__OnPointerReleased_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _element, uDelegate::New(::TYPES[12/*Fuse.Input.PointerMovedHandler*/], (void*)Swiper__OnPointerMoved_fn, this));
}

// private void OnUnrooted() [instance] :928
void Swiper::OnUnrooted()
{
    uStackFrame __("Fuse.Gestures.Internal.Swiper", "OnUnrooted()");
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), _element, uDelegate::New(::TYPES[11/*Fuse.Input.PointerPressedHandler*/], (void*)Swiper__OnPointerPressed_fn, this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), _element, uDelegate::New(::TYPES[13/*Fuse.Input.PointerReleasedHandler*/], (void*)Swiper__OnPointerReleased_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _element, uDelegate::New(::TYPES[12/*Fuse.Input.PointerMovedHandler*/], (void*)Swiper__OnPointerMoved_fn, this));
    _element = NULL;
}

// private void OnUpdated() [instance] :958
void Swiper::OnUpdated()
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        ::g::Fuse::Motion::Simulation::Simulation::Update(uInterface(uPtr(uPtr(region)->PointBody1D), ::TYPES[4/*Fuse.Motion.Simulation.Simulation*/]), ::g::Fuse::Time::FrameInterval() * uPtr(region)->TimeMultiplier);
        region->SetProgress((double)(::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(region->PointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), &ret9), ret9), false);
    }

    CheckNeedUpdated(true);
}

// public void RemoveRegion(Fuse.Gestures.Internal.SwipeRegion region) [instance] :911
...
// private void RestartMove(float2 currentCoord) [instance] :1043
...
// private Fuse.Gestures.Internal.SwipeRegion SelectRegion(float2 diff, bool force) [instance] :1126
...
// public void SetActivation(Fuse.Gestures.Internal.SwipeRegion region, bool on, [bool bypass]) [instance] :1181
void Swiper::SetActivation(::g::Fuse::Gestures::Internal::SwipeRegion* region, bool on, bool bypass)
{
    ...
    if (d != (::g::Fuse::Motion::Simulation::DestinationSimulation::get_Destination_ex(uInterface(uPtr(region->PointBody1D), ::TYPES[1/*Fuse.Motion.Simulation.DestinationSimulation<float>*/]), &ret12), ret12))
    {
        ::g::Fuse::Motion::Simulation::DestinationSimulation::set_Destination_ex(uInterface(uPtr(uPtr(region)->PointBody1D), ::TYPES[1/*Fuse.Motion.Simulation.DestinationSimulation<float>*/]), uCRef(d));
        region->IsActive(on);
        changed = true;
    }
    ...
    if (bypass)
    {
        ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(uPtr(region)->PointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), uCRef(d));
    ...
    else
    {
        ...
        ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(uPtr(region)->PointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), uCRef((float)uPtr(region)->Progress()));
        region->SetProgress((double)(::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(region->PointBody1D), ::TYPES[8/*Fuse.Motion.Simulation.MotionSimulation<float>*/]), &ret13), ret13), false);
    }

    CheckNeedUpdated(false);
}

// public static Fuse.Gestures.Internal.Swiper AttachSwiper(Fuse.Elements.Element elm) [static] :866
...
// private Swiper New(Fuse.Elements.Element elm) [static] :860
...
// internal sealed class SwipeRegion :670
// {
// static SwipeRegion() :670
...
static void SwipeRegion_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[17] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Bool_typeof());
    type->SetFields(1,
        ...
        ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(::g::Uno::Float_typeof()), offsetof(::g::Fuse::Gestures::Internal::SwipeRegion, PointBody1D), 0,
...
// public generated SwipeRegion() :670
void SwipeRegion__ctor_1_fn(SwipeRegion* __this)
{
    __this->ctor_1();
}

// public float ActivateStrength(float2 diff) :823
...
// public generated SwipeRegion() [instance] :670
void SwipeRegion::ctor_1()
{
    uStackFrame __("Fuse.Gestures.Internal.SwipeRegion", ".ctor()");
    Range = ::g::Uno::Math::DegreesToRadians1(30.0f);
    PointBody1D = (uObject*)((::g::Fuse::Motion::Simulation::SmoothSnap*)::g::Fuse::Motion::Simulation::SmoothSnap::CreateNormalized(::TYPES[2/*Fuse.Motion.Simulation.SmoothSnap<float>*/]));
...
// public float ActivateStrength(float2 diff) [instance] :823
...
// private void DoRevertActive() [instance] :736
void SwipeRegion::DoRevertActive()
{
    uStackFrame __("Fuse.Gestures.Internal.SwipeRegion", "DoRevertActive()");
    SetProgress(0.0, false);
    ::g::Fuse::Motion::Simulation::DestinationSimulation::set_Destination_ex(uInterface(uPtr(PointBody1D), ::TYPES[1/*Fuse.Motion.Simulation.DestinationSimulation<float>*/]), uCRef(0.0f));
    IsActive(false);
}

// private void DoSwiped() [instance] :745
...
// public bool InteractProgress(float2 diff, double startProgress) [instance] :838
...
// public bool get_IsActive() [instance] :725
bool SwipeRegion::IsActive()
{
    uStackFrame __("Fuse.Gestures.Internal.SwipeRegion", "get_IsActive()");
    return _isActive;
}

// public void set_IsActive(bool value) [instance] :726
...
// public bool IsPointInside(Fuse.Elements.Element prime, float2 coord) [instance] :803
...
// public bool get_IsSelectable() [instance] :766
...
// public bool get_IsStatic() [instance] :761
bool SwipeRegion::IsStatic()
{
    uStackFrame __("Fuse.Gestures.Internal.SwipeRegion", "get_IsStatic()");
    return ::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(PointBody1D), ::TYPES[4/*Fuse.Motion.Simulation.Simulation*/]));
}

// public double get_Progress() [instance] :675
...
// public float ScalarValue(float2 x) [instance] :848
...
bool SwipeRegion::SetProgress(double value, bool interacting)
{
    ...
    if ((_progress == 1.0) || (_progress == 0.0))
    {
        ...
        if (TriggerSwipe || AutoTrigger)
        {
            TriggerSwipe = false;
            _wasActive = active;
            ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)SwipeRegion__DoSwiped_fn, this), -1, 0);
            swiped = true;
        }

        if (active && RevertActive)
            ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)SwipeRegion__DoRevertActive_fn, this), -1, 0);
    }

    return swiped;
}

// public double get_StableProgress() [instance] :681
...
// public generated void add_Swiped(Uno.Action<bool> value) [instance] :719
void SwipeRegion::add_Swiped(uDelegate* value)
{
    uStackFrame __("Fuse.Gestures.Internal.SwipeRegion", "add_Swiped(Uno.Action<bool>)");
    Swiped1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Swiped1, value), ::TYPES[17/*Uno.Action<bool>*/]);
}

// public generated void remove_Swiped(Uno.Action<bool> value) [instance] :719
void SwipeRegion::remove_Swiped(uDelegate* value)
{
    ...
    Swiped1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Swiped1, value), ::TYPES[17/*Uno.Action<bool>*/]);
}

// public generated SwipeRegion New() [static] :670
...
// internal enum SwipeRegionArea :664
...
// internal sealed class TwoFinger :1231
// {
// static TwoFinger() :1231
...
{
    ::TYPES[18] = TwoFinger__Point_typeof()->Array();
    ::TYPES[9] = uObject_typeof();
    ::TYPES[5] = ::g::Uno::Action_typeof();
    ::TYPES[14] = ::g::Uno::Delegate_typeof();
    ::TYPES[19] = ::g::Fuse::Input::PointerEventArgs_typeof();
    ::TYPES[11] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    ::TYPES[13] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
    ::TYPES[12] = ::g::Fuse::Input::PointerMovedHandler_typeof();
    ::TYPES[20] = ::g::Fuse::Gestures::Internal::TwoFingerEventHandler_typeof();
    ::TYPES[21] = ::g::Fuse::Gestures::Internal::TwoFingerRotateHandler_typeof();
    ::TYPES[22] = ::g::Fuse::Gestures::Internal::TwoFingerTranslateHandler_typeof();
    ::TYPES[23] = ::g::Fuse::Gestures::Internal::TwoFingerZoomHandler_typeof();
    type->SetFields(0,
...
// public generated void add_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) :1291
void TwoFinger__add_Rotated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Rotated(value);
}

// public generated void remove_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) :1291
void TwoFinger__remove_Rotated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->remove_Rotated(value);
}

// public generated void add_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) :1288
void TwoFinger__add_Started_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Started(value);
}

// public generated void remove_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) :1288
void TwoFinger__remove_Started_fn(TwoFinger* __this, uDelegate* value)
{
    __this->remove_Started(value);
}

// public generated void add_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) :1292
void TwoFinger__add_Translated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Translated(value);
}

// public generated void remove_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) :1292
void TwoFinger__remove_Translated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->remove_Translated(value);
}

// public generated void add_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) :1290
void TwoFinger__add_Zoomed_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Zoomed(value);
}

// public generated void remove_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) :1290
...
// private TwoFinger(Fuse.Visual n) [instance] :1240
void TwoFinger::ctor_(::g::Fuse::Visual* n)
{
    uStackFrame __("Fuse.Gestures.Internal.TwoFinger", ".ctor(Fuse.Visual)");
    _keyZoomRangeUp = 200.0f;
    _keyZoomRangeDown = 100.0f;
    _startThresholdDistance = 20.0f;
    _attachCount = 1;
    _allowKeyControl = true;
    _point = uArray::Init<TwoFinger__Point*>(::TYPES[18/*Fuse.Gestures.Internal.TwoFinger.Point[]*/], 2, (TwoFinger__Point*)TwoFinger__Point::New1(), (TwoFinger__Point*)TwoFinger__Point::New1());
    _node = n;
}

// private void Begin() [instance] :1336
void TwoFinger::Begin()
{
    uStackFrame __("Fuse.Gestures.Internal.TwoFinger", "Begin()");

    if (!::g::Fuse::Input::Pointer::HardCapture(uPtr(uPtr(_point)->Strong<TwoFinger__Point*>(0))->Down, _node, this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)TwoFinger__OnLostCapture_fn, this)) || ((uPtr(uPtr(_point)->Strong<TwoFinger__Point*>(1))->Down != -1) && !::g::Fuse::Input::Pointer::HardCapture(uPtr(uPtr(_point)->Strong<TwoFinger__Point*>(1))->Down, _node, this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)TwoFinger__OnLostCapture_fn, this))))
    {
        OnLostCapture();
        return;
    }
    ...
    _begun = true;
    uPtr(_node)->BeginInteraction(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)TwoFinger__OnLostCapture_fn, this));
...
// public void Detach() [instance] :1264
...
// public generated void add_Ended(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1289
void TwoFinger::add_Ended(uDelegate* value)
{
    ...
    Ended1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Ended1, value), ::TYPES[20/*Fuse.Gestures.Internal.TwoFingerEventHandler*/]);
}

// public generated void remove_Ended(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1289
void TwoFinger::remove_Ended(uDelegate* value)
{
    ...
    Ended1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Ended1, value), ::TYPES[20/*Fuse.Gestures.Internal.TwoFingerEventHandler*/]);
}

// private float2 FromWindow(float2 p) [instance] :1356
...
// private void OnLostCapture() [instance] :1294
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :1373
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :1315
void TwoFinger::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (!::g::Fuse::Input::Pointer::SoftCapture(uPtr(args)->PointIndex(), _node, this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)TwoFinger__OnLostCapture_fn, this)))
    {
        OnLostCapture();
        return;
    }
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :1445
...
// private void OnRooted() [instance] :1274
void TwoFinger::OnRooted()
{
    uStackFrame __("Fuse.Gestures.Internal.TwoFinger", "OnRooted()");
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), _node, uDelegate::New(::TYPES[11/*Fuse.Input.PointerPressedHandler*/], (void*)TwoFinger__OnPointerPressed_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), _node, uDelegate::New(::TYPES[13/*Fuse.Input.PointerReleasedHandler*/], (void*)TwoFinger__OnPointerReleased_fn, this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _node, uDelegate::New(::TYPES[12/*Fuse.Input.PointerMovedHandler*/], (void*)TwoFinger__OnPointerMoved_fn, this));
}

// private void OnUnrooted() [instance] :1281
void TwoFinger::OnUnrooted()
{
    uStackFrame __("Fuse.Gestures.Internal.TwoFinger", "OnUnrooted()");
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Pressed()), _node, uDelegate::New(::TYPES[11/*Fuse.Input.PointerPressedHandler*/], (void*)TwoFinger__OnPointerPressed_fn, this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Released()), _node, uDelegate::New(::TYPES[13/*Fuse.Input.PointerReleasedHandler*/], (void*)TwoFinger__OnPointerReleased_fn, this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Pointer::Moved()), _node, uDelegate::New(::TYPES[12/*Fuse.Input.PointerMovedHandler*/], (void*)TwoFinger__OnPointerMoved_fn, this));
}

// private Fuse.Gestures.Internal.TwoFinger.Point PointFromArgs(Fuse.Input.PointerEventArgs args) [instance] :1364
...
// public generated void add_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) [instance] :1291
void TwoFinger::add_Rotated(uDelegate* value)
{
    ...
    Rotated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Rotated1, value), ::TYPES[21/*Fuse.Gestures.Internal.TwoFingerRotateHandler*/]);
}

// public generated void remove_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) [instance] :1291
void TwoFinger::remove_Rotated(uDelegate* value)
{
    ...
    Rotated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Rotated1, value), ::TYPES[21/*Fuse.Gestures.Internal.TwoFingerRotateHandler*/]);
}

// public generated void add_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1288
void TwoFinger::add_Started(uDelegate* value)
{
    ...
    Started1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Started1, value), ::TYPES[20/*Fuse.Gestures.Internal.TwoFingerEventHandler*/]);
}

// public generated void remove_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1288
void TwoFinger::remove_Started(uDelegate* value)
{
    ...
    Started1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Started1, value), ::TYPES[20/*Fuse.Gestures.Internal.TwoFingerEventHandler*/]);
}

// public generated void add_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) [instance] :1292
void TwoFinger::add_Translated(uDelegate* value)
{
    ...
    Translated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Translated1, value), ::TYPES[22/*Fuse.Gestures.Internal.TwoFingerTranslateHandler*/]);
}

// public generated void remove_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) [instance] :1292
void TwoFinger::remove_Translated(uDelegate* value)
{
    ...
    Translated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Translated1, value), ::TYPES[22/*Fuse.Gestures.Internal.TwoFingerTranslateHandler*/]);
}

// public generated void add_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) [instance] :1290
void TwoFinger::add_Zoomed(uDelegate* value)
{
    ...
    Zoomed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Zoomed1, value), ::TYPES[23/*Fuse.Gestures.Internal.TwoFingerZoomHandler*/]);
}

// public generated void remove_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) [instance] :1290
void TwoFinger::remove_Zoomed(uDelegate* value)
{
    ...
    Zoomed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Zoomed1, value), ::TYPES[23/*Fuse.Gestures.Internal.TwoFingerZoomHandler*/]);
}

// public static Fuse.Gestures.Internal.TwoFinger Attach(Fuse.Visual n) [static] :1248
...
// private TwoFinger New(Fuse.Visual n) [static] :1240
...
// internal delegate void TwoFingerEventHandler() :1226
...
// internal delegate void TwoFingerRotateHandler(float angle) :1228
...
// internal delegate void TwoFingerTranslateHandler(float2 amount) :1229
...
// internal delegate void TwoFingerZoomHandler(float factor) :1227
