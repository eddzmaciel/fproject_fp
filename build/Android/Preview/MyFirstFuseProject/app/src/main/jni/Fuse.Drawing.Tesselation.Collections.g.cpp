...
static void Dict_build(uType* type)
{
    ...
    type->SetPrecalc(
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Collections::DictNode_typeof()->MakeType(type->T(0))),
...
uObject* Dict::Items()
{
    uType* __types[] = {
        ...
        __type->GetBase(Dict_typeof())->Precalced(0/*Fuse.Drawing.Tesselation.Collections.DictNode<T>*/),
        __type->GetBase(Dict_typeof())->T(0),
        __type->GetBase(Dict_typeof())->Precalced(3/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.Collections.DictNode<T>>*/),
    ...
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(__types[0], (uObject*)_nodes, uDelegate::New(__types[4], (void*)Dict__Key_fn, this));
}
...
{
    ::TYPES[6] = ::g::Uno::Collections::IEnumerator1_typeof();
    ::TYPES[7] = ::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerator_typeof();
    type->SetPrecalc(
...
void PriorityQueue__Remove_fn(PriorityQueue* __this, void* item)
{
    ...
    for (int index = 0; index < __this->_used; ++index)
        if (::g::Uno::Object::Equals(uBoxPtr(__types[0], uPtr(item), U_ALLOCA(__types[0]->ObjectSize)), uBoxPtr(__types[0], uPtr(__this->_elements)->TItem(index))))
        {
