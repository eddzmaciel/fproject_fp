...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Content\Fonts\$.uno
// -------------------------------------------------------------------------
...
static void BitmapFont_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("CreateFromPbf", NULL, (void*)BitmapFont__CreateFromPbf_fn, 0, true, BitmapFont_typeof(), 2, ::g::Uno::Buffer_typeof(), ::g::Uno::Graphics::Texture2D_typeof()));
}
...
// public static Uno.Content.Fonts.BitmapFont CreateFromPbf(Uno.Buffer pbf, texture2D tex) :64
...
// private void Uno.IDisposable.Dispose() :59
...
{
    uStackFrame __("Uno.Content.Fonts.BitmapFont", ".ctor()");
...
// public static Uno.Content.Fonts.BitmapFont CreateFromPbf(Uno.Buffer pbf, texture2D tex) [static] :64
...
static void BitmapFont__CharPair_build(uType* type)
{
    ...
    type->Reflection.SetFields(2,
        ...
        new uField("Right", 1));
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BitmapFont__CharPair__New1_fn, 0, true, BitmapFont__CharPair_typeof(), 2, ::g::Uno::Char_typeof(), ::g::Uno::Char_typeof()));
}
...
{
    uStackFrame __("Uno.Content.Fonts.BitmapFont.CharPair", "GetHashCode()");
    int hash = 27;
...
{
    uStackFrame __("Uno.Content.Fonts.BitmapFont.CharPair", ".ctor(char,char)");
    Left = left;
    Right = right;
}
...
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "Dispose()");
    __this->_handle->Release();
    __this->_handle = 0;
}

// public override sealed string get_FamilyName() :230
void CppFontFace__get_FamilyName_fn(CppFontFace* __this, uString** __retval)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "get_FamilyName()");
    return *__retval = uStringFromXliString(__this->_handle->GetFamilyName()), void();
}

// public override sealed float GetAscender(float size) :238
void CppFontFace__GetAscender_fn(CppFontFace* __this, float* size, float* __retval)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "GetAscender(float)");
    float size_ = *size;
    return *__retval = __this->_handle->GetAscender(size_), void();
}

// public override sealed float GetDescender(float size) :243
void CppFontFace__GetDescender_fn(CppFontFace* __this, float* size, float* __retval)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "GetDescender(float)");
    float size_ = *size;
    return *__retval = __this->_handle->GetDescender(size_), void();
}

// public override sealed float GetLineHeight(float size) :248
void CppFontFace__GetLineHeight_fn(CppFontFace* __this, float* size, float* __retval)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "GetLineHeight(float)");
    float size_ = *size;
    return *__retval = __this->_handle->GetLineHeight(size_), void();
}

// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(byte[] data, int offset, int length) :204
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(string filename) :198
...
// public CppFontFace New(byte[] data, int offset, int length) :217
...
// public override sealed string get_StyleName() :235
void CppFontFace__get_StyleName_fn(CppFontFace* __this, uString** __retval)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "get_StyleName()");
    return *__retval = uStringFromXliString(__this->_handle->GetStyleName()), void();
}

// public override sealed bool TryGetKerning(float size, char left, char right, float2& result) :275
...
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "TryGetKerning(float,char,char,float2&)");
    float size_ = *size;
    uChar left_ = *left;
    uChar right_ = *right;
...
// public CppFontFace(byte[] data, int offset, int length) [instance] :217
void CppFontFace::ctor_1(uArray* data, int offset, int length)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", ".ctor(byte[],int,int)");
    ctor_();
    _handle = CppFontFace::LoadFontFaceHandle(data, offset, length);
}

// public CppFontFace(Uno.IO.BundleFile file) [instance] :212
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(byte[] data, int offset, int length) [static] :204
uImage::FontFace* CppFontFace::LoadFontFaceHandle(uArray* data, int offset, int length)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "LoadFontFaceHandle(byte[],int,int)");
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(string filename) [static] :198
uImage::FontFace* CppFontFace::LoadFontFaceHandle1(uString* filename)
{
    uStackFrame __("Uno.Content.Fonts.CppFontFace", "LoadFontFaceHandle(string)");
    uBase::Auto<uBase::Stream> f = uBase::Bundle->OpenFile(uStringToXliString(filename));
    return uImage::FontFace::Load(f);
}

// public CppFontFace New(byte[] data, int offset, int length) [static] :217
...
// public CppFontFace New(Uno.IO.BundleFile file) [static] :212
...
// public sealed class DefaultTextTransform :298
// {
static void DefaultTextTransform_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)DefaultTextTransform__New1_fn, 0, true, DefaultTextTransform_typeof(), 0));
}
...
// public generated DefaultTextTransform() [instance] :298
void DefaultTextTransform::ctor_1()
{
    uStackFrame __("Uno.Content.Fonts.DefaultTextTransform", ".ctor()");
    _matrix = ::g::Uno::Float4x4__Identity();
    ctor_();
}

// public generated DefaultTextTransform New() [static] :298
...
static void FontFace_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction("Load", NULL, (void*)FontFace__Load_fn, 0, true, FontFace_typeof(), 4, ::g::Uno::String_typeof(), ::g::Uno::Byte_typeof()->Array(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof()),
        new uFunction("Load", NULL, (void*)FontFace__Load1_fn, 0, true, FontFace_typeof(), 1, ::g::Uno::IO::BundleFile_typeof()),
...
// protected generated FontFace() :329
void FontFace__ctor__fn(FontFace* __this)
{
    __this->ctor_();
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) :345
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) :331
void FontFace__Load1_fn(::g::Uno::IO::BundleFile* file, FontFace** __retval)
{
    *__retval = FontFace::Load1(file);
}

// protected generated FontFace() [instance] :329
void FontFace::ctor_()
{
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) [static] :345
FontFace* FontFace::Load(uString* name, uArray* data, int offset, int length)
{
    uStackFrame __("Uno.Content.Fonts.FontFace", "Load(string,byte[],int,int)");
    return ::g::Uno::Content::Fonts::CppFontFace::New1(data, offset, length);
}

// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) [static] :331
...
static void FontFaceHelpers_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Char_typeof(), ::g::Uno::Content::Fonts::RenderedGlyph_typeof());
    ::TYPES[4] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Char_typeof(), ::g::Uno::Content::Fonts::RenderedGlyph_typeof());
    ::TYPES[5] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Char_typeof(), ::g::Uno::Content::Fonts::RenderedGlyph_typeof());
    type->Reflection.SetFunctions(1,
...
// public static Uno.Content.Fonts.BitmapFont RenderSpriteFont(Uno.Content.Fonts.FontFace font, float size, string charset) :392
...
// public static Uno.Content.Fonts.BitmapFont RenderSpriteFont(Uno.Content.Fonts.FontFace font, float size, string charset) [static] :392
...
// public struct RenderedGlyph :525
// {
static void RenderedGlyph_build(uType* type)
{
    ...
    type->Reflection.SetFields(3,
        ...
        new uField("Bitmap", 2));
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)RenderedGlyph__New1_fn, 0, true, RenderedGlyph_typeof(), 3, ::g::Uno::Float2_typeof(), ::g::Uno::Float2_typeof(), ::g::Uno::Content::Images::Bitmap_typeof()));
}
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :531
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :531
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [instance] :531
void RenderedGlyph::ctor_(::g::Uno::Float2 advance, ::g::Uno::Float2 bearing, ::g::Uno::Content::Images::Bitmap* bitmap)
{
    uStackFrame __("Uno.Content.Fonts.RenderedGlyph", ".ctor(float2,float2,Uno.Content.Images.Bitmap)");
    Advance = advance;
    Bearing = bearing;
    Bitmap = bitmap;
}

// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [static] :531
...
static void SdfFontShader_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SdfFontShader__New1_fn, 0, true, SdfFontShader_typeof(), 0));
}
...
// public generated SdfFontShader() :581
void SdfFontShader__ctor_1_fn(SdfFontShader* __this)
{
    __this->ctor_1();
}

// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :583
...
// private generated void init_DrawCalls() :581
void SdfFontShader__init_DrawCalls_fn(SdfFontShader* __this)
{
    __this->init_DrawCalls();
}

// public generated SdfFontShader New() :581
void SdfFontShader__New1_fn(SdfFontShader** __retval)
{
    *__retval = SdfFontShader::New1();
}

// public generated SdfFontShader() [instance] :581
void SdfFontShader::ctor_1()
{
    uStackFrame __("Uno.Content.Fonts.SdfFontShader", ".ctor()");
    ctor_();
    init_DrawCalls();
}

// private generated void init_DrawCalls() [instance] :581
void SdfFontShader::init_DrawCalls()
{
    uStackFrame __("Uno.Content.Fonts.SdfFontShader", "init_DrawCalls()");
    _draw_526147dd = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::UnoCore_bundle::SdfFontShadere233cf94());
}

// public generated SdfFontShader New() [static] :581
...
static void SpriteFontShader_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SpriteFontShader__New1_fn, 0, true, SpriteFontShader_typeof(), 0));
}
...
// public generated SpriteFontShader() :630
void SpriteFontShader__ctor_1_fn(SpriteFontShader* __this)
{
    __this->ctor_1();
}

// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :632
...
// private generated void init_DrawCalls() :630
void SpriteFontShader__init_DrawCalls_fn(SpriteFontShader* __this)
{
    __this->init_DrawCalls();
}

// public generated SpriteFontShader New() :630
void SpriteFontShader__New1_fn(SpriteFontShader** __retval)
{
    *__retval = SpriteFontShader::New1();
}

// public generated SpriteFontShader() [instance] :630
void SpriteFontShader::ctor_1()
{
    uStackFrame __("Uno.Content.Fonts.SpriteFontShader", ".ctor()");
    ctor_();
    init_DrawCalls();
}

// private generated void init_DrawCalls() [instance] :630
void SpriteFontShader::init_DrawCalls()
{
    uStackFrame __("Uno.Content.Fonts.SpriteFontShader", "init_DrawCalls()");
...
// public generated SpriteFontShader New() [static] :630
...
// public sealed class TextRenderer :650
// {
static void TextRenderer_build(uType* type)
{
    ::STRINGS[2] = uString::Const("font");
    ::TYPES[6] = ::g::Uno::Content::Fonts::TextTransform_typeof();
    ::TYPES[7] = ::g::Uno::Char_typeof();
    ...
    type->Reflection.SetFunctions(12,
        ...
        new uFunction(".ctor", NULL, (void*)TextRenderer__New1_fn, 0, true, TextRenderer_typeof(), 3, ::g::Uno::Int_typeof(), ::g::Uno::Content::Fonts::TextShader_typeof(), ::g::Uno::Content::Fonts::TextTransform_typeof()),
...
// public TextRenderer(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) :669
...
// public float2 MeasureString(string text, int startIndex, int length) :742
...
// public TextRenderer New(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) :669
...
// public Uno.Content.Fonts.TextTransform get_Transform() :698
...
// public void set_Transform(Uno.Content.Fonts.TextTransform value) :699
void TextRenderer__set_Transform_fn(TextRenderer* __this, ::g::Uno::Content::Fonts::TextTransform* value)
{
    __this->Transform(value);
}

// private void WriteGlyph(Uno.Content.Fonts.BitmapFont.GlyphInfo ci, float2 caret) :791
...
// public void WriteString(float2 caret, string text) :786
void TextRenderer__WriteString_fn(TextRenderer* __this, ::g::Uno::Float2* caret, uString* text)
{
    __this->WriteString(*caret, text);
}

// public void WriteString(float2 caret, string text, int startIndex, int length) :833
...
// public TextRenderer(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) [instance] :669
...
// public void Begin(Uno.Content.Fonts.BitmapFont font) [instance] :726
...
// public float4 get_Color() [instance] :716
::g::Uno::Float4 TextRenderer::Color()
{
    uStackFrame __("Uno.Content.Fonts.TextRenderer", "get_Color()");
    return ::g::Uno::Float4__New2((float)_color.X / 255.0f, (float)_color.Y / 255.0f, (float)_color.Z / 255.0f, (float)_color.W / 255.0f);
}

// public void set_Color(float4 value) [instance] :717
void TextRenderer::Color(::g::Uno::Float4 value)
{
    uStackFrame __("Uno.Content.Fonts.TextRenderer", "set_Color(float4)");
...
// public generated bool get_HasBegun() [instance] :652
bool TextRenderer::HasBegun()
{
    uStackFrame __("Uno.Content.Fonts.TextRenderer", "get_HasBegun()");
    return _HasBegun;
}

// private generated void set_HasBegun(bool value) [instance] :652
void TextRenderer::HasBegun(bool value)
{
    uStackFrame __("Uno.Content.Fonts.TextRenderer", "set_HasBegun(bool)");
    _HasBegun = value;
}

// public float2 MeasureString(string text) [instance] :737
...
// public float2 MeasureString(string text, int startIndex, int length) [instance] :742
...
// public Uno.Content.Fonts.TextTransform get_Transform() [instance] :698
::g::Uno::Content::Fonts::TextTransform* TextRenderer::Transform()
{
    uStackFrame __("Uno.Content.Fonts.TextRenderer", "get_Transform()");
    return _transform;
}

// public void set_Transform(Uno.Content.Fonts.TextTransform value) [instance] :699
void TextRenderer::Transform(::g::Uno::Content::Fonts::TextTransform* value)
{
    uStackFrame __("Uno.Content.Fonts.TextRenderer", "set_Transform(Uno.Content.Fonts.TextTransform)");
    _transform = value;
}

// private void WriteGlyph(Uno.Content.Fonts.BitmapFont.GlyphInfo ci, float2 caret) [instance] :791
...
// public void WriteString(float2 caret, string text) [instance] :786
...
// public void WriteString(float2 caret, string text, int startIndex, int length) [instance] :833
void TextRenderer::WriteString1(::g::Uno::Float2 caret, uString* text, int startIndex, int length)
{
    ...
    for (int i = startIndex; i < (startIndex + length); i++)
    {
        ...
        else if ((uPtr(_font)->FontFace != NULL) && uPtr(uPtr(_font)->FontFace)->ContainsGlyph(uPtr(_font)->PixelSize, c))
        {
            ...
            ::g::Uno::Content::Fonts::BitmapFont* tempFont = ::g::Uno::Content::Fonts::FontFaceHelpers::RenderSpriteFont(uPtr(oldFont)->FontFace, uPtr(oldFont)->PixelSize, ::g::Uno::Char::ToString(c, ::TYPES[7/*char*/]));

            {
                const auto __finally_fun = [&]()
                {
                    ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)tempFont), ::TYPES[8/*Uno.IDisposable*/]));
                };
...
// public TextRenderer New(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) [static] :669
...
// protected generated TextShader() :986
void TextShader__ctor__fn(TextShader* __this)
{
    __this->ctor_();
}

// protected generated TextShader() [instance] :986
...
// public sealed class TextShaderData :942
// {
...
// internal TextShaderData(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) :960
...
// internal TextShaderData New(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) :960
...
// internal TextShaderData(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) [instance] :960
void TextShaderData::ctor_(::g::Uno::Graphics::IndexBuffer* ibo, ::g::Uno::Graphics::VertexBuffer* vbo)
{
    uStackFrame __("Uno.Content.Fonts.TextShaderData", ".ctor(Uno.Graphics.IndexBuffer,Uno.Graphics.VertexBuffer)");
    FontScale = 1.0f;
...
// internal TextShaderData New(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) [static] :960
...
// public abstract class TextTransform :1018
// {
...
// protected generated TextTransform() :1018
void TextTransform__ctor__fn(TextTransform* __this)
{
    __this->ctor_();
}

// public virtual Uno.Graphics.PolygonFace get_CullFace() :1028
void TextTransform__get_CullFace_fn(TextTransform* __this, int* __retval)
{
    uStackFrame __("Uno.Content.Fonts.TextTransform", "get_CullFace()");
    return *__retval = 0, void();
}

// protected generated TextTransform() [instance] :1018
