...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Meshes\0.33.5\$.uno
// ------------------------------------------------------------

// public static class MeshGenerator :10
// {
static void MeshGenerator_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
...
// public static Uno.Content.Models.ModelMesh CreateCone(float height, float radius, int horizontalTessellation, int verticalTessellation) :243
...
// public static Uno.Content.Models.ModelMesh CreateCube(float3 pivot, float halfExtent) :12
...
// public static Uno.Content.Models.ModelMesh CreateCylinder(float height, float radius, int horizontalTessellation, int verticalTessellation) :130
...
// public static Uno.Content.Models.ModelMesh CreateSphere(float3 pivot, float radius, int slices, int stacks) :69
...
// public static Uno.Content.Models.ModelMesh CreateCone(float height, float radius, int horizontalTessellation, int verticalTessellation) [static] :243
...
// public static Uno.Content.Models.ModelMesh CreateCube(float3 pivot, float halfExtent) [static] :12
...
// public static Uno.Content.Models.ModelMesh CreateCylinder(float height, float radius, int horizontalTessellation, int verticalTessellation) [static] :130
...
// public static Uno.Content.Models.ModelMesh CreateSphere(float3 pivot, float radius, int slices, int stacks) [static] :69
...
static void MeshTools_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Float3_typeof()->Array();
    ::TYPES[3] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
    ::TYPES[6] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[7] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[8] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[9] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
...
// public static Uno.Content.Models.ModelMesh CalculateNormals(Uno.Content.Models.ModelMesh mesh) :354
...
// public static Uno.Content.Models.ModelMesh CalculateTangentsAndBinormals(Uno.Content.Models.ModelMesh m) :392
...
// public static Uno.Content.Models.ModelMesh CalculateNormals(Uno.Content.Models.ModelMesh mesh) [static] :354
...
// public static Uno.Content.Models.ModelMesh CalculateTangentsAndBinormals(Uno.Content.Models.ModelMesh m) [static] :392
