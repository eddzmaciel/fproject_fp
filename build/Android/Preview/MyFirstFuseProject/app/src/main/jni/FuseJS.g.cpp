...
// C:\ProgramData\Uno\Packages\FuseJS\0.33.5\$.uno
// -----------------------------------------------

// public sealed class Base64 :347
// {
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) :382
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) :414
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) :366
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) :398
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :382
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :414
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :366
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :398
...
// public sealed class Bundle :449
// {
...
// private static object Read(Fuse.Scripting.Context c, object[] args) [static] :519
...
// private static string Read(string filename) [static] :529
...
// private static Uno.Threading.Future<string> ReadAsync(object[] args) [static] :493
...
// private static Uno.Threading.Future<string> ReadAsync(string filename) [static] :546
...
// private static bool TryGetBundleFile(string sourcePath, Uno.IO.BundleFile& bundleFile) [static] :461
...
void Environment::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[12/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[14/*"preview"*/], uCRef(true), &ret6), ret6));
}
...
// private sealed class FileReaderImpl.FileReadCommand :582
// {
...
// public string ReadAsDataURL() :593
...
// public FileReadCommand(string path) [instance] :585
...
// public string ReadAsDataURL() [instance] :593
...
// public string ReadAsText() [instance] :589
...
// public FileReadCommand New(string path) [static] :585
...
// public sealed class FileReaderImpl :580
// {
...
// private static Uno.Threading.Future<string> readAsText(object[] args) :617
...
// public FileReaderImpl() [instance] :603
...
// public FileReaderImpl New() [static] :603
...
// private static Uno.Threading.Future<string> readAsDataURL(object[] args) [static] :611
...
// private static Uno.Threading.Future<string> readAsText(object[] args) [static] :617
...
// internal sealed class RaiseEvent :634
// {
static void RaiseEvent_build(uType* type)
{
    ::STRINGS[37] = uString::Const("Cannot find message with name: ");
    ::STRINGS[38] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseJS\\0.33.5\\$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[37/*"Cannot find...*/], Name), this, ::STRINGS[38/*"C:\\Program...*/], 646, ::STRINGS[39/*"Raise"*/]);
        return;
    }
...
// public generated RaiseEvent New() [static] :634
...
// private sealed class Bundle.ReadClosure :551
// {
...
// public ReadClosure(string filename) [instance] :555
...
// public string Invoke() [instance] :560
...
// public ReadClosure New(string filename) [static] :555
...
// public sealed class UserEvents :656
// {
...
// public UserEvents() :659
void UserEvents__ctor_2_fn(UserEvents* __this)
{
    __this->ctor_2();
}

// public UserEvents New() :659
void UserEvents__New2_fn(UserEvents** __retval)
{
    *__retval = UserEvents::New2();
}

// public static object Raise(Fuse.Scripting.Context context, object[] args) :672
...
// public UserEvents() [instance] :659
...
// public UserEvents New() [static] :659
...
// public static object Raise(Fuse.Scripting.Context context, object[] args) [static] :672
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[42/*"The FuseJS/...*/], context, ::STRINGS[38/*"C:\\Program...*/], 677, ::STRINGS[39/*"Raise"*/]);
