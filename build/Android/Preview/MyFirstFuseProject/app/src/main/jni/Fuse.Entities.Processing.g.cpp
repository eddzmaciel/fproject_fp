...
static void Extrude_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Fuse::IOutput_typeof()->MakeType(::g::Fuse::Drawing::Polygon_typeof());
...
::g::Fuse::Entities::Mesh* Extrude::Output()
{
    ...
    if ((_source == NULL) || ((::g::Fuse::IOutput::get_Output_ex(uInterface(uPtr(_source), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), &ret2), ret2) == NULL))
        return NULL;

    _output = ::g::Fuse::Entities::Mesh::New2(uPtr((::g::Fuse::IOutput::get_Output_ex(uInterface(uPtr(_source), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), &ret3), ret3))->Extrude(Depth(), SmoothingThreshold()));
    return _output;
}
...
void Extrude::add_OutputChanged(uDelegate* value)
{
    ...
    OutputChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(OutputChanged1, value), ::TYPES[2/*Uno.Action*/]);
}
...
void Extrude::remove_OutputChanged(uDelegate* value)
{
    ...
    OutputChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(OutputChanged1, value), ::TYPES[2/*Uno.Action*/]);
}
...
void Extrude::Source(uObject* value)
{
    ...
    if (_source != NULL)
        ::g::Fuse::IOutput::remove_OutputChanged(uInterface(uPtr(_source), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)Extrude__Invalidate_fn, this));

    _source = value;

    if (_source != NULL)
        ::g::Fuse::IOutput::add_OutputChanged(uInterface(uPtr(_source), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)Extrude__Invalidate_fn, this));
...
::g::Fuse::Drawing::Polygon* Stroke::Output()
{
    ...
    _output = uPtr((::g::Fuse::IOutput::get_Output_ex(uInterface(uPtr(Source()), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), &ret3), ret3))->Stroke(::g::Uno::Math::Max1(0.1f, Width()), Offset(), StartCap(), EndCap());
    return _output;
}
...
void Stroke::Source(uObject* value)
{
    ...
    if (_source != NULL)
        ::g::Fuse::IOutput::remove_OutputChanged(uInterface(uPtr(_source), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)Stroke__Invalidate_fn, this));

    _source = value;

    if (_source != NULL)
        ::g::Fuse::IOutput::add_OutputChanged(uInterface(uPtr(_source), ::TYPES[1/*Fuse.IOutput<Fuse.Drawing.Polygon>*/]), uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)Stroke__Invalidate_fn, this));
