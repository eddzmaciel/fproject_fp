...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Time\Text\$.uno
// ---------------------------------------------------------------------
...
static void FixedFormatPattern_build(uType* type)
{
    ...
    type->SetPrecalc(
        ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(type->T(0)));
    type->SetFields(0,
...
void FixedFormatPattern__Format_fn(FixedFormatPattern* __this, void* bucket, uString** __retval)
{
    ...
    for (array1 = __this->_parts, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uPtr(sb)->Append2((::g::Uno::Time::Text::IPatternPart::Write_ex(uInterface(uPtr(part), __types[1]), bucket, &ret2), ret2));
    }
...
void FixedFormatPattern__Parse_fn(FixedFormatPattern* __this, uString* line, void* bucket)
{
    ...
    for (int i = 0; i < uPtr(__this->_parts)->Length(); i++)
    {
        ...
        int readCount = (::g::Uno::Time::Text::IPatternPart::Read_ex(uInterface(uPtr(part), __types[1]), line, uCRef<int>(position), bucket, &ret3), ret3);
        position = position + readCount;

        if (readCount == 0)
            i = i + ::g::Uno::Time::Text::IPatternPart::SkipNextPartsCountIfThisNotSpecified(uInterface(uPtr(part), __types[1]));
    }
...
{
    uStackFrame __("Uno.Time.Text.FixedFormatPattern`1", ".ctor(Uno.Time.Text.IPatternPart<T>[])");
    _parts = parts;
}
...
{
    ::TYPES[1] = ::g::Uno::Time::Text::FixedFormatPattern_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof());
    ::TYPES[2] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof())->Array();
    ::TYPES[3] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof());
    ::TYPES[4] = ::g::Uno::Time::Text::SignPart_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof());
    ::TYPES[5] = ::g::Uno::Action2_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[6] = ::g::Uno::Func1_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[7] = ::g::Uno::Time::Text::NumberPart_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof());
    ::TYPES[8] = ::g::Uno::Time::Text::SeparatorPart_typeof()->MakeType(LocalDatePattern__LocalDateBucket_typeof());
    ::TYPES[9] = ::g::Uno::Exception_typeof();
    ::TYPES[10] = ::g::Uno::Time::Text::ParseResult_typeof()->MakeType(::g::Uno::Time::LocalDate_typeof());
    type->SetFields(0,
...
void LocalDatePattern::ctor_()
{
    ...
    _generalPattern = ((::g::Uno::Time::Text::FixedFormatPattern*)::g::Uno::Time::Text::FixedFormatPattern::New1(::TYPES[1/*Uno.Time.Text.FixedFormatPattern<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], uArray::Init<uObject*>(::TYPES[2/*Uno.Time.Text.IPatternPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>[]*/], 6, (uObject*)((::g::Uno::Time::Text::SignPart*)::g::Uno::Time::Text::SignPart::New2(::TYPES[4/*Uno.Time.Text.SignPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], uDelegate::New(::TYPES[5/*Uno.Action<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__SetSign_fn, this), uDelegate::New(::TYPES[6/*Uno.Func<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__GetSign_fn, this))), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[7/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], 4, true, uDelegate::New(::TYPES[5/*Uno.Action<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__SetYear_fn, this), uDelegate::New(::TYPES[6/*Uno.Func<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__GetYear_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[8/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], true, '-', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[7/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], 2, true, uDelegate::New(::TYPES[5/*Uno.Action<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__SetMonth_fn, this), uDelegate::New(::TYPES[6/*Uno.Func<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__GetMonth_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[8/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], true, '-', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[7/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDatePattern.LocalDateBucket>*/], 2, true, uDelegate::New(::TYPES[5/*Uno.Action<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__SetDay_fn, this), uDelegate::New(::TYPES[6/*Uno.Func<Uno.Time.Text.LocalDatePattern.LocalDateBucket, int>*/], (void*)LocalDatePattern__GetDay_fn, this))))));
}
...
::g::Uno::Time::Text::ParseResult* LocalDatePattern::Parse(uString* text)
{
    ...
    try
    {
        ...
        return (::g::Uno::Time::Text::ParseResult__ForValue_fn(::TYPES[10/*Uno.Time.Text.ParseResult<Uno.Time.LocalDate>*/], ld, &ret4), ret4);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* ex = __t.Exception;
        return (::g::Uno::Time::Text::ParseResult*)::g::Uno::Time::Text::ParseResult::ForException(::TYPES[10/*Uno.Time.Text.ParseResult<Uno.Time.LocalDate>*/], ex);
    }
}
...
{
    ::TYPES[11] = ::g::Uno::Time::Text::FixedFormatPattern_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof());
    ::TYPES[12] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof())->Array();
    ::TYPES[13] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof());
    ::TYPES[14] = ::g::Uno::Time::Text::SignPart_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof());
    ::TYPES[15] = ::g::Uno::Action2_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[16] = ::g::Uno::Func1_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[17] = ::g::Uno::Time::Text::NumberPart_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof());
    ::TYPES[18] = ::g::Uno::Time::Text::SeparatorPart_typeof()->MakeType(LocalDateTimePattern__LocalDateTimeBucket_typeof());
    ::TYPES[9] = ::g::Uno::Exception_typeof();
    ::TYPES[19] = ::g::Uno::Time::Text::ParseResult_typeof()->MakeType(::g::Uno::Time::LocalDateTime_typeof());
    type->SetFields(0,
...
void LocalDateTimePattern::ctor_()
{
    ...
    _generalPattern = ((::g::Uno::Time::Text::FixedFormatPattern*)::g::Uno::Time::Text::FixedFormatPattern::New1(::TYPES[11/*Uno.Time.Text.FixedFormatPattern<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], uArray::Init<uObject*>(::TYPES[12/*Uno.Time.Text.IPatternPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>[]*/], 12, (uObject*)((::g::Uno::Time::Text::SignPart*)::g::Uno::Time::Text::SignPart::New2(::TYPES[14/*Uno.Time.Text.SignPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetSign_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetSign_fn, this))), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], 4, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetYear_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetYear_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], true, '-', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetMonth_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetMonth_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], true, '-', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetDay_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetDay_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], true, 'T', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetHour_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetHour_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetMinute_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetMinute_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__SetSecond_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.LocalDateTimePattern.LocalDateTimeBucket, int>*/], (void*)LocalDateTimePattern__GetSecond_fn, this))))));
}
...
::g::Uno::Time::Text::ParseResult* LocalDateTimePattern::Parse(uString* text)
{
    ...
    try
    {
        ...
        return (::g::Uno::Time::Text::ParseResult__ForValue_fn(::TYPES[19/*Uno.Time.Text.ParseResult<Uno.Time.LocalDateTime>*/], ldt, &ret4), ret4);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* ex = __t.Exception;
        return (::g::Uno::Time::Text::ParseResult*)::g::Uno::Time::Text::ParseResult::ForException(::TYPES[19/*Uno.Time.Text.ParseResult<Uno.Time.LocalDateTime>*/], ex);
    }
}
...
{
    ::TYPES[20] = ::g::Uno::Time::Text::FixedFormatPattern_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof());
    ::TYPES[21] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof())->Array();
    ::TYPES[22] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof());
    ::TYPES[23] = ::g::Uno::Time::Text::NumberPart_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof());
    ::TYPES[24] = ::g::Uno::Action2_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[25] = ::g::Uno::Func1_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[26] = ::g::Uno::Time::Text::SeparatorPart_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof());
    ::TYPES[27] = ::g::Uno::Time::Text::RangeNumberPart_typeof()->MakeType(LocalTimePattern__LocalTimeBucket_typeof());
    ::TYPES[9] = ::g::Uno::Exception_typeof();
    ::TYPES[28] = ::g::Uno::Time::Text::ParseResult_typeof()->MakeType(::g::Uno::Time::LocalTime_typeof());
    type->SetFields(0,
...
void LocalTimePattern::ctor_()
{
    ...
    _generalPattern = ((::g::Uno::Time::Text::FixedFormatPattern*)::g::Uno::Time::Text::FixedFormatPattern::New1(::TYPES[20/*Uno.Time.Text.FixedFormatPattern<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], uArray::Init<uObject*>(::TYPES[21/*Uno.Time.Text.IPatternPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>[]*/], 7, (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[23/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], 2, true, uDelegate::New(::TYPES[24/*Uno.Action<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__SetHour_fn, this), uDelegate::New(::TYPES[25/*Uno.Func<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__GetHour_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[26/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[23/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], 2, true, uDelegate::New(::TYPES[24/*Uno.Action<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__SetMinute_fn, this), uDelegate::New(::TYPES[25/*Uno.Func<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__GetMinute_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[26/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[23/*Uno.Time.Text.NumberPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], 2, true, uDelegate::New(::TYPES[24/*Uno.Action<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__SetSecond_fn, this), uDelegate::New(::TYPES[25/*Uno.Func<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__GetSecond_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[26/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], false, '.', 0)), (uObject*)((::g::Uno::Time::Text::RangeNumberPart*)::g::Uno::Time::Text::RangeNumberPart::New1(::TYPES[27/*Uno.Time.Text.RangeNumberPart<Uno.Time.Text.LocalTimePattern.LocalTimeBucket>*/], 3, 7, uDelegate::New(::TYPES[24/*Uno.Action<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__SetMillisecond_fn, this), uDelegate::New(::TYPES[25/*Uno.Func<Uno.Time.Text.LocalTimePattern.LocalTimeBucket, int>*/], (void*)LocalTimePattern__GetMillisecond_fn, this))))));
}
...
::g::Uno::Time::Text::ParseResult* LocalTimePattern::Parse(uString* text)
{
    ...
    try
    {
        ...
        return (::g::Uno::Time::Text::ParseResult__ForValue_fn(::TYPES[28/*Uno.Time.Text.ParseResult<Uno.Time.LocalTime>*/], uCRef(lt), &ret4), ret4);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* ex = __t.Exception;
        return (::g::Uno::Time::Text::ParseResult*)::g::Uno::Time::Text::ParseResult::ForException(::TYPES[28/*Uno.Time.Text.ParseResult<Uno.Time.LocalTime>*/], ex);
    }
}
...
void NumberPart__Write_fn(NumberPart* __this, void* value, uString** __retval)
{
    ...
    int ret2;
    return *__retval = ::g::Uno::String::Format(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"{0:D"*/], uBox<int>(::g::Uno::Int_typeof(), __this->ExpectedSize())), ::STRINGS[4/*"}"*/]), uArray::Init<uObject*>(::TYPES[30/*object[]*/], 1, uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Math::Abs5((::g::Uno::Time::Text::PatternPart__Get_fn(__this, value, &ret2), ret2))))), void();
}
...
{
    uStackFrame __("Uno.Time.Text.NumberPart`1", ".ctor(int,bool,Uno.Action<T, int>,Uno.Func<T, int>)");
    ctor_();
    Setter(setter);
    Getter(getter);
    ExpectedSize(size);
...
{
    ::TYPES[31] = ::g::Uno::Time::Text::FixedFormatPattern_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[32] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof())->Array();
    ::TYPES[33] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[34] = ::g::Uno::Time::Text::SignPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[35] = ::g::Uno::Action2_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[36] = ::g::Uno::Func1_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[37] = ::g::Uno::Time::Text::NumberPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[38] = ::g::Uno::Time::Text::SeparatorPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[39] = ::g::Uno::Time::Text::RangeNumberPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[40] = ::g::Uno::Time::Text::OffsetPatternPart_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof());
    ::TYPES[41] = ::g::Uno::Action2_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof(), ::g::Uno::Time::Offset_typeof());
    ::TYPES[42] = ::g::Uno::Func1_typeof()->MakeType(OffsetDateTimePattern__OffsetDateTimeBucket_typeof(), ::g::Uno::Time::Offset_typeof());
    ::TYPES[9] = ::g::Uno::Exception_typeof();
    ::TYPES[43] = ::g::Uno::Time::Text::ParseResult_typeof()->MakeType(::g::Uno::Time::OffsetDateTime_typeof());
    type->SetFields(0,
...
void OffsetDateTimePattern::ctor_()
{
    ...
    _generalPattern = ((::g::Uno::Time::Text::FixedFormatPattern*)::g::Uno::Time::Text::FixedFormatPattern::New1(::TYPES[31/*Uno.Time.Text.FixedFormatPattern<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], uArray::Init<uObject*>(::TYPES[32/*Uno.Time.Text.IPatternPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>[]*/], 15, (uObject*)((::g::Uno::Time::Text::SignPart*)::g::Uno::Time::Text::SignPart::New2(::TYPES[34/*Uno.Time.Text.SignPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetSign_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetSign_fn, this))), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[37/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 4, true, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetYear_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetYear_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[38/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], true, '-', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[37/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetMonth_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetMonth_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[38/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], true, '-', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[37/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetDay_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetDay_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[38/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], true, 'T', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[37/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetHour_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetHour_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[38/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[37/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetMinute_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetMinute_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[38/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[37/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 2, true, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetSecond_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetSecond_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New2(::TYPES[38/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], false, '.', 1)), (uObject*)((::g::Uno::Time::Text::RangeNumberPart*)::g::Uno::Time::Text::RangeNumberPart::New1(::TYPES[39/*Uno.Time.Text.RangeNumberPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], 3, 3, uDelegate::New(::TYPES[35/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__SetMillisecond_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, int>*/], (void*)OffsetDateTimePattern__GetMillisecond_fn, this))), (uObject*)((::g::Uno::Time::Text::OffsetPatternPart*)::g::Uno::Time::Text::OffsetPatternPart::New1(::TYPES[40/*Uno.Time.Text.OffsetPatternPart<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket>*/], uDelegate::New(::TYPES[41/*Uno.Action<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, Uno.Time.Offset>*/], (void*)OffsetDateTimePattern__SetOffset_fn, this), uDelegate::New(::TYPES[42/*Uno.Func<Uno.Time.Text.OffsetDateTimePattern.OffsetDateTimeBucket, Uno.Time.Offset>*/], (void*)OffsetDateTimePattern__GetOffset_fn, this))))));
}
...
::g::Uno::Time::Text::ParseResult* OffsetDateTimePattern::Parse(uString* text)
{
    ...
    try
    {
        ...
        return (::g::Uno::Time::Text::ParseResult__ForValue_fn(::TYPES[43/*Uno.Time.Text.ParseResult<Uno.Time.OffsetDateTime>*/], result, &ret4), ret4);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* ex = __t.Exception;
        return (::g::Uno::Time::Text::ParseResult*)::g::Uno::Time::Text::ParseResult::ForException(::TYPES[43/*Uno.Time.Text.ParseResult<Uno.Time.OffsetDateTime>*/], ex);
    }
}
...
static void OffsetPattern_build(uType* type)
{
    ...
    ::TYPES[44] = ::g::Uno::Time::Text::FixedFormatPattern_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[45] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof())->Array();
    ::TYPES[46] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[47] = ::g::Uno::Time::Text::SignPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[48] = ::g::Uno::Action2_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[49] = ::g::Uno::Func1_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[50] = ::g::Uno::Time::Text::NumberPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[51] = ::g::Uno::Time::Text::SeparatorPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[9] = ::g::Uno::Exception_typeof();
    ::TYPES[52] = ::g::Uno::Time::Text::ParseResult_typeof()->MakeType(::g::Uno::Time::Offset_typeof());
    type->SetFields(0,
...
void OffsetPattern::ctor_()
{
    ...
    _generalPattern = ((::g::Uno::Time::Text::FixedFormatPattern*)::g::Uno::Time::Text::FixedFormatPattern::New1(::TYPES[44/*Uno.Time.Text.FixedFormatPattern<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], uArray::Init<uObject*>(::TYPES[45/*Uno.Time.Text.IPatternPart<Uno.Time.Text.OffsetPattern.OffsetBucket>[]*/], 6, (uObject*)((::g::Uno::Time::Text::SignPart*)::g::Uno::Time::Text::SignPart::New1(::TYPES[47/*Uno.Time.Text.SignPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], true, uDelegate::New(::TYPES[48/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetSign_fn, this), uDelegate::New(::TYPES[49/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetSign_fn, this))), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[50/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], 2, true, uDelegate::New(::TYPES[48/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetHour_fn, this), uDelegate::New(::TYPES[49/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetHour_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New1(::TYPES[51/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], false, true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[50/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], 2, false, uDelegate::New(::TYPES[48/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetMinute_fn, this), uDelegate::New(::TYPES[49/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetMinute_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New1(::TYPES[51/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], false, true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[50/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], 2, false, uDelegate::New(::TYPES[48/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetSecond_fn, this), uDelegate::New(::TYPES[49/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetSecond_fn, this))))));
}
...
::g::Uno::Time::Text::ParseResult* OffsetPattern::Parse(uString* text)
{
    ...
    try
    {
        if (::g::Uno::String::op_Equality(text, ::STRINGS[5/*"Z"*/]))
            return (::g::Uno::Time::Text::ParseResult__ForValue_fn(::TYPES[52/*Uno.Time.Text.ParseResult<Uno.Time.Offset>*/], uCRef(::g::Uno::Time::Offset::Zero()), &ret3), ret3);

        OffsetPattern__OffsetBucket* bucket = OffsetPattern__OffsetBucket::New1();
        ::g::Uno::Time::Text::FixedFormatPattern__Parse_fn(uPtr(_generalPattern), text, bucket);
        ::g::Uno::Time::Offset offset = ::g::Uno::Time::Offset__FromHoursAndMinutes(bucket->Sign * bucket->Hour, bucket->Sign * bucket->Minute);
        return (::g::Uno::Time::Text::ParseResult__ForValue_fn(::TYPES[52/*Uno.Time.Text.ParseResult<Uno.Time.Offset>*/], uCRef(offset), &ret4), ret4);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* ex = __t.Exception;
        return (::g::Uno::Time::Text::ParseResult*)::g::Uno::Time::Text::ParseResult::ForException(::TYPES[52/*Uno.Time.Text.ParseResult<Uno.Time.Offset>*/], ex);
    }
}
...
{
    uStackFrame __("Uno.Time.Text.OffsetPatternPart`1", ".ctor(Uno.Action<T, Uno.Time.Offset>,Uno.Func<T, Uno.Time.Offset>)");
    ctor_();
    Setter(setter);
    Getter(getter);
}
...
void ParseResult__ctor__fn(ParseResult* __this, void* value)
{
    ...
    uStackFrame __("Uno.Time.Text.ParseResult`1", ".ctor(T)");
    __this->_value() = value;
}
...
void ParseResult__ForValue_fn(uType* __type, void* value, ParseResult** __retval)
{
    ...
    uStackFrame __("Uno.Time.Text.ParseResult`1", "ForValue(T)");
    ParseResult* ret3;
...
{
    uStackFrame __("Uno.Time.Text.ParseResult`1", ".ctor(Uno.Exception)");
...
{
    uStackFrame __("Uno.Time.Text.ParseResult`1", "ForException(Uno.Exception)");
...
void PatternPart__Write_fn(PatternPart* __this, void* value, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::Object::ToString(uBoxPtr(__types[1], uPtr((PatternPart__Get_fn(__this, value, &ret2), ret2)), U_ALLOCA(__types[1]->ObjectSize))), void();
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "get_ExpectedSize()");
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "set_ExpectedSize(int)");
    _ExpectedSize = value;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "get_Getter()");
    return _Getter;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "set_Getter(Uno.Func<TBucket, T>)");
    _Getter = value;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "get_Obligatory()");
    return _Obligatory;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "set_Obligatory(bool)");
    _Obligatory = value;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "get_Setter()");
    return _Setter;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "set_Setter(Uno.Action<TBucket, T>)");
    _Setter = value;
}
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "get_SkipNextPartsCountIfThisNotSpecified()");
...
{
    uStackFrame __("Uno.Time.Text.PatternPart`2", "set_SkipNextPartsCountIfThisNotSpecified(int)");
...
void RangeNumberPart__Write_fn(RangeNumberPart* __this, void* value, uString** __retval)
{
    ...
    uStackFrame __("Uno.Time.Text.RangeNumberPart`1", "Write(T)");
...
{
    uStackFrame __("Uno.Time.Text.RangeNumberPart`1", ".ctor(int,int,Uno.Action<T, int>,Uno.Func<T, int>)");
    ctor_();
    Setter(setter);
    Getter(getter);
    _maxSize = maxSize;
...
void SeparatorPart__Write_fn(SeparatorPart* __this, void* value, uString** __retval)
{
    ...
    return *__retval = (__this->Obligatory() || __this->_show) ? (uString*)::g::Uno::Char::ToString(__this->_separator, ::TYPES[54/*char*/]) : (uString*)::g::Uno::String::Empty(), void();
}
...
{
    uStackFrame __("Uno.Time.Text.SeparatorPart`1", ".ctor(bool,bool,char,[int])");
    ctor_();
    ExpectedSize(1);
    Obligatory(obligatory);
...
{
    uStackFrame __("Uno.Time.Text.SeparatorPart`1", ".ctor(bool,char,[int])");
    ctor_();
    ExpectedSize(1);
    Obligatory(obligatory);
    SkipNextPartsCountIfThisNotSpecified(skipNextPartsCountIfThisNotSpecified);
...
{
    uStackFrame __("Uno.Time.Text.SignPart`1", ".ctor(bool,Uno.Action<T, int>,Uno.Func<T, int>)");
    ctor_();
    Setter(setter);
    Getter(getter);
    ExpectedSize(1);
...
{
    uStackFrame __("Uno.Time.Text.SignPart`1", ".ctor(Uno.Action<T, int>,Uno.Func<T, int>)");
    ctor_();
    Setter(setter);
    Getter(getter);
    ExpectedSize(1);
