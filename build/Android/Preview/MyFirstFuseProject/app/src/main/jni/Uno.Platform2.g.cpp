...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Platform2\$.uno
// ---------------------------------------------------------------------
...
static void Application_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\UnoCore\\0.33.1\\Source\\Uno\\Platform2\\$.uno");
    ...
    ::TYPES[6] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[7] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    ::TYPES[8] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    ::TYPES[9] = ::g::Uno::EventHandler_typeof();
    type->SetFields(0,
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof()), (uintptr_t)&::g::Uno::Platform2::Application::_delayedURIS_, uFieldFlagsStatic,
        ::g::Uno::Platform2::ApplicationState_typeof(), (uintptr_t)&::g::Uno::Platform2::Application::_State_, uFieldFlagsStatic,
        ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof()), (uintptr_t)&::g::Uno::Platform2::Application::_receivedURI1_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFunctions(25,
        new uFunction("add__receivedURI", NULL, (void*)Application__add__receivedURI_fn, 0, true, uVoid_typeof(), 1, ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof())),
        new uFunction("remove__receivedURI", NULL, (void*)Application__remove__receivedURI_fn, 0, true, uVoid_typeof(), 1, ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof())),
...
{
    uStackFrame __("Uno.Platform2.Application", "_Init()");
...
{
    uStackFrame __("Uno.Platform2.Application", "_Start()");
    Application_typeof()->Init();
    uStartApp();
}
...
void Application::DispatchDelayedUri()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
    {
        ...
        {
            for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum13 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(Application::_delayedURIS()), &ret14), ret14); enum13.MoveNext(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]); )
            {
                uString* u = enum13.Current(::TYPES[2/*Uno.Collections.List<string>.Enumerator*/]);
...
void Application::EnterBackground()
{
    ...
    switch (Application::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"EnterBackgr...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 197);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"EnterBackgr...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 201);
            return;
        }
        case 1:
            return;
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert9 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 215, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert9), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 2)));
    Application::State(1);
    Application::DidEnterBackground();
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert10 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 224, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert10), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 1)));
}
...
void Application::EnterForeground()
{
    ...
    switch (Application::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"EnterForegr...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 88);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"EnterForegr...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 92);
            return;
        }
        case 1:
            break;
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 104, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert3), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 1)));
    Application::State(2);
    Application::DidEnterForeground();
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert4 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 113, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert4), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 2)));
}
...
void Application::EnterInteractive()
{
    ...
    switch (Application::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"EnterIntera...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 125);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"EnterIntera...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 129);
            return;
        }
        case 1:
        {
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert5 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 143, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert5), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 2)));
    Application::State(3);
    Application::DidEnterInteractive();
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert6 == 3, ::STRINGS[9/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 152, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert6), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 3)));
}
...
void Application::ExitInteractive()
{
    ...
    switch (Application::State())
    {
        case -1:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[10/*"ExitInterac...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 164);
            return;
        }
        case 0:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[11/*"ExitInterac...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 168);
            return;
        }
        case 1:
        case 2:
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert7 == 3, ::STRINGS[9/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 179, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert7), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 3)));
    Application::State(2);
    Application::DidExitInteractive();
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert8 == 2, ::STRINGS[3/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 188, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert8), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 2)));
}
...
{
    uStackFrame __("Uno.Platform2.Application", "GetRootView()");
    Application_typeof()->Init();
...
{
    uStackFrame __("Uno.Platform2.Application", "Quit()");
    Application_typeof()->Init();
...
{
    uStackFrame __("Uno.Platform2.Application", "SetRootView(Uno.Platform.ViewNativeHandle)");
    Application_typeof()->Init();
...
void Application::Start()
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == 0, ::STRINGS[12/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 61, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert1), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 0)));
    Application::_Start();
    Application::State(1);
    Application::DidStart();
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert2 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 73, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert2), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 1)));
}
...
void Application::Terminate()
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert11 == 1, ::STRINGS[4/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 245, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert11), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), 1)));
    Application::State(-1);
    Application::WillTerminate();
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert12 == -1, ::STRINGS[13/*"Uno.Platfor...*/], ::STRINGS[1/*"C:\\Program...*/], 254, uArray::Init<uObject*>(::TYPES[4/*object[]*/], 2, uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), assert12), uBox<int>(::g::Uno::Platform2::ApplicationState_typeof(), -1)));
    Application::State(0);
}
...
{
    uStackFrame __("Uno.Platform2.Application", "get_RootView()");
    Application_typeof()->Init();
...
{
    uStackFrame __("Uno.Platform2.Application", "set_RootView(Uno.Platform.ViewNativeHandle)");
    Application_typeof()->Init();
...
{
    uStackFrame __("Uno.Platform2.Application", "get_State()");
    Application_typeof()->Init();
...
{
    uStackFrame __("Uno.Platform2.Application", "set_State(Uno.Platform2.ApplicationState)");
    Application_typeof()->Init();
...
void Application::add__receivedURI(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::_receivedURI1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::_receivedURI1(), value), ::TYPES[6/*Uno.EventHandler<string>*/]);
}
...
void Application::remove__receivedURI(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::_receivedURI1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::_receivedURI1(), value), ::TYPES[6/*Uno.EventHandler<string>*/]);
}
...
void Application::add_EnteringBackground(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::EnteringBackground1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::EnteringBackground1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::remove_EnteringBackground(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::EnteringBackground1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::EnteringBackground1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::add_EnteringForeground(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::EnteringForeground1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::EnteringForeground1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::remove_EnteringForeground(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::EnteringForeground1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::EnteringForeground1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::add_EnteringInteractive(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::EnteringInteractive1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::EnteringInteractive1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::remove_EnteringInteractive(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::EnteringInteractive1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::EnteringInteractive1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::add_ExitedInteractive(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ExitedInteractive1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::ExitedInteractive1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::remove_ExitedInteractive(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ExitedInteractive1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::ExitedInteractive1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::add_KeyDown(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::KeyDown1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::KeyDown1(), value), ::TYPES[8/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
void Application::remove_KeyDown(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::KeyDown1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::KeyDown1(), value), ::TYPES[8/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
void Application::add_KeyUp(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::KeyUp1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::KeyUp1(), value), ::TYPES[8/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
void Application::remove_KeyUp(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::KeyUp1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::KeyUp1(), value), ::TYPES[8/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
void Application::add_ReceivedLowMemoryWarning(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ReceivedLowMemoryWarning1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::ReceivedLowMemoryWarning1(), value), ::TYPES[9/*Uno.EventHandler*/]);
}
...
void Application::remove_ReceivedLowMemoryWarning(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::ReceivedLowMemoryWarning1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::ReceivedLowMemoryWarning1(), value), ::TYPES[9/*Uno.EventHandler*/]);
}
...
void Application::add_Started(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::Started1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::Started1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::remove_Started(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::Started1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::Started1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::add_Terminating(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::Terminating1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::Terminating1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
...
void Application::remove_Terminating(uDelegate* value)
{
    ...
    Application_typeof()->Init();
    Application::Terminating1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::Terminating1(), value), ::TYPES[7/*Uno.Platform2.ApplicationStateTransitionHandler*/]);
}
// }
...
{
    uStackFrame __("Uno.Platform2.Display", "Finalize()");
    __this->Destroy();
}
...
static void Display_build(uType* type)
{
    ::TYPES[1] = ::g::Uno::Delegate_typeof();
    ::TYPES[5] = uObject_typeof();
    ::TYPES[10] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::TimerEventArgs_typeof());
    ::TYPES[9] = ::g::Uno::EventHandler_typeof();
    type->SetFields(0,
...
void Display::ctor_()
{
    uStackFrame __("Uno.Platform2.Display", ".ctor()");
    Density(1.0f);
    Initialize();
}
...
void Display::add__tick(uDelegate* value)
{
    ...
    _tick1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_tick1, value), ::TYPES[10/*Uno.EventHandler<Uno.Platform.TimerEventArgs>*/]);
}
...
void Display::remove__tick(uDelegate* value)
{
    ...
    _tick1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_tick1, value), ::TYPES[10/*Uno.EventHandler<Uno.Platform.TimerEventArgs>*/]);
}

// public generated float get_Density() [instance] :412
float Display::Density()
{
    uStackFrame __("Uno.Platform2.Display", "get_Density()");
    return _Density;
}
...
{
    uStackFrame __("Uno.Platform2.Display", "set_Density(float)");
    _Density = value;
}
...
{
    uStackFrame __("Uno.Platform2.Display", "Destroy()");
...
{
    uStackFrame __("Uno.Platform2.Display", "DisableTickNotifications()");
...
{
    uStackFrame __("Uno.Platform2.Display", "EnableTickNotifications()");
...
{
    uStackFrame __("Uno.Platform2.Display", "get_Frame()");
    return _frame;
}
...
void Display::add_FrameChanged(uDelegate* value)
{
    ...
    FrameChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(FrameChanged1, value), ::TYPES[9/*Uno.EventHandler*/]);
}
...
void Display::remove_FrameChanged(uDelegate* value)
{
    ...
    FrameChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(FrameChanged1, value), ::TYPES[9/*Uno.EventHandler*/]);
}

// public uint get_FramesPerSecond() [instance] :443
uint32_t Display::FramesPerSecond()
{
    uStackFrame __("Uno.Platform2.Display", "get_FramesPerSecond()");
...
{
    uStackFrame __("Uno.Platform2.Display", "set_FramesPerSecond(uint)");
...
{
    uStackFrame __("Uno.Platform2.Display", "Initialize()");
...
{
    uStackFrame __("Uno.Platform2.Display", "SetFramesPerSecond(uint)");
...
{
    uStackFrame __("Uno.Platform2.Display", "GetMainDisplay()");
...
{
    uStackFrame __("Uno.Platform2.Display", "get_MainDisplay()");
