...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(context)->Evaluate(::STRINGS[0/*"es6-promise"*/], uPtr(::g::FuseReactive_bundle::es6promiseb20a54aa())->ReadAllText());
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observableaea4615f()))->EvaluateExports(context, ::STRINGS[1/*"FuseJS/Obse...*/]), ::TYPES[0/*Fuse.Scripting.Function*/]);
    uObject* res;
...
static void Http__FuseJSHttpRequest_build(uType* type)
{
    ...
    ::TYPES[6] = ::g::Uno::String_typeof();
    ::TYPES[23] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[24] = ::g::Uno::Double_typeof();
    ::TYPES[25] = ::g::Uno::Net::Http::HttpResponseType_typeof();
    type->SetFields(0,
...
uObject* Http__FuseJSHttpRequest::GetResponseType(uArray* args)
{
    ...
    return uBox<int>(::TYPES[21/*int*/], uPtr(_req)->HttpResponseType());
}
...
uObject* Http__FuseJSHttpRequest::GetState(uArray* args)
{
    ...
    return uBox<int>(::TYPES[21/*int*/], uPtr(_req)->State());
}
...
void Http__FuseJSHttpRequest::OnAbort(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::New(::TYPES[22/*object[]*/], 0));
}
...
void Http__FuseJSHttpRequest::OnError(::g::Uno::Net::Http::HttpMessageHandlerRequest* res, uString* error)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[22/*object[]*/], 1, error));
}
...
void Http__FuseJSHttpRequest::OnProgress(::g::Uno::Net::Http::HttpMessageHandlerRequest* res, int current, int total, bool hastotal)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[22/*object[]*/], 3, uBox<int>(::TYPES[21/*int*/], current), uBox<int>(::TYPES[21/*int*/], total), uBox(::TYPES[32/*bool*/], hastotal)));
}
...
void Http__FuseJSHttpRequest::OnStateChanged(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[22/*object[]*/], 1, uBox<int>(::TYPES[21/*int*/], uPtr(_req)->State())));
}
...
uObject* Http__FuseJSHttpRequest::SendAsync(uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
    {
        ...
        uArray* data2 = uAs<uArray*>(args->Strong<uObject*>(0), ::TYPES[23/*byte[]*/]);
...
uObject* Http__FuseJSHttpRequest::SetResponseType(uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
    {
        ...
        int value = uIs(arg, ::TYPES[21/*int*/]) ? uUnbox<int>(::TYPES[21/*int*/], arg) : (int)uUnbox<double>(::TYPES[24/*double*/], arg);
...
static void Http_build(uType* type)
{
    ...
    ::TYPES[5] = uObject_typeof();
    ::TYPES[26] = ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), uObject_typeof()->Array(), uObject_typeof());
    type->SetInterfaces(
...
void Http__Evaluate_fn(Http* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uPtr(uPtr(result)->Object)->Item(::STRINGS[28/*"exports"*/], ::g::Fuse::Reactive::FuseJS::FunctionClosure::New1(c, uDelegate::New(::TYPES[26/*Uno.Func<Fuse.Scripting.Context, object[], object>*/], (void*)Http__CreateClient_fn, __this))->Callback());
}
...
{
    ::TYPES[28] = ::g::Uno::Collections::List_typeof()->MakeType(TimerManager__Timer_typeof());
    ::TYPES[11] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof());
    type->SetFields(0,
...
void TimerManager::ctor_()
{
    ...
    _timers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[28/*Uno.Collections.List<Fuse.Reactive.FuseJS.TimerManager.Timer>*/]));
}
...
static void TimerModule_build(uType* type)
{
    ...
    ::TYPES[5] = uObject_typeof();
    ::TYPES[29] = ::g::Fuse::Scripting::NativeMember_typeof();
    ::TYPES[30] = ::g::Fuse::Scripting::NativeCallback_typeof();
...
void TimerModule::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[29/*"create"*/], uDelegate::New(::TYPES[30/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Create_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[30/*"delete"*/], uDelegate::New(::TYPES[30/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Delete_fn, this)));
    add_Reset(uDelegate::New(::TYPES[31/*Uno.EventHandler*/], (void*)TimerModule__OnReset_fn, this));
}
...
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    bool repeat = uUnbox<bool>(::TYPES[32/*bool*/], args->Strong<uObject*>(2));
    uArray* innerArgs = uArray::New(::TYPES[22/*object[]*/], args->Length() - 3);

    for (int i = 0; i < innerArgs->Length(); i++)
        uPtr(innerArgs)->Strong<uObject*>(i) = uPtr(args)->Strong<uObject*>(3 + i);

    return uBox<int>(::TYPES[21/*int*/], uPtr(_tm)->AddTimer(ms, uDelegate::New(::TYPES[12/*Uno.Action*/], (void*)TimerModule__CallbackClosure__Callback_fn, TimerModule__CallbackClosure::New1(context, func, innerArgs)), repeat));
}
