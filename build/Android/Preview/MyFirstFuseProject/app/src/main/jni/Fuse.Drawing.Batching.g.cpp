...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.33.5\$.uno
// --------------------------------------------------------------

// public sealed class Batch :11
// {
static void Batch_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(55,
        ...
        new uFunction("get_IndexBuffer", NULL, (void*)Batch__get_IndexBuffer_fn, 0, false, ::g::Uno::Graphics::IndexBuffer_typeof(), 0),
        ...
        new uFunction(".ctor", NULL, (void*)Batch__New1_fn, 0, true, Batch_typeof(), 3, ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof()),
...
// public Batch(int maxVertices, int maxIndices, bool staticBatch) :16
...
// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib0Buffer() :66
...
// public void set_Attrib0Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :66
void Batch__set_Attrib0Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib0Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib1Buffer() :67
...
// public void set_Attrib1Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :67
void Batch__set_Attrib1Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib1Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib2Buffer() :68
...
// public void set_Attrib2Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :68
void Batch__set_Attrib2Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib2Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib3Buffer() :69
...
// public void set_Attrib3Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :69
void Batch__set_Attrib3Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib3Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib4Buffer() :70
...
// public void set_Attrib4Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :70
void Batch__set_Attrib4Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib4Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib5Buffer() :71
...
// public void set_Attrib5Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :71
void Batch__set_Attrib5Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib5Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib6Buffer() :72
...
// public void set_Attrib6Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :72
void Batch__set_Attrib6Buffer_fn(Batch* __this, ::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    __this->Attrib6Buffer(value);
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib7Buffer() :73
...
// public void set_BoneIndexBuffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :63
...
// public Fuse.Drawing.Batching.BatchVertexBuffer get_BoneWeightBuffer() :64
...
// public void set_BoneWeightBuffer(Fuse.Drawing.Batching.BatchVertexBuffer value) :64
...
// public void set_InstanceIndices(Fuse.Drawing.Batching.BatchVertexBuffer value) :62
...
// public Batch New(int maxVertices, int maxIndices, bool staticBatch) :16
...
// public void set_Attrib0Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :66
void Batch::Attrib0Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib0Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib0 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib1Buffer() [instance] :67
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib1Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib1Buffer()");
...
// public void set_Attrib1Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :67
void Batch::Attrib1Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib1Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib1 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib2Buffer() [instance] :68
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib2Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib2Buffer()");
...
// public void set_Attrib2Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :68
void Batch::Attrib2Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib2Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib2 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib3Buffer() [instance] :69
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib3Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib3Buffer()");
...
// public void set_Attrib3Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :69
void Batch::Attrib3Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib3Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib3 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib4Buffer() [instance] :70
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib4Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib4Buffer()");
...
// public void set_Attrib4Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :70
void Batch::Attrib4Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib4Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib4 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib5Buffer() [instance] :71
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib5Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib5Buffer()");
...
// public void set_Attrib5Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :71
void Batch::Attrib5Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib5Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib5 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib6Buffer() [instance] :72
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib6Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib6Buffer()");
...
// public void set_Attrib6Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :72
void Batch::Attrib6Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib6Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib6 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Attrib7Buffer() [instance] :73
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Attrib7Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Attrib7Buffer()");
...
// public void set_Attrib7Buffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :73
void Batch::Attrib7Buffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Attrib7Buffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    attrib7 = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Binormals() [instance] :59
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Binormals()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Binormals()");
...
// public void set_Binormals(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :59
void Batch::Binormals(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Binormals(Fuse.Drawing.Batching.BatchVertexBuffer)");
    binormals = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_BoneIndexBuffer() [instance] :63
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::BoneIndexBuffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_BoneIndexBuffer()");
...
// public void set_BoneIndexBuffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :63
void Batch::BoneIndexBuffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_BoneIndexBuffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    boneIndices = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_BoneWeightBuffer() [instance] :64
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::BoneWeightBuffer()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_BoneWeightBuffer()");
...
// public void set_BoneWeightBuffer(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :64
void Batch::BoneWeightBuffer(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_BoneWeightBuffer(Fuse.Drawing.Batching.BatchVertexBuffer)");
    boneWeights = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Colors() [instance] :61
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Colors()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Colors()");
...
// public void set_Colors(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :61
void Batch::Colors(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Colors(Fuse.Drawing.Batching.BatchVertexBuffer)");
    colors = value;
}

// public Uno.Graphics.IndexBuffer get_IndexBuffer() [instance] :116
...
// public Uno.Graphics.IndexType get_IndexType() [instance] :121
int Batch::IndexType()
{
...
// public Fuse.Drawing.Batching.BatchIndexBuffer get_Indices() [instance] :85
::g::Fuse::Drawing::Batching::BatchIndexBuffer* Batch::Indices()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Indices()");
...
// public void set_Indices(Fuse.Drawing.Batching.BatchIndexBuffer value) [instance] :85
void Batch::Indices(::g::Fuse::Drawing::Batching::BatchIndexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Indices(Fuse.Drawing.Batching.BatchIndexBuffer)");
    indexBuffer = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_InstanceIndices() [instance] :62
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::InstanceIndices()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_InstanceIndices()");
...
// public void set_InstanceIndices(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :62
void Batch::InstanceIndices(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_InstanceIndices(Fuse.Drawing.Batching.BatchVertexBuffer)");
    instanceIndex = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Normals() [instance] :58
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Normals()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Normals()");
...
// public void set_Normals(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :58
void Batch::Normals(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Normals(Fuse.Drawing.Batching.BatchVertexBuffer)");
    normals = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Positions() [instance] :49
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Positions()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Positions()");
...
// public void set_Positions(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :49
void Batch::Positions(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Positions(Fuse.Drawing.Batching.BatchVertexBuffer)");
    positions = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_Tangents() [instance] :60
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::Tangents()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_Tangents()");
...
// public void set_Tangents(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :60
void Batch::Tangents(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_Tangents(Fuse.Drawing.Batching.BatchVertexBuffer)");
    tangents = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord0s() [instance] :50
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord0s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord0s()");
...
// public void set_TexCoord0s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :50
void Batch::TexCoord0s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord0s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord0s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord1s() [instance] :51
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord1s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord1s()");
...
// public void set_TexCoord1s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :51
void Batch::TexCoord1s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord1s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord1s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord2s() [instance] :52
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord2s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord2s()");
...
// public void set_TexCoord2s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :52
void Batch::TexCoord2s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord2s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord2s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord3s() [instance] :53
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord3s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord3s()");
...
// public void set_TexCoord3s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :53
void Batch::TexCoord3s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord3s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord3s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord4s() [instance] :54
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord4s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord4s()");
...
// public void set_TexCoord4s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :54
void Batch::TexCoord4s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord4s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord4s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord5s() [instance] :55
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord5s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord5s()");
...
// public void set_TexCoord5s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :55
void Batch::TexCoord5s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord5s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord5s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord6s() [instance] :56
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord6s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord6s()");
...
// public void set_TexCoord6s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :56
void Batch::TexCoord6s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord6s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord6s = value;
}

// public Fuse.Drawing.Batching.BatchVertexBuffer get_TexCoord7s() [instance] :57
::g::Fuse::Drawing::Batching::BatchVertexBuffer* Batch::TexCoord7s()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_TexCoord7s()");
...
// public void set_TexCoord7s(Fuse.Drawing.Batching.BatchVertexBuffer value) [instance] :57
void Batch::TexCoord7s(::g::Fuse::Drawing::Batching::BatchVertexBuffer* value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_TexCoord7s(Fuse.Drawing.Batching.BatchVertexBuffer)");
    texCoord7s = value;
}

// public int get_VertexCount() [instance] :79
int Batch::VertexCount()
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "get_VertexCount()");
    return hasExplicitVertexCount ? explicitVertexCount : maxIndices;
}

// public void set_VertexCount(int value) [instance] :80
void Batch::VertexCount(int value)
{
    uStackFrame __("Fuse.Drawing.Batching.Batch", "set_VertexCount(int)");
    hasExplicitVertexCount = true;
    explicitVertexCount = value;
}

// public Batch New(int maxVertices, int maxIndices, bool staticBatch) [static] :16
...
// public static class BatchHelpers :137
// {
static void BatchHelpers_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[2] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[3] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[4] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
...
// public static Fuse.Drawing.Batching.BatchIndexBuffer CreateBatchIndexBuffer(Uno.Content.Models.IndexArray array) :208
...
// public static Fuse.Drawing.Batching.BatchVertexBuffer CreateBatchVertexBuffer(Uno.Content.Models.VertexAttributeArray array) :179
...
// public static Fuse.Drawing.Batching.Batch CreateSingleBatch(Uno.Content.Models.ModelMesh m) :139
...
// public static Fuse.Drawing.Batching.BatchIndexBuffer CreateBatchIndexBuffer(Uno.Content.Models.IndexArray array) [static] :208
...
// public static Fuse.Drawing.Batching.BatchVertexBuffer CreateBatchVertexBuffer(Uno.Content.Models.VertexAttributeArray array) [static] :179
...
// public static Fuse.Drawing.Batching.Batch CreateSingleBatch(Uno.Content.Models.ModelMesh m) [static] :139
...
// public sealed class BatchIndexBuffer :238
// {
static void BatchIndexBuffer_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(13,
        ...
        new uFunction(".ctor", NULL, (void*)BatchIndexBuffer__New1_fn, 0, true, BatchIndexBuffer_typeof(), 3, ::g::Uno::Graphics::IndexType_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)BatchIndexBuffer__New2_fn, 0, true, BatchIndexBuffer_typeof(), 2, ::g::Uno::Graphics::IndexType_typeof(), ::g::Uno::Buffer_typeof()),
...
// public BatchIndexBuffer(Uno.Graphics.IndexType type, int maxIndices, bool staticBatch) :257
...
// public BatchIndexBuffer New(Uno.Graphics.IndexType type, Uno.Buffer data) :264
...
// public BatchIndexBuffer(Uno.Graphics.IndexType type, Uno.Buffer data) [instance] :264
...
// public Uno.Buffer get_Buffer() [instance] :276
::g::Uno::Buffer* BatchIndexBuffer::Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchIndexBuffer", "get_Buffer()");
...
// public Uno.Graphics.IndexType get_DataType() [instance] :243
int BatchIndexBuffer::DataType()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchIndexBuffer", "get_DataType()");
    return dataType;
}

// public void set_DataType(Uno.Graphics.IndexType value) [instance] :244
...
// public void Flush() [instance] :320
...
// public Uno.Graphics.IndexBuffer get_IndexBuffer() [instance] :306
...
// public void Invalidate() [instance] :329
void BatchIndexBuffer::Invalidate()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchIndexBuffer", "Invalidate()");
    isDirty = true;
}

// public int get_Position() [instance] :286
int BatchIndexBuffer::Position()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchIndexBuffer", "get_Position()");
    return _position;
}

// public void set_Position(int value) [instance] :287
void BatchIndexBuffer::Position(int value)
{
    uStackFrame __("Fuse.Drawing.Batching.BatchIndexBuffer", "set_Position(int)");
    _position = value;
}

// public int get_StrideInBytes() [instance] :251
...
// public void Write(byte value) [instance] :290
...
// public void Write(ushort value) [instance] :296
...
// public BatchIndexBuffer New(Uno.Graphics.IndexType type, int maxIndices, bool staticBatch) [static] :257
...
// public BatchIndexBuffer New(Uno.Graphics.IndexType type, Uno.Buffer data) [static] :264
...
// public sealed class BatchVertexBuffer :347
// {
static void BatchVertexBuffer_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(31,
        ...
        new uFunction(".ctor", NULL, (void*)BatchVertexBuffer__New1_fn, 0, true, BatchVertexBuffer_typeof(), 3, ::g::Uno::Graphics::VertexAttributeType_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)BatchVertexBuffer__New2_fn, 0, true, BatchVertexBuffer_typeof(), 2, ::g::Uno::Graphics::VertexAttributeType_typeof(), ::g::Uno::Buffer_typeof()),
...
// public BatchVertexBuffer(Uno.Graphics.VertexAttributeType type, int maxVertices, bool staticBatch) :365
...
// public BatchVertexBuffer New(Uno.Graphics.VertexAttributeType type, Uno.Buffer data) :372
...
// public BatchVertexBuffer(Uno.Graphics.VertexAttributeType type, Uno.Buffer data) [instance] :372
...
// public Uno.Buffer get_Buffer() [instance] :386
::g::Uno::Buffer* BatchVertexBuffer::Buffer()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchVertexBuffer", "get_Buffer()");
...
// public Uno.Graphics.VertexAttributeType get_DataType() [instance] :352
int BatchVertexBuffer::DataType()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchVertexBuffer", "get_DataType()");
    return dataType;
}

// public void set_DataType(Uno.Graphics.VertexAttributeType value) [instance] :353
...
// public void Flush() [instance] :533
...
// public void Invalidate() [instance] :545
void BatchVertexBuffer::Invalidate()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchVertexBuffer", "Invalidate()");
    isDirty = true;
}

// public int get_Position() [instance] :408
int BatchVertexBuffer::Position()
{
    uStackFrame __("Fuse.Drawing.Batching.BatchVertexBuffer", "get_Position()");
    return _position;
}

// public void set_Position(int value) [instance] :409
void BatchVertexBuffer::Position(int value)
{
    uStackFrame __("Fuse.Drawing.Batching.BatchVertexBuffer", "set_Position(int)");
    _position = value;
}

// public int get_StrideInBytes() [instance] :360
...
// public Uno.Graphics.VertexBuffer get_VertexBuffer() [instance] :396
...
// public void Write(byte value) [instance] :430
...
// public void Write(byte2 value) [instance] :436
...
// public void Write(byte4 value) [instance] :442
...
// public void Write(float2 value) [instance] :412
...
// public void Write(float3 value) [instance] :418
...
// public void Write(float4 value) [instance] :424
...
// public void Write(int value) [instance] :508
...
// public void Write(int2 value) [instance] :514
...
// public void Write(int3 value) [instance] :520
...
// public void Write(int4 value) [instance] :526
...
// public void Write(sbyte value) [instance] :448
...
// public void Write(sbyte2 value) [instance] :454
...
// public void Write(sbyte4 value) [instance] :460
...
// public void Write(short value) [instance] :484
...
// public void Write(short2 value) [instance] :490
...
// public void Write(short4 value) [instance] :496
...
// public void Write(uint value) [instance] :502
...
// public void Write(ushort value) [instance] :466
...
// public void Write(ushort2 value) [instance] :472
...
// public void Write(ushort4 value) [instance] :478
...
// public BatchVertexBuffer New(Uno.Graphics.VertexAttributeType type, int maxVertices, bool staticBatch) [static] :365
...
// public BatchVertexBuffer New(Uno.Graphics.VertexAttributeType type, Uno.Buffer data) [static] :372
...
// public Entry(Uno.Content.Models.ModelMesh m, int instanceId) :566
void Entry__ctor__fn(Entry* __this, ::g::Uno::Content::Models::ModelMesh* m, int* instanceId)
{
    __this->ctor_(m, *instanceId);
}

// public Entry New(Uno.Content.Models.ModelMesh m, int instanceId) :566
void Entry__New1_fn(::g::Uno::Content::Models::ModelMesh* m, int* instanceId, Entry** __retval)
{
    *__retval = Entry::New1(m, *instanceId);
}

// public Entry(Uno.Content.Models.ModelMesh m, int instanceId) [instance] :566
void Entry::ctor_(::g::Uno::Content::Models::ModelMesh* m, int instanceId)
{
    uStackFrame __("Fuse.Drawing.Batching.Entry", ".ctor(Uno.Content.Models.ModelMesh,int)");
    Mesh = m;
    InstanceIndex = instanceId;
}

// public Entry New(Uno.Content.Models.ModelMesh m, int instanceId) [static] :566
...
// public sealed class MeshBatcher :569
// {
static void MeshBatcher_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("BoneWeights");
    ::STRINGS[17] = uString::Const("BoneIndices");
    ::TYPES[5] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::Batching::Entry_typeof());
    ::TYPES[6] = ::g::Uno::UInt_typeof()->Array();
    ::TYPES[7] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[2] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[3] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof()));
    ::TYPES[4] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
    ::TYPES[8] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::Batching::Batch_typeof());
    ::TYPES[9] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[10] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Batching::Batch_typeof());
    ::TYPES[11] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Batching::Batch_typeof());
    ::TYPES[12] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Batching::Entry_typeof(), ::g::Uno::Content::Models::ModelMesh_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Batching::Entry_typeof());
    ::TYPES[14] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Batching::Entry_typeof(), ::g::Uno::Content::Models::ModelMesh_typeof());
    type->SetFields(0,
        ::g::Fuse::Drawing::Batching::Batch_typeof()->Array(), offsetof(::g::Fuse::Drawing::Batching::MeshBatcher, batches), 0,
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::Batching::Entry_typeof()), offsetof(::g::Fuse::Drawing::Batching::MeshBatcher, entries), 0);
    type->Reflection.SetFunctions(8,
        ...
        new uFunction("get_Batches", NULL, (void*)MeshBatcher__get_Batches_fn, 0, false, ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Batching::Batch_typeof()), 0),
        new uFunction("get_Entries", NULL, (void*)MeshBatcher__get_Entries_fn, 0, false, ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelMesh_typeof()), 0),
        ...
        new uFunction(".ctor", NULL, (void*)MeshBatcher__New1_fn, 0, true, MeshBatcher_typeof(), 0));
}
...
// public void AddMesh(Uno.Content.Models.ModelMesh mesh, int instanceId) :597
...
// public int get_BatchCount() :587
void MeshBatcher__get_BatchCount_fn(MeshBatcher* __this, int* __retval)
{
    *__retval = __this->BatchCount();
}

// public Uno.Collections.IEnumerable<Fuse.Drawing.Batching.Batch> get_Batches() :584
void MeshBatcher__get_Batches_fn(MeshBatcher* __this, uObject** __retval)
{
    *__retval = __this->Batches();
}

// private static Uno.Content.Models.ModelMesh CreateFakeIndexBuffer(Uno.Content.Models.ModelMesh m) :751
...
// public int AddMesh(Uno.Content.Models.ModelMesh mesh) [instance] :592
...
// public void AddMesh(Uno.Content.Models.ModelMesh mesh, int instanceId) [instance] :597
...
// public int get_BatchCount() [instance] :587
...
// public Uno.Collections.IEnumerable<Fuse.Drawing.Batching.Batch> get_Batches() [instance] :584
uObject* MeshBatcher::Batches()
{
    uStackFrame __("Fuse.Drawing.Batching.MeshBatcher", "get_Batches()");
    Flush();
    return (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[11/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Drawing.Batching.Batch>*/], batches));
}

// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelMesh> get_Entries() [instance] :574
uObject* MeshBatcher::Entries()
{
    uStackFrame __("Fuse.Drawing.Batching.MeshBatcher", "get_Entries()");
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[12/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Batching.Entry, Uno.Content.Models.ModelMesh>*/], (uObject*)entries, uDelegate::New(::TYPES[14/*Uno.Func<Fuse.Drawing.Batching.Entry, Uno.Content.Models.ModelMesh>*/], (void*)MeshBatcher__Mesh_fn));
}

// public int get_EntryCount() [instance] :578
...
// public void Flush() [instance] :609
void MeshBatcher::Flush()
{
    ...
    ::g::Uno::Content::Models::VertexAttributeArray* position;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord1;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord2;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord3;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord4;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord5;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord6;
    ::g::Uno::Content::Models::VertexAttributeArray* texcoord7;
    ::g::Uno::Content::Models::VertexAttributeArray* normal;
    ::g::Uno::Content::Models::VertexAttributeArray* tangent;
    ::g::Uno::Content::Models::VertexAttributeArray* binormal;
    ::g::Uno::Content::Models::VertexAttributeArray* color;
    ::g::Uno::Content::Models::VertexAttributeArray* boneWeights;
    ::g::Uno::Content::Models::VertexAttributeArray* boneIndex;
...
// private static Uno.Content.Models.ModelMesh CreateFakeIndexBuffer(Uno.Content.Models.ModelMesh m) [static] :751
...
// private static Uno.Content.Models.ModelMesh Mesh(Fuse.Drawing.Batching.Entry entry) [static] :576
...
// public MeshBatcher New() [static] :590
