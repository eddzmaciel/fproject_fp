...
// C:\ProgramData\Uno\Packages\Android\0.33.0\$.uno
// ------------------------------------------------
...
// {
// static NativeActivityHelper() :683
...
// public static extern void Init() :689
void NativeActivityHelper__Init_fn()
{
    NativeActivityHelper::Init();
}

// public static extern void Init() [static] :689
void NativeActivityHelper::Init()
{
    ...
    jclass cls = ::g::Android::Base::JNI::LoadClass(jni, "com.apps.myfirstfuseproject.MyFirstFuseProject");
