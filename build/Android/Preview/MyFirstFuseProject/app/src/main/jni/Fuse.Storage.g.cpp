...
// C:\ProgramData\Uno\Packages\Fuse.Storage\0.33.5\$.uno
// -----------------------------------------------------
...
static void StorageModule_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Fuse::Scripting::NativeMember_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[9] = ::g::Fuse::Scripting::NativePromise_typeof()->MakeType(::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof());
    ::TYPES[10] = ::g::Fuse::Scripting::FutureFactory_typeof()->MakeType(::g::Uno::Bool_typeof());
    ::TYPES[11] = ::g::Fuse::Scripting::NativePromise_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[12] = ::g::Fuse::Scripting::FutureFactory_typeof()->MakeType(::g::Uno::String_typeof());
    ...
    type->SetFields(5,
        StorageModule_typeof(), (uintptr_t)&::g::Fuse::Storage::StorageModule::_instance_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StorageModule__New2_fn, 0, true, StorageModule_typeof(), 0));
}
...
void StorageModule::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[4/*"writeSync"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.NativeCallback*/], (void*)StorageModule__Write_fn)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[5/*"readSync"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.NativeCallback*/], (void*)StorageModule__Read_fn)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[6/*"deleteSync"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.NativeCallback*/], (void*)StorageModule__Delete_fn)));
    AddMember((::g::Fuse::Scripting::NativePromise*)::g::Fuse::Scripting::NativePromise::New1(::TYPES[9/*Fuse.Scripting.NativePromise<bool, bool>*/], ::STRINGS[7/*"write"*/], uDelegate::New(::TYPES[10/*Fuse.Scripting.FutureFactory<bool>*/], (void*)StorageModule__WriteAsync_fn), NULL));
    AddMember((::g::Fuse::Scripting::NativePromise*)::g::Fuse::Scripting::NativePromise::New1(::TYPES[11/*Fuse.Scripting.NativePromise<string, string>*/], ::STRINGS[8/*"read"*/], uDelegate::New(::TYPES[12/*Fuse.Scripting.FutureFactory<string>*/], (void*)StorageModule__ReadAsync_fn), NULL));
}
...
uObject* StorageModule::Delete(::g::Fuse::Scripting::Context* c, uArray* args)
{
    ...
    {
        uString* filename = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[13/*string*/]);
...
uObject* StorageModule::Write(::g::Fuse::Scripting::Context* c, uArray* args)
{
    ...
    {
        uString* filename = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[13/*string*/]);
        uString* value = uAs<uString*>(args->Strong<uObject*>(1), ::TYPES[13/*string*/]);
