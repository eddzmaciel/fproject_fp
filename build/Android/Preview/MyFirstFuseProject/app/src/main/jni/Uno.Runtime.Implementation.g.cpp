...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Runtime\Implementation\$.uno
// ----------------------------------------------------------------------------------
...
void ArrayCopyImpl::ValidateArguments(uType* __type, uArray* sourceArray, int sourceIndex, uArray* destinationArray, int destinationIndex, int length)
{
    ...
    if (uPtr(sourceArray)->Length() < (sourceIndex + length))
        U_THROW(::g::Uno::ArgumentException::New4(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[6/*"Destination...*/], uBox<int>(::TYPES[3/*int*/], uPtr(sourceArray)->Length())), ::STRINGS[7/*", "*/]), uBox<int>(::TYPES[3/*int*/], destinationIndex)), ::STRINGS[7/*", "*/]), uBox<int>(::TYPES[3/*int*/], length))));
...
{
    ::g::Uno::Platform::SystemUI::add_BottomFrameWillResize(uDelegate::New(::TYPES[2/*Uno.EventHandler<Uno.Platform.SystemUIWillResizeEventArgs>*/], (void*)PlatformWindowImpl__OnSoftKeyboardWillResize_fn));
}
...
static void TextEncodingImpl_build(uType* type)
{
    ...
    ::TYPES[0] = uObject_typeof();
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Byte_typeof());
...
uArray* TextEncodingImpl::DecodeBase64(uString* value)
{
    ...
    ::g::Uno::Collections::List* ret = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<byte>*/]);
    uArray* charArray3 = uArray::New(::TYPES[5/*int[]*/], 3);
    uArray* charArray4 = uArray::New(::TYPES[5/*int[]*/], 4);
...
uArray* TextEncodingImpl::EncodeAscii(uString* value)
{
    ...
    uArray* res = uArray::New(::TYPES[6/*byte[]*/], uPtr(value)->Length());
