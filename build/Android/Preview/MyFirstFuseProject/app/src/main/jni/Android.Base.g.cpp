...
static void JNI_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(59,
        ...
        new uFunction("SetByteArrayRegion", NULL, (void*)JNI__SetByteArrayRegion_fn, 0, true, uVoid_typeof(), 4, ::g::Android::Base::Primitives::ujobject_typeof(), ::g::Uno::SByte_typeof()->Array(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof()),
...
{
    uStackFrame __("Android.Base.JNI", "NewBooleanArray(int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
...
{
    uStackFrame __("Android.Base.JNI", "NewByteArray(int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
...
{
    uStackFrame __("Android.Base.JNI", "NewCharArray(int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
...
{
    uStackFrame __("Android.Base.JNI", "NewDoubleArray(int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
...
{
    uStackFrame __("Android.Base.JNI", "NewLongArray(int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
...
{
    uStackFrame __("Android.Base.JNI", "NewObjectArray(Android.Base.Primitives.ujclass,int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
...
{
    uStackFrame __("Android.Base.JNI", "NewShortArray(int)");
    JNI_typeof()->Init();
    JNIEnv* jni = JNI::GetEnvPtr();
