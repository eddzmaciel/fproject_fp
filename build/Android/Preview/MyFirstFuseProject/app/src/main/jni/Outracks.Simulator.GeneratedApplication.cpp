...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("192.168.100.5");
    ::STRINGS[3] = uString::Const("C:\\Users\\Eddz-\\Documents\\Fuse\\MyFirstFuseProject\\MyFirstFuseProject.unoproj");
    ::STRINGS[4] = uString::Const("MyFirstFuseProject");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[4/*"MyFirstFuse...*/]);
}
