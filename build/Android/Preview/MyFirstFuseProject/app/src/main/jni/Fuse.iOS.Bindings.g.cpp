...
// C:\ProgramData\Uno\Packages\Fuse.iOS\0.33.5\$.uno
// -------------------------------------------------

// internal sealed class Blitter :1082
// {
// static Blitter() :1082
...
// public generated Blitter() :1082
void Blitter__ctor__fn(Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Visual where, texture2D vt, float2 pos, float2 size) :1086
...
// private generated void init_DrawCalls() :1082
void Blitter__init_DrawCalls_fn(Blitter* __this)
{
    __this->init_DrawCalls();
}

// public generated Blitter New() :1082
...
// public generated Blitter() [instance] :1082
void Blitter::ctor_()
{
...
// public void Blit(Fuse.DrawContext dc, Fuse.Visual where, texture2D vt, float2 pos, float2 size) [instance] :1086
void Blitter::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* where, ::g::Uno::Graphics::Texture2D* vt, ::g::Uno::Float2 pos, ::g::Uno::Float2 size)
{
    ...
    _draw_f3eb9bce.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[0/*Fuse.IRenderViewport*/])));
...
// private generated void init_DrawCalls() [instance] :1082
void Blitter::init_DrawCalls()
{
    ...
    _draw_f3eb9bce = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::Viewport2da28930());
}

// public generated Blitter New() [static] :1082
