...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Polygons\0.33.5\Sweep\$.uno
// --------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Polygons\0.33.5\Meshes\$.uno
// ---------------------------------------------------------------------
...
void EdgeLoopEnumerable__GetNext_fn(EdgeLoopEnumerable* __this, ::g::Fuse::Drawing::Tesselation::HalfEdge* e, ::g::Fuse::Drawing::Tesselation::HalfEdge** __retval)
{
    ...
    return *__retval = (uPtr(e)->LeftNext() == __this->_first().Strong< ::g::Fuse::Drawing::Tesselation::HalfEdge*>()) ? uCast< ::g::Fuse::Drawing::Tesselation::HalfEdge*>(NULL, ::TYPES[1/*Fuse.Drawing.Tesselation.HalfEdge*/]) : (::g::Fuse::Drawing::Tesselation::HalfEdge*)uPtr(e)->LeftNext(), void();
}
...
void EdgesEnumerable__GetNext_fn(EdgesEnumerable* __this, ::g::Fuse::Drawing::Tesselation::HalfEdge* v, ::g::Fuse::Drawing::Tesselation::HalfEdge** __retval)
{
    ...
    return *__retval = (uPtr(v)->Next() == __this->_head) ? uCast< ::g::Fuse::Drawing::Tesselation::HalfEdge*>(NULL, ::TYPES[1/*Fuse.Drawing.Tesselation.HalfEdge*/]) : (::g::Fuse::Drawing::Tesselation::HalfEdge*)uPtr(v)->Next(), void();
}
...
void EdgesEnumerable::ctor_1(::g::Fuse::Drawing::Tesselation::HalfEdge* head)
{
    ...
    ::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerable__ctor__fn(this, (uPtr(head)->Next() == head) ? uCast< ::g::Fuse::Drawing::Tesselation::HalfEdge*>(NULL, ::TYPES[1/*Fuse.Drawing.Tesselation.HalfEdge*/]) : (::g::Fuse::Drawing::Tesselation::HalfEdge*)uPtr(head)->Next());
    _head = head;
}
...
{
    ::TYPES[2] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Tesselation::HalfEdge_typeof(), ::g::Uno::Float2_typeof());
    ::TYPES[3] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof(), ::g::Uno::Float2_typeof());
    ::TYPES[4] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[6] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    type->SetFields(0,
...
::g::Fuse::Drawing::Contour* Face::ToContour()
{
    ...
    return ::g::Fuse::Drawing::Contour::New2(true, (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[2/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Tesselation.HalfEdge, float2>*/], EdgeLoop(), uDelegate::New(::TYPES[3/*Uno.Func<Fuse.Drawing.Tesselation.HalfEdge, float2>*/], (void*)Face__Coords_fn)));
}
...
::g::Uno::Geometry::Triangle2D* Face::ToTriangle()
{
    ...
    uObject* iter = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(EdgeLoop()), ::TYPES[4/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/]));

    if (!::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(iter), ::TYPES[5/*Uno.Collections.IEnumerator*/])))
        return NULL;

    ::g::Fuse::Drawing::Tesselation::HalfEdge* a = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(iter), ::TYPES[6/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret2), ret2);

    if (!::g::Uno::Collections::IEnumerator::MoveNext(uInterface(iter, ::TYPES[5/*Uno.Collections.IEnumerator*/])))
        return NULL;

    ::g::Fuse::Drawing::Tesselation::HalfEdge* b = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(iter, ::TYPES[6/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret3), ret3);

    if (!::g::Uno::Collections::IEnumerator::MoveNext(uInterface(iter, ::TYPES[5/*Uno.Collections.IEnumerator*/])))
        return NULL;

    ::g::Fuse::Drawing::Tesselation::HalfEdge* c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(iter, ::TYPES[6/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret4), ret4);
...
{
    ::TYPES[7] = ::g::Fuse::Drawing::Tesselation::Face_typeof();
    type->SetInterfaces(
...
void FacesEnumerable__GetNext_fn(FacesEnumerable* __this, ::g::Fuse::Drawing::Tesselation::Face* v, ::g::Fuse::Drawing::Tesselation::Face** __retval)
{
    ...
    return *__retval = (uPtr(v)->Next() == __this->_head) ? uCast< ::g::Fuse::Drawing::Tesselation::Face*>(NULL, ::TYPES[7/*Fuse.Drawing.Tesselation.Face*/]) : (::g::Fuse::Drawing::Tesselation::Face*)uPtr(v)->Next(), void();
}
...
void FacesEnumerable::ctor_1(::g::Fuse::Drawing::Tesselation::Face* head)
{
    ...
    ::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerable__ctor__fn(this, (uPtr(head)->Next() == head) ? uCast< ::g::Fuse::Drawing::Tesselation::Face*>(NULL, ::TYPES[7/*Fuse.Drawing.Tesselation.Face*/]) : (::g::Fuse::Drawing::Tesselation::Face*)uPtr(head)->Next());
    _head = head;
}
...
static void Mesh_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[6] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    ::TYPES[8] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[9] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[10] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Tesselation::Face_typeof(), ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[11] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof(), ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[12] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[13] = ::g::Uno::Predicate_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Vertex_typeof());
    type->SetFields(0,
...
void Mesh::DeleteInternalEdges()
{
    ...
    for (uObject* enum4 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Edges()), ::TYPES[4/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::HalfEdge* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[6/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret10), ret10);
...
void Mesh::DiscardExterior()
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Faces()), ::TYPES[8/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.Face>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::Face* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[9/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.Face>*/]), &ret11), ret11);
...
void Mesh::Dispose()
{
    ...
    for (uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Edges()), ::TYPES[4/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::HalfEdge* edge = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[6/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret12), ret12);
...
uObject* Mesh::GetContours()
{
    ...
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[10/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Tesselation.Face, Fuse.Drawing.Contour>*/], InteriorFaces(), uDelegate::New(::TYPES[11/*Uno.Func<Fuse.Drawing.Tesselation.Face, Fuse.Drawing.Contour>*/], (void*)Mesh__CreateContour_fn, this));
}
...
uObject* Mesh::InteriorFaces()
{
    ...
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Where(::TYPES[12/*Uno.Collections.EnumerableExtensions.Where<Fuse.Drawing.Tesselation.Face>*/], Faces(), uDelegate::New(::TYPES[13/*Uno.Predicate<Fuse.Drawing.Tesselation.Face>*/], (void*)Mesh__IsInside_fn, this));
}
...
void Mesh::SetWindingNumber(int value)
{
    ...
    for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Edges()), ::TYPES[4/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::HalfEdge* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[6/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret13), ret13);
...
void Mesh::TessellateInterior()
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Faces()), ::TYPES[8/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.Face>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::Face* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[9/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.Face>*/]), &ret14), ret14);
...
static void MeshBuilder_build(uType* type)
{
    ...
    ::TYPES[15] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[17] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[18] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetFields(0,
...
::g::Fuse::Drawing::Tesselation::Mesh* MeshBuilder::CreateFromContours(uObject* contours)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(contours), ::TYPES[15/*Uno.Collections.IEnumerable<Fuse.Drawing.Contour>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Contour* contour = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[16/*Uno.Collections.IEnumerator<Fuse.Drawing.Contour>*/]), &ret4), ret4);
        uPtr(b)->NewContour();

        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(contour)->Vertices()), ::TYPES[17/*Uno.Collections.IEnumerable<float2>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::Float2 v = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[18/*Uno.Collections.IEnumerator<float2>*/]), &ret5), ret5);
...
void OriginEnumerable__GetNext_fn(OriginEnumerable* __this, ::g::Fuse::Drawing::Tesselation::HalfEdge* edge, ::g::Fuse::Drawing::Tesselation::HalfEdge** __retval)
{
    ...
    return *__retval = (uPtr(edge)->OriginNext() == __this->_first().Strong< ::g::Fuse::Drawing::Tesselation::HalfEdge*>()) ? uCast< ::g::Fuse::Drawing::Tesselation::HalfEdge*>(NULL, ::TYPES[1/*Fuse.Drawing.Tesselation.HalfEdge*/]) : (::g::Fuse::Drawing::Tesselation::HalfEdge*)uPtr(edge)->OriginNext(), void();
}
...
static void Sweep_build(uType* type)
{
    ...
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Vertex_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Vertex_typeof());
    ::TYPES[8] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[9] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[20] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    ::TYPES[21] = ::g::Uno::Predicate_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    type->SetFields(0,
...
void Sweep::InitPriorityQ()
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(_mesh)->Vertices()), ::TYPES[14/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.Vertex>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::Vertex* v = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[19/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.Vertex>*/]), &ret13), ret13);
...
void Sweep::RemoveDegenerateFaces()
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(_mesh)->Faces()), ::TYPES[8/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.Face>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[5/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::Face* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[9/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.Face>*/]), &ret14), ret14);
...
void Sweep::SweepEvent(::g::Fuse::Drawing::Tesselation::Vertex* vEvent)
{
    ...
    uPtr(_dict)->CheckInvariants();
    uPtr(_mesh)->CheckConsistency();
    ::g::Fuse::Drawing::Tesselation::HalfEdge* e = (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault1_fn(::TYPES[20/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Drawing.Tesselation.HalfEdge>*/], uPtr(vEvent)->OutgoingEdges(), uDelegate::New(::TYPES[21/*Uno.Predicate<Fuse.Drawing.Tesselation.HalfEdge>*/], (void*)Sweep__HasActiveRegion_fn), &ret15), ret15);
...
{
    ::TYPES[22] = ::g::Fuse::Drawing::Tesselation::Vertex_typeof();
    type->SetInterfaces(
...
void VerticesEnumerable__GetNext_fn(VerticesEnumerable* __this, ::g::Fuse::Drawing::Tesselation::Vertex* v, ::g::Fuse::Drawing::Tesselation::Vertex** __retval)
{
    ...
    return *__retval = (uPtr(v)->Next() == __this->_head) ? uCast< ::g::Fuse::Drawing::Tesselation::Vertex*>(NULL, ::TYPES[22/*Fuse.Drawing.Tesselation.Vertex*/]) : (::g::Fuse::Drawing::Tesselation::Vertex*)uPtr(v)->Next(), void();
}
...
void VerticesEnumerable::ctor_1(::g::Fuse::Drawing::Tesselation::Vertex* head)
{
    ...
    ::g::Fuse::Drawing::Tesselation::Collections::LinkedListEnumerable__ctor__fn(this, (uPtr(head)->Next() == head) ? uCast< ::g::Fuse::Drawing::Tesselation::Vertex*>(NULL, ::TYPES[22/*Fuse.Drawing.Tesselation.Vertex*/]) : (::g::Fuse::Drawing::Tesselation::Vertex*)uPtr(head)->Next());
    _head = head;
}
