...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.33.5\$.uno
// ------------------------------------------------------

// public enum Alignment :2480
...
// public static class AlignmentHelpers :2505
// {
...
// public static float2 GetAnchor(Fuse.Elements.Alignment a) :2516
void AlignmentHelpers__GetAnchor_fn(int* a, ::g::Uno::Float2* __retval)
{
    *__retval = AlignmentHelpers::GetAnchor(*a);
}

// public static Fuse.Elements.Alignment GetHorizontalAlign(Fuse.Elements.Alignment a) :2511
void AlignmentHelpers__GetHorizontalAlign_fn(int* a, int* __retval)
{
    *__retval = AlignmentHelpers::GetHorizontalAlign(*a);
}

// internal static Fuse.Elements.SimpleAlignment GetHorizontalSimpleAlign(Fuse.Elements.Alignment a) :2539
...
// public static Fuse.Elements.Alignment GetVerticalAlign(Fuse.Elements.Alignment a) :2507
void AlignmentHelpers__GetVerticalAlign_fn(int* a, int* __retval)
{
    *__retval = AlignmentHelpers::GetVerticalAlign(*a);
}

// internal static Fuse.Elements.SimpleAlignment GetVerticalSimpleAlign(Fuse.Elements.Alignment a) :2529
void AlignmentHelpers__GetVerticalSimpleAlign_fn(int* a, int* __retval)
{
    *__retval = AlignmentHelpers::GetVerticalSimpleAlign(*a);
}

// public static float2 GetAnchor(Fuse.Elements.Alignment a) [static] :2516
...
// public static Fuse.Elements.Alignment GetHorizontalAlign(Fuse.Elements.Alignment a) [static] :2511
...
// internal static Fuse.Elements.SimpleAlignment GetHorizontalSimpleAlign(Fuse.Elements.Alignment a) [static] :2539
...
// public static Fuse.Elements.Alignment GetVerticalAlign(Fuse.Elements.Alignment a) [static] :2507
...
// internal static Fuse.Elements.SimpleAlignment GetVerticalSimpleAlign(Fuse.Elements.Alignment a) [static] :2529
...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.33.5\Caching\$.uno
// --------------------------------------------------------------
...
{
    ::TYPES[2] = ::g::Fuse::RootViewport_typeof();
    ::TYPES[3] = ::g::Fuse::Elements::CacheTile_typeof()->Array();
    ::TYPES[4] = ::g::Fuse::IFrustum_typeof();
    type->SetFields(0,
...
bool Cache::GetCachePreference(::g::Fuse::DrawContext* dc)
{
    ...
    if (uIs((::g::Fuse::Visual*)uPtr(_element)->Parent(), ::TYPES[2/*Fuse.RootViewport*/]))
        ;
...
bool Cache::PinAndValidate(::g::Fuse::DrawContext* dc)
{
    ...
    if (!::g::Uno::Recti__Equals2(cacheRect, _cacheRect))
    {
        ...
        if ((_cacheTiles == NULL) || (numTiles != uPtr(_cacheTiles)->Length()))
            _cacheTiles = uArray::New(::TYPES[3/*Fuse.Elements.CacheTile[]*/], numTiles);
...
{
    ::TYPES[5] = ::g::Fuse::IRenderViewport_typeof();
...
void CacheHelper::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Cache* cache, float opacity)
{
    ...
    for (array1 = uPtr(cache)->CacheTiles(), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        _draw_ac95a784.Uniform2(1, ::g::Uno::Float2__op_Division1(::g::Uno::Float2__New2((float)uPtr(tile.Texture())->Size().X, (float)uPtr(tile.Texture())->Size().Y), dc->ViewportPixelsPerPoint()));
        _draw_ac95a784.Uniform12(2, tile._compositMatrix);
        _draw_ac95a784.Uniform12(3, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[5/*Fuse.IRenderViewport*/])));
...
void CacheHelper::init_DrawCalls()
{
    ...
    uArray* Vertices_ac95a784_1_0_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[6/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
    ...
    _draw_ac95a784 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseElements_bundle::CacheHelper6627cb47());
}
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Elements\\0.33.5\\$.uno");
    ...
    ::TYPES[7] = Element__GMSCacheItem_typeof()->Array();
    ::TYPES[8] = ::g::Fuse::Elements::BoxSizing_typeof();
    ::TYPES[9] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[10] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[11] = uObject_typeof();
    ::TYPES[4] = ::g::Fuse::IFrustum_typeof();
    ::TYPES[12] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[13] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[0] = ::g::Uno::Int_typeof();
    ::TYPES[14] = ::g::Uno::Delegate_typeof();
    ::TYPES[15] = ::g::Fuse::Node_typeof();
    ::TYPES[16] = ::g::Fuse::Visual_typeof();
    ::TYPES[17] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[18] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[19] = ::g::Uno::Action_typeof();
    ::TYPES[20] = ::g::Fuse::Elements::ITransformOrigin_typeof();
    ::TYPES[21] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::Float_typeof());
    ::TYPES[22] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[23] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::UX::Size2_typeof());
    ::TYPES[24] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::UX::Size2_typeof());
    ::TYPES[25] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::Float_typeof());
    ::TYPES[26] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::AspectConstraint_typeof());
    ::TYPES[27] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::AspectConstraint_typeof());
    ::TYPES[28] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::CachingMode_typeof());
    ::TYPES[29] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::CachingMode_typeof());
    ::TYPES[30] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof());
    ::TYPES[31] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::HitTestMode_typeof());
    ::TYPES[32] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::HitTestMode_typeof());
    ::TYPES[33] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::UX::Size_typeof());
    ::TYPES[34] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::UX::Size_typeof());
    ::TYPES[35] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::Float4_typeof());
    ::TYPES[36] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Uno::Float4_typeof());
    ::TYPES[37] = ::g::Uno::UX::IPropertyListener_typeof();
    ::TYPES[38] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::ITransformOrigin_typeof());
    ::TYPES[39] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Elements::ITransformOrigin_typeof());
    ::TYPES[40] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[41] = ::g::Fuse::Elements::PreplacementHandler_typeof();
    type->SetInterfaces(
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Draw called...*/], __this, ::STRINGS[5/*"C:\\Program...*/], 806, ::STRINGS[10/*"Draw"*/]);
...
void Element__OnRooted_fn(Element* __this)
{
    ...
    if (__this->HasEffects())
        ...
        for (uObject* enum7 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Effects()), ::TYPES[18/*Uno.Collections.IEnumerable<Fuse.Effects.Effect>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum7), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum7), ::TYPES[13/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret21), ret21);
            uPtr(e)->Rooted();
        }
...
void Element__OnUnrooted_fn(Element* __this)
{
    ...
    if (__this->HasEffects())
        ...
        for (uObject* enum8 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Effects()), ::TYPES[18/*Uno.Collections.IEnumerable<Fuse.Effects.Effect>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum8), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum8), ::TYPES[13/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret22), ret22);
            uPtr(e)->Unrooted();
        }
...
void Element__PrependInverseTransformOrigin_fn(Element* __this, ::g::Fuse::FastMatrix* m)
{
    ...
    ::g::Uno::Float3 off = ::g::Fuse::Elements::ITransformOrigin::GetOffset(uInterface(uPtr(__this->TransformOrigin()), ::TYPES[20/*Fuse.Elements.ITransformOrigin*/]), __this);
...
void Element::ctor_3()
{
    ...
    _gmsCache = uArray::New(::TYPES[7/*Fuse.Elements.Element.GMSCacheItem[]*/], 2);
...
::g::Uno::UX::Size2 Element::Anchor()
{
    ...
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[23/*Fuse.Visual.Get<Uno.UX.Size2>*/], uCRef<int>(4096), uCRef(::g::Uno::UX::Size2__Auto()), &ret24), ret24);
}
...
float Element::Aspect()
{
    ...
    float ret25;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[25/*Fuse.Visual.Get<float>*/], uCRef<int>(65536), uCRef(1.0f), &ret25), ret25);
}
...
int Element::AspectConstraint()
{
    ...
    int ret26;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[26/*Fuse.Visual.Get<Fuse.Elements.AspectConstraint>*/], uCRef<int>(131072), uCRef<int>(3), &ret26), ret26);
}
...
int Element::CachingMode()
{
    ...
    int ret27;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[28/*Fuse.Visual.Get<Fuse.Elements.CachingMode>*/], uCRef<int>(262144), uCRef<int>(0), &ret27), ret27);
}
...
::g::Fuse::VisualBounds* Element::CalcRenderBoundsWithEffects()
{
    ...
    if (HasActiveEffects())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Effects()), ::TYPES[9/*Uno.Collections.ICollection<Fuse.Effects.Effect>*/])); i++)
            if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Effects()), ::TYPES[10/*Uno.Collections.IList<Fuse.Effects.Effect>*/]), uCRef<int>(i), &ret13), ret13))->Active())
                r = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Effects()), ::TYPES[10/*Uno.Collections.IList<Fuse.Effects.Effect>*/]), uCRef<int>(i), &ret14), ret14))->ModifyRenderBounds(r);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[4/*", max-size: "*/]), uBox<int>(::TYPES[0/*int*/], ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[5/*"C:\\Program...*/], 782);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[6/*"This elemen...*/], this, ::STRINGS[5/*"C:\\Program...*/], 970, ::STRINGS[7/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[5/*"C:\\Program...*/], 978, ::STRINGS[7/*"Composit"*/]);
    }
}
...
void Element::CompositEffects(::g::Fuse::DrawContext* dc)
{
    ...
    if (hasActiveEffects)
        ...
        for (uObject* enum3 = (uObject*)uPtr(_effects)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[13/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret15), ret15);
    ...
    if (hasActiveEffects && HasCompositionEffect())
        ...
        for (uObject* enum4 = (uObject*)uPtr(_effects)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Effects::Effect* e1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[13/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret16), ret16);
    ...
    if (hasActiveEffects)
        ...
        for (uObject* enum5 = (uObject*)uPtr(_effects)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Effects::Effect* e2 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[13/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret17), ret17);
...
uObject* Element::Effects()
{
    ...
    if (_effects == NULL)
        _effects = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[30/*Uno.Collections.ObservableList<Fuse.Effects.Effect>*/], uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectAdded_fn, this), uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRemoved_fn, this)));
...
bool Element::HasActiveEffects()
{
    ...
    if (HasEffects())
        ...
        for (uObject* enum2 = (uObject*)uPtr(_effects)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[13/*Uno.Collections.IEnumerator<Fuse.Effects.Effect>*/]), &ret28), ret28);
...
int Element::HitTestMode()
{
    ...
    int ret30;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[31/*Fuse.Visual.Get<Fuse.Elements.HitTestMode>*/], uCRef<int>(524288), uCRef<int>(5), &ret30), ret30);
}
...
void Element::HitTestMode(int value)
{
    ...
    ::g::Fuse::Visual__Set_fn(this, ::TYPES[32/*Fuse.Visual.Set<Fuse.Elements.HitTestMode>*/], uCRef<int>(524288), uCRef<int>(value), uCRef<int>(5));
    InvalidateHitTestBounds();
}
...
// public Uno.UX.Size get_LimitHeight() [instance] :2950
::g::Uno::UX::Size Element::LimitHeight()
{
    uStackFrame __("Fuse.Elements.Element", "get_LimitHeight()");
    ::g::Uno::UX::Size ret31;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(16777216), uCRef(::g::Uno::UX::Size__Auto()), &ret31), ret31);
}

// public void set_LimitHeight(Uno.UX.Size value) [instance] :2951
void Element::LimitHeight(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(16777216), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}

// public Uno.UX.Size get_LimitWidth() [instance] :2963
::g::Uno::UX::Size Element::LimitWidth()
{
    uStackFrame __("Fuse.Elements.Element", "get_LimitWidth()");
    ::g::Uno::UX::Size ret32;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(8388608), uCRef(::g::Uno::UX::Size__Auto()), &ret32), ret32);
}

// public void set_LimitWidth(Uno.UX.Size value) [instance] :2964
void Element::LimitWidth(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(8388608), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
...
::g::Uno::Float4 Element::Margin()
{
    ...
    ::g::Uno::Float4 ret33;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[35/*Fuse.Visual.Get<float4>*/], uCRef<int>(1024), uCRef(::g::Uno::Float4__New1(0.0f)), &ret33), ret33);
}
...
void Element::Margin(::g::Uno::Float4 value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[36/*Fuse.Visual.Set<float4>*/], uCRef<int>(1024), uCRef(value), uCRef(::g::Uno::Float4__New1(0.0f)));
        InvalidateLayout(2);
    }
}
...
::g::Uno::UX::Size Element::MaxHeight()
{
    ...
    ::g::Uno::UX::Size ret34;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(512), uCRef(::g::Uno::UX::Size__Auto()), &ret34), ret34);
}
...
void Element::MaxHeight(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(512), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
...
::g::Uno::UX::Size Element::MaxWidth()
{
    ...
    ::g::Uno::UX::Size ret35;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(256), uCRef(::g::Uno::UX::Size__Auto()), &ret35), ret35);
}
...
void Element::MaxWidth(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(256), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
...
::g::Uno::UX::Size Element::MinHeight()
{
    ...
    ::g::Uno::UX::Size ret36;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(128), uCRef(::g::Uno::UX::Size__Auto()), &ret36), ret36);
}
...
void Element::MinHeight(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(128), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
...
::g::Uno::UX::Size Element::MinWidth()
{
    ...
    ::g::Uno::UX::Size ret37;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(64), uCRef(::g::Uno::UX::Size__Auto()), &ret37), ret37);
}
...
void Element::MinWidth(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(64), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
...
::g::Uno::UX::Size2 Element::Offset()
{
    ...
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[23/*Fuse.Visual.Get<Uno.UX.Size2>*/], uCRef<int>(8192), uCRef(::g::Uno::UX::Size2__Auto()), &ret38), ret38);
}
...
void Element::OnEffectAdded(::g::Fuse::Effects::Effect* e)
{
    ...
    uPtr(e)->Added(this);
    e->add_RenderingChanged(uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderingChanged_fn, this));
...
void Element::OnEffectRemoved(::g::Fuse::Effects::Effect* e)
{
    ...
    uPtr(e)->Removed(this);
    e->remove_RenderingChanged(uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderingChanged_fn, this));
...
float Element::Opacity()
{
    ...
    float ret39;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[25/*Fuse.Visual.Get<float>*/], uCRef<int>(4194304), uCRef(1.0f), &ret39), ret39);
}
...
::g::Uno::Float4 Element::Padding()
{
    ...
    ::g::Uno::Float4 ret40;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[35/*Fuse.Visual.Get<float4>*/], uCRef<int>(2048), uCRef(::g::Uno::Float4__New1(0.0f)), &ret40), ret40);
}
...
void Element::Padding(::g::Uno::Float4 value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[36/*Fuse.Visual.Set<float4>*/], uCRef<int>(2048), uCRef(value), uCRef(::g::Uno::Float4__New1(0.0f)));
        InvalidateLayout(2);
    }
}
...
void Element::PerformPlacement(::g::Uno::Float2 position, ::g::Uno::Float2 size, bool temp)
{
    ...
    if ((newParent || newPosition) || newSize)
    {
        if (!temp && !_pendingDispatchPlacement)
        {
            ...
            if (::g::Uno::Delegate::op_Inequality(Placed1, NULL))
            {
                ::g::Fuse::UpdateManager::AddDeferredAction1(uDelegate::New(::TYPES[19/*Uno.Action*/], (void*)Element__DispatchPlacement_fn, this), ::g::Fuse::LayoutPriority::Placement());
...
void Element::add_Placed(uDelegate* value)
{
    ...
    Placed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Placed1, value), ::TYPES[40/*Fuse.PlacedHandler*/]);
}
...
void Element::remove_Placed(uDelegate* value)
{
    ...
    Placed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Placed1, value), ::TYPES[40/*Fuse.PlacedHandler*/]);
}
...
void Element::add_Preplacement(uDelegate* value)
{
    ...
    Preplacement1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Preplacement1, value), ::TYPES[41/*Fuse.Elements.PreplacementHandler*/]);
}
...
void Element::remove_Preplacement(uDelegate* value)
{
    ...
    Preplacement1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Preplacement1, value), ::TYPES[41/*Fuse.Elements.PreplacementHandler*/]);
}
...
uObject* Element::TransformOrigin()
{
    ...
    uObject* ret41;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[38/*Fuse.Visual.Get<Fuse.Elements.ITransformOrigin>*/], uCRef<int>(2097152), Element::DefaultTransformOrigin(), &ret41), ret41);
}
...
void Element::TransformOrigin(uObject* value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[39/*Fuse.Visual.Set<Fuse.Elements.ITransformOrigin>*/], uCRef<int>(2097152), value, Element::DefaultTransformOrigin());
        InvalidateLocalTransform();
    }
}
...
::g::Uno::UX::Size Element::X()
{
    ...
    ::g::Uno::UX::Size ret42;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(16384), uCRef(::g::Uno::UX::Size__Auto()), &ret42), ret42);
}
...
void Element::X(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(16384), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
...
::g::Uno::UX::Size Element::Y()
{
    ...
    ::g::Uno::UX::Size ret43;
    return (::g::Fuse::Visual__Get_fn(this, ::TYPES[33/*Fuse.Visual.Get<Uno.UX.Size>*/], uCRef<int>(32768), uCRef(::g::Uno::UX::Size__Auto()), &ret43), ret43);
}
...
void Element::Y(::g::Uno::UX::Size value)
{
    ...
    {
        ::g::Fuse::Visual__Set_fn(this, ::TYPES[34/*Fuse.Visual.Set<Uno.UX.Size>*/], uCRef<int>(32768), uCRef(value), uCRef(::g::Uno::UX::Size__Auto()));
        InvalidateLayout(2);
    }
}
// }
...
static void ElementAtlas_build(uType* type)
{
    ...
    ::TYPES[42] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::Element_typeof());
    ::TYPES[43] = ::g::Uno::EventHandler_typeof();
    ::TYPES[44] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::Element_typeof());
    ::TYPES[16] = ::g::Fuse::Visual_typeof();
    ::TYPES[5] = ::g::Fuse::IRenderViewport_typeof();
    ::TYPES[4] = ::g::Fuse::IFrustum_typeof();
    type->SetFields(0,
...
void ElementAtlas::ctor_()
{
    ...
    _elements = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[42/*Uno.Collections.List<Fuse.Elements.Element>*/]));
    _framebuffer = ::g::Fuse::Elements::ElementAtlasFramebuffer::New1();
    uPtr(_framebuffer)->add_FramebufferCollected(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], (void*)ElementAtlas__OnFramebufferCollected_fn, this));
...
void ElementAtlas::Dispose()
{
    ...
    uPtr(_framebuffer)->remove_FramebufferCollected(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], (void*)ElementAtlas__OnFramebufferCollected_fn, this));
    uPtr(_framebuffer)->Dispose();
}
...
void ElementAtlas::FillFramebuffer(::g::Fuse::DrawContext* dc, bool drawAll, ::g::Uno::Rect scissorRectInClipSpace)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::Element*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret7), ret7); enum2.MoveNext(::TYPES[44/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::Element* elm = enum2.Current(::TYPES[44/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]);
        ::g::Fuse::Elements::ElementBatchEntry* entry = uPtr(elm)->ElementBatchEntry();
...
void ElementAtlas::OnFramebufferCollected(uObject* sender, ::g::Uno::EventArgs* eventArgs)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::Element*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret8), ret8); enum1.MoveNext(::TYPES[44/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::Element* elm = enum1.Current(::TYPES[44/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]);
...
void ElementAtlasFramebuffer::add_FramebufferCollected(uDelegate* value)
{
    ...
    FramebufferCollected1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(FramebufferCollected1, value), ::TYPES[43/*Uno.EventHandler*/]);
}
...
void ElementAtlasFramebuffer::remove_FramebufferCollected(uDelegate* value)
{
    ...
    FramebufferCollected1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(FramebufferCollected1, value), ::TYPES[43/*Uno.EventHandler*/]);
}
...
void ElementAtlasFramebufferPool::Initialize()
{
    ...
    ElementAtlasFramebufferPool::UpdateElementAtlasSize();
    uPtr(::g::Uno::Platform2::Display::MainDisplay())->add_FrameChanged(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], (void*)ElementAtlasFramebufferPool__OnResized_fn));
...
void ElementAtlasFramebufferPool::add_AtlasSizeChanged(uDelegate* value)
{
    ...
    ElementAtlasFramebufferPool::AtlasSizeChanged1_ = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ElementAtlasFramebufferPool::AtlasSizeChanged1_, value), ::TYPES[43/*Uno.EventHandler*/]);
}
...
void ElementAtlasFramebufferPool::remove_AtlasSizeChanged(uDelegate* value)
{
    ...
    ElementAtlasFramebufferPool::AtlasSizeChanged1_ = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ElementAtlasFramebufferPool::AtlasSizeChanged1_, value), ::TYPES[43/*Uno.EventHandler*/]);
}
// }
...
{
    ::TYPES[45] = ::g::Fuse::Resources::ISoftDisposable_typeof();
    ::TYPES[43] = ::g::Uno::EventHandler_typeof();
    ::TYPES[46] = ::g::Uno::Collections::LinkedList_typeof()->MakeType(::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof());
    type->SetInterfaces(
...
void ElementAtlasFramebufferPoolImpl::ctor_()
{
    ...
    ::g::Fuse::Elements::ElementAtlasFramebufferPool::add_AtlasSizeChanged(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], (void*)ElementAtlasFramebufferPoolImpl__OnAtlasSizeChanged_fn, this));
}
...
void ElementAtlasFramebufferPoolImpl::EnsurePool()
{
    ...
    _framebufferPool = ((::g::Uno::Collections::LinkedList*)::g::Uno::Collections::LinkedList::New1(::TYPES[46/*Uno.Collections.LinkedList<Fuse.Elements.ElementAtlasFramebufferPoolEntry>*/]));
...
static void ElementBatch_build(uType* type)
{
    ...
    ::TYPES[47] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ::TYPES[48] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    type->SetInterfaces(
...
void ElementBatch::ctor_(::g::Fuse::Elements::ElementBatcher* elementBatcher, ::g::Fuse::Elements::ElementAtlas* elementAtlas)
{
    ...
    _elements = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[47/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>*/]));
...
void ElementBatch::Dispose()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatchEntry*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret7), ret7); enum1.MoveNext(::TYPES[48/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementBatchEntry* elm = enum1.Current(::TYPES[48/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]);
...
void ElementBatch::init_DrawCalls()
{
    ...
    _draw_9aaabe09 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseElements_bundle::ElementBatch2ee7bdf7());
}
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Elements\\0.33.5\\Caching\\$.uno");
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[50] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementAtlas_typeof());
    ::TYPES[51] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementBatch_typeof());
    ::TYPES[52] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::IElementBatchDrawable_typeof());
    ::TYPES[47] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ::TYPES[45] = ::g::Fuse::Resources::ISoftDisposable_typeof();
    ::TYPES[43] = ::g::Uno::EventHandler_typeof();
    ::TYPES[53] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementAtlas_typeof());
    ::TYPES[54] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[55] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[56] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementBatch_typeof());
    ::TYPES[48] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::ElementBatchEntry_typeof());
    ::TYPES[57] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::IElementBatchDrawable_typeof());
    ::TYPES[58] = ::g::Fuse::Elements::IElementBatchDrawable_typeof();
    ::TYPES[0] = ::g::Uno::Int_typeof();
    ::TYPES[16] = ::g::Fuse::Visual_typeof();
    type->SetInterfaces(
...
void ElementBatcher::ctor_()
{
    ...
    _elements = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<Fuse.Visual>*/]));
    _atlasPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[50/*Uno.Collections.List<Fuse.Elements.ElementAtlas>*/]));
    _batchPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[51/*Uno.Collections.List<Fuse.Elements.ElementBatch>*/]));
    _drawList = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[52/*Uno.Collections.List<Fuse.Elements.IElementBatchDrawable>*/]));
    _reinsertCheckList = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[47/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>*/]));
    ::g::Fuse::Resources::DisposalManager::Add1((uObject*)this);
    ::g::Fuse::Elements::ElementAtlasFramebufferPool::add_AtlasSizeChanged(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], (void*)ElementBatcher__OnAtlasSizeChanged_fn, this));
}
...
void ElementBatcher::DiscardAtlasing()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret14), ret14); enum1.MoveNext(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementAtlas* atlas = enum1.Current(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
        uPtr(atlas)->Dispose();
    }

    uPtr(_atlasPool)->Clear();

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret15), ret15); enum2.MoveNext(::TYPES[54/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ::g::Fuse::Visual* node = enum2.Current(::TYPES[54/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]);
        ::g::Fuse::Elements::Element* elm = uAs< ::g::Fuse::Elements::Element*>(node, ::TYPES[55/*Fuse.Elements.Element*/]);
...
void ElementBatcher::DiscardBatching()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatch*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_batchPool), &ret16), ret16); enum3.MoveNext(::TYPES[56/*Uno.Collections.List<Fuse.Elements.ElementBatch>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementBatch* batch = enum3.Current(::TYPES[56/*Uno.Collections.List<Fuse.Elements.ElementBatch>.Enumerator*/]);
        uPtr(batch)->Dispose();
    }
...
void ElementBatcher::Draw(::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Uno::Collections::List* removeList = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[50/*Uno.Collections.List<Fuse.Elements.ElementAtlas>*/]);

        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum7 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret17), ret17); enum7.MoveNext(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
        {
            ::g::Fuse::Elements::ElementAtlas* a = enum7.Current(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);

            if ((double)uPtr(a)->SpilledRatio() > 0.5)
                ::g::Uno::Collections::List__Add_fn(uPtr(removeList), a);
        }

        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum8 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret18), ret18); enum8.MoveNext(::TYPES[54/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
        {
            ::g::Fuse::Visual* node = enum8.Current(::TYPES[54/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]);
            ::g::Fuse::Elements::Element* elm = uAs< ::g::Fuse::Elements::Element*>(node, ::TYPES[55/*Fuse.Elements.Element*/]);

            if (elm == NULL)
                continue;

            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum9 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(removeList), &ret19), ret19); enum9.MoveNext(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
            {
                ::g::Fuse::Elements::ElementAtlas* a1 = enum9.Current(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum10 = (::g::Uno::Collections::List__GetEnumerator_fn(removeList, &ret20), ret20); enum10.MoveNext(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
        {
            ::g::Fuse::Elements::ElementAtlas* a2 = enum10.Current(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatchEntry*> > enum11 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_reinsertCheckList), &ret22), ret22); enum11.MoveNext(::TYPES[48/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementBatchEntry* e = enum11.Current(::TYPES[48/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum12 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_drawList), &ret24), ret24); enum12.MoveNext(::TYPES[57/*Uno.Collections.List<Fuse.Elements.IElementBatchDrawable>.Enumerator*/]); )
    {
        uObject* d = enum12.Current(::TYPES[57/*Uno.Collections.List<Fuse.Elements.IElementBatchDrawable>.Enumerator*/]);
        ::g::Fuse::Elements::IElementBatchDrawable::Draw(uInterface(uPtr(d), ::TYPES[58/*Fuse.Elements.IElementBatchDrawable*/]), dc, localToClipTransform, scissorRectInClipSpace);
    }
}
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret25), ret25); enum4.MoveNext(::TYPES[54/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ::g::Fuse::Visual* node = enum4.Current(::TYPES[54/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]);
        ...
        ::g::Fuse::Elements::Element* elm = uCast< ::g::Fuse::Elements::Element*>(node, ::TYPES[55/*Fuse.Elements.Element*/]);
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            if (atlas == NULL)
            {
                for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum5 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret26), ret26); enum5.MoveNext(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
                {
                    ::g::Fuse::Elements::ElementAtlas* a = enum5.Current(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[20/*"BUG: atlas-...*/], 1, ::STRINGS[21/*"C:\\Program...*/], 1067);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum6 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret27), ret27); enum6.MoveNext(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::ElementAtlas* a1 = enum6.Current(::TYPES[53/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]);
...
// public sealed class InteractiveTransform :2617
// {
// static InteractiveTransform() :2617
...
// public generated InteractiveTransform() :2617
void InteractiveTransform__ctor_3_fn(InteractiveTransform* __this)
{
    __this->ctor_3();
}

// internal void AppendRotationScale(Fuse.FastMatrix matrix) :2693
...
// public override sealed void AppendTo(Fuse.FastMatrix matrix, [float weight]) :2686
...
// public override sealed bool get_IsFlat() :2677
...
// public generated InteractiveTransform New() :2617
void InteractiveTransform__New2_fn(InteractiveTransform** __retval)
{
    *__retval = InteractiveTransform::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix matrix) :2679
...
// public void SetTranslation(float2 value, Uno.UX.IPropertyListener origin) :2667
...
// public void SetZoomFactor(float value, Uno.UX.IPropertyListener origin) :2628
...
// public float2 get_Translation() :2662
...
// public generated InteractiveTransform() [instance] :2617
...
// internal void AppendRotationScale(Fuse.FastMatrix matrix) [instance] :2693
...
// public float get_Rotation() [instance] :2643
...
// public void set_Rotation(float value) [instance] :2644
...
// public void SetRotation(float value, Uno.UX.IPropertyListener origin) [instance] :2648
...
// public void SetTranslation(float2 value, Uno.UX.IPropertyListener origin) [instance] :2667
...
// public void SetZoomFactor(float value, Uno.UX.IPropertyListener origin) [instance] :2628
...
// public float2 get_Translation() [instance] :2662
...
// public void set_Translation(float2 value) [instance] :2663
...
// public float get_ZoomFactor() [instance] :2623
...
// public void set_ZoomFactor(float value) [instance] :2624
...
// public generated InteractiveTransform New() [static] :2617
...
// public sealed class LayoutMasterBoxSizing :2715
// {
// static LayoutMasterBoxSizing() :2715
...
{
    ::TYPES[59] = LayoutMasterBoxSizing__LayoutMasterData_typeof();
    ::TYPES[11] = uObject_typeof();
    type->SetFields(0,
...
// public generated LayoutMasterBoxSizing() :2715
void LayoutMasterBoxSizing__ctor_1_fn(LayoutMasterBoxSizing* __this)
{
    __this->ctor_1();
}

// public override sealed float2 CalcArrangePaddingSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2750
...
// public override sealed Fuse.Elements.BoxPlacement CalcBoxPlacement(Fuse.Elements.Element element, float2 position, Fuse.LayoutParams lp) :2719
...
// public override sealed float2 CalcMarginSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2741
...
// public static Fuse.Elements.Element GetLayoutMaster(Fuse.Elements.Element elm) :2862
...
// private static Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData GetLayoutMasterData(Fuse.Elements.Element elm) :2837
...
// public static Fuse.Elements.LayoutMasterMode GetLayoutMasterMode(Fuse.Elements.Element elm) :2880
...
// public override sealed Fuse.LayoutDependent IsContentRelativeSize(Fuse.Elements.Element element) :2849
...
// public generated LayoutMasterBoxSizing New() :2715
void LayoutMasterBoxSizing__New1_fn(LayoutMasterBoxSizing** __retval)
{
    *__retval = LayoutMasterBoxSizing::New1();
}

// public override sealed void RequestLayout(Fuse.Elements.Element element) :2735
...
// public static void ResetLayoutMaster(Fuse.Elements.Element elm) :2868
void LayoutMasterBoxSizing__ResetLayoutMaster_fn(::g::Fuse::Elements::Element* elm)
{
    LayoutMasterBoxSizing::ResetLayoutMaster(elm);
}

// public static void SetLayoutMaster(Fuse.Elements.Element elm, Fuse.Elements.Element master) :2856
...
// public static void SetLayoutMasterMode(Fuse.Elements.Element elm, Fuse.Elements.LayoutMasterMode mode) :2874
...
// public generated LayoutMasterBoxSizing() [instance] :2715
...
// public static Fuse.Elements.Element GetLayoutMaster(Fuse.Elements.Element elm) [static] :2862
...
// private static Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData GetLayoutMasterData(Fuse.Elements.Element elm) [static] :2837
LayoutMasterBoxSizing__LayoutMasterData* LayoutMasterBoxSizing::GetLayoutMasterData(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(uPtr(elm)->Properties())->TryGet(LayoutMasterBoxSizing::_layoutMasterDataProperty(), &v))
        return uCast<LayoutMasterBoxSizing__LayoutMasterData*>(v, ::TYPES[59/*Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData*/]);
...
// public static Fuse.Elements.LayoutMasterMode GetLayoutMasterMode(Fuse.Elements.Element elm) [static] :2880
...
// public generated LayoutMasterBoxSizing New() [static] :2715
...
// public static void ResetLayoutMaster(Fuse.Elements.Element elm) [static] :2868
...
// public static void SetLayoutMaster(Fuse.Elements.Element elm, Fuse.Elements.Element master) [static] :2856
...
// public static void SetLayoutMasterMode(Fuse.Elements.Element elm, Fuse.Elements.LayoutMasterMode mode) [static] :2874
...
// private sealed class LayoutMasterBoxSizing.LayoutMasterData :2757
// {
...
// public void set_Master(Fuse.Elements.Element value) :2768
...
// public generated LayoutMasterData New() :2757
...
// private void OnPlaced(object s, object args) :2831
...
// internal void ScheduleCheckLayout() :2787
...
// public generated LayoutMasterData() [instance] :2757
void LayoutMasterBoxSizing__LayoutMasterData::ctor_()
{
}

// internal void CheckLayout() [instance] :2797
void LayoutMasterBoxSizing__LayoutMasterData::CheckLayout()
{
    ...
    {
        ::g::Fuse::Elements::Element* pe = uAs< ::g::Fuse::Elements::Element*>(uPtr(_master)->Parent(), ::TYPES[55/*Fuse.Elements.Element*/]);
...
// public Fuse.Elements.Element get_Master() [instance] :2767
...
// public void set_Master(Fuse.Elements.Element value) [instance] :2768
void LayoutMasterBoxSizing__LayoutMasterData::Master(::g::Fuse::Elements::Element* value)
{
    ...
    if (_master != NULL)
        uPtr(_master)->remove_Placed(uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__OnPlaced_fn, this));

    _master = value;

    if (_master != NULL)
        uPtr(_master)->add_Placed(uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__OnPlaced_fn, this));

    if (uPtr(Element)->IsRootingCompleted())
        ScheduleCheckLayout();
}

// private void OnPlaced(object s, object args) [instance] :2831
void LayoutMasterBoxSizing__LayoutMasterData::OnPlaced(uObject* s, uObject* args)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[19/*Uno.Action*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__CheckLayout_fn, this), -1, 0);
}

// internal void ScheduleCheckLayout() [instance] :2787
...
// public generated LayoutMasterData New() [static] :2757
...
// public enum LayoutMasterMode :2708
...
// public sealed class LimitBoxSizing :2895
// {
// static LimitBoxSizing() :2895
...
// public generated LimitBoxSizing() :2895
void LimitBoxSizing__ctor_1_fn(LimitBoxSizing* __this)
{
    __this->ctor_1();
}

// public override sealed float2 CalcArrangePaddingSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2914
...
// public override sealed Fuse.Elements.BoxPlacement CalcBoxPlacement(Fuse.Elements.Element element, float2 position, Fuse.LayoutParams lp) :2899
...
// public override sealed float2 CalcMarginSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :2904
...
// private float2 Limit(Fuse.Elements.Element element, float2 std) :2919
...
// public generated LimitBoxSizing New() :2895
...
// public generated LimitBoxSizing() [instance] :2895
...
// private float2 Limit(Fuse.Elements.Element element, float2 std) [instance] :2919
...
// public generated LimitBoxSizing New() [static] :2895
...
// private class TranslationModes.OffsetMode :2990
// {
static void TranslationModes__OffsetMode_build(uType* type)
{
    ...
    ::TYPES[40] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[11] = uObject_typeof();
    ::TYPES[61] = TranslationModes__OffsetMode__Subscriptions_typeof();
    type->SetInterfaces(
...
// public generated OffsetMode() :2990
void TranslationModes__OffsetMode__ctor__fn(TranslationModes__OffsetMode* __this)
{
    __this->ctor_();
}

// public float3 GetAbsVector(Fuse.Translation t) :2992
...
// protected virtual float3 GetDstOffset(Fuse.Elements.Element e) :3042
...
// protected virtual float3 GetSrcOffset(Fuse.Elements.Element e) :3043
...
// public object Subscribe(Fuse.ITransformRelative transform) :3021
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :3033
...
// public generated OffsetMode() [instance] :2990
void TranslationModes__OffsetMode::ctor_()
{
}

// public float3 GetAbsVector(Fuse.Translation t) [instance] :2992
::g::Uno::Float3 TranslationModes__OffsetMode::GetAbsVector(::g::Fuse::Translation* t)
{
    ...
    ::g::Fuse::Elements::Element* dstElement = uAs< ::g::Fuse::Elements::Element*>(n, ::TYPES[55/*Fuse.Elements.Element*/]);
    ...
    ::g::Fuse::Elements::Element* elm = uAs< ::g::Fuse::Elements::Element*>(t->Parent(), ::TYPES[55/*Fuse.Elements.Element*/]);
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :3021
uObject* TranslationModes__OffsetMode::Subscribe(uObject* transform)
{
    ...
    uPtr(collection1)->Relative = ::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]));
    uPtr(collection1)->TargetParent = uPtr(::g::Fuse::ITransformRelative::Target(uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/])))->Parent();
    uPtr(collection1)->Target = uAs< ::g::Fuse::Elements::Element*>(::g::Fuse::ITransformRelative::Target(uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/])), ::TYPES[55/*Fuse.Elements.Element*/]);
    TranslationModes__OffsetMode__Subscriptions* s = collection1;
    uPtr(uPtr(s)->Relative)->add_WorldTransformInvalidated(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], uInterface(transform, ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
    uPtr(s->TargetParent)->add_WorldTransformInvalidated(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], uInterface(transform, ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    if (s->Target != NULL)
        uPtr(uPtr(s)->Target)->add_Placed(uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return s;
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :3033
void TranslationModes__OffsetMode::Unsubscribe(uObject* transform, uObject* sub)
{
    ...
    TranslationModes__OffsetMode__Subscriptions* s = uAs<TranslationModes__OffsetMode__Subscriptions*>(sub, ::TYPES[61/*Fuse.Elements.TranslationModes.OffsetMode.Subscriptions*/]);
    uPtr(uPtr(s)->Relative)->remove_WorldTransformInvalidated(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
    uPtr(s->TargetParent)->remove_WorldTransformInvalidated(uDelegate::New(::TYPES[43/*Uno.EventHandler*/], uInterface(transform, ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    if (s->Target != NULL)
        uPtr(uPtr(s)->Target)->remove_Placed(uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}
// }

// C:\ProgramData\Uno\Packages\Fuse.Controls\0.33.5\$.uno
// ------------------------------------------------------
...
// private sealed class TranslationModes.PositionOffsetMode :3046
// {
...
// public generated PositionOffsetMode() [instance] :3046
...
// public generated PositionOffsetMode New() [static] :3046
...
// private sealed class TranslationModes.RelativeResizeChangeMode :3105
// {
...
// public generated RelativeResizeChangeMode() :3105
void TranslationModes__RelativeResizeChangeMode__ctor__fn(TranslationModes__RelativeResizeChangeMode* __this)
{
    __this->ctor_();
}

// public bool GetSizeChange(Fuse.Visual target, Fuse.Visual relative, float2& baseSize, float2& deltaSize) :3107
...
// public generated RelativeResizeChangeMode New() :3105
...
// public generated RelativeResizeChangeMode() [instance] :3105
void TranslationModes__RelativeResizeChangeMode::ctor_()
{
}

// public bool GetSizeChange(Fuse.Visual target, Fuse.Visual relative, float2& baseSize, float2& deltaSize) [instance] :3107
bool TranslationModes__RelativeResizeChangeMode::GetSizeChange(::g::Fuse::Visual* target, ::g::Fuse::Visual* relative, ::g::Uno::Float2* baseSize, ::g::Uno::Float2* deltaSize)
{
    ...
    if (!uIs(target, ::TYPES[55/*Fuse.Elements.Element*/]) || !uIs(relative, ::TYPES[55/*Fuse.Elements.Element*/]))
    {
    ...
    ::g::Uno::Float2 targetSize = uPtr(uAs< ::g::Fuse::Elements::Element*>(target, ::TYPES[55/*Fuse.Elements.Element*/]))->IntendedSize();
    ::g::Uno::Float2 relativeSize = uPtr(uAs< ::g::Fuse::Elements::Element*>(relative, ::TYPES[55/*Fuse.Elements.Element*/]))->ActualSize();
    *deltaSize = ::g::Uno::Float2__op_Subtraction2(relativeSize, targetSize);
    *baseSize = targetSize;
    return true;
}

// public generated RelativeResizeChangeMode New() [static] :3105
...
// internal enum SimpleAlignment :2550
...
// private sealed class TranslationModes.SizeFactorMode :3068
// {
static void TranslationModes__SizeFactorMode_build(uType* type)
{
    ::TYPES[55] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[62] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[60] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[40] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[11] = uObject_typeof();
    type->SetInterfaces(
...
// public generated SizeFactorMode New() :3068
...
// public object Subscribe(Fuse.ITransformRelative transform) :3085
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :3092
...
// public generated SizeFactorMode() [instance] :3068
void TranslationModes__SizeFactorMode::ctor_()
{
}

// public float3 GetScaleVector(Fuse.Scaling t) [instance] :3070
::g::Uno::Float3 TranslationModes__SizeFactorMode::GetScaleVector(::g::Fuse::Scaling* t)
{
    ...
    ::g::Fuse::Elements::Element* dst = uAs< ::g::Fuse::Elements::Element*>(uPtr(t)->RelativeNode(), ::TYPES[55/*Fuse.Elements.Element*/]);
    ::g::Fuse::Elements::Element* src = uAs< ::g::Fuse::Elements::Element*>(t->Parent(), ::TYPES[55/*Fuse.Elements.Element*/]);
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :3085
uObject* TranslationModes__SizeFactorMode::Subscribe(uObject* transform)
{
    ...
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/])), ::TYPES[62/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[62/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return n;
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :3092
void TranslationModes__SizeFactorMode::Unsubscribe(uObject* transform, uObject* sub)
{
    ...
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[62/*Fuse.IActualPlacement*/])), ::TYPES[62/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}

// public generated SizeFactorMode New() [static] :3068
...
// public enum StretchDirection :2588
...
// public enum StretchSizing :2601
...
// private sealed class TranslationModes.OffsetMode.Subscriptions :3015
// {
...
// public generated Subscriptions() [instance] :3015
void TranslationModes__OffsetMode__Subscriptions::ctor_()
{
}

// public generated Subscriptions New() [static] :3015
...
// private sealed class TranslationModes.TransformOriginOffsetMode :3050
// {
...
// public generated TransformOriginOffsetMode() :3050
void TranslationModes__TransformOriginOffsetMode__ctor_1_fn(TranslationModes__TransformOriginOffsetMode* __this)
{
    __this->ctor_1();
}

// protected override sealed float3 GetDstOffset(Fuse.Elements.Element e) :3052
void TranslationModes__TransformOriginOffsetMode__GetDstOffset_fn(TranslationModes__TransformOriginOffsetMode* __this, ::g::Fuse::Elements::Element* e, ::g::Uno::Float3* __retval)
{
    ...
    return *__retval = ::g::Fuse::Elements::ITransformOrigin::GetOffset(uInterface(uPtr(uPtr(e)->TransformOrigin()), ::TYPES[20/*Fuse.Elements.ITransformOrigin*/]), e), void();
}

// protected override sealed float3 GetSrcOffset(Fuse.Elements.Element e) :3057
...
// public generated TransformOriginOffsetMode New() :3050
...
// public generated TransformOriginOffsetMode() [instance] :3050
...
// public generated TransformOriginOffsetMode New() [static] :3050
...
// public static class TranslationModes :2988
// {
// static TranslationModes() :2988
...
{
    ::TYPES[63] = ::g::Fuse::ITranslationMode_typeof();
    ::TYPES[64] = ::g::Fuse::IScalingMode_typeof();
    ::TYPES[65] = ::g::Fuse::Animations::IResizeMode_typeof();
    type->SetFields(0,
...
static void Viewport_build(uType* type)
{
    ...
    ::TYPES[67] = ::g::Fuse::PerspectiveFrustum_typeof();
    ::TYPES[68] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[2] = ::g::Fuse::RootViewport_typeof();
    ::TYPES[22] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[15] = ::g::Fuse::Node_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(86,
        ...
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Elements::Viewport, OnDraw_LocalTransform_a781a46e_4_9_2), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Elements::Viewport, OnDraw_LocalTransform_a781a46e_4_9_3), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Elements::Viewport, OnDraw_LocalTransform_a781a46e_4_9_4), 0,
...
void Viewport__FuseIRenderViewportget_ViewOrigin_fn(Viewport* __this, ::g::Uno::Float3* __retval)
{
    ...
    return *__retval = ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(__this->Frustum()), ::TYPES[4/*Fuse.IFrustum*/]), (uObject*)__this), void();
}
...
void Viewport__FuseIRenderViewportget_ViewRange_fn(Viewport* __this, ::g::Uno::Float2* __retval)
{
    ...
    return *__retval = ::g::Fuse::IFrustum::GetDepthRange(uInterface(uPtr(__this->Frustum()), ::TYPES[4/*Fuse.IFrustum*/]), (uObject*)__this), void();
}
...
void Viewport__OnDraw_fn(Viewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->Mode() == 2)
    {
        ...
        ::g::Uno::Float4x4 LocalTransform_a781a46e_4_9_5 = ::g::Uno::Matrix::Mul10(__this->OnDraw_LocalTransform_a781a46e_4_9_2, ::g::Uno::Matrix::Scaling1(__this->ActualSize().X, __this->ActualSize().Y, 1.0f), __this->OnDraw_LocalTransform_a781a46e_4_9_3, __this->OnDraw_LocalTransform_a781a46e_4_9_4);
        ...
        __this->_draw_a781a46e.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[5/*Fuse.IRenderViewport*/])));
        __this->_draw_a781a46e.Uniform12(2, (__this != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_a781a46e_4_9_5, __this->WorldTransform()) : LocalTransform_a781a46e_4_9_5);
...
void Viewport__OnRooted_fn(Viewport* __this)
{
    ...
    __this->add_Placed(uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], (void*)Viewport__OnPlaced_fn, __this));
}
...
void Viewport__OnUnrooted_fn(Viewport* __this)
{
    ...
    __this->remove_Placed(uDelegate::New(::TYPES[40/*Fuse.PlacedHandler*/], (void*)Viewport__OnPlaced_fn, __this));
...
void Viewport::init_DrawCalls()
{
    ...
    OnDraw_VertexData_a781a46e_7_2_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(uArray::Init< ::g::Uno::Float2>(::TYPES[6/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f))), 0);
    OnDraw_LocalTransform_a781a46e_4_9_2 = ::g::Uno::Matrix::Translation(-::g::Uno::Float2__New1(0.0f).X, -::g::Uno::Float2__New1(0.0f).Y, 0.0f);
    OnDraw_LocalTransform_a781a46e_4_9_3 = ::g::Uno::Matrix::RotationZ(0.0f);
    OnDraw_LocalTransform_a781a46e_4_9_4 = ::g::Uno::Matrix::Translation(::g::Uno::Float2__New1(0.0f).X, ::g::Uno::Float2__New1(0.0f).Y, 0.0f);
    _draw_a781a46e = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::Viewport2da28930());
}
...
bool Viewport::IsRoot()
{
    ...
    return (Parent() == NULL) || uIs((::g::Fuse::Visual*)Parent(), ::TYPES[2/*Fuse.RootViewport*/]);
}
...
::g::Uno::Float2 Viewport::PixelSize()
{
    ...
    return IsDisabled() ? ::g::Fuse::ICommonViewport::PixelSize(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[68/*Fuse.ICommonViewport*/])) : ::g::Uno::Float2__op_Multiply1(ActualSize(), PixelsPerPoint());
}
...
float Viewport::PixelsPerPoint()
{
    ...
    return ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[68/*Fuse.ICommonViewport*/]));
}
...
::g::Uno::Geometry::Ray Viewport::PointToWorldRay(::g::Uno::Float2 pointPos)
{
    ...
    if (IsDisabled())
        return ::g::Fuse::IViewport::PointToWorldRay(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[66/*Fuse.IViewport*/]), pointPos);

    if (!IsRoot())
    {
        ::g::Uno::Geometry::Ray pr = ::g::Fuse::IViewport::PointToWorldRay(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[66/*Fuse.IViewport*/]), pointPos);
        ::g::Uno::Geometry::Ray local = ::g::Fuse::IViewport::WorldToLocalRay(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[66/*Fuse.IViewport*/]), uPtr(Parent())->Viewport(), pr, this);
...
::g::Uno::Float2 Viewport::Size()
{
    ...
    return IsDisabled() ? ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[68/*Fuse.ICommonViewport*/])) : ActualSize();
}
...
void Viewport::UpdatePerspective()
{
    ...
    ::g::Fuse::PerspectiveFrustum* pf = uAs< ::g::Fuse::PerspectiveFrustum*>(Frustum(), ::TYPES[67/*Fuse.PerspectiveFrustum*/]);
...
::g::Uno::Float4x4 Viewport::ViewTransform()
{
    ...
    return IsDisabled() ? ::g::Fuse::ICommonViewport::ViewTransform(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[68/*Fuse.ICommonViewport*/])) : uPtr(FrustumViewport())->ViewTransform;
}
...
::g::Uno::Geometry::Ray Viewport::WorldToLocalRay(uObject* world, ::g::Uno::Geometry::Ray worldRay, ::g::Fuse::Visual* where)
{
    ...
    if (IsDisabled())
    {
        ...
        return ::g::Fuse::IViewport::WorldToLocalRay(uInterface(uPtr(uPtr(Parent())->Viewport()), ::TYPES[66/*Fuse.IViewport*/]), world, worldRay, where);
    }
