...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Navigation\0.33.5\NavigationControlBit\$.uno
// --------------------------------------------------------------------------------------

// public partial sealed class EnterHorizontal :8
// {
...
static void EnterHorizontal_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)EnterHorizontal__New3_fn, 0, true, EnterHorizontal_typeof(), 0));
}
...
// public partial sealed class EnterVertical :22
// {
...
static void EnterVertical_build(uType* type)
{
    ...
    type->SetFields(31);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)EnterVertical__New3_fn, 0, true, EnterVertical_typeof(), 0));
}
...
// public partial sealed class ExitHorizontal :35
// {
...
static void ExitHorizontal_build(uType* type)
{
    ...
    type->SetFields(31);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ExitHorizontal__New3_fn, 0, true, ExitHorizontal_typeof(), 0));
}
...
// public partial sealed class ExitVertical :48
// {
...
static void ExitVertical_build(uType* type)
{
    ...
    type->SetFields(31);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ExitVertical__New3_fn, 0, true, ExitVertical_typeof(), 0));
}
...
static void NavEnterHorizontal_build(uType* type)
{
    ...
    type->SetFields(31);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NavEnterHorizontal__New3_fn, 0, true, NavEnterHorizontal_typeof(), 0));
}
...
static void NavExitHorizontal_build(uType* type)
{
    ...
    type->SetFields(31);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NavExitHorizontal__New3_fn, 0, true, NavExitHorizontal_typeof(), 0));
}
...
static void NavRemoveHorizontal_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Fuse::Animations::Animator_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::RemovingAnimation_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::RemovingAnimation_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::RemovingAnimation_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::RemovingAnimation_type, interface3),
    ...
    type->SetFields(28);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NavRemoveHorizontal__New3_fn, 0, true, NavRemoveHorizontal_typeof(), 0));
}
...
::g::Fuse::Triggers::RemovingAnimation_type* NavRemoveHorizontal_typeof()
{
    ...
    type->SetBase(::g::Fuse::Triggers::RemovingAnimation_typeof());
