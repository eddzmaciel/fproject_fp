// This file was generated based on C:\Users\Eddz-\Documents\Fuse\MyFirstFuseProject\build\Android\Preview\cache\PageWithTitle.g.uno.
...
static void PageWithTitle_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[3] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::Float4_typeof());
    ...
    ::TYPES[11] = ::g::Fuse::Layouts::Layout_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(92,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof()), offsetof(::g::PageWithTitle, temp_TextColor_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::PageWithTitle, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof()), offsetof(::g::PageWithTitle, temp1_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::PageWithTitle, temp2_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof()), offsetof(::g::PageWithTitle, this_HeaderColor_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof()), offsetof(::g::PageWithTitle, this_HeaderTextColor_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::PageWithTitle, this_Instructions_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::PageWithTitle, this_Title_inst), 0,
    ...
    type->Reflection.SetFunctions(10,
        ...
        new uFunction(".ctor", NULL, (void*)PageWithTitle__New5_fn, 0, true, PageWithTitle_typeof(), 0),
...
{
    uStackFrame __("PageWithTitle", "get_HeaderColor()");
...
{
    uStackFrame __("PageWithTitle", "get_HeaderTextColor()");
...
void PageWithTitle::InitializeUX()
{
    ...
    temp_Value_inst = ::g::MyFirstFuseProject_FuseControlsText_Value_Property::New1(temp, PageWithTitle::__selector0());
    this_Title_inst = ::g::MyFirstFuseProject_PageWithTitle_Title_Property::New1(this, PageWithTitle::__selector1());
    temp_TextColor_inst = ::g::MyFirstFuseProject_FuseControlsText_TextColor_Property::New1(temp, PageWithTitle::__selector2());
    this_HeaderTextColor_inst = ::g::MyFirstFuseProject_PageWithTitle_HeaderTextColor_Property::New1(this, PageWithTitle::__selector3());
    ::g::Fuse::Controls::Panel* temp1 = ::g::Fuse::Controls::Panel::New3();
    temp1_Color_inst = ::g::MyFirstFuseProject_FuseControlsPanel_Color_Property::New1(temp1, PageWithTitle::__selector4());
    this_HeaderColor_inst = ::g::MyFirstFuseProject_PageWithTitle_HeaderColor_Property::New1(this, PageWithTitle::__selector5());
    ::g::Fuse::Controls::Text* temp2 = ::g::Fuse::Controls::Text::New3();
    temp2_Value_inst = ::g::MyFirstFuseProject_FuseControlsText_Value_Property::New1(temp2, PageWithTitle::__selector0());
    this_Instructions_inst = ::g::MyFirstFuseProject_PageWithTitle_Instructions_Property::New1(this, PageWithTitle::__selector6());
    ...
    ::g::Fuse::Controls::PropertyBinding* temp5 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[2/*Fuse.Controls.PropertyBinding<string>*/], temp_Value_inst, this_Title_inst);
    ::g::Fuse::Controls::PropertyBinding* temp6 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[3/*Fuse.Controls.PropertyBinding<float4>*/], temp_TextColor_inst, this_HeaderTextColor_inst);
    ::g::Fuse::Controls::PropertyBinding* temp7 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[3/*Fuse.Controls.PropertyBinding<float4>*/], temp1_Color_inst, this_HeaderColor_inst);
    ...
    ::g::Fuse::Controls::PropertyBinding* temp11 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[2/*Fuse.Controls.PropertyBinding<string>*/], temp2_Value_inst, this_Instructions_inst);
    HitTestMode(6);
    Name(PageWithTitle::__selector7());
    ::g::Fuse::Controls::DockPanel::SetDock(temp4, 2);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), temp1);
    temp1->Height(::g::Uno::UX::Size__New1(45.0f, 1));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[7/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp6);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp8->Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    temp9->Threshold(0.4f);
    temp9->Invert(true);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[9/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp10);
    temp10->Y(1.0f);
    temp10->Easing(21);
    temp10->Duration(0.4);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[7/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp11);
    Layout(temp3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), temp4);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Node>*/]), temp8);
}

// public string get_Instructions() [instance] :38
uString* PageWithTitle::Instructions()
{
    uStackFrame __("PageWithTitle", "get_Instructions()");
