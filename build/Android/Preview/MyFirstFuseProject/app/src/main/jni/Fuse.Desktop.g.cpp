...
// C:\ProgramData\Uno\Packages\Fuse.Desktop\0.33.5\$.uno
// -----------------------------------------------------
...
{
    ::TYPES[0] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::PointerEventArgs_typeof());
    ::TYPES[1] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    ::TYPES[2] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::TextInputEventArgs_typeof());
    ::TYPES[3] = ::g::Fuse::IRenderViewport_typeof();
    ::TYPES[4] = ::g::Uno::Exception_typeof();
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(DesktopRootViewport_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(DesktopRootViewport_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(DesktopRootViewport_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(DesktopRootViewport_type, interface3),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(DesktopRootViewport_type, interface4),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(DesktopRootViewport_type, interface5),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(DesktopRootViewport_type, interface6),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(DesktopRootViewport_type, interface7),
        ::g::Fuse::IViewport_typeof(), offsetof(DesktopRootViewport_type, interface8),
        ::g::Fuse::ICommonViewport_typeof(), offsetof(DesktopRootViewport_type, interface9),
        ::g::Fuse::IRenderViewport_typeof(), offsetof(DesktopRootViewport_type, interface10));
    type->SetFields(63,
...
DesktopRootViewport_type* DesktopRootViewport_typeof()
{
    ...
    type->interface10.fp_get_ProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ProjectionTransform_fn;
    type->interface10.fp_get_ViewProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewProjectionTransform_fn;
    type->interface10.fp_get_ViewOrigin = (void(*)(uObject*, ::g::Uno::Float3*))::g::Fuse::RootViewport__get_ViewOrigin_fn;
    type->interface10.fp_get_ViewRange = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_ViewRange_fn;
    type->interface9.fp_get_PixelsPerPoint = (void(*)(uObject*, float*))::g::Fuse::RootViewport__get_PixelsPerPoint_fn;
    type->interface9.fp_get_Size = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_Size_fn;
    type->interface9.fp_get_PixelSize = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_PixelSize_fn;
    type->interface9.fp_get_ViewTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewTransform_fn;
...
void DesktopRootViewport::OnPointerMoved(uObject* sender, ::g::Uno::Platform::PointerEventArgs* args)
{
    ...
    try
    {
        uPtr(args)->Handled(uPtr(::g::Fuse::Input::Pointer::RaiseMoved(this, TranslatePointerEvent(args)))->IsHandled());
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
void DesktopRootViewport::OnPointerPressed(uObject* sender, ::g::Uno::Platform::PointerEventArgs* args)
{
    ...
    try
    {
        uPtr(args)->Handled(uPtr(::g::Fuse::Input::Pointer::RaisePressed(this, TranslatePointerEvent(args)))->IsHandled());
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
void DesktopRootViewport::OnPointerReleased(uObject* sender, ::g::Uno::Platform::PointerEventArgs* args)
{
    ...
    try
    {
        uPtr(args)->Handled(uPtr(::g::Fuse::Input::Pointer::RaiseReleased(this, TranslatePointerEvent(args)))->IsHandled());
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
void DesktopRootViewport::OnPointerWheelChanged(uObject* sender, ::g::Uno::Platform::PointerEventArgs* args)
{
    ...
    try
    {
        uPtr(args)->Handled(uPtr(::g::Fuse::Input::Pointer::RaiseWheelMoved(this, TranslatePointerEvent(args)))->IsHandled());
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
