...
{
    uStackFrame __("Experimental.Cache.ProxyStream", "get_CanRead()");
...
{
    uStackFrame __("Experimental.Cache.ProxyStream", "get_CanSeek()");
...
{
    uStackFrame __("Experimental.Cache.ProxyStream", "get_CanWrite()");
    return *__retval = true, void();
}
