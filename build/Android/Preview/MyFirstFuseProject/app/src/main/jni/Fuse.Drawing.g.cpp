...
// C:\ProgramData\Uno\Packages\Fuse.Drawing\0.33.5\$.uno
// -----------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Paths\0.33.5\$.uno
// -----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Polygons\0.33.5\Rendering\$.uno
// ------------------------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Drawing\\0.33.5\\$.uno");
    ::STRINGS[3] = uString::Const("Prepare");
    ::TYPES[7] = ::g::Fuse::Scripting::Marshal__IConverter_typeof();
...
void Brush::Prepare(::g::Fuse::DrawContext* dc, ::g::Uno::Float2 canvasSize)
{
    ...
    if (!IsPinned())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Brush is no...*/], this, ::STRINGS[2/*"C:\\Program...*/], 152, ::STRINGS[3/*"Prepare"*/]);
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Polygons\0.33.5\$.uno
// --------------------------------------------------------------
...
static void ButtCap_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[2] = ::g::Uno::Float2_typeof()->Array();
}
...
void ButtCap__Create_fn(ButtCap* __this, ::g::Uno::Float2* from, ::g::Uno::Float2* to, uObject** __retval)
{
    ...
    return *__retval = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<float2>*/], uArray::New(::TYPES[2/*float2[]*/], 0))), void();
}
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Polygons\0.33.5\Collections\$.uno
// --------------------------------------------------------------------------
...
{
    ::TYPES[11] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    ::TYPES[12] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[13] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->SetPrecalc(
...
static void Contour_build(uType* type)
{
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[10] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[14] = ::g::Fuse::Drawing::Cache_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetFields(0,
...
void Contour::ctor_(bool isClosed, uArray* vertices)
{
    ...
    ctor_1(isClosed, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<float2>*/], vertices)));
}
...
void Contour::ctor_1(bool isClosed, uObject* vertices)
{
    ...
    ::g::Uno::Float2 ret3;
    ::g::Uno::Float2 ret4;
    _vertices = ((::g::Fuse::Drawing::Cache*)::g::Fuse::Drawing::Cache::New2(::TYPES[14/*Fuse.Drawing.Cache<float2>*/], ::g::Fuse::Drawing::NonConsecutiveExtension::NonConsecutive(vertices)));
    IsClosed(isClosed);
...
{
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    type->SetInterfaces(
...
{
    ::TYPES[16] = ::g::Fuse::Drawing::ClosePath_typeof();
    ::TYPES[17] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::PathGeometry_typeof());
    ::TYPES[18] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[20] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetInterfaces(
...
bool ContourEnumerator::MoveNext()
{
    ...
    bool isClosed = uIs((::g::Fuse::Drawing::PathGeometry*)_currentHead, ::TYPES[16/*Fuse.Drawing.ClosePath*/]);
    ::g::Uno::Collections::List* revPath = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[17/*Uno.Collections.List<Fuse.Drawing.PathGeometry>*/]);
    ...
    ::g::Uno::Collections::List* vertices = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[18/*Uno.Collections.List<float2>*/]);
    ...
    for (int i = revPath->Count() - 1; i >= 0; --i)
    {
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(headVertices), ::TYPES[9/*Uno.Collections.IEnumerable<float2>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::Float2 v = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[20/*Uno.Collections.IEnumerator<float2>*/]), &ret4), ret4);
...
{
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[21] = ::g::Uno::Collections::EmptyEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetFields(4);
}
...
void ContourTerminator__EvaluateLast_fn(ContourTerminator* __this, uObject** __retval)
{
    ...
    return *__retval = (uObject*)((::g::Uno::Collections::EmptyEnumerable*)::g::Uno::Collections::EmptyEnumerable::New1(::TYPES[21/*Uno.Collections.EmptyEnumerable<float2>*/])), void();
}
...
bool Brush__Converter::CanConvert(uType* t)
{
    ...
    return ::g::Uno::Type::op_Equality(t, ::TYPES[49/*Fuse.Drawing.Brush*/]) || ::g::Uno::Type::IsSubclassOf(uPtr(t), ::TYPES[49/*Fuse.Drawing.Brush*/]);
}
...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.33.5\Drawing\$.uno
// --------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing\0.33.5\Brushes\$.uno
// -------------------------------------------------------------
...
static void LinearGradient_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[26] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[27] = ::g::Fuse::Drawing::GradientStop_typeof()->Array();
    ::TYPES[28] = ::g::Uno::UX::IPropertyListener_typeof();
    ::TYPES[29] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[30] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[31] = ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), ::g::Fuse::Drawing::GradientStop_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[32] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[33] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    type->SetInterfaces(
...
void LinearGradient::InitList()
{
    ...
    _stops = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[25/*Uno.Collections.ObservableList<Fuse.Drawing.GradientStop>*/], uDelegate::New(::TYPES[26/*Uno.Action<Fuse.Drawing.GradientStop>*/], (void*)LinearGradient__OnAdded_fn, this), uDelegate::New(::TYPES[26/*Uno.Action<Fuse.Drawing.GradientStop>*/], (void*)LinearGradient__OnRemoved_fn, this)));
    _sortedStops = uArray::New(::TYPES[27/*Fuse.Drawing.GradientStop[]*/], 0);
}
...
void LinearGradient::SortStops()
{
    ...
    uObject* order = (uObject*)::g::Uno::Collections::EnumerableExtensions::OrderBy1(::TYPES[29/*Uno.Collections.EnumerableExtensions.OrderBy<Fuse.Drawing.GradientStop>*/], (uObject*)_stops, uDelegate::New(::TYPES[31/*Uno.Func<Fuse.Drawing.GradientStop, Fuse.Drawing.GradientStop, int>*/], (void*)LinearGradient__SelectOffset_fn));
    _sortedStops = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[32/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.GradientStop>*/], order));
}
...
{
    ::TYPES[1] = ::g::Uno::Float4_typeof()->Array();
    ::TYPES[34] = ::g::Uno::Float_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Float2_typeof()->Array();
    type->SetFields(0,
...
uArray* LinearGradientDrawable::FillBuffer_Offsets_3cb3c708_1_5_4(int Offsets_1_5_1, uArray* Offsets_1_5_2)
{
    ...
    LinearGradientDrawable_typeof()->Init();
    uArray* ofs = uArray::New(::TYPES[34/*float[]*/], ::g::Uno::Math::Max8(Offsets_1_5_1, 1));
...
void LineTo__EvaluateLast_fn(LineTo* __this, uObject** __retval)
{
    ...
    return *__retval = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<float2>*/], uArray::Init< ::g::Uno::Float2>(::TYPES[2/*float2[]*/], 2, __this->_lastPosition, __this->EndPosition()))), void();
}
...
uObject* NonConsecutiveEnumerable::GetEnumerator()
{
    ...
    return (uObject*)::g::Fuse::Drawing::NonConsecutiveEnumerator::New1((uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_source), ::TYPES[9/*Uno.Collections.IEnumerable<float2>*/])));
}
...
bool NonConsecutiveEnumerator::MoveNext()
{
    ...
    if (!_hasCurrent)
    {
        if (!::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(_source), ::TYPES[19/*Uno.Collections.IEnumerator*/])))
            return false;

        _first = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(_source), ::TYPES[20/*Uno.Collections.IEnumerator<float2>*/]), &ret2), ret2);
        _current = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(_source), ::TYPES[20/*Uno.Collections.IEnumerator<float2>*/]), &ret3), ret3);
        _hasCurrent = true;
        return true;
    }
    ...
    while (true)
    {
        ...
        ::g::Uno::Float2 next = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(_source), ::TYPES[20/*Uno.Collections.IEnumerator<float2>*/]), &ret4), ret4);
...
static void PathGeometry_build(uType* type)
{
    ...
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[21] = ::g::Uno::Collections::EmptyEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[35] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    type->SetFields(0,
...
static void PathGeometryRenderer_build(uType* type)
{
    ...
    ::TYPES[36] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[37] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof(), ::g::Fuse::Drawing::PolygonFiller_typeof());
    ::TYPES[38] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[39] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[40] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof(), ::g::Fuse::Drawing::PolygonFiller_typeof());
    ::TYPES[8] = uObject_typeof();
    ::TYPES[41] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[42] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[43] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[44] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof(), ::g::Fuse::Drawing::PolygonFiller_typeof());
    ::TYPES[45] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof(), ::g::Fuse::Drawing::PolygonFiller_typeof());
    ::TYPES[46] = ::g::Uno::Delegate_typeof();
    ::TYPES[47] = ::g::Fuse::Drawing::DynamicBrush_typeof();
    ::TYPES[28] = ::g::Uno::UX::IPropertyListener_typeof();
    ::TYPES[48] = ::g::Fuse::Drawing::Stroke_typeof();
    ::TYPES[49] = ::g::Fuse::Drawing::Brush_typeof();
    ::TYPES[23] = ::g::Uno::Int_typeof();
    ::TYPES[50] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[51] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[52] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[53] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[54] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof());
    ::TYPES[55] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[56] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[57] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[58] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
...
void PathGeometryRenderer__UnoUXIPropertyListenerOnPropertyChanged_fn(PathGeometryRenderer* __this, ::g::Uno::UX::PropertyObject* po, ::g::Uno::UX::Selector* prop)
{
    ...
    if (uIs(po, ::TYPES[48/*Fuse.Drawing.Stroke*/]))
        __this->OnStrokeChanged(uCast< ::g::Fuse::Drawing::Stroke*>(po, ::TYPES[48/*Fuse.Drawing.Stroke*/]));
    else if (uIs(po, ::TYPES[49/*Fuse.Drawing.Brush*/]))
        __this->OnShadingChanged();
    else
...
void PathGeometryRenderer::ctor_()
{
    ...
    _density = 1.0f;
    _antialiasing = 1;
    _fillRule = uDelegate::New(::TYPES[36/*Uno.Predicate<int>*/], (void*)::g::Fuse::Drawing::WindingRules__NonZero_fn);
...
void PathGeometryRenderer::CalcBounds()
{
    ...
    if (HasStrokes())
    {
        ...
        for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Fuse::Drawing::PolygonFiller*> > enum3 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(_strokeRenderers)->Values()), &ret15), ret15); enum3.MoveNext(::TYPES[37/*Uno.Collections.Dictionary<Fuse.Drawing.Stroke, Fuse.Drawing.PolygonFiller>.ValueCollection.Enumerator*/]); )
        {
            ::g::Fuse::Drawing::PolygonFiller* s = enum3.Current(::TYPES[37/*Uno.Collections.Dictionary<Fuse.Drawing.Stroke, Fuse.Drawing.PolygonFiller>.ValueCollection.Enumerator*/]);
...
void PathGeometryRenderer::CompleteStrokeRenderers(float density)
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Strokes()), ::TYPES[38/*Uno.Collections.IEnumerable<Fuse.Drawing.Stroke>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Stroke* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[39/*Uno.Collections.IEnumerator<Fuse.Drawing.Stroke>*/]), &ret16), ret16);
...
void PathGeometryRenderer::DrawStrokes(::g::Fuse::Drawing::RendererContext* ctx)
{
    ...
    if (HasStrokes())
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Strokes()), ::TYPES[38/*Uno.Collections.IEnumerable<Fuse.Drawing.Stroke>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Drawing::Stroke* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[39/*Uno.Collections.IEnumerator<Fuse.Drawing.Stroke>*/]), &ret18), ret18);
            DrawStroke(ctx, s);
        }
}
...
void PathGeometryRenderer::EnsureStrokeRenderers()
{
    ...
    if (_strokeRenderers == NULL)
        _strokeRenderers = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[40/*Uno.Collections.Dictionary<Fuse.Drawing.Stroke, Fuse.Drawing.PolygonFiller>*/]));
}
...
::g::Fuse::Drawing::Brush* PathGeometryRenderer::Fill()
{
    ...
    return HasFills() ? (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[50/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Drawing.Brush>*/], Fills(), &ret28), ret28) : NULL;
}
...
void PathGeometryRenderer::Fill(::g::Fuse::Drawing::Brush* value)
{
    ...
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(Fills()), ::TYPES[52/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]));

    if (value != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Fills()), ::TYPES[52/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), value);
}
...
uObject* PathGeometryRenderer::Fills()
{
    ...
    return (uObject*)(ind11 = _fills, ((ind11 != NULL) ? ind11 : (::g::Uno::Collections::ObservableList*)(_fills = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[53/*Uno.Collections.ObservableList<Fuse.Drawing.Brush>*/], uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Drawing.Brush>*/], (void*)PathGeometryRenderer__OnFillAdded_fn, this), uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Drawing.Brush>*/], (void*)PathGeometryRenderer__OnFillRemoved_fn, this))))));
}
...
uObject* PathGeometryRenderer::GetHitPart1(::g::Uno::Float2 p, uObject* fills, uObject* strokes)
{
    ...
    if (strokes != NULL)
        ...
        for (uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(strokes), ::TYPES[38/*Uno.Collections.IEnumerable<Fuse.Drawing.Stroke>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Drawing::Stroke* stroke = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[39/*Uno.Collections.IEnumerator<Fuse.Drawing.Stroke>*/]), &ret19), ret19);
    ...
    if (fills != NULL)
    {
        ...
        if (uPtr(_fillRenderer)->Intersects(p))
            return (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(fills), ::TYPES[41/*Uno.Collections.IList<Fuse.Drawing.Brush>*/]), uCRef<int>(0), &ret20), ret20);
    }
...
void PathGeometryRenderer::InvalidateStrokeAndFill()
{
    ...
    if (HasStrokes())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Strokes()), ::TYPES[42/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/])); i++)
            OnStrokeChanged((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Strokes()), ::TYPES[43/*Uno.Collections.IList<Fuse.Drawing.Stroke>*/]), uCRef<int>(i), &ret22), ret22));

    if (_strokeRenderers != NULL)
    {
        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong< ::g::Fuse::Drawing::Stroke*>, uStrong< ::g::Fuse::Drawing::PolygonFiller*> > enum4 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(_strokeRenderers), &ret23), ret23); enum4.MoveNext(::TYPES[44/*Uno.Collections.Dictionary<Fuse.Drawing.Stroke, Fuse.Drawing.PolygonFiller>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong< ::g::Fuse::Drawing::Stroke*>, uStrong< ::g::Fuse::Drawing::PolygonFiller*> > p = enum4.Current(::TYPES[44/*Uno.Collections.Dictionary<Fuse.Drawing.Stroke, Fuse.Drawing.PolygonFiller>.Enumerator*/]);
            uPtr(p.Value(::TYPES[45/*Uno.Collections.KeyValuePair<Fuse.Drawing.Stroke, Fuse.Drawing.PolygonFiller>*/]))->Dispose();
        }
...
void PathGeometryRenderer::OnFillAdded(::g::Fuse::Drawing::Brush* f)
{
    ...
    if (uIs(f, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(f, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))->AddPropertyListener((uObject*)this);
...
void PathGeometryRenderer::OnFillRemoved(::g::Fuse::Drawing::Brush* f)
{
    ...
    if (uIs(f, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(f, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))->RemovePropertyListener((uObject*)this);
...
void PathGeometryRenderer::SoftDispose()
{
    ...
    if (_strokeRenderers != NULL)
    {
        for (uObject* enum7 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Strokes()), ::TYPES[38/*Uno.Collections.IEnumerable<Fuse.Drawing.Stroke>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum7), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Drawing::Stroke* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum7), ::TYPES[39/*Uno.Collections.IEnumerator<Fuse.Drawing.Stroke>*/]), &ret26), ret26);
            ::g::Fuse::Drawing::PolygonFiller* strokeRenderer = NULL;
...
::g::Fuse::Drawing::Stroke* PathGeometryRenderer::Stroke()
{
    ...
    return HasStrokes() ? (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[55/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Drawing.Stroke>*/], (uObject*)_strokes, &ret30), ret30) : NULL;
}
...
void PathGeometryRenderer::Stroke(::g::Fuse::Drawing::Stroke* value)
{
    ...
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(Strokes()), ::TYPES[42/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/]));

    if (value != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Strokes()), ::TYPES[42/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/]), value);
}
...
uObject* PathGeometryRenderer::Strokes()
{
    ...
    return (uObject*)(ind12 = _strokes, ((ind12 != NULL) ? ind12 : (::g::Uno::Collections::ObservableList*)(_strokes = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[56/*Uno.Collections.ObservableList<Fuse.Drawing.Stroke>*/], uDelegate::New(::TYPES[57/*Uno.Action<Fuse.Drawing.Stroke>*/], (void*)PathGeometryRenderer__OnStrokeAdded_fn, this), uDelegate::New(::TYPES[57/*Uno.Action<Fuse.Drawing.Stroke>*/], (void*)PathGeometryRenderer__OnStrokeRemoved_fn, this))))));
}
...
void PathGeometryRenderer::add_VisualInvalidated(uDelegate* value)
{
    ...
    VisualInvalidated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(VisualInvalidated1, value), ::TYPES[58/*Uno.Action*/]);
}
...
void PathGeometryRenderer::remove_VisualInvalidated(uDelegate* value)
{
    ...
    VisualInvalidated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(VisualInvalidated1, value), ::TYPES[58/*Uno.Action*/]);
}
...
static void Polygon_build(uType* type)
{
    ...
    ::TYPES[36] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[59] = ::g::Fuse::Drawing::Cache_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[60] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Float3_typeof());
    ::TYPES[61] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Float4_typeof());
    ::TYPES[62] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Geometry::Triangle2D_typeof());
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[63] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Geometry::Triangle2D_typeof());
    ::TYPES[35] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[2] = ::g::Uno::Float2_typeof()->Array();
    ::TYPES[64] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Content::Models::VertexAttributeArray_typeof());
    ::TYPES[65] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::Float3_typeof());
    ::TYPES[66] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float3_typeof());
    ::TYPES[67] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::Float4_typeof());
    ::TYPES[68] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float4_typeof());
    ::TYPES[69] = ::g::Fuse::Drawing::Contour_typeof()->Array();
    ::TYPES[70] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[71] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[72] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Tesselation::Face_typeof(), ::g::Uno::Geometry::Triangle2D_typeof());
    ::TYPES[73] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof(), ::g::Uno::Geometry::Triangle2D_typeof());
    ::TYPES[74] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[75] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[76] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::Face_typeof());
    ::TYPES[77] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    ::TYPES[78] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Drawing::Tesselation::HalfEdge_typeof());
    ::TYPES[79] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[18] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[80] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::Float2_typeof());
    ::TYPES[10] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[81] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::PolygonDrawable_typeof());
    ::TYPES[82] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Drawing::PolygonDrawable_typeof());
    ::TYPES[83] = ::g::Fuse::Drawing::PolygonDrawable_typeof()->Array();
    type->SetFields(0,
...
void Polygon::ctor_(uArray* contours)
{
    ...
    ctor_2(uDelegate::New(::TYPES[36/*Uno.Predicate<int>*/], (void*)::g::Fuse::Drawing::WindingRules__NonZero_fn), contours);
}
...
void Polygon::ctor_1(uObject* contours)
{
    ...
    ctor_3(uDelegate::New(::TYPES[36/*Uno.Predicate<int>*/], (void*)::g::Fuse::Drawing::WindingRules__NonZero_fn), contours);
}
...
void Polygon::ctor_2(uDelegate* windingRule, uArray* contours)
{
    ...
    _contours = ((::g::Fuse::Drawing::Cache*)::g::Fuse::Drawing::Cache::New1(::TYPES[59/*Fuse.Drawing.Cache<Fuse.Drawing.Contour>*/], contours));
}
...
void Polygon::ctor_3(uDelegate* windingRule, uObject* contours)
{
    ...
    _windingRule = windingRule;
    _contours = ((::g::Fuse::Drawing::Cache*)::g::Fuse::Drawing::Cache::New2(::TYPES[59/*Fuse.Drawing.Cache<Fuse.Drawing.Contour>*/], contours));
}
...
::g::Uno::Content::Models::ModelMesh* Polygon::Extrude(float depth, float smoothingThreshold)
{
    ...
    Polygon* poly = this;
    ::g::Uno::Collections::List* vertices = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[60/*Uno.Collections.List<float3>*/]);
    ::g::Uno::Collections::List* normals = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[60/*Uno.Collections.List<float3>*/]);
    ::g::Uno::Collections::List* tangents = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[61/*Uno.Collections.List<float4>*/]);

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(poly->GetFillTriangles()), ::TYPES[62/*Uno.Collections.IEnumerable<Uno.Geometry.Triangle2D>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::Geometry::Triangle2D* tri = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[63/*Uno.Collections.IEnumerator<Uno.Geometry.Triangle2D>*/]), &ret10), ret10);
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(poly->GetBoundaryContours()), ::TYPES[35/*Uno.Collections.IEnumerable<Fuse.Drawing.Contour>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Contour* contour = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[15/*Uno.Collections.IEnumerator<Fuse.Drawing.Contour>*/]), &ret11), ret11);
    ...
    ::g::Uno::Collections::Dictionary* dict = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[64/*Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray>*/]);
    ::g::Uno::Collections::Dictionary__set_Item_fn(dict, ::STRINGS[27/*"Position"*/], ::g::Uno::Content::Models::VertexAttributeArray::New4((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[65/*Uno.Collections.EnumerableExtensions.ToArray<float3>*/], (uObject*)vertices)));
    ::g::Uno::Collections::Dictionary__set_Item_fn(dict, ::STRINGS[28/*"Normal"*/], ::g::Uno::Content::Models::VertexAttributeArray::New4((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[65/*Uno.Collections.EnumerableExtensions.ToArray<float3>*/], (uObject*)normals)));
    ::g::Uno::Collections::Dictionary__set_Item_fn(dict, ::STRINGS[29/*"Tangent"*/], ::g::Uno::Content::Models::VertexAttributeArray::New5((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[67/*Uno.Collections.EnumerableExtensions.ToArray<float4>*/], (uObject*)tangents)));
...
uObject* Polygon::GetBoundaryContours()
{
    ...
    if (IsDegenerate())
        _boundaryContours = uArray::New(::TYPES[69/*Fuse.Drawing.Contour[]*/], 0);
    ...
    if (_boundaryContours == NULL)
    {
        ...
        _boundaryContours = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[70/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.Contour>*/], mesh->GetContours()));
        mesh->Dispose();
    }

    return (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[71/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Drawing.Contour>*/], _boundaryContours));
}
...
uObject* Polygon::GetFillTriangles()
{
    ...
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[72/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Tesselation.Face, Uno.Geometry.Triangle2D>*/], mesh->InteriorFaces(), uDelegate::New(::TYPES[73/*Uno.Func<Fuse.Drawing.Tesselation.Face, Uno.Geometry.Triangle2D>*/], (void*)Polygon__CreateTriangle_fn, this));
}
...
uArray* Polygon::GetTriangleVertices()
{
    ...
    uPtr(mesh)->ComputeInterior(_windingRule);
    mesh->TessellateInterior();
    uArray* vertices = uArray::New(::TYPES[2/*float2[]*/], ::g::Uno::Collections::EnumerableExtensions::Count(::TYPES[74/*Uno.Collections.EnumerableExtensions.Count<Fuse.Drawing.Tesselation.Face>*/], mesh->InteriorFaces()) * 3);
    int v = 0;

    for (uObject* enum4 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(mesh->InteriorFaces()), ::TYPES[75/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.Face>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Tesselation::Face* face = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::TYPES[76/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.Face>*/]), &ret12), ret12);

        for (uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(face)->EdgeLoop()), ::TYPES[77/*Uno.Collections.IEnumerable<Fuse.Drawing.Tesselation.HalfEdge>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Drawing::Tesselation::HalfEdge* vert = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[78/*Uno.Collections.IEnumerator<Fuse.Drawing.Tesselation.HalfEdge>*/]), &ret13), ret13);
...
Polygon* Polygon::Stroke(float Width, float Offset, int StartCap, int EndCap)
{
    ...
    ::g::Uno::Collections::List* strokeContours = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List<Fuse.Drawing.Contour>*/]);

    for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Contours()), ::TYPES[35/*Uno.Collections.IEnumerable<Fuse.Drawing.Contour>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Drawing::Contour* contour = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[15/*Uno.Collections.IEnumerator<Fuse.Drawing.Contour>*/]), &ret14), ret14);
        int vertexCount = uPtr(contour)->VertexCount();

        if (vertexCount < 2)
            continue;

        ::g::Uno::Collections::List* outer = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[18/*Uno.Collections.List<float2>*/]);
        ::g::Uno::Collections::List* inner = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[18/*Uno.Collections.List<float2>*/]);
        float dist = 0.0f;
        ...
        else
        {
            ...
            ::g::Uno::Collections::List__Add_fn(uPtr(strokeContours), ::g::Fuse::Drawing::Contour::New2(true, (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[80/*Uno.Collections.EnumerableExtensions.Union<float2>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[80/*Uno.Collections.EnumerableExtensions.Union<float2>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[80/*Uno.Collections.EnumerableExtensions.Union<float2>*/], start, (uObject*)outer), end), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<float2>*/], innerRev)))));
        }
    }
...
uObject* Polygon::Triangulate()
{
    ...
    if (uPtr(verts)->Length() < 3)
        return (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[82/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Drawing.PolygonDrawable>*/], uArray::New(::TYPES[83/*Fuse.Drawing.PolygonDrawable[]*/], 0)));

    return (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[82/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Drawing.PolygonDrawable>*/], uArray::Init< ::g::Fuse::Drawing::PolygonDrawable*>(::TYPES[83/*Fuse.Drawing.PolygonDrawable[]*/], 1, (::g::Fuse::Drawing::PolygonDrawable*)::g::Fuse::Drawing::PolygonDrawable::New1(verts))));
}
...
{
    ::TYPES[23] = ::g::Uno::Int_typeof();
    ::TYPES[84] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::Border_typeof());
    ::TYPES[85] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Contour_typeof(), ::g::Fuse::Drawing::Border_typeof());
    ::TYPES[86] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Contour_typeof(), ::g::Fuse::Drawing::Border_typeof());
    ::TYPES[87] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::PolygonDrawable_typeof());
    ::TYPES[88] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Border_typeof(), ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[89] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Border_typeof());
    ::TYPES[90] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Drawing::Border_typeof());
    ::TYPES[91] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Border_typeof(), ::g::Fuse::Drawing::Contour_typeof());
    ::TYPES[92] = ::g::Fuse::Drawing::Border_typeof()->Array();
...
void PolygonFiller::ctor_(::g::Fuse::Drawing::Polygon* polygon, int antialiasing, float density)
{
    ...
    if (false && (antialiasing == 1))
    {
        ...
        _antialiasingBorders = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[84/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.Border>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[85/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Contour, Fuse.Drawing.Border>*/], boundaries, uDelegate::New(::TYPES[86/*Uno.Func<Fuse.Drawing.Contour, Fuse.Drawing.Border>*/], (void*)PolygonFiller__CreateBorder_fn, this))));
        _fills = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[87/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.PolygonDrawable>*/], ::g::Fuse::Drawing::Polygon::New2((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[88/*Uno.Collections.EnumerableExtensions.Select<Fuse.Drawing.Border, Fuse.Drawing.Contour>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[90/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Drawing.Border>*/], _antialiasingBorders)), uDelegate::New(::TYPES[91/*Uno.Func<Fuse.Drawing.Border, Fuse.Drawing.Contour>*/], (void*)PolygonFiller__Contour_fn, this)))->Triangulate()));
    }
    else
    {
        _fills = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[87/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.PolygonDrawable>*/], uPtr(polygon)->Triangulate()));
        _antialiasingBorders = uArray::New(::TYPES[92/*Fuse.Drawing.Border[]*/], 0);
    }
}
...
void RoundCap__Create_fn(RoundCap* __this, ::g::Uno::Float2* from, ::g::Uno::Float2* to, uObject** __retval)
{
    ...
    return *__retval = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<float2>*/], verts)), void();
}
...
// public sealed class Stroke :312
// {
// static Stroke() :312
...
static void Stroke_build(uType* type)
{
    ...
    ::TYPES[47] = ::g::Fuse::Drawing::DynamicBrush_typeof();
    ::TYPES[28] = ::g::Uno::UX::IPropertyListener_typeof();
    ::TYPES[94] = ::g::Fuse::Drawing::ISolidColor_typeof();
    type->SetInterfaces(
...
// public Stroke(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin]) :516
...
// public void Prepare(Fuse.DrawContext dc, float2 canvasSize) :553
void Stroke__Prepare_fn(Stroke* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Float2* canvasSize)
{
    __this->Prepare(dc, *canvasSize);
}

// public void SetColor(float4 color, Uno.UX.IPropertyListener origin) :360
void Stroke__SetColor_fn(Stroke* __this, ::g::Uno::Float4* color, uObject* origin)
{
    __this->SetColor(*color, origin);
}

// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector prop) :315
...
// public Stroke(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin]) [instance] :516
...
// private float Adjust(float w, float ppi) [instance] :478
...
// public Fuse.Drawing.StrokeAdjustment get_Adjustment() [instance] :402
...
// public void set_Adjustment(Fuse.Drawing.StrokeAdjustment value) [instance] :403
...
// private float AdjustPosition(float w, float ppi) [instance] :455
...
// public Fuse.Drawing.StrokeAlignment get_Alignment() [instance] :418
...
// public void set_Alignment(Fuse.Drawing.StrokeAlignment value) [instance] :419
...
// public Fuse.Drawing.Brush get_Brush() [instance] :325
...
// public void set_Brush(Fuse.Drawing.Brush value) [instance] :326
void Stroke::Brush(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (uIs((::g::Fuse::Drawing::Brush*)_brush, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(_brush, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))->RemovePropertyListener((uObject*)this);

    _brush = value;

    if (uIs((::g::Fuse::Drawing::Brush*)_brush, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))
        uPtr(uCast< ::g::Fuse::Drawing::DynamicBrush*>(_brush, ::TYPES[47/*Fuse.Drawing.DynamicBrush*/]))->AddPropertyListener((uObject*)this);
...
// public float4 get_Color() [instance] :349
::g::Uno::Float4 Stroke::Color()
{
    uStackFrame __("Fuse.Drawing.Stroke", "get_Color()");

    if (uIs((::g::Fuse::Drawing::Brush*)Brush(), ::TYPES[94/*Fuse.Drawing.ISolidColor*/]))
        return ::g::Fuse::Drawing::ISolidColor::Color(uInterface(uPtr((uObject*)Brush()), ::TYPES[94/*Fuse.Drawing.ISolidColor*/]));

    return ::g::Uno::Float4__New1(0.0f);
}

// public void set_Color(float4 value) [instance] :355
...
// public float2 GetDeviceAdjusted(float ppi) [instance] :430
...
// public bool get_IsPinned() [instance] :539
...
// public Fuse.Drawing.LineCap get_LineCap() [instance] :491
int Stroke::LineCap()
{
...
// public void set_LineCap(Fuse.Drawing.LineCap value) [instance] :492
...
// public Fuse.Drawing.LineJoin get_LineJoin() [instance] :505
int Stroke::LineJoin()
{
...
// public void set_LineJoin(Fuse.Drawing.LineJoin value) [instance] :506
...
// public float get_Offset() [instance] :389
float Stroke::Offset()
{
...
// public void set_Offset(float value) [instance] :390
...
// protected void OnPinned() [instance] :541
...
// protected void OnUnpinned() [instance] :547
...
// public void Prepare(Fuse.DrawContext dc, float2 canvasSize) [instance] :553
...
// public void SetColor(float4 color, Uno.UX.IPropertyListener origin) [instance] :360
...
// public void Unpin() [instance] :532
void Stroke::Unpin()
{
...
// public float get_Width() [instance] :377
float Stroke::Width()
{
...
// public void set_Width(float value) [instance] :378
...
// public Stroke New(Fuse.Drawing.Brush brush, [float width], [Fuse.Drawing.LineCap lineCap], [Fuse.Drawing.LineJoin lineJoin]) [static] :516
...
// public enum StrokeAdjustment :297
...
// public enum StrokeAlignment :305
...
// public static class WindingRules :566
// {
...
// public static bool Negative(int n) [static] :580
...
// public static bool NonZero(int n) [static] :572
...
// public static bool Odd(int n) [static] :568
...
// public static bool Positive(int n) [static] :576
