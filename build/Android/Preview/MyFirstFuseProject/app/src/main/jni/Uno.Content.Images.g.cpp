...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Content\Images\$.uno
// --------------------------------------------------------------------------
...
static void Bitmap_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        ...
        new uFunction(".ctor", NULL, (void*)Bitmap__New1_fn, 0, true, Bitmap_typeof(), 3, ::g::Uno::Int2_typeof(), ::g::Uno::Graphics::Format_typeof(), ::g::Uno::Buffer_typeof()),
...
{
    uStackFrame __("Uno.Content.Images.Bitmap", "get_Buffer()");
    return _Buffer;
}
...
{
    uStackFrame __("Uno.Content.Images.Bitmap", "set_Buffer(Uno.Buffer)");
    _Buffer = value;
}
...
int Bitmap::Format()
{
    uStackFrame __("Uno.Content.Images.Bitmap", "get_Format()");
    return _Format;
}
...
{
    uStackFrame __("Uno.Content.Images.Bitmap", "set_Format(Uno.Graphics.Format)");
    _Format = value;
}
...
{
    uStackFrame __("Uno.Content.Images.Bitmap", "get_Size()");
    return _Size;
}
...
{
    uStackFrame __("Uno.Content.Images.Bitmap", "set_Size(int2)");
    _Size = value;
}
