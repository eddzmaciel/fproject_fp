...
// C:\ProgramData\Uno\Packages\Uno.Net.Sockets\0.33.1\$.uno
// --------------------------------------------------------
...
// public override sealed bool get_CanSeek() :382
...
// public override sealed bool get_CanWrite() :377
...
// public NetworkStream New(Uno.Net.Sockets.Socket socket) :352
...
// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :398
...
// public override sealed void SetLength(long value) :368
...
// public NetworkStream(Uno.Net.Sockets.Socket socket) [instance] :352
...
// public NetworkStream New(Uno.Net.Sockets.Socket socket) [static] :352
...
static void Socket_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Net::EndPoint_typeof();
    ...
    type->Reflection.SetFunctions(11,
        new uFunction("Accept", NULL, (void*)Socket__Accept_fn, 0, false, Socket_typeof(), 0),
...
// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) :688
...
// public void Listen(int backlog) :876
void Socket__Listen_fn(Socket* __this, int* backlog)
{
    __this->Listen(*backlog);
}

// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) :688
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) :708
void Socket__New2_fn(int* handle, bool* connected, Socket** __retval)
{
    *__retval = Socket::New2(*handle, *connected);
}

// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) :887
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) :900
void Socket__Shutdown_fn(Socket* __this, int* how)
{
    __this->Shutdown(*how);
}

// private void UpdateRemoteEndPoint() :741
void Socket__UpdateRemoteEndPoint_fn(Socket* __this)
{
    __this->UpdateRemoteEndPoint();
}

// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [instance] :688
...
// private extern Socket(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [instance] :708
...
// public Uno.Net.Sockets.Socket Accept() [instance] :916
...
// public void Bind(Uno.Net.EndPoint endPoint) [instance] :849
...
// public void Close() [instance] :929
void Socket::Close()
{
...
// public void Connect(Uno.Net.EndPoint endPoint) [instance] :770
...
// public void Listen(int backlog) [instance] :876
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) [instance] :887
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) [instance] :900
...
// private void UpdateRemoteEndPoint() [instance] :741
...
// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [static] :688
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [static] :708
...
// internal sealed extern class SocketHelpers :470
// {
...
// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) :628
void SocketHelpers__Accept_fn(int* sock, int* __retval)
{
    *__retval = SocketHelpers::Accept(*sock);
}

// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :583
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :557
...
// public static int GetFamily(Uno.Net.Sockets.AddressFamily addressFamily) :472
void SocketHelpers__GetFamily_fn(int* addressFamily, int* __retval)
{
    *__retval = SocketHelpers::GetFamily(*addressFamily);
}

// public static Uno.Net.IPEndPoint GetLocalEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) :511
...
// public static int GetProtocol(Uno.Net.Sockets.ProtocolType protocolType) :491
void SocketHelpers__GetProtocol_fn(int* protocolType, int* __retval)
{
    *__retval = SocketHelpers::GetProtocol(*protocolType);
}

// public static Uno.Net.IPEndPoint GetRemoteEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) :536
...
// public static int GetSocketShudown(Uno.Net.Sockets.SocketShutdown socketShutdown) :500
...
// public static int GetType(Uno.Net.Sockets.SocketType socketType) :482
void SocketHelpers__GetType1_fn(int* socketType, int* __retval)
{
    *__retval = SocketHelpers::GetType1(*socketType);
}

// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) :609
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) :656
void SocketHelpers__Shutdown_fn(int* sock, int* how, int* __retval)
{
    *__retval = SocketHelpers::Shutdown(*sock, *how);
}

// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :628
int SocketHelpers::Accept(int sock)
{
    uStackFrame __("Uno.Net.Sockets.SocketHelpers", "Accept(Uno.Net.Sockets.Socket.SocketHandle)");
    struct sockaddr_in sa = { 0 };
    socklen_t len = sizeof(sa);
    return accept(sock, (struct sockaddr*)&sa, &len);
}

// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :583
int SocketHelpers::Bind(int sock, int family, uArray* address, int64_t scopeId, int port)
{
    uStackFrame __("Uno.Net.Sockets.SocketHelpers", "Bind(Uno.Net.Sockets.Socket.SocketHandle,int,byte[],long,int)");
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :557
...
// public static int GetFamily(Uno.Net.Sockets.AddressFamily addressFamily) [static] :472
...
// public static Uno.Net.IPEndPoint GetLocalEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :511
...
// public static int GetProtocol(Uno.Net.Sockets.ProtocolType protocolType) [static] :491
...
// public static Uno.Net.IPEndPoint GetRemoteEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :536
...
// public static int GetSocketShudown(Uno.Net.Sockets.SocketShutdown socketShutdown) [static] :500
...
// public static int GetType(Uno.Net.Sockets.SocketType socketType) [static] :482
...
// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) [static] :609
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) [static] :656
...
// public enum SocketShutdown :450
