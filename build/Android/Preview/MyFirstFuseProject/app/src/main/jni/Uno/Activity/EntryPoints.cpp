...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/myfirstfuseproject/MyFirstFuseProject");
    jclass entryPointsClass = env->FindClass("com/apps/myfirstfuseproject/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/myfirstfuseproject/Display");
