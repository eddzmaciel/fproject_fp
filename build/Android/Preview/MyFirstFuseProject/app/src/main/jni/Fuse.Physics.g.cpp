...
// C:\ProgramData\Uno\Packages\Fuse.Physics\0.33.5\$.uno
// -----------------------------------------------------
...
// internal Body(Fuse.Physics.World world, Fuse.Visual node) :46
...
// public static float GetFriction(Fuse.Visual n) :15
...
// internal Body New(Fuse.Physics.World world, Fuse.Visual node) :46
void Body__New1_fn(::g::Fuse::Physics::World* world, ::g::Fuse::Visual* node, Body** __retval)
{
    *__retval = Body::New1(world, node);
}

// internal static Fuse.Physics.Body Pin(Fuse.Visual n) :60
void Body__Pin_fn(::g::Fuse::Visual* n, Body** __retval)
{
    *__retval = Body::Pin(n);
}

// public static void SetFriction(Fuse.Visual n, float friction) :23
...
// internal Body(Fuse.Physics.World world, Fuse.Visual node) [instance] :46
...
void Body::Update(double deltaTime)
{
    ...
    if (_constraint != NULL)
    {
        ...
        if (uIs((::g::Fuse::Visual*)Visual, ::TYPES[4/*Fuse.Elements.Element*/]))
            s = uPtr(uAs< ::g::Fuse::Elements::Element*>(Visual, ::TYPES[4/*Fuse.Elements.Element*/]))->ActualSize();
...
// public static float GetFriction(Fuse.Visual n) [static] :15
...
// internal Body New(Fuse.Physics.World world, Fuse.Visual node) [static] :46
...
// internal static Fuse.Physics.Body Pin(Fuse.Visual n) [static] :60
...
// public static void SetFriction(Fuse.Visual n, float friction) [static] :23
...
// public sealed class Draggable :182
// {
static void Draggable_build(uType* type)
{
    ::TYPES[5] = ::g::Fuse::Input::PointerEventArgs_typeof();
    ::TYPES[3] = uObject_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[7] = ::g::Fuse::Physics::IRule_typeof();
    ::TYPES[8] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    ::TYPES[9] = ::g::Fuse::Input::PointerMovedHandler_typeof();
    ::TYPES[10] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(Draggable_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(Draggable_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(Draggable_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(Draggable_type, interface3),
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", NULL, (void*)Draggable__New2_fn, 0, true, Draggable_typeof(), 0));
}
...
// public generated Draggable() :182
void Draggable__ctor_3_fn(Draggable* __this)
{
    __this->ctor_3();
}

// public generated Fuse.Elements.Element get_Bounds() :186
void Draggable__get_Bounds_fn(Draggable* __this, ::g::Fuse::Elements::Element** __retval)
{
    *__retval = __this->Bounds();
}

// public generated void set_Bounds(Fuse.Elements.Element value) :186
void Draggable__set_Bounds_fn(Draggable* __this, ::g::Fuse::Elements::Element* value)
{
    __this->Bounds(value);
}

// private void Fuse.Physics.IRule.Update(double deltaTime, Fuse.Physics.World world) :268
...
// private float3 GetPointerPosition(Fuse.Input.PointerEventArgs args) :209
...
// private void OnReleased(object sender, Fuse.Input.PointerReleasedArgs args) :256
...
// protected override sealed void OnRooted() :188
void Draggable__OnRooted_fn(Draggable* __this)
{
    ...
    ::g::Fuse::Input::Pointer::AddHandlers(__this->Parent(), uDelegate::New(::TYPES[8/*Fuse.Input.PointerPressedHandler*/], (void*)Draggable__OnPressed_fn, __this), uDelegate::New(::TYPES[9/*Fuse.Input.PointerMovedHandler*/], (void*)Draggable__OnMoved_fn, __this), uDelegate::New(::TYPES[10/*Fuse.Input.PointerReleasedHandler*/], (void*)Draggable__OnReleased_fn, __this), NULL, NULL, NULL);
}

// protected override sealed void OnUnrooted() :198
void Draggable__OnUnrooted_fn(Draggable* __this)
{
    ...
    __this->_body = NULL;
    ::g::Fuse::Input::Pointer::RemoveHandlers(__this->Parent(), uDelegate::New(::TYPES[8/*Fuse.Input.PointerPressedHandler*/], (void*)Draggable__OnPressed_fn, __this), uDelegate::New(::TYPES[9/*Fuse.Input.PointerMovedHandler*/], (void*)Draggable__OnMoved_fn, __this), uDelegate::New(::TYPES[10/*Fuse.Input.PointerReleasedHandler*/], (void*)Draggable__OnReleased_fn, __this), NULL, NULL, NULL);
    ::g::Fuse::Node__OnUnrooted_fn(__this);
}

// public generated Draggable() [instance] :182
...
// public generated Fuse.Elements.Element get_Bounds() [instance] :186
...
// public generated void set_Bounds(Fuse.Elements.Element value) [instance] :186
...
// private float3 GetPointerPosition(Fuse.Input.PointerEventArgs args) [instance] :209
...
// private void OnMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :245
...
// private void OnPointerLost() [instance] :233
...
// private void OnPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :218
void Draggable::OnPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (uPtr(args)->TryHardCapture(this, uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)Draggable__OnPointerLost_fn, this), uPtr(args)->Visual()))
    {
...
// private void OnReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :256
...
// public generated Draggable New() [static] :182
...
// public sealed class EnteredForceField :427
// {
static void EnteredForceField_build(uType* type)
{
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface3),
    ...
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)EnteredForceField__New2_fn, 0, true, EnteredForceField_typeof(), 0),
...
// public generated EnteredForceField() :427
void EnteredForceField__ctor_6_fn(EnteredForceField* __this)
{
    __this->ctor_6();
}

// public generated EnteredForceField New() :427
...
// public generated float get_Threshold() [instance] :429
...
// public generated void set_Threshold(float value) [instance] :429
...
// public generated EnteredForceField New() [static] :427
...
// public sealed class ExitedForceField :464
// {
static void ExitedForceField_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)ExitedForceField__New2_fn, 0, true, ExitedForceField_typeof(), 0),
...
// public generated ExitedForceField() :464
void ExitedForceField__ctor_6_fn(ExitedForceField* __this)
{
    __this->ctor_6();
}

// public generated ExitedForceField New() :464
void ExitedForceField__New2_fn(ExitedForceField** __retval)
{
    *__retval = ExitedForceField::New2();
}

// protected internal override sealed void SetForce(Fuse.Physics.Body body, float force) :470
...
// public generated float get_Threshold() [instance] :466
...
// public generated void set_Threshold(float value) [instance] :466
...
// public generated ExitedForceField New() [static] :464
...
// public abstract class ForceField :312
// {
static void ForceField_build(uType* type)
{
    ::TYPES[7] = ::g::Fuse::Physics::IRule_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ForceField_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(ForceField_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ForceField_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ForceField_type, interface3),
...
// protected generated ForceField() :312
void ForceField__ctor_3_fn(ForceField* __this)
{
    __this->ctor_3();
}

// private void Fuse.Physics.IRule.Update(double deltaTime, Fuse.Physics.World world) :334
...
// protected override sealed void OnRooted() :318
...
// protected override sealed void OnUnrooted() :327
...
// internal Fuse.Physics.World get_World() [instance] :316
...
// public sealed class ForceFieldEventArgs :372
// {
...
// internal ForceFieldEventArgs(Fuse.Physics.Body body, Fuse.Physics.ForceField field) :379
...
// private generated void set_ForceField(Fuse.Physics.ForceField value) :375
...
// internal ForceFieldEventArgs New(Fuse.Physics.Body body, Fuse.Physics.ForceField field) :379
...
// public Fuse.Visual get_Visual() :377
void ForceFieldEventArgs__get_Visual_fn(ForceFieldEventArgs* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->Visual();
}

// internal ForceFieldEventArgs(Fuse.Physics.Body body, Fuse.Physics.ForceField field) [instance] :379
...
// internal generated Fuse.Physics.Body get_Body() [instance] :374
...
// private generated void set_Body(Fuse.Physics.Body value) [instance] :374
...
// internal generated Fuse.Physics.ForceField get_ForceField() [instance] :375
...
// private generated void set_ForceField(Fuse.Physics.ForceField value) [instance] :375
...
// public Fuse.Visual get_Visual() [instance] :377
...
// internal ForceFieldEventArgs New(Fuse.Physics.Body body, Fuse.Physics.ForceField field) [static] :379
...
// public delegate void ForceFieldEventHandler(object sender, Fuse.Physics.ForceFieldEventArgs args) :386
...
// public abstract class ForceFieldEventTrigger :388
// {
static void ForceFieldEventTrigger_build(uType* type)
{
    ::TYPES[11] = ::g::Uno::Delegate_typeof();
    ::TYPES[3] = uObject_typeof();
    ::TYPES[12] = ::g::Fuse::Physics::ForceFieldEventHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceFieldTrigger_type, interface2),
...
// public generated void add_Handler(Fuse.Physics.ForceFieldEventHandler value) [instance] :390
void ForceFieldEventTrigger::add_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[12/*Fuse.Physics.ForceFieldEventHandler*/]);
}

// public generated void remove_Handler(Fuse.Physics.ForceFieldEventHandler value) [instance] :390
void ForceFieldEventTrigger::remove_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[12/*Fuse.Physics.ForceFieldEventHandler*/]);
}

// protected internal void OnTriggered(Fuse.Physics.Body body) [instance] :392
...
// public abstract class ForceFieldTrigger :351
// {
static void ForceFieldTrigger_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ForceFieldTrigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(ForceFieldTrigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ForceFieldTrigger_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ForceFieldTrigger_type, interface3),
...
// protected generated ForceFieldTrigger() :351
void ForceFieldTrigger__ctor_4_fn(ForceFieldTrigger* __this)
{
    __this->ctor_4();
}

// public generated Fuse.Physics.ForceField get_ForceField() :353
void ForceFieldTrigger__get_ForceField_fn(ForceFieldTrigger* __this, ::g::Fuse::Physics::ForceField** __retval)
{
    *__retval = __this->ForceField();
}

// public generated void set_ForceField(Fuse.Physics.ForceField value) :353
void ForceFieldTrigger__set_ForceField_fn(ForceFieldTrigger* __this, ::g::Fuse::Physics::ForceField* value)
{
    __this->ForceField(value);
}

// internal static void SetForce(Fuse.Physics.ForceField field, Fuse.Physics.Body body, float force) :355
...
// protected generated ForceFieldTrigger() [instance] :351
...
// public generated Fuse.Physics.ForceField get_ForceField() [instance] :353
...
// public generated void set_ForceField(Fuse.Physics.ForceField value) [instance] :353
...
// internal static void SetForce(Fuse.Physics.ForceField field, Fuse.Physics.Body body, float force) [static] :355
void ForceFieldTrigger::SetForce1(::g::Fuse::Physics::ForceField* field, ::g::Fuse::Physics::Body* body, float force)
{
    ...
    {
        ::g::Fuse::Node* b = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(uPtr(body)->Visual)->Children()), ::TYPES[13/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret1), ret1);
...
// public sealed class InForceFieldAnimation :506
// {
static void InForceFieldAnimation_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction(".ctor", NULL, (void*)InForceFieldAnimation__New2_fn, 0, true, InForceFieldAnimation_typeof(), 0),
...
// public generated float get_From() [instance] :511
...
// public generated void set_From(float value) [instance] :511
...
// public generated float get_To() [instance] :515
...
// public generated void set_To(float value) [instance] :515
...
// public InForceFieldAnimation New() [static] :517
...
// internal abstract interface IRule :736
// {
...
// public sealed class PointAttractor :541
// {
static void PointAttractor_build(uType* type)
{
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[17] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Physics::Body_typeof());
    ::TYPES[18] = ::g::Fuse::Physics::ForceField_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceField_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Physics::ForceField_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceField_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Physics::ForceField_type, interface3),
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction(".ctor", NULL, (void*)PointAttractor__New2_fn, 0, true, PointAttractor_typeof(), 0),
...
// public generated PointAttractor() :541
void PointAttractor__ctor_4_fn(PointAttractor* __this)
{
    __this->ctor_4();
}

// private bool AnyStrongerForce(Fuse.Physics.Body b, float force, Fuse.Physics.World w) :582
...
void PointAttractor__OnUpdate_fn(PointAttractor* __this, double* deltaTime, ::g::Fuse::Physics::World* world)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Physics::Body*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(__this->World())->Bodies()), &ret6), ret6); enum2.MoveNext(::TYPES[17/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]); )
    {
        ::g::Fuse::Physics::Body* b = enum2.Current(::TYPES[17/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]);
...
// private bool AnyStrongerForce(Fuse.Physics.Body b, float force, Fuse.Physics.World w) [instance] :582
bool PointAttractor::AnyStrongerForce(::g::Fuse::Physics::Body* b, float force, ::g::Fuse::Physics::World* w)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(w)->Rules()), ::TYPES[14/*Uno.Collections.IEnumerable<Fuse.Physics.IRule>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[15/*Uno.Collections.IEnumerator*/])); )
    {
        uObject* r = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[16/*Uno.Collections.IEnumerator<Fuse.Physics.IRule>*/]), &ret5), ret5);
...
// private float CalcForce(Fuse.Physics.Body b) [instance] :576
...
// private float Curve(float x) [instance] :600
...
// private float3 DirectionTo(Fuse.Physics.Body b) [instance] :571
...
// public generated bool get_Exclusive() [instance] :569
...
// public generated void set_Exclusive(bool value) [instance] :569
...
// public float3 get_Offset() [instance] :546
...
// public void set_Offset(float3 value) [instance] :547
...
// public float get_Radius() [instance] :553
...
// public void set_Radius(float value) [instance] :554
...
// public float get_Strength() [instance] :560
...
// public void set_Strength(float value) [instance] :561
...
// public generated string get_Tag() [instance] :598
...
// public generated void set_Tag(string value) [instance] :598
...
// private float3 get_TargetPoint() [instance] :566
...
// public generated PointAttractor New() [static] :541
...
// public sealed class Spring :647
// {
static void Spring_build(uType* type)
{
    ::TYPES[7] = ::g::Fuse::Physics::IRule_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(Spring_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(Spring_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(Spring_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(Spring_type, interface3),
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction(".ctor", NULL, (void*)Spring__New2_fn, 0, true, Spring_typeof(), 0),
...
// public generated Spring() :647
void Spring__ctor_3_fn(Spring* __this)
{
    __this->ctor_3();
}

// private void Fuse.Physics.IRule.Update(double deltaTime, Fuse.Physics.World world) :708
...
// protected override sealed void OnUnrooted() :692
...
// public float get_Length() [instance] :670
float Spring::Length()
{
...
// public void set_Length(float value) [instance] :671
...
// public float get_Stiffness() [instance] :677
...
// public void set_Stiffness(float value) [instance] :678
...
// public Fuse.Visual get_Target() [instance] :653
...
// public void set_Target(Fuse.Visual value) [instance] :654
...
// public generated Spring New() [static] :647
Spring* Spring::New2()
{
...
// public sealed class WhileDragging :284
// {
static void WhileDragging_build(uType* type)
{
    ...
    type->SetFields(27);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)WhileDragging__New2_fn, 0, true, WhileDragging_typeof(), 0));
}
...
// internal static void Begin(Fuse.Visual n) [static] :286
void WhileDragging::Begin(::g::Fuse::Visual* n)
{
    ...
    {
        WhileDragging* wd = uAs<WhileDragging*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(n)->Children()), ::TYPES[13/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), WhileDragging_typeof());
...
// internal static void End(Fuse.Visual n) [static] :295
void WhileDragging::End(::g::Fuse::Visual* n)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(n)->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        WhileDragging* wd = uAs<WhileDragging*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(n)->Children()), ::TYPES[13/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), WhileDragging_typeof());
...
// public generated WhileDragging New() [static] :284
...
{
    ::TYPES[19] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Physics::Body_typeof());
    ::TYPES[20] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[21] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    ::TYPES[7] = ::g::Fuse::Physics::IRule_typeof();
    ::TYPES[17] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Physics::Body_typeof());
    ::TYPES[3] = uObject_typeof();
    ::TYPES[22] = ::g::Fuse::Physics::Body_typeof();
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Physics::IRule_typeof());
    type->SetFields(0,
...
// private World() [instance] :745
void World::ctor_()
{
    uStackFrame __("Fuse.Physics.World", ".ctor()");
    _bodies = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[19/*Uno.Collections.List<Fuse.Physics.Body>*/]));
    _bodyHandle = ::g::Fuse::Properties::CreateHandle();
    _rules = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[20/*Uno.Collections.List<Fuse.Physics.IRule>*/]));
    _firstFrame = true;
}

// internal void AddRule(Fuse.Physics.IRule rule) [instance] :852
...
// internal Uno.Collections.List<Fuse.Physics.Body> get_Bodies() [instance] :789
...
// private void EndSimulation() [instance] :842
void World::EndSimulation()
{
    uStackFrame __("Fuse.Physics.World", "EndSimulation()");
    ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)World__OnUpdate_fn, this), 0);
    _isSimulating = false;
}

// private void EnsureSimulation() [instance] :835
void World::EnsureSimulation()
{
    ...
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)World__OnUpdate_fn, this), 0);
    _isSimulating = true;
}

// private void OnUpdate() [instance] :864
void World::OnUpdate()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_rules), &ret4), ret4); enum1.MoveNext(::TYPES[21/*Uno.Collections.List<Fuse.Physics.IRule>.Enumerator*/]); )
    {
        uObject* r = enum1.Current(::TYPES[21/*Uno.Collections.List<Fuse.Physics.IRule>.Enumerator*/]);
        ::g::Fuse::Physics::IRule::Update(uInterface(uPtr(r), ::TYPES[7/*Fuse.Physics.IRule*/]), deltaTime, this);
    }

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Physics::Body*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_bodies), &ret5), ret5); enum2.MoveNext(::TYPES[17/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]); )
    {
        ::g::Fuse::Physics::Body* b = enum2.Current(::TYPES[17/*Uno.Collections.List<Fuse.Physics.Body>.Enumerator*/]);
...
// internal Fuse.Physics.Body PinBody(Fuse.Visual node) [instance] :798
...
// internal void RemoveRule(Fuse.Physics.IRule rule) [instance] :857
...
// public Uno.Collections.IEnumerable<Fuse.Physics.IRule> get_Rules() [instance] :850
uObject* World::Rules()
{
...
// internal Fuse.Physics.Body TryGetBody(Fuse.Visual node) [instance] :793
::g::Fuse::Physics::Body* World::TryGetBody(::g::Fuse::Visual* node)
{
    uStackFrame __("Fuse.Physics.World", "TryGetBody(Fuse.Visual)");
    return uAs< ::g::Fuse::Physics::Body*>(uPtr(uPtr(node)->Properties())->Get(_bodyHandle), ::TYPES[22/*Fuse.Physics.Body*/]);
}

// internal void UnpinBody(Fuse.Physics.Body body) [instance] :816
...
// internal static Fuse.Physics.World FindWorld(Fuse.Visual n) [static] :777
...
// public static bool GetIsPhysicsWorld(Fuse.Visual n) [static] :772
...
// public static void SetIsPhysicsWorld(Fuse.Visual n, bool isPhysicsWorld) [static] :752
...
// public static void SetIsPhysicsWorldStyle(Fuse.Visual n, bool isPhysicsWorld) [static] :766
