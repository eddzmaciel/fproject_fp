...
{
    type->SetFields(2,
        ::g::Uno::Func_typeof()->MakeType(uObject_typeof()), offsetof(::g::Outracks::Simulator::Runtime::UxTemplate, _create), 0);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)UxTemplate__New2_fn, 0, true, UxTemplate_typeof(), 3, ::g::Uno::Func_typeof()->MakeType(uObject_typeof()), ::g::Uno::String_typeof(), ::g::Uno::Bool_typeof()));
}
...
{
    uStackFrame __("Outracks.Simulator.Runtime.UxTemplate", ".ctor(Uno.Func<object>,string,bool)");
