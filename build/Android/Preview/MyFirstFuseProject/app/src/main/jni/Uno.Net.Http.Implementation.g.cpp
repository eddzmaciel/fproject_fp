...
// C:\ProgramData\Uno\Packages\Uno.Net.Http\0.33.1\Implementation\Android\$.uno
// ----------------------------------------------------------------------------
...
static void AndroidHttpRequest_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Byte_typeof()->Array());
    ::TYPES[2] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[3] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Byte_typeof()->Array());
    ::TYPES[4] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::Byte_typeof());
    ::TYPES[5] = ::g::Uno::Int_typeof();
    type->SetInterfaces(
        ::g::Android::Base::Wrappers::IJWrapper_typeof(), offsetof(AndroidHttpRequest_type, interface0),
    ...
    type->SetFields(4,
        ...
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Byte_typeof()->Array()), offsetof(::g::Uno::Net::Http::Implementation::AndroidHttpRequest, _responseData), 0,
        ::g::Uno::Int_typeof(), offsetof(::g::Uno::Net::Http::Implementation::AndroidHttpRequest, _responseLength), 0,
        ::g::Uno::Byte_typeof()->Array(), offsetof(::g::Uno::Net::Http::Implementation::AndroidHttpRequest, _result), 0);
}
...
AndroidHttpRequest_type* AndroidHttpRequest_typeof()
{
    ...
    type->SetBase(::g::Android::com::fuse::ExperimentalHttp::HttpRequest_typeof());
...
void AndroidHttpRequest__OnDataReceived_fn(AndroidHttpRequest* __this, uObject* arg0, int* arg1)
{
    ...
    if (arg1_ == -1)
    {
        ...
        __this->_result = uArray::New(::TYPES[2/*byte[]*/], __this->_responseLength);
        int pos = 0;

        for (::g::Uno::Collections::List__Enumerator<uStrong<uArray*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_responseData), &ret4), ret4); enum1.MoveNext(::TYPES[3/*Uno.Collections.List<byte[]>.Enumerator*/]); )
        {
            uArray* chunk = enum1.Current(::TYPES[3/*Uno.Collections.List<byte[]>.Enumerator*/]);
            int chunkLength = uPtr(chunk)->Length();
            ::g::Uno::Array::Copy(::TYPES[4/*Uno.Array.Copy<byte>*/], chunk, 0, __this->_result, pos, chunkLength);
            pos = pos + chunkLength;
        }
    }
    else
    {
        ::g::Uno::Collections::List__Add_fn(uPtr(__this->_responseData), ::g::Android::Base::Types::Arrays::JavaToUnoByteArray1(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(uPtr(arg0), ::TYPES[0/*Android.Base.Wrappers.IJWrapper*/])), (int64_t)arg1_));
...
void AndroidHttpRequest::ctor_5(::g::Uno::Net::Http::HttpMessageHandlerRequest* request, uString* method, uString* url)
{
    ...
    _request = request;
    _responseData = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[1/*Uno.Collections.List<byte[]>*/]));
    _responseLength = 0;
    _result = uArray::New(::TYPES[2/*byte[]*/], 0);
}
...
{
    uStackFrame __("Uno.Net.Http.Implementation.AndroidHttpRequest", "GetResponseContentByteArray()");
    return _result;
}
...
// C:\ProgramData\Uno\Packages\Uno.Net.Http\0.33.1\Implementation\$.uno
// --------------------------------------------------------------------
