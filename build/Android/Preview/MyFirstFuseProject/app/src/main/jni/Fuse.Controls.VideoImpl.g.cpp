...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Video\0.33.5\$.uno
// ------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.EmptyVideo", "Fuse.Controls.VideoImpl.IVideoPlayer.get_Duration()");
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.EmptyVideo", "Fuse.Controls.VideoImpl.IVideoPlayer.get_Position()");
    return *__retval = 0.0, void();
}
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.EmptyVideo", "Fuse.Controls.VideoImpl.IVideoPlayer.get_Size()");
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.EmptyVideo", "Fuse.Controls.VideoImpl.IVideoPlayer.get_VideoTexture()");
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.EmptyVideo", "Fuse.Controls.VideoImpl.IVideoPlayer.get_Volume()");
...
// internal sealed class GraphicsVideoService :628
// {
// static GraphicsVideoService() :628
...
// public GraphicsVideoService(Fuse.Controls.VideoImpl.IVideoCallbacks callbacks) :642
void GraphicsVideoService__ctor__fn(GraphicsVideoService* __this, uObject* callbacks)
{
    __this->ctor_(callbacks);
}

// private void Fuse.Controls.VideoImpl.IVideoService.set_AutoPlay(bool value) :693
void GraphicsVideoService__FuseControlsVideoImplIVideoServiceset_AutoPlay_fn(GraphicsVideoService* __this, bool* value)
{
    uStackFrame __("Fuse.Controls.VideoImpl.GraphicsVideoService", "Fuse.Controls.VideoImpl.IVideoService.set_AutoPlay(bool)");
    bool value_ = *value;
    __this->_autoPlay = value_;
}

// private double Fuse.Controls.VideoImpl.IVideoService.get_Duration() :664
void GraphicsVideoService__FuseControlsVideoImplIVideoServiceget_Duration_fn(GraphicsVideoService* __this, double* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.GraphicsVideoService", "Fuse.Controls.VideoImpl.IVideoService.get_Duration()");
...
// private void Fuse.Controls.VideoImpl.IVideoService.set_IsLooping(bool value) :690
void GraphicsVideoService__FuseControlsVideoImplIVideoServiceset_IsLooping_fn(GraphicsVideoService* __this, bool* value)
{
    uStackFrame __("Fuse.Controls.VideoImpl.GraphicsVideoService", "Fuse.Controls.VideoImpl.IVideoService.set_IsLooping(bool)");
    bool value_ = *value;
    __this->_isLooping = value_;
}

// private bool Fuse.Controls.VideoImpl.IVideoService.get_IsValid() :695
void GraphicsVideoService__FuseControlsVideoImplIVideoServiceget_IsValid_fn(GraphicsVideoService* __this, bool* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.GraphicsVideoService", "Fuse.Controls.VideoImpl.IVideoService.get_IsValid()");
    return *__retval = __this->_player != NULL, void();
}

// private void Fuse.Controls.VideoImpl.IVideoService.Load(string url) :697
...
// private void Fuse.Controls.VideoImpl.IVideoService.Load(Uno.UX.FileSource file) :712
...
// private void Fuse.Controls.VideoImpl.IVideoService.Pause() :657
...
// private void Fuse.Controls.VideoImpl.IVideoService.Play() :647
...
// private double Fuse.Controls.VideoImpl.IVideoService.get_Position() :685
...
// private void Fuse.Controls.VideoImpl.IVideoService.set_Position(double value) :686
...
// private int2 Fuse.Controls.VideoImpl.IVideoService.get_Size() :669
void GraphicsVideoService__FuseControlsVideoImplIVideoServiceget_Size_fn(GraphicsVideoService* __this, ::g::Uno::Int2* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.GraphicsVideoService", "Fuse.Controls.VideoImpl.IVideoService.get_Size()");
...
// private void Fuse.Controls.VideoImpl.IVideoService.Unload() :758
...
// private void Fuse.Controls.VideoImpl.IVideoService.Update() :736
...
// private Uno.Graphics.VideoTexture Fuse.Controls.VideoImpl.IVideoService.get_VideoTexture() :674
...
// private void Fuse.Controls.VideoImpl.IVideoService.set_Volume(float value) :680
...
// private bool get_IsCompleted() :729
void GraphicsVideoService__get_IsCompleted_fn(GraphicsVideoService* __this, bool* __retval)
{
    *__retval = __this->IsCompleted();
}

// public GraphicsVideoService New(Fuse.Controls.VideoImpl.IVideoCallbacks callbacks) :642
...
// private void OnPlayerFrameAvailable(object sender, Uno.EventArgs args) :812
...
// public GraphicsVideoService(Fuse.Controls.VideoImpl.IVideoCallbacks callbacks) [instance] :642
...
// private bool get_IsCompleted() [instance] :729
...
// private void OnLoaded(Fuse.Controls.VideoImpl.IVideoPlayer player) [instance] :793
...
// private void OnLoadingError(Uno.Exception e) [instance] :802
...
// private void OnPlayerError(object sender, Uno.Exception e) [instance] :807
...
// private void OnPlayerFrameAvailable(object sender, Uno.EventArgs args) [instance] :812
...
// private Fuse.Controls.VideoImpl.IVideoPlayer get_Player() [instance] :634
uObject* GraphicsVideoService::Player()
{
    uStackFrame __("Fuse.Controls.VideoImpl.GraphicsVideoService", "get_Player()");
    uObject* ind1 = _player;
    return (ind1 != NULL) ? ind1 : (uObject*)_empty;
}

// private void Reset() [instance] :769
...
// private void SetPlayer(Fuse.Controls.VideoImpl.IVideoPlayer player) [instance] :785
...
// public GraphicsVideoService New(Fuse.Controls.VideoImpl.IVideoCallbacks callbacks) [static] :642
...
// internal abstract interface IVideoCallbacks :577
// {
...
// internal abstract interface IVideoService :552
// {
...
// internal sealed class LoadingClosure :586
// {
...
// private LoadingClosure(Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> loadedFuture, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) :604
...
// public static Uno.IDisposable Load(string url, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) :588
...
// public static Uno.IDisposable Load(Uno.UX.FileSource file, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) :593
...
// private LoadingClosure New(Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> loadedFuture, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) :604
...
// private void Uno.IDisposable.Dispose() :616
...
// private LoadingClosure(Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> loadedFuture, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) [instance] :604
...
// public static Uno.IDisposable Load(string url, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) [static] :588
...
// public static Uno.IDisposable Load(Uno.UX.FileSource file, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) [static] :593
...
// private LoadingClosure New(Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> loadedFuture, Uno.Action<Fuse.Controls.VideoImpl.IVideoPlayer> loaded, Uno.Action<Uno.Exception> error) [static] :604
...
// internal sealed class Scale9Rectangle :1260
// {
// static Scale9Rectangle() :1260
...
static void Scale9Rectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::Scale9Rectangle, _draw_6354424c), 0,
        ::g::Uno::UShort_typeof()->Array(), offsetof(::g::Fuse::Controls::VideoImpl::Scale9Rectangle, Draw_indices_6354424c_1_2_12), 0,
        ::g::Uno::Graphics::IndexBuffer_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::Scale9Rectangle, Draw_xv_6354424c_1_3_2), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::Scale9Rectangle, Draw_xv_6354424c_1_3_3), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::Scale9Rectangle, Draw_yv_6354424c_1_4_6), 0,
...
// public generated Scale9Rectangle() :1260
void Scale9Rectangle__ctor__fn(Scale9Rectangle* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, Uno.Graphics.VideoTexture tex, float4 margin) :1264
...
// private generated void init_DrawCalls() :1260
void Scale9Rectangle__init_DrawCalls_fn(Scale9Rectangle* __this)
{
    __this->init_DrawCalls();
}

// public generated Scale9Rectangle New() :1260
...
// public generated Scale9Rectangle() [instance] :1260
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, Uno.Graphics.VideoTexture tex, float4 margin) [instance] :1264
void Scale9Rectangle::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* element, ::g::Uno::Float2 size, ::g::Uno::Float2 scaleTextureSize, ::g::Uno::Graphics::VideoTexture* tex, ::g::Uno::Float4 margin)
{
    ...
    _draw_6354424c.BlendEnabled(true);
    _draw_6354424c.DepthTestEnabled(false);
    _draw_6354424c.CullFace(0);
    _draw_6354424c.BlendSrcRgb(2);
    _draw_6354424c.BlendDstRgb(3);
    _draw_6354424c.BlendDstAlpha(3);
    _draw_6354424c.Use();
    _draw_6354424c.Attrib1(0, 3, Draw_xv_6354424c_1_3_3, 12, 0);
    _draw_6354424c.Attrib1(1, 3, Draw_yv_6354424c_1_4_6, 12, 0);
    _draw_6354424c.Uniform(2, margin.X);
    _draw_6354424c.Uniform(3, size.X - margin.Z);
    _draw_6354424c.Uniform(4, size.X);
    _draw_6354424c.Uniform(5, margin.Y);
    _draw_6354424c.Uniform(6, size.Y - margin.W);
    _draw_6354424c.Uniform(7, size.Y);
    _draw_6354424c.Uniform12(8, uPtr(element)->WorldTransform());
    _draw_6354424c.Uniform12(9, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(uPtr(dc)->Viewport()), ::TYPES[8/*Fuse.IRenderViewport*/])));
    _draw_6354424c.Uniform(10, scaleTextureSize.X - margin.Z);
    _draw_6354424c.Uniform(11, scaleTextureSize.X);
    _draw_6354424c.Uniform(12, scaleTextureSize.Y - margin.W);
    _draw_6354424c.Uniform(13, scaleTextureSize.Y);
    _draw_6354424c.Uniform2(14, scaleTextureSize);
    _draw_6354424c.Sampler6(15, tex);
    _draw_6354424c.Draw(uPtr(Draw_indices_6354424c_1_2_12)->Length(), 2, Draw_xv_6354424c_1_3_2);
}

// private generated void init_DrawCalls() [instance] :1260
void Scale9Rectangle::init_DrawCalls()
{
    uStackFrame __("Fuse.Controls.VideoImpl.Scale9Rectangle", "init_DrawCalls()");
    uArray* indices_6354424c_1_2_1 = uArray::Init<int>(::TYPES[9/*ushort[]*/], 54, 0, 4, 5, 0, 5, 1, 1, 5, 6, 1, 6, 2, 2, 6, 7, 2, 7, 3, 4, 8, 9, 4, 9, 5, 5, 9, 10, 5, 10, 6, 6, 10, 11, 6, 11, 7, 8, 12, 13, 8, 13, 9, 9, 13, 14, 9, 14, 10, 10, 14, 15, 10, 15, 11);
    Draw_xv_6354424c_1_3_2 = ::g::Uno::Graphics::IndexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer9(indices_6354424c_1_2_1), 0);
    Draw_xv_6354424c_1_3_3 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer4(uArray::Init< ::g::Uno::Float3>(::TYPES[10/*float3[]*/], 16, ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f))), 0);
    Draw_yv_6354424c_1_4_6 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer4(uArray::Init< ::g::Uno::Float3>(::TYPES[10/*float3[]*/], 16, ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(1.0f, 0.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 1.0f, 0.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f), ::g::Uno::Float3__New2(0.0f, 0.0f, 1.0f))), 0);
    Draw_indices_6354424c_1_2_12 = indices_6354424c_1_2_1;
    _draw_6354424c = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControlsVideo_bundle::Scale9Rectanglef8978c7b());
}

// public generated Scale9Rectangle New() [static] :1260
...
// internal static class VideoDiskCache :833
// {
// static VideoDiskCache() :839
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Controls.Video\\0.33.5\\$.uno");
...
// public static string GetFileExtension(string fileName) :870
...
// public static string GetFilePath(Uno.UX.FileSource fileSource) :857
...
// private static void OnWindowClosed(object sender, Uno.EventArgs args) :844
...
// public static string GetFileExtension(string fileName) [static] :870
...
// public static string GetFilePath(Uno.UX.FileSource fileSource) [static] :857
...
// private static void OnWindowClosed(object sender, Uno.EventArgs args) [static] :844
void VideoDiskCache::OnWindowClosed(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(VideoDiskCache::_files()), &ret4), ret4); enum1.MoveNext(::TYPES[14/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ...
        {
            ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[15/*Uno.Collections.KeyValuePair<string, string>*/])), 1, ::STRINGS[3/*"C:\\Program...*/], 851);
...
static void VideoDrawElement_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, _draw_2f837289), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, Draw_LocalTransform_2f837289_3_9_2), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, Draw_LocalTransform_2f837289_3_9_3), 0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(::g::Fuse::Controls::VideoImpl::VideoDrawElement, Draw_VertexData_2f837289_6_2_1), 0,
...
// public generated VideoDrawElement() :1236
void VideoDrawElement__ctor__fn(VideoDrawElement* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 offset, float2 size, float2 uvPosition, float2 uvSize, Uno.Graphics.VideoTexture tex) :1240
...
// private generated void init_DrawCalls() :1236
void VideoDrawElement__init_DrawCalls_fn(VideoDrawElement* __this)
{
    __this->init_DrawCalls();
}

// public generated VideoDrawElement New() :1236
...
// public generated VideoDrawElement() [instance] :1236
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 offset, float2 size, float2 uvPosition, float2 uvSize, Uno.Graphics.VideoTexture tex) [instance] :1240
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoDrawElement", "Draw(Fuse.DrawContext,Fuse.Visual,float2,float2,float2,float2,Uno.Graphics.VideoTexture)");
    ::g::Uno::Float4x4 LocalTransform_2f837289_3_9_4 = ::g::Uno::Matrix::Mul10(Draw_LocalTransform_2f837289_3_9_2, ::g::Uno::Matrix::Scaling1(size.X, size.Y, 1.0f), Draw_LocalTransform_2f837289_3_9_3, ::g::Uno::Matrix::Translation(offset.X, offset.Y, 0.0f));
    _draw_2f837289.BlendEnabled(true);
    _draw_2f837289.DepthTestEnabled(false);
    _draw_2f837289.CullFace(uPtr(dc)->CullFace());
    _draw_2f837289.BlendSrcRgb(2);
    _draw_2f837289.BlendDstRgb(3);
    _draw_2f837289.BlendDstAlpha(3);
    _draw_2f837289.Use();
    _draw_2f837289.Attrib1(0, 2, Draw_VertexData_2f837289_6_2_1, 8, 0);
    _draw_2f837289.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[8/*Fuse.IRenderViewport*/])));
    _draw_2f837289.Uniform2(2, uvSize);
    _draw_2f837289.Uniform2(3, uvPosition);
    _draw_2f837289.Uniform12(4, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_2f837289_3_9_4, uPtr(element)->WorldTransform()) : LocalTransform_2f837289_3_9_4);
    _draw_2f837289.Sampler6(5, tex);
    _draw_2f837289.DrawArrays(6);
}

// private generated void init_DrawCalls() [instance] :1236
void VideoDrawElement::init_DrawCalls()
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoDrawElement", "init_DrawCalls()");
    Draw_VertexData_2f837289_6_2_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(uArray::Init< ::g::Uno::Float2>(::TYPES[16/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f))), 0);
    Draw_LocalTransform_2f837289_3_9_2 = ::g::Uno::Matrix::Translation(-::g::Uno::Float2__New1(0.0f).X, -::g::Uno::Float2__New1(0.0f).Y, 0.0f);
    Draw_LocalTransform_2f837289_3_9_3 = ::g::Uno::Matrix::RotationZ(0.0f);
    _draw_2f837289 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControlsVideo_bundle::VideoDrawElementf76cd0d3());
}

// public generated VideoDrawElement New() [static] :1236
...
// internal static class VideoLoader :893
// {
...
// public static Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> Load(string url) :895
void VideoLoader__Load_fn(uString* url, ::g::Uno::Threading::Future1** __retval)
{
    *__retval = VideoLoader::Load(url);
}

// public static Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> Load(Uno.UX.FileSource file) :904
void VideoLoader__Load1_fn(::g::Uno::UX::FileSource* file, ::g::Uno::Threading::Future1** __retval)
{
    *__retval = VideoLoader::Load1(file);
}

// public static Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> Load(string url) [static] :895
...
// public static Uno.Threading.Future<Fuse.Controls.VideoImpl.IVideoPlayer> Load(Uno.UX.FileSource file) [static] :904
...
// internal sealed extern class VideoVisual :968
// {
...
// public VideoVisual() :1000
void VideoVisual__ctor_5_fn(VideoVisual* __this)
{
    __this->ctor_5();
}

// protected override sealed void Attach() :973
...
// protected override sealed void Detach() :987
...
// public override sealed void Draw(Fuse.DrawContext dc) :1208
...
// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnCompleted() :1036
...
// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnError(Uno.Exception e) :1017
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[5/*"Video error"*/], e, __this, ::STRINGS[3/*"C:\\Program...*/], 1021, ::STRINGS[6/*"Fuse.Contro...*/]);
}

// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnFrameAvailable() :1007
...
// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnLoading() :1024
...
// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnReady() :1030
...
// private double Fuse.Triggers.IMediaPlayback.get_Duration() :1057
void VideoVisual__FuseTriggersIMediaPlaybackget_Duration_fn(VideoVisual* __this, double* __retval)
{
    ...
    return *__retval = ::g::Fuse::Controls::VideoImpl::IVideoService::Duration(uInterface(uPtr(__this->_videoService), ::TYPES[17/*Fuse.Controls.VideoImpl.IVideoService*/])), void();
}

// private double Fuse.Triggers.IMediaPlayback.get_Position() :1051
...
// private void Fuse.Triggers.IMediaPlayback.set_Position(double value) :1052
...
// private float Fuse.Triggers.IMediaPlayback.get_Volume() :1045
void VideoVisual__FuseTriggersIMediaPlaybackget_Volume_fn(VideoVisual* __this, float* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoVisual", "Fuse.Triggers.IMediaPlayback.get_Volume()");
    return *__retval = __this->_volume, void();
}

// private void Fuse.Triggers.IMediaPlayback.set_Volume(float value) :1046
void VideoVisual__FuseTriggersIMediaPlaybackset_Volume_fn(VideoVisual* __this, float* value)
{
    ...
    float value_ = *value;
    ::g::Fuse::Controls::VideoImpl::IVideoService::Volume(uInterface(uPtr(__this->_videoService), ::TYPES[17/*Fuse.Controls.VideoImpl.IVideoService*/]), __this->_volume = value_);
}

// private bool Fuse.Triggers.IPlayback.get_CanPause() :1105
void VideoVisual__FuseTriggersIPlaybackget_CanPause_fn(VideoVisual* __this, bool* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoVisual", "Fuse.Triggers.IPlayback.get_CanPause()");
    return *__retval = true, void();
}

// private bool Fuse.Triggers.IPlayback.get_CanPlayTo() :1103
void VideoVisual__FuseTriggersIPlaybackget_CanPlayTo_fn(VideoVisual* __this, bool* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoVisual", "Fuse.Triggers.IPlayback.get_CanPlayTo()");
    return *__retval = false, void();
}

// private bool Fuse.Triggers.IPlayback.get_CanResume() :1106
void VideoVisual__FuseTriggersIPlaybackget_CanResume_fn(VideoVisual* __this, bool* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoVisual", "Fuse.Triggers.IPlayback.get_CanResume()");
    return *__retval = true, void();
}

// private bool Fuse.Triggers.IPlayback.get_CanStop() :1104
void VideoVisual__FuseTriggersIPlaybackget_CanStop_fn(VideoVisual* __this, bool* __retval)
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoVisual", "Fuse.Triggers.IPlayback.get_CanStop()");
    return *__retval = true, void();
}

// private void Fuse.Triggers.IPlayback.Pause() :1072
...
// private void Fuse.Triggers.IPlayback.PlayTo(double progress) :1066
void VideoVisual__FuseTriggersIPlaybackPlayTo_fn(VideoVisual* __this, double* progress)
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoVisual", "Fuse.Triggers.IPlayback.PlayTo(double)");
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[7/*"IPlayback.P...*/], __this, ::STRINGS[3/*"C:\\Program...*/], 1068, ::STRINGS[8/*"Fuse.Trigge...*/]);
}

// private double Fuse.Triggers.IPlayback.get_Progress() :1099
...
// private void Fuse.Triggers.IPlayback.set_Progress(double value) :1100
...
// private void Fuse.Triggers.IPlayback.Resume() :1082
...
// private void Fuse.Triggers.IPlayback.Stop() :1060
...
// private double Fuse.Triggers.IProgress.get_Progress() :1094
...
// private void Fuse.Triggers.IProgress.add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1110
...
// private void Fuse.Triggers.IProgress.remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1111
...
// public override sealed float2 GetMarginSize(Fuse.LayoutParams lp) :1171
...
// protected override sealed void OnHitTest(Fuse.HitTestContext htc) :1223
...
// private void OnParamChanged(object sender, Uno.EventArgs args) :1140
...
// private void OnProgressChanged() :1115
void VideoVisual__OnProgressChanged_fn(VideoVisual* __this)
{
    __this->OnProgressChanged();
}

// private void OnRenderParamChanged(object sender, Uno.EventArgs args) :1131
...
// private void OnSourceChanged(object sender, Uno.EventArgs args) :1147
...
// private void OnUpdate() :1124
void VideoVisual__OnUpdate_fn(VideoVisual* __this)
{
    __this->OnUpdate();
}

// private generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1114
void VideoVisual__add_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->add_ProgressChanged(value);
}

// private generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1114
void VideoVisual__remove_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->remove_ProgressChanged(value);
}

// private void ResetTriggers() :1162
void VideoVisual__ResetTriggers_fn(VideoVisual* __this)
{
    __this->ResetTriggers();
}

// public VideoVisual() [instance] :1000
...
// private float2 GetSize() [instance] :1179
...
// private void OnParamChanged(object sender, Uno.EventArgs args) [instance] :1140
...
// private void OnProgressChanged() [instance] :1115
...
// private void OnRenderParamChanged(object sender, Uno.EventArgs args) [instance] :1131
...
// private void OnSourceChanged(object sender, Uno.EventArgs args) [instance] :1147
...
// private void OnUpdate() [instance] :1124
...
// private generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :1114
...
// private generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :1114
...
// private void ResetTriggers() [instance] :1162
...
// public VideoVisual New() [static] :1000
