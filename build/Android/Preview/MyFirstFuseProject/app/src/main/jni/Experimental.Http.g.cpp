...
// C:\ProgramData\Uno\Packages\Experimental.Http\0.33.5\$.uno
// ----------------------------------------------------------
...
{
    uStackFrame __("Experimental.Http.BinaryLoader", ".ctor()");
    ctor_();
}
...
static void HttpLoader_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        ...
        new uFunction("LoadBinary", NULL, (void*)HttpLoader__LoadBinary_fn, 0, true, uVoid_typeof(), 3, ::g::Uno::String_typeof(), ::g::Uno::Action2_typeof()->MakeType(::g::Experimental::Http::HttpResponseHeader_typeof(), ::g::Uno::Buffer_typeof()), ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof())));
}
...
{
    uStackFrame __("Experimental.Http.HttpLoader", "get_CacheMaxAge()");
    HttpLoader_typeof()->Init();
...
{
    uStackFrame __("Experimental.Http.HttpLoader", "set_CacheMaxAge(int)");
    HttpLoader_typeof()->Init();
...
static void HttpResponseHeader_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[6] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[7] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_Headers", NULL, (void*)HttpResponseHeader__get_Headers_fn, 0, false, ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof()), 0),
        new uFunction(".ctor", NULL, (void*)HttpResponseHeader__New1_fn, 0, true, HttpResponseHeader_typeof(), 0),
...
{
    uStackFrame __("Experimental.Http.HttpResponseHeader", "get_Headers()");
    return _Headers;
}
...
{
    uStackFrame __("Experimental.Http.HttpResponseHeader", "set_Headers(Uno.Collections.Dictionary<string, string>)");
    _Headers = value;
}
...
{
    uStackFrame __("Experimental.Http.HttpResponseHeader", "get_ReasonPhrase()");
...
{
    uStackFrame __("Experimental.Http.HttpResponseHeader", "set_ReasonPhrase(string)");
    _ReasonPhrase = value;
}
...
{
    uStackFrame __("Experimental.Http.HttpResponseHeader", "get_StatusCode()");
    return _StatusCode;
}
...
{
    uStackFrame __("Experimental.Http.HttpResponseHeader", "set_StatusCode(int)");
    _StatusCode = value;
}
...
void HttpResponseHeader::Write(::g::Uno::IO::BinaryWriter* w)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Headers()), &ret3), ret3); enum1.MoveNext(::TYPES[6/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uString*> > h = enum1.Current(::TYPES[6/*Uno.Collections.Dictionary<string, string>.Enumerator*/]);
        WriteSafe(w, h.Key(::TYPES[7/*Uno.Collections.KeyValuePair<string, string>*/]));
        WriteSafe(w, h.Value(::TYPES[7/*Uno.Collections.KeyValuePair<string, string>*/]));
    }
}
...
HttpResponseHeader* HttpResponseHeader::Read(::g::Uno::IO::BinaryReader* r)
{
    ...
    int c = r->ReadInt();
    h->Headers((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[5/*Uno.Collections.Dictionary<string, string>*/]));
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Experimental.Http\\0.33.5\\$.uno");
    ...
    ::TYPES[3] = ::g::Experimental::Cache::ICache_typeof();
    ::TYPES[10] = ::g::Experimental::Cache::CacheLoaded_typeof();
    ...
    ::TYPES[13] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    type->SetFields(0,
...
::g::Uno::Collections::Dictionary* Loader::ExtractHeaders(uString* headers)
{
    ...
    int index2;
    int length3;
    ::g::Uno::Collections::Dictionary* res = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[5/*Uno.Collections.Dictionary<string, string>*/]);

    for (array1 = ::g::Uno::String::Split(uPtr(headers), uArray::Init<int>(::TYPES[9/*char[]*/], 1, 10)), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        uString* header = uPtr(array1)->Strong<uString*>(index2);

        if (!::g::Uno::String::IsNullOrEmpty(::g::Uno::String::Trim(uPtr(header))))
        {
            uArray* arr = ::g::Uno::String::Split(uPtr(header), uArray::Init<int>(::TYPES[9/*char[]*/], 1, ':'));
...
{
    uStackFrame __("Experimental.Http.Loader", "get_Header()");
    return _header;
}
...
void Loader::Initiate()
{
    ...
    if (Cache != NULL)
    {
        bool has = ::g::Experimental::Cache::ICache::LoadRecord(uInterface(uPtr(Cache), ::TYPES[3/*Experimental.Cache.ICache*/]), Loader::ConstructRecordId(Method, Uri), uDelegate::New(::TYPES[10/*Experimental.Cache.CacheLoaded*/], (void*)Loader__OnCacheReady_fn, this));
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 1, ::STRINGS[9/*"C:\\Program...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 1, ::STRINGS[9/*"C:\\Program...*/], 854);
...
void Loader::MakeRequest()
{
    ...
    uPtr(request)->add_Error(uDelegate::New(::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/], (void*)Loader__OnError_fn, this));
    request->add_Done(uDelegate::New(::TYPES[13/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Loader__OnLoaded_fn, this));
