...
// C:\ProgramData\Uno\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\Bytecode\$.uno
// --------------------------------------------------------------------------------
...
{
    BindVariable::Write_ = uDelegate::New(::TYPES[1/*Uno.Action<Outracks.Simulator.Bytecode.BindVariable, Uno.IO.BinaryWriter>*/], (void*)BindVariable___Write_fn);
    BindVariable::Read_ = uDelegate::New(::TYPES[2/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.BindVariable>*/], (void*)BindVariable___Read_fn);
}
...
static void BindVariable_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Action2_typeof()->MakeType(BindVariable_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[2] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), BindVariable_typeof());
    ::TYPES[0] = uObject_typeof();
    type->SetFields(0,
...
void BlobLiteral__ToString_fn(BlobLiteral* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[4/*"new byte["*/], uBox<int>(::TYPES[113/*int*/], uPtr(__this->Bytes)->Length())), ::STRINGS[5/*"]"*/]), void();
}
...
void BooleanLiteral__ToString_fn(BooleanLiteral* __this, uString** __retval)
{
    ...
    bool ind1;
    return *__retval = ::g::Uno::Bool::ToString((ind1 = __this->BooleanValue, ind1), ::TYPES[3/*bool*/]), void();
}
...
static void CallDynamicMethod_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Expression_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Expression_typeof());
    ::TYPES[6] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Expression_typeof());
    ::TYPES[7] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Expression_typeof());
    ::TYPES[0] = uObject_typeof();
    ::TYPES[8] = ::g::Outracks::Simulator::StringSplitting_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Expression_typeof());
    ::TYPES[9] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Expression_typeof());
    type->SetFields(0,
...
void CallDynamicMethod::ctor_2(::g::Outracks::Simulator::Bytecode::Expression* o, ::g::Outracks::Simulator::Bytecode::TypeMemberName* method, uArray* arguments)
{
    ...
    ctor_3(o, method, (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[4/*Outracks.Simulator.List.ToImmutableList<Outracks.Simulator.Bytecode.Expression>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[6/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.Bytecode.Expression>*/], arguments))));
}
...
void CallDynamicMethod::Write3(::g::Uno::IO::BinaryWriter* writer)
{
    ...
    ::g::Outracks::Simulator::List::Write1(::TYPES[9/*Outracks.Simulator.List.Write<Outracks.Simulator.Bytecode.Expression>*/], writer, Arguments, ::g::Outracks::Simulator::Bytecode::Expression::Write1());
}
...
CallDynamicMethod* CallDynamicMethod::Read2(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::ImmutableList* _Arguments = (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::Read(::TYPES[7/*Outracks.Simulator.List.Read<Outracks.Simulator.Bytecode.Expression>*/], reader, ::g::Outracks::Simulator::Bytecode::Expression::Read1());
...
CallLambda* CallLambda::Read2(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::ImmutableList* arguments = (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::Read(::TYPES[7/*Outracks.Simulator.List.Read<Outracks.Simulator.Bytecode.Expression>*/], reader, ::g::Outracks::Simulator::Bytecode::Expression::Read1());
...
void CallLambda::Write2(CallLambda* o, ::g::Uno::IO::BinaryWriter* writer)
{
    ...
    ::g::Outracks::Simulator::List::Write1(::TYPES[9/*Outracks.Simulator.List.Write<Outracks.Simulator.Bytecode.Expression>*/], writer, o->Arguments, ::g::Outracks::Simulator::Bytecode::Expression::Write1());
}
// }
...
{
    Expression::Write1_ = uDelegate::New(::TYPES[10/*Uno.Action<Outracks.Simulator.Bytecode.Expression, Uno.IO.BinaryWriter>*/], (void*)Expression___Write1_fn);
    Expression::Read1_ = uDelegate::New(::TYPES[11/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.Expression>*/], (void*)Expression___Read1_fn);
}

static void Expression_build(uType* type)
{
    ::TYPES[10] = ::g::Uno::Action2_typeof()->MakeType(Expression_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[11] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Expression_typeof());
    ::TYPES[12] = Expression_typeof()->MakeMethod(1, ::g::Uno::Char_typeof());
    ::TYPES[13] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::ReadVariable_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[14] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Literal_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[15] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Lambda_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[16] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::MethodGroup_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[17] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::IsType_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[18] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::LogicalOr_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[19] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Instantiate_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[20] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::CallLambda_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[21] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::CallStaticMethod_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[22] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::CallDynamicMethod_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[23] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::ReadStaticField_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[24] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::ReadProperty_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[25] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::WriteProperty_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[26] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::AddEventHandler_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[27] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::RemoveEventHandler_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[28] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::ReadVariable_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[29] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::ReadVariable_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[30] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Literal_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[31] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Literal_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[32] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Lambda_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[33] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Lambda_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[34] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::MethodGroup_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[35] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::MethodGroup_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[36] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::IsType_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[37] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::IsType_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[38] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::LogicalOr_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[39] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::LogicalOr_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[40] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Instantiate_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[41] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Instantiate_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[42] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::CallLambda_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[43] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::CallLambda_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[44] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::CallStaticMethod_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[45] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::CallStaticMethod_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[46] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::CallDynamicMethod_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[47] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::CallDynamicMethod_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[48] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::ReadStaticField_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[49] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::ReadStaticField_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[50] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::ReadProperty_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[51] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::ReadProperty_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[52] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::WriteProperty_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[53] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::WriteProperty_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[54] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::AddEventHandler_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[55] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::AddEventHandler_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[56] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::RemoveEventHandler_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[57] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::RemoveEventHandler_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[58] = ::g::Outracks::Simulator::Bytecode::ReadVariable_typeof();
    ::TYPES[59] = ::g::Outracks::Simulator::Bytecode::Literal_typeof();
    ::TYPES[60] = ::g::Outracks::Simulator::Bytecode::Lambda_typeof();
    ::TYPES[61] = ::g::Outracks::Simulator::Bytecode::MethodGroup_typeof();
    ::TYPES[62] = ::g::Outracks::Simulator::Bytecode::IsType_typeof();
    ::TYPES[63] = ::g::Outracks::Simulator::Bytecode::LogicalOr_typeof();
    ::TYPES[64] = ::g::Outracks::Simulator::Bytecode::Instantiate_typeof();
    ::TYPES[65] = ::g::Outracks::Simulator::Bytecode::CallLambda_typeof();
    ::TYPES[66] = ::g::Outracks::Simulator::Bytecode::CallStaticMethod_typeof();
    ::TYPES[67] = ::g::Outracks::Simulator::Bytecode::CallDynamicMethod_typeof();
    ::TYPES[68] = ::g::Outracks::Simulator::Bytecode::ReadStaticField_typeof();
    ::TYPES[69] = ::g::Outracks::Simulator::Bytecode::ReadProperty_typeof();
    ::TYPES[70] = ::g::Outracks::Simulator::Bytecode::WriteProperty_typeof();
    ::TYPES[71] = ::g::Outracks::Simulator::Bytecode::AddEventHandler_typeof();
    ::TYPES[72] = ::g::Outracks::Simulator::Bytecode::RemoveEventHandler_typeof();
    type->SetFields(0,
...
void Expression__Match3_fn(Expression* __this, uType* __type, uDelegate* a1, uDelegate* a2, uDelegate* a3, uDelegate* a4, uDelegate* a5, uDelegate* a6, uDelegate* a7, uDelegate* a8, uDelegate* a9, uDelegate* a10, uDelegate* a11, uDelegate* a12, uDelegate* a13, uDelegate* a15, uDelegate* a16, uTRef __retval)
{
    ...
    ::g::Outracks::Simulator::Bytecode::ReadVariable* t1 = uAs< ::g::Outracks::Simulator::Bytecode::ReadVariable*>(self, ::TYPES[58/*Outracks.Simulator.Bytecode.ReadVariable*/]);

    if (t1 != NULL)
        return __retval.Store((uPtr(a1)->Invoke(&ret32, 1, t1), ret32)), void();

    ::g::Outracks::Simulator::Bytecode::Literal* t2 = uAs< ::g::Outracks::Simulator::Bytecode::Literal*>(self, ::TYPES[59/*Outracks.Simulator.Bytecode.Literal*/]);

    if (t2 != NULL)
        return __retval.Store((uPtr(a2)->Invoke(&ret33, 1, t2), ret33)), void();

    ::g::Outracks::Simulator::Bytecode::Lambda* t3 = uAs< ::g::Outracks::Simulator::Bytecode::Lambda*>(self, ::TYPES[60/*Outracks.Simulator.Bytecode.Lambda*/]);

    if (t3 != NULL)
        return __retval.Store((uPtr(a3)->Invoke(&ret34, 1, t3), ret34)), void();

    ::g::Outracks::Simulator::Bytecode::MethodGroup* t4 = uAs< ::g::Outracks::Simulator::Bytecode::MethodGroup*>(self, ::TYPES[61/*Outracks.Simulator.Bytecode.MethodGroup*/]);

    if (t4 != NULL)
        return __retval.Store((uPtr(a4)->Invoke(&ret35, 1, t4), ret35)), void();

    ::g::Outracks::Simulator::Bytecode::IsType* t5 = uAs< ::g::Outracks::Simulator::Bytecode::IsType*>(self, ::TYPES[62/*Outracks.Simulator.Bytecode.IsType*/]);

    if (t5 != NULL)
        return __retval.Store((uPtr(a5)->Invoke(&ret36, 1, t5), ret36)), void();

    ::g::Outracks::Simulator::Bytecode::LogicalOr* t6 = uAs< ::g::Outracks::Simulator::Bytecode::LogicalOr*>(self, ::TYPES[63/*Outracks.Simulator.Bytecode.LogicalOr*/]);

    if (t6 != NULL)
        return __retval.Store((uPtr(a6)->Invoke(&ret37, 1, t6), ret37)), void();

    ::g::Outracks::Simulator::Bytecode::Instantiate* t7 = uAs< ::g::Outracks::Simulator::Bytecode::Instantiate*>(self, ::TYPES[64/*Outracks.Simulator.Bytecode.Instantiate*/]);

    if (t7 != NULL)
        return __retval.Store((uPtr(a7)->Invoke(&ret38, 1, t7), ret38)), void();

    ::g::Outracks::Simulator::Bytecode::CallLambda* t8 = uAs< ::g::Outracks::Simulator::Bytecode::CallLambda*>(self, ::TYPES[65/*Outracks.Simulator.Bytecode.CallLambda*/]);

    if (t8 != NULL)
        return __retval.Store((uPtr(a8)->Invoke(&ret39, 1, t8), ret39)), void();

    ::g::Outracks::Simulator::Bytecode::CallStaticMethod* t9 = uAs< ::g::Outracks::Simulator::Bytecode::CallStaticMethod*>(self, ::TYPES[66/*Outracks.Simulator.Bytecode.CallStaticMethod*/]);

    if (t9 != NULL)
        return __retval.Store((uPtr(a9)->Invoke(&ret40, 1, t9), ret40)), void();

    ::g::Outracks::Simulator::Bytecode::CallDynamicMethod* t10 = uAs< ::g::Outracks::Simulator::Bytecode::CallDynamicMethod*>(self, ::TYPES[67/*Outracks.Simulator.Bytecode.CallDynamicMethod*/]);

    if (t10 != NULL)
        return __retval.Store((uPtr(a10)->Invoke(&ret41, 1, t10), ret41)), void();

    ::g::Outracks::Simulator::Bytecode::ReadStaticField* t11 = uAs< ::g::Outracks::Simulator::Bytecode::ReadStaticField*>(self, ::TYPES[68/*Outracks.Simulator.Bytecode.ReadStaticField*/]);

    if (t11 != NULL)
        return __retval.Store((uPtr(a11)->Invoke(&ret42, 1, t11), ret42)), void();

    ::g::Outracks::Simulator::Bytecode::ReadProperty* t12 = uAs< ::g::Outracks::Simulator::Bytecode::ReadProperty*>(self, ::TYPES[69/*Outracks.Simulator.Bytecode.ReadProperty*/]);

    if (t12 != NULL)
        return __retval.Store((uPtr(a12)->Invoke(&ret43, 1, t12), ret43)), void();

    ::g::Outracks::Simulator::Bytecode::WriteProperty* t13 = uAs< ::g::Outracks::Simulator::Bytecode::WriteProperty*>(self, ::TYPES[70/*Outracks.Simulator.Bytecode.WriteProperty*/]);

    if (t13 != NULL)
        return __retval.Store((uPtr(a13)->Invoke(&ret44, 1, t13), ret44)), void();

    ::g::Outracks::Simulator::Bytecode::AddEventHandler* t15 = uAs< ::g::Outracks::Simulator::Bytecode::AddEventHandler*>(self, ::TYPES[71/*Outracks.Simulator.Bytecode.AddEventHandler*/]);

    if (t15 != NULL)
        return __retval.Store((uPtr(a15)->Invoke(&ret45, 1, t15), ret45)), void();

    ::g::Outracks::Simulator::Bytecode::RemoveEventHandler* t16 = uAs< ::g::Outracks::Simulator::Bytecode::RemoveEventHandler*>(self, ::TYPES[72/*Outracks.Simulator.Bytecode.RemoveEventHandler*/]);
...
static void Lambda_build(uType* type)
{
    ...
    ::TYPES[75] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[76] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[77] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[78] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[0] = uObject_typeof();
    ::TYPES[79] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[80] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[81] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Statement_typeof());
    type->SetFields(0,
...
void Lambda__ToString_fn(Lambda* __this, uString** __retval)
{
    ...
    for (uObject* enum1 = (uObject*)uPtr(__this->LocalVariables)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[77/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Outracks::Simulator::Bytecode::BindVariable* stmnt = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[78/*Uno.Collections.IEnumerator<Outracks.Simulator.Bytecode.BindVariable>*/]), &ret5), ret5);
        uPtr(code)->Append2(Lambda::AddStatementSeparator(stmnt));
    }

    for (uObject* enum2 = (uObject*)uPtr(__this->Statements)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[77/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Outracks::Simulator::Bytecode::Statement* stmnt1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[79/*Uno.Collections.IEnumerator<Outracks.Simulator.Bytecode.Statement>*/]), &ret6), ret6);
...
Lambda* Lambda::Read2(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::ImmutableList* localVariables = (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::Read(::TYPES[75/*Outracks.Simulator.List.Read<Outracks.Simulator.Bytecode.BindVariable>*/], reader, ::g::Outracks::Simulator::Bytecode::BindVariable::Read());
    ::g::Outracks::Simulator::ImmutableList* statements = (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::Read(::TYPES[76/*Outracks.Simulator.List.Read<Outracks.Simulator.Bytecode.Statement>*/], reader, ::g::Outracks::Simulator::Bytecode::Statement::Read());
...
void Lambda::Write2(Lambda* l, ::g::Uno::IO::BinaryWriter* writer)
{
    ...
    ::g::Outracks::Simulator::List::Write1(::TYPES[80/*Outracks.Simulator.List.Write<Outracks.Simulator.Bytecode.BindVariable>*/], writer, l->LocalVariables, ::g::Outracks::Simulator::Bytecode::BindVariable::Write());
    ::g::Outracks::Simulator::List::Write1(::TYPES[81/*Outracks.Simulator.List.Write<Outracks.Simulator.Bytecode.Statement>*/], writer, l->Statements, ::g::Outracks::Simulator::Bytecode::Statement::Write());
}
// }
...
{
    ::TYPES[82] = ::g::Outracks::Simulator::Bytecode::BooleanLiteral_typeof();
    ::TYPES[83] = ::g::Outracks::Simulator::Bytecode::StringLiteral_typeof();
    ::TYPES[84] = ::g::Outracks::Simulator::Bytecode::NumberLiteral_typeof();
    ::TYPES[85] = ::g::Outracks::Simulator::Bytecode::EnumLiteral_typeof();
    ::TYPES[86] = ::g::Outracks::Simulator::Bytecode::BlobLiteral_typeof();
    ::TYPES[87] = Literal_typeof()->MakeMethod(1, ::g::Uno::Char_typeof());
    ::TYPES[88] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::BooleanLiteral_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[89] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::StringLiteral_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[90] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::NumberLiteral_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[91] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::EnumLiteral_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[92] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::BlobLiteral_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[93] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::BooleanLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[94] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BooleanLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[95] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::StringLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[96] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::StringLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[97] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::NumberLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[98] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::NumberLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[99] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::EnumLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[100] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::EnumLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[101] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::BlobLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[102] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BlobLiteral_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->Reflection.SetFunctions(4,
...
void Literal__Match5_fn(Literal* __this, uType* __type, uDelegate* a1, uDelegate* a2, uDelegate* a3, uDelegate* a4, uDelegate* a5, uTRef __retval)
{
    ...
    Literal* self = __this;
    ::g::Outracks::Simulator::Bytecode::BooleanLiteral* t1 = uAs< ::g::Outracks::Simulator::Bytecode::BooleanLiteral*>(self, ::TYPES[82/*Outracks.Simulator.Bytecode.BooleanLiteral*/]);

    if (t1 != NULL)
        return __retval.Store((uPtr(a1)->Invoke(&ret1, 1, t1), ret1)), void();

    ::g::Outracks::Simulator::Bytecode::StringLiteral* t2 = uAs< ::g::Outracks::Simulator::Bytecode::StringLiteral*>(self, ::TYPES[83/*Outracks.Simulator.Bytecode.StringLiteral*/]);

    if (t2 != NULL)
        return __retval.Store((uPtr(a2)->Invoke(&ret2, 1, t2), ret2)), void();

    ::g::Outracks::Simulator::Bytecode::NumberLiteral* t3 = uAs< ::g::Outracks::Simulator::Bytecode::NumberLiteral*>(self, ::TYPES[84/*Outracks.Simulator.Bytecode.NumberLiteral*/]);

    if (t3 != NULL)
        return __retval.Store((uPtr(a3)->Invoke(&ret3, 1, t3), ret3)), void();

    ::g::Outracks::Simulator::Bytecode::EnumLiteral* t4 = uAs< ::g::Outracks::Simulator::Bytecode::EnumLiteral*>(self, ::TYPES[85/*Outracks.Simulator.Bytecode.EnumLiteral*/]);

    if (t4 != NULL)
        return __retval.Store((uPtr(a4)->Invoke(&ret4, 1, t4), ret4)), void();

    ::g::Outracks::Simulator::Bytecode::BlobLiteral* t5 = uAs< ::g::Outracks::Simulator::Bytecode::BlobLiteral*>(self, ::TYPES[86/*Outracks.Simulator.Bytecode.BlobLiteral*/]);
...
static void MethodGroup_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const(")");
    ::TYPES[103] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Signature_typeof());
    ::TYPES[0] = uObject_typeof();
    ::TYPES[104] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Signature_typeof());
    ::TYPES[105] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Signature_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
MethodGroup* MethodGroup::Read2(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::Signature*> > c = (::g::Outracks::Simulator::Bytecode::Optional__Read1_fn(::TYPES[103/*Outracks.Simulator.Bytecode.Optional.Read<Outracks.Simulator.Bytecode.Signature>*/], reader, ::g::Outracks::Simulator::Bytecode::Signature::Read(), &ret2), ret2);
...
{
    NamespaceName::Write_ = uDelegate::New(::TYPES[106/*Uno.Action<Outracks.Simulator.Bytecode.NamespaceName, Uno.IO.BinaryWriter>*/], (void*)NamespaceName___Write_fn);
    NamespaceName::Read_ = uDelegate::New(::TYPES[107/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.NamespaceName>*/], (void*)NamespaceName___Read_fn);
}

static void NamespaceName_build(uType* type)
{
    ::TYPES[106] = ::g::Uno::Action2_typeof()->MakeType(NamespaceName_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[107] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), NamespaceName_typeof());
    ::TYPES[0] = uObject_typeof();
    type->SetInterfaces(
...
static void NoOperation_build(uType* type)
{
    ...
    ::TYPES[108] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[0] = uObject_typeof();
    ::TYPES[109] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[110] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
...
void NoOperation__ToString_fn(NoOperation* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition1(::STRINGS[18/*"// "*/], uBox(::TYPES[144/*Outracks.Simulator.Bytecode.Optional<string>*/], __this->Description().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong<uString*> > >())), void();
}
...
void NoOperation::Write2(::g::Uno::IO::BinaryWriter* writer)
{
    ...
    ::g::Outracks::Simulator::Bytecode::Optional__Write1_fn(::TYPES[109/*Outracks.Simulator.Bytecode.Optional.Write<string>*/], writer, uCRef(Description().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong<uString*> > >()), uDelegate::New(::TYPES[110/*Uno.Action<string>*/], (void*)::g::Uno::IO::BinaryWriter__Write24_fn, uPtr(writer)));
}
...
NoOperation* NoOperation::Read1(::g::Uno::IO::BinaryReader* reader)
{
    ...
    return NoOperation::New1((::g::Outracks::Simulator::Bytecode::Optional__Read1_fn(::TYPES[108/*Outracks.Simulator.Bytecode.Optional.Read<string>*/], reader, ::g::Outracks::Simulator::Serialization::ReadString(), &ret2), ret2));
}
...
{
    ::TYPES[111] = ::g::Outracks::Simulator::Bytecode::NumberType_typeof();
    ::TYPES[112] = ::g::Uno::Double_typeof();
    ::TYPES[113] = ::g::Uno::Int_typeof();
    type->SetFields(0,
...
void NumberLiteral__ToString_fn(NumberLiteral* __this, uString** __retval)
{
    ...
    double ind1;
    return *__retval = ::g::Uno::Double::ToString((ind1 = __this->DoubleValue, ind1), ::TYPES[112/*double*/]), void();
}
...
{
    ::TYPES[114] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof();
...
{
    uType* __types[] = {
        ::TYPES[114/*Outracks.Simulator.Bytecode.Optional`1*/]->MakeType(__type->U(0)),
        __type->U(0),
    };
...
void Optional1__Equals2_fn(uTRef __this, uType* __type, void* other, bool* __retval)
{
    ...
    bool ind1;
    other_ = other;
    return *__retval = ::g::Uno::Bool::Equals((ind1 = __type->Field(__this, 0/*_hasValue*/).Value<bool>(), ind1), ::TYPES[3/*bool*/], uBox(::TYPES[3/*bool*/], other_[0/*_hasValue*/].Value<bool>())) && ::g::Uno::Object::Equals(uBoxPtr(__type->T(0), uPtr(__type->Field(__this, 1/*_value*/)), U_ALLOCA(__type->T(0)->ObjectSize)), uBoxPtr(__type->T(0), other_[1/*_value*/])), void();
}
...
void Optional1__GetHashCode_fn(uTRef __this, uType* __type, int* __retval)
{
    ...
    bool ind2;
    return *__retval = (::g::Uno::Bool::GetHashCode((ind2 = __type->Field(__this, 0/*_hasValue*/).Value<bool>(), ind2), ::TYPES[3/*bool*/]) * 397) ^ ::g::Uno::Object::GetHashCode(uBoxPtr(__type->T(0), uPtr(__type->Field(__this, 1/*_value*/)), U_ALLOCA(__type->T(0)->ObjectSize))), void();
}
...
static void OptionalExtensions_build(uType* type)
{
    ::TYPES[114] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof();
    ::TYPES[0] = uObject_typeof();
    ::TYPES[115] = ::g::Outracks::Simulator::Bytecode::Optional_typeof();
    type->Reflection.SetFunctions(3,
...
void OptionalExtensions__ToOptional_fn(uType* __type, uObject* self, uTRef __retval)
{
    uType* __types[] = {
        ::TYPES[114/*Outracks.Simulator.Bytecode.Optional`1*/]->MakeType(__type->U(0)),
        __type->U(0),
        ::TYPES[115/*Outracks.Simulator.Bytecode.Optional*/]->MakeMethod(1, __type->U(0)),
        ::TYPES[115/*Outracks.Simulator.Bytecode.Optional*/]->MakeMethod(1, __type->U(0)),
    };
...
{
    Parameter::Read_ = uDelegate::New(::TYPES[116/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.Parameter>*/], (void*)Parameter___Read_fn);
    Parameter::Write_ = uDelegate::New(::TYPES[117/*Uno.Action<Outracks.Simulator.Bytecode.Parameter, Uno.IO.BinaryWriter>*/], (void*)Parameter___Write_fn);
}

static void Parameter_build(uType* type)
{
    ::STRINGS[22] = uString::Const(" ");
    ::TYPES[116] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Parameter_typeof());
    ::TYPES[117] = ::g::Uno::Action2_typeof()->MakeType(Parameter_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[0] = uObject_typeof();
    type->SetFields(0,
...
{
    Signature::Read_ = uDelegate::New(::TYPES[118/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.Signature>*/], (void*)Signature___Read_fn);
}
...
static void Signature_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const(", ");
    ::STRINGS[8] = uString::Const(")");
    ::TYPES[118] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Signature_typeof());
    ::TYPES[119] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Parameter_typeof());
    ::TYPES[120] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[121] = ::g::Outracks::Simulator::Bytecode::Parameter_typeof()->Array();
    ::TYPES[122] = ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Parameter_typeof());
    ::TYPES[123] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[124] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[125] = ::g::Uno::String_typeof()->Array();
    ::TYPES[126] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[127] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[128] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Parameter_typeof());
    ::TYPES[129] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    type->SetFields(0,
...
void Signature__ToString_fn(Signature* __this, uString** __retval)
{
    ...
    uArray* names = uArray::New(::TYPES[125/*string[]*/], uPtr(__this->Parameters)->Count());
    ...
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[6/*"("*/], ::g::Outracks::Simulator::StringSplitting::Join((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[127/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], names)), ::STRINGS[7/*", "*/])), ::STRINGS[8/*")"*/]), void();
}
...
Signature* Signature::_Read(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::ImmutableList* parameters = (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::Read(::TYPES[119/*Outracks.Simulator.List.Read<Outracks.Simulator.Bytecode.Parameter>*/], reader, ::g::Outracks::Simulator::Bytecode::Parameter::Read());
    ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::TypeName*> > returnType = (::g::Outracks::Simulator::Bytecode::Optional__Read1_fn(::TYPES[120/*Outracks.Simulator.Bytecode.Optional.Read<Outracks.Simulator.Bytecode.TypeName>*/], reader, ::g::Outracks::Simulator::Bytecode::TypeName::Read(), &ret2), ret2);
...
Signature* Signature::Action(uArray* variables)
{
    ...
    uArray* parameters = uArray::New(::TYPES[121/*Outracks.Simulator.Bytecode.Parameter[]*/], uPtr(variables)->Length());
...
void Signature::Write(Signature* s, ::g::Uno::IO::BinaryWriter* writer)
{
    ...
    Signature_typeof()->Init();
    ::g::Outracks::Simulator::List::Write1(::TYPES[128/*Outracks.Simulator.List.Write<Outracks.Simulator.Bytecode.Parameter>*/], writer, uPtr(s)->Parameters, ::g::Outracks::Simulator::Bytecode::Parameter::Write());
    ::g::Outracks::Simulator::Bytecode::Optional__Write_fn(::TYPES[129/*Outracks.Simulator.Bytecode.Optional.Write<Outracks.Simulator.Bytecode.TypeName>*/], writer, uCRef(s->ReturnType().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::TypeName*> > >()), ::g::Outracks::Simulator::Bytecode::TypeName::Write());
}
// }
...
{
    Statement::Write_ = uDelegate::New(::TYPES[130/*Uno.Action<Outracks.Simulator.Bytecode.Statement, Uno.IO.BinaryWriter>*/], (void*)Statement___Write_fn);
    Statement::Read_ = uDelegate::New(::TYPES[131/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.Statement>*/], (void*)Statement___Read_fn);
}

static void Statement_build(uType* type)
{
    ::STRINGS[26] = uString::Const("NOP");
    ::TYPES[130] = ::g::Uno::Action2_typeof()->MakeType(Statement_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[131] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Statement_typeof());
    ::TYPES[132] = Statement_typeof()->MakeMethod(1, ::g::Uno::Char_typeof());
    ::TYPES[133] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::NoOperation_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[134] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Expression_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[135] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Return_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[136] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::NoOperation_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[137] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::NoOperation_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[138] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Expression_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[139] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Bytecode::Return_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[140] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Return_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[141] = ::g::Outracks::Simulator::Bytecode::NoOperation_typeof();
    ::TYPES[142] = ::g::Outracks::Simulator::Bytecode::Expression_typeof();
    ::TYPES[143] = ::g::Outracks::Simulator::Bytecode::Return_typeof();
    ::TYPES[144] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[145] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(Statement_typeof());
    ::TYPES[146] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(Statement_typeof());
    ::TYPES[147] = Statement_typeof()->Array();
    ::TYPES[148] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, Statement_typeof());
    type->SetFields(0,
...
void Statement__Match1_fn(Statement* __this, uType* __type, uDelegate* a1, uDelegate* a3, uDelegate* a4, uTRef __retval)
{
    ...
    ::g::Outracks::Simulator::Bytecode::NoOperation* t1 = uAs< ::g::Outracks::Simulator::Bytecode::NoOperation*>(self, ::TYPES[141/*Outracks.Simulator.Bytecode.NoOperation*/]);

    if (t1 != NULL)
        return __retval.Store((uPtr(a1)->Invoke(&ret8, 1, t1), ret8)), void();

    ::g::Outracks::Simulator::Bytecode::Expression* t3 = uAs< ::g::Outracks::Simulator::Bytecode::Expression*>(self, ::TYPES[142/*Outracks.Simulator.Bytecode.Expression*/]);

    if (t3 != NULL)
        return __retval.Store((uPtr(a3)->Invoke(&ret9, 1, t3), ret9)), void();

    ::g::Outracks::Simulator::Bytecode::Return* t4 = uAs< ::g::Outracks::Simulator::Bytecode::Return*>(self, ::TYPES[143/*Outracks.Simulator.Bytecode.Return*/]);
...
Statement* Statement::Nop()
{
    ...
    return ::g::Outracks::Simulator::Bytecode::NoOperation::New1((::g::Outracks::Simulator::Bytecode::Optional1__op_Implicit1_fn(::TYPES[144/*Outracks.Simulator.Bytecode.Optional<string>*/], ::STRINGS[26/*"NOP"*/], &ret11), ret11));
}
...
uObject* Statement::op_Addition(Statement* left, Statement* right)
{
    ...
    Statement_typeof()->Init();
    return (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[146/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.Bytecode.Statement>*/], uArray::Init<Statement*>(::TYPES[147/*Outracks.Simulator.Bytecode.Statement[]*/], 2, left, right)));
}
...
uObject* Statement::op_Addition1(Statement* statement, uObject* statements)
{
    ...
    Statement_typeof()->Init();
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[148/*Uno.Collections.EnumerableExtensions.Union<Outracks.Simulator.Bytecode.Statement>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[146/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.Bytecode.Statement>*/], uArray::Init<Statement*>(::TYPES[147/*Outracks.Simulator.Bytecode.Statement[]*/], 1, statement))), statements);
}
...
uObject* Statement::op_Addition2(uObject* statements, Statement* statement)
{
    ...
    Statement_typeof()->Init();
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[148/*Uno.Collections.EnumerableExtensions.Union<Outracks.Simulator.Bytecode.Statement>*/], statements, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[146/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.Bytecode.Statement>*/], uArray::Init<Statement*>(::TYPES[147/*Outracks.Simulator.Bytecode.Statement[]*/], 1, statement))));
}
// }
...
static void StringLiteral_build(uType* type)
{
    ...
    ::TYPES[108] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[149] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof());
    ::TYPES[144] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[150] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[151] = ::g::Outracks::Simulator::Bytecode::OptionalExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[152] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
StringLiteral* StringLiteral::Read3(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::Bytecode::Optional1<uStrong<uString*> > ret2;
    ::g::Outracks::Simulator::Bytecode::Optional1<uStrong<uString*> > maybeString = (::g::Outracks::Simulator::Bytecode::Optional__Read1_fn(::TYPES[108/*Outracks.Simulator.Bytecode.Optional.Read<string>*/], reader, uDelegate::New(::TYPES[149/*Uno.Func<Uno.IO.BinaryReader, string>*/], (void*)StringLiteral__ReadString_fn), &ret2), ret2);
    return StringLiteral::New1(maybeString.HasValue(::TYPES[144/*Outracks.Simulator.Bytecode.Optional<string>*/]) ? (uString*)maybeString.Value(::TYPES[144/*Outracks.Simulator.Bytecode.Optional<string>*/]) : NULL);
}
...
void StringLiteral::Write3(StringLiteral* l, ::g::Uno::IO::BinaryWriter* writer)
{
    ...
    ::g::Outracks::Simulator::Bytecode::Optional__Write_fn(::TYPES[150/*Outracks.Simulator.Bytecode.Optional.Write<string>*/], writer, uCRef(::g::Outracks::Simulator::Bytecode::OptionalExtensions::ToOptional(::TYPES[151/*Outracks.Simulator.Bytecode.OptionalExtensions.ToOptional<string>*/], uPtr(l)->StringValue)), uDelegate::New(::TYPES[152/*Uno.Action<string, Uno.IO.BinaryWriter>*/], (void*)StringLiteral__WriteString_fn));
}
...
{
    TypeName::Write_ = uDelegate::New(::TYPES[153/*Uno.Action<Outracks.Simulator.Bytecode.TypeName, Uno.IO.BinaryWriter>*/], (void*)TypeName___Write_fn);
    TypeName::Read_ = uDelegate::New(::TYPES[154/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.TypeName>*/], (void*)TypeName___Read_fn);
}
...
static void TypeName_build(uType* type)
{
    ...
    ::TYPES[153] = ::g::Uno::Action2_typeof()->MakeType(TypeName_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[154] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), TypeName_typeof());
    ::TYPES[155] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::NamespaceName_typeof());
    ::TYPES[156] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[157] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::NamespaceName_typeof());
    ::TYPES[158] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[159] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[160] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(TypeName_typeof());
    ::TYPES[161] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(TypeName_typeof());
    ::TYPES[162] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::NamespaceName_typeof());
    ::TYPES[163] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::NamespaceName_typeof());
    ::TYPES[164] = ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(TypeName_typeof());
    ::TYPES[165] = ::g::Uno::Collections::List_typeof()->MakeType(TypeName_typeof());
    ::TYPES[0] = uObject_typeof();
    ::TYPES[166] = ::g::Outracks::Simulator::StringSplitting_typeof()->MakeMethod(1, TypeName_typeof());
    type->SetInterfaces(
...
void TypeName::_Write1(::g::Uno::IO::BinaryWriter* writer)
{
    ...
    ::g::Outracks::Simulator::Bytecode::Optional__Write_fn(::TYPES[157/*Outracks.Simulator.Bytecode.Optional.Write<Outracks.Simulator.Bytecode.NamespaceName>*/], writer, uCRef(Namespace().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::NamespaceName*> > >()), ::g::Outracks::Simulator::Bytecode::NamespaceName::Write());
    uPtr(writer)->Write24(Surname);
    ::g::Outracks::Simulator::List::Write1(::TYPES[158/*Outracks.Simulator.List.Write<Outracks.Simulator.Bytecode.TypeName>*/], writer, GenericArguments, TypeName::Write());
}
...
TypeName* TypeName::Parameterize(uArray* methodArgumentTypes)
{
    ...
    return TypeName::New1(Namespace().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::NamespaceName*> > >(), Surname, (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[159/*Outracks.Simulator.List.ToImmutableList<Outracks.Simulator.Bytecode.TypeName>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[161/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.Bytecode.TypeName>*/], methodArgumentTypes))));
}
...
TypeName* TypeName::WithGenericSuffix()
{
    ...
    return TypeName::New1(Namespace().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::NamespaceName*> > >(), ::g::Uno::String::op_Addition2(Surname, (uPtr(GenericArguments)->Count() == 0) ? ::STRINGS[29/*""*/] : (uString*)::g::Uno::String::op_Addition1(::STRINGS[30/*"`"*/], uBox<int>(::TYPES[113/*int*/], uPtr(GenericArguments)->Count()))), (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::ImmutableList::Empty(::TYPES[164/*Outracks.Simulator.ImmutableList<Outracks.Simulator.Bytecode.TypeName>*/]));
}
...
TypeName* TypeName::_Read(::g::Uno::IO::BinaryReader* reader)
{
    ...
    ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::NamespaceName*> > ns = (::g::Outracks::Simulator::Bytecode::Optional__Read1_fn(::TYPES[155/*Outracks.Simulator.Bytecode.Optional.Read<Outracks.Simulator.Bytecode.NamespaceName>*/], reader, ::g::Outracks::Simulator::Bytecode::NamespaceName::Read(), &ret6), ret6);
    uString* surname = uPtr(reader)->ReadString();
    ::g::Outracks::Simulator::ImmutableList* genericArguments = (::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::Read(::TYPES[156/*Outracks.Simulator.List.Read<Outracks.Simulator.Bytecode.TypeName>*/], reader, TypeName::Read());
...
uObject* TypeName::ParseGenericArguments(uString* argumentList)
{
    ...
    TypeName_typeof()->Init();
    ::g::Uno::Collections::List* types = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[165/*Uno.Collections.List<Outracks.Simulator.Bytecode.TypeName>*/]);
    int indent = 0;
    int nameStart = 0;
...
static void Variable__cctor__fn(uType* __type)
{
    ...
    Variable::Write_ = uDelegate::New(::TYPES[167/*Uno.Action<Outracks.Simulator.Bytecode.Variable, Uno.IO.BinaryWriter>*/], (void*)Variable___Write_fn);
    Variable::Read_ = uDelegate::New(::TYPES[168/*Uno.Func<Uno.IO.BinaryReader, Outracks.Simulator.Bytecode.Variable>*/], (void*)Variable___Read_fn);
}

static void Variable_build(uType* type)
{
    ::STRINGS[33] = uString::Const("this");
    ::TYPES[167] = ::g::Uno::Action2_typeof()->MakeType(Variable_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[168] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Variable_typeof());
    ::TYPES[0] = uObject_typeof();
    type->SetInterfaces(
