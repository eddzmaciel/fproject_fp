...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Time\$.uno
// ----------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Time\Utilities\$.uno
// --------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Time\Timezones\$.uno
// --------------------------------------------------------------------------
...
void LocalTime__Equals_fn(LocalTime* __this, uType* __type, uObject* obj, bool* __retval)
{
    ...
    if (uIs(obj, LocalTime_typeof()))
        return *__retval = LocalTime__op_Equality(*__this, uUnbox<LocalTime>(LocalTime_typeof(), obj)), void();
...
void LocalTime__GetHashCode_fn(LocalTime* __this, uType* __type, int* __retval)
{
    ...
    return *__retval = ::g::Uno::Long::GetHashCode(ticks, ::TYPES[4/*long*/]), void();
}
...
{
    ::TYPES[9] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::LocalDateTime_typeof());
    ::TYPES[3] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
    type->SetFields(0,
...
void OffsetDateTime__GetHashCode_fn(OffsetDateTime* __this, int* __retval)
{
    ...
    int ret3;
    int hash = ::g::Uno::Time::HashCodeHelper::Initialize();
    hash = (::g::Uno::Time::HashCodeHelper__Hash_fn(::TYPES[9/*Uno.Time.HashCodeHelper.Hash<Uno.Time.LocalDateTime>*/], uCRef<int>(hash), __this->_localDateTime, &ret2), ret2);
    hash = (::g::Uno::Time::HashCodeHelper__Hash_fn(::TYPES[3/*Uno.Time.HashCodeHelper.Hash<Uno.Time.Offset>*/], uCRef<int>(hash), uCRef(__this->_offset), &ret3), ret3);
    return *__retval = hash, void();
}
...
void Preconditions::CheckArgumentRange(uString* paramName, int value, int minInclusive, int maxInclusive)
{
    ...
    if ((value < minInclusive) || (value > maxInclusive))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New7(paramName, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"Value shoul...*/], uBox<int>(::TYPES[8/*int*/], minInclusive)), ::STRINGS[9/*"-"*/]), uBox<int>(::TYPES[8/*int*/], maxInclusive)), ::STRINGS[10/*"]"*/])));
}
...
void Preconditions::CheckArgumentRange1(uString* paramName, int64_t value, int64_t minInclusive, int64_t maxInclusive)
{
    ...
    if ((value < minInclusive) || (value > maxInclusive))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New7(paramName, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"Value shoul...*/], uBox<int64_t>(::TYPES[4/*long*/], minInclusive)), ::STRINGS[9/*"-"*/]), uBox<int64_t>(::TYPES[4/*long*/], maxInclusive)), ::STRINGS[10/*"]"*/])));
}
...
static void ZonedDateTime_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::DateTimeZone_typeof());
    ::TYPES[5] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::CalendarSystem_typeof());
    ::TYPES[9] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::LocalDateTime_typeof());
    ::TYPES[3] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
...
void ZonedDateTime__GetHashCode_fn(ZonedDateTime* __this, int* __retval)
{
    ...
    int ret9;
    int hash = ::g::Uno::Time::HashCodeHelper::Initialize();
    hash = (::g::Uno::Time::HashCodeHelper__Hash_fn(::TYPES[9/*Uno.Time.HashCodeHelper.Hash<Uno.Time.LocalDateTime>*/], uCRef<int>(hash), __this->_localDateTime, &ret7), ret7);
...
void ZonedDateTime::ctor_1(::g::Uno::Time::Instant instant, ::g::Uno::Time::DateTimeZone* zone, ::g::Uno::Time::CalendarSystem* calendar)
{
    ...
    ::g::Uno::Time::Preconditions::CheckNotNull(::TYPES[10/*Uno.Time.Preconditions.CheckNotNull<Uno.Time.DateTimeZone>*/], zone, ::STRINGS[11/*"zone"*/]);
    ::g::Uno::Time::Preconditions::CheckNotNull(::TYPES[5/*Uno.Time.Preconditions.CheckNotNull<Uno.Time.CalendarSystem>*/], calendar, ::STRINGS[2/*"calendar"*/]);
...
ZonedDateTime* ZonedDateTime::WithZone(::g::Uno::Time::DateTimeZone* targetZone)
{
    ...
    ::g::Uno::Time::Preconditions::CheckNotNull(::TYPES[10/*Uno.Time.Preconditions.CheckNotNull<Uno.Time.DateTimeZone>*/], targetZone, ::STRINGS[12/*"targetZone"*/]);
