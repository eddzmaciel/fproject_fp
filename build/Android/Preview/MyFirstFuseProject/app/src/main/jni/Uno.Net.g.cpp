...
// public generated Dns() :992
void Dns__ctor__fn(Dns* __this)
{
    __this->ctor_();
}

// public static Uno.Net.IPAddress[] GetHostAddresses(string hostNameOrAddress) :1105
void Dns__GetHostAddresses_fn(uString* hostNameOrAddress, uArray** __retval)
{
    *__retval = Dns::GetHostAddresses(hostNameOrAddress);
}

// private static Uno.Net.IPAddress[] GetHostAddressesImpl(string hostNameOrAddress) :1075
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() :1062
void Dns__GetLocalAddresses_fn(uArray** __retval)
{
    *__retval = Dns::GetLocalAddresses();
}

// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) :1026
...
// public generated Dns New() :992
void Dns__New1_fn(Dns** __retval)
{
    *__retval = Dns::New1();
}

// public generated Dns() [instance] :992
void Dns::ctor_()
{
}

// public static Uno.Net.IPAddress[] GetHostAddresses(string hostNameOrAddress) [static] :1105
...
// private static Uno.Net.IPAddress[] GetHostAddressesImpl(string hostNameOrAddress) [static] :1075
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() [static] :1062
...
// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) [static] :1026
bool Dns::JavaGetLocalAddresses(::g::Uno::Collections::List* addresses)
{
    uStackFrame __("Uno.Net.Dns", "JavaGetLocalAddresses(Uno.Collections.List<string>)");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "JavaGetLocalAddresses30", "(Ljava/lang/Object;)Z");
        ::g::Uno::Collections::List* _uaddresses=addresses;
        jobject _addresses = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box5(_uaddresses);
...
// public generated Dns New() [static] :992
Dns* Dns::New1()
{
...
// public sealed class IPAddress :48
// {
// static IPAddress() :48
    ...
    switch (__this->AddressFamily())
    {
        ...
        case 23:
        {
            ...
            if (__this->_scopeId != 0U)
                ret = ::g::Uno::String::Format(::STRINGS[9/*"{0}%{1}"*/], uArray::Init<uObject*>(::TYPES[6/*object[]*/], 2, ret, uBox<uint32_t>(::g::Uno::UInt_typeof(), __this->_scopeId)));
...
// public IPAddress(byte[] octets) [instance] :104
void IPAddress::ctor_(uArray* octets)
{
    ...
    if (uPtr(octets)->Length() == 4)
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[1/*"Invalid ip ...*/], uBox<int>(::TYPES[4/*int*/], uPtr(octets)->Length()))));
...
// public IPAddress(byte[] address, long scopeId) [instance] :118
...
// public Uno.Net.Sockets.AddressFamily get_AddressFamily() [instance] :88
...
// public byte[] GetAddressBytes() [instance] :200
...
// public long get_ScopeId() [instance] :87
...
// private static extern string IPv6AddressToString(byte[] bytes) [static] :208
...
// public IPAddress New(byte[] octets) [static] :104
...
// public IPAddress New(byte[] address, long scopeId) [static] :118
...
// public static Uno.Net.IPAddress Parse(string address) [static] :150
IPAddress* IPAddress::Parse(uString* address)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(address), uArray::Init<int>(::TYPES[5/*char[]*/], 1, '.'));
...
// private static extern byte[] ParseIPv6Address(string address) [static] :137
...
void IPEndPoint__ToString_fn(IPEndPoint* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(uPtr(__this->Address())->ToString(), ::STRINGS[11/*":"*/]), uBox<int>(::TYPES[4/*int*/], __this->Port())), void();
}
