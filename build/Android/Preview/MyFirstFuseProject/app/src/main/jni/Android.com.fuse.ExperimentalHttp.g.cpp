...
// C:\ProgramData\Uno\Packages\Uno.Net.Http\0.33.1\Implementation\Android\ExperimentalHttp\$.uno
// ---------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "Abort()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseHeader(Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseHeaders()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseStatus()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseString()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SendAsync()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SendAsyncBuf(Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SendAsyncStr(Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SetHeader(Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper)");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SetResponseType(int)");
    int arg0_ = arg0;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SetTimeout(int)");
    int arg0_ = arg0;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "_Init()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "_InitProxy()");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "_IsThisType(Android.Base.Wrappers.IJWrapper)");
    int N = 44;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "Abort_IMPL_44305(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseHeader_IMPL_44307(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseHeaders_IMPL_44308(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseStatus_IMPL_44306(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "GetResponseString_IMPL_44297(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "HttpRequest_IMPL_44284(Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(HttpRequest::_javaClass1(),HttpRequest::_Init1());
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "InstallCache(Android.Base.Wrappers.IJWrapper,long)");
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "InstallCache_IMPL_44279(Android.Base.Wrappers.IJWrapper,long)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SendAsync_IMPL_44299(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SendAsyncBuf_IMPL_44300(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    CLASS_INIT(HttpRequest::_javaClass1(),HttpRequest::_Init1());
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SendAsyncStr_IMPL_44301(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    CLASS_INIT(HttpRequest::_javaClass1(),HttpRequest::_Init1());
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SetHeader_IMPL_44293(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    jobject _obArg3 = ((!arg3_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg3_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    CLASS_INIT(HttpRequest::_javaClass1(),HttpRequest::_Init1());
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SetResponseType_IMPL_44292(bool,Android.Base.Primitives.ujobject,int)");
    INIT_JNI;
...
{
    uStackFrame __("Android.com.fuse.ExperimentalHttp.HttpRequest", "SetTimeout_IMPL_44294(bool,Android.Base.Primitives.ujobject,int)");
    INIT_JNI;
