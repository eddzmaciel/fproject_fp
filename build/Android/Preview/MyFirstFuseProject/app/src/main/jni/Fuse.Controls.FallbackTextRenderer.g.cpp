...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Primitives\0.33.5\TextControls\FallbackTextRenderer\$.uno
// ---------------------------------------------------------------------------------------------------
...
static void DefaultTextRenderer_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Content::Fonts::TextShader_typeof();
    ::TYPES[3] = ::g::Uno::Content::Fonts::TextTransform_typeof();
    type->SetFields(0,
        ...
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(DefaultTextRenderer__FontKey_typeof(), ::g::Uno::Content::Fonts::BitmapFont_typeof()), (uintptr_t)&::g::Fuse::Controls::FallbackTextRenderer::DefaultTextRenderer::_bitmapFonts_, uFieldFlagsStatic,
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer", ".ctor(Uno.Content.Fonts.FontFace)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer", "get_FontFace()");
    return _FontFace;
}
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer", "set_FontFace(Uno.Content.Fonts.FontFace)");
    _FontFace = value;
}
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer.FontKey", ".ctor(Uno.Content.Fonts.FontFace,int)");
    FontFace = fontFace;
    Size = size;
}
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.ProperTextTransform", "get_Matrix()");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.ProperTextTransform", "set_Matrix(float4x4)");
...
void ProperTextTransform__ResolveClipSpaceMatrix_fn(ProperTextTransform* __this, ::g::Uno::Float4x4* __retval)
{
    ...
    return *__retval = ::g::Uno::Matrix::Mul8(__this->Matrix(), ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(uPtr(__this->DrawContext)->Viewport()), ::TYPES[4/*Fuse.IRenderViewport*/]))), void();
}

// public generated ProperTextTransform() [instance] :184
void ProperTextTransform::ctor_1()
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.ProperTextTransform", ".ctor()");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.RectExtensions", "MoveRectInsideRect(Uno.Rect,Uno.Rect)");
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.RectExtensions", "MoveRectToContainRect(Uno.Rect,Uno.Rect)");
    ::g::Uno::Float2 pos = a.Position();
    float newX = pos.X;
    float newY = pos.Y;
...
// internal sealed class TextRenderer :284
// {
// static TextRenderer() :284
static void TextRenderer__cctor__fn(uType* __type)
{
    TextRenderer::_textRenderers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[5/*Uno.Collections.Dictionary<Fuse.Font, Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer>*/]));
}

static void TextRenderer_build(uType* type)
{
    ::STRINGS[1] = uString::Const("");
    ::TYPES[5] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Font_typeof(), ::g::Fuse::Controls::FallbackTextRenderer::DefaultTextRenderer_typeof());
    ::TYPES[6] = ::g::Uno::Int_typeof();
    ::TYPES[7] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[8] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::FallbackTextRenderer::WrappedLine_typeof());
    ::TYPES[9] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::FallbackTextRenderer::WrappedLine_typeof());
    ::TYPES[10] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::FallbackTextRenderer::WrappedLine_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Font_typeof(), ::g::Fuse::Controls::FallbackTextRenderer::DefaultTextRenderer_typeof()), (uintptr_t)&::g::Fuse::Controls::FallbackTextRenderer::TextRenderer::_textRenderers_, uFieldFlagsStatic);
}
...
// public Uno.Rect GetRenderBounds() :447
void TextRenderer__GetRenderBounds_fn(TextRenderer* __this, ::g::Uno::Rect* __retval)
{
    *__retval = __this->GetRenderBounds();
}

// internal static Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer GetTextRenderer(Fuse.Font f) :294
...
// private void InitWrap(float wrapWidth, string value, bool useMin) :332
...
// public TextRenderer(Fuse.Controls.TextControl text) [instance] :287
void TextRenderer::ctor_(::g::Fuse::Controls::TextControl* text)
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.TextRenderer", ".ctor(Fuse.Controls.TextControl)");
    Control = text;
}

// public void Arrange(float2 position, float2 size) [instance] :425
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :405
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :315
...
// public Uno.Rect GetRenderBounds() [instance] :447
::g::Uno::Rect TextRenderer::GetRenderBounds()
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.TextRenderer", "GetRenderBounds()");
    return ::g::Uno::Rect__Translate(_textBounds, _position);
}

// private void InitWrap(float wrapWidth, string value, bool useMin) [instance] :332
void TextRenderer::InitWrap(float wrapWidth, uString* value, bool useMin)
{
    ...
    uArray* lines = ::g::Uno::String::Split(uPtr(value), uArray::Init<int>(::TYPES[7/*char[]*/], 1, 10));
    ::g::Uno::Collections::List* wrappedLines = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[8/*Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WrappedLine>*/]);
    ...
    if (uPtr(Control)->TextWrapping() == 1)
        ...
        for (int index2 = 0, length3 = uPtr(lines)->Length(); index2 < length3; ++index2)
        {
            ...
            uPtr(wrappedLines)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[10/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Controls.FallbackTextRenderer.WrappedLine>*/], ::g::Fuse::Controls::FallbackTextRenderer::WordWrapper::WrapLine(_wrapInfo, line))));
        }
    else
    {
        int y = 0;
...
// public void Invalidate() [instance] :442
void TextRenderer::Invalidate()
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.TextRenderer", "Invalidate()");
    _wrapInfo = NULL;
}

// public void SoftDispose() [instance] :452
void TextRenderer::SoftDispose()
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.TextRenderer", "SoftDispose()");
    _wrapInfo = NULL;
}

// private void UpdateArrange() [instance] :433
...
// internal static Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer GetTextRenderer(Fuse.Font f) [static] :294
::g::Fuse::Controls::FallbackTextRenderer::DefaultTextRenderer* TextRenderer::GetTextRenderer(::g::Fuse::Font* f)
{
    ...
    {
        tr = ::g::Fuse::Controls::FallbackTextRenderer::DefaultTextRenderer::New1(uPtr(f)->FontFace());
...
// public TextRenderer New(Fuse.Controls.TextControl text) [static] :287
...
// internal sealed class WordWrapInfo :466
// {
static void WordWrapInfo_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo, AbsoluteZoom), 0,
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo, FontSize), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo, IsEnabled), 0,
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo, LineHeight), 0,
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo, LineSpacing), 0,
        ...
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo, WrapWidth), 0);
}
...
// public WordWrapInfo(Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) :476
...
// public override sealed bool Equals(object obj) :488
...
void WordWrapInfo__GetHashCode_fn(WordWrapInfo* __this, int* __retval)
{
    ...
    float ind5;
    float ind6;
    return *__retval = (((((::g::Uno::Object::GetHashCode(uPtr(__this->TextRenderer)) ^ ::g::Uno::Bool::GetHashCode((ind1 = __this->IsEnabled, ind1), ::TYPES[11/*bool*/])) ^ ::g::Uno::Float::GetHashCode((ind2 = __this->WrapWidth, ind2), ::TYPES[12/*float*/])) ^ ::g::Uno::Float::GetHashCode((ind3 = __this->FontSize, ind3), ::TYPES[12/*float*/])) ^ ::g::Uno::Float::GetHashCode((ind4 = __this->LineHeight, ind4), ::TYPES[12/*float*/])) ^ ::g::Uno::Float::GetHashCode((ind5 = __this->LineSpacing, ind5), ::TYPES[12/*float*/])) ^ ::g::Uno::Float::GetHashCode((ind6 = __this->AbsoluteZoom, ind6), ::TYPES[12/*float*/]), void();
}

// public WordWrapInfo New(Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) :476
...
// public WordWrapInfo(Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) [instance] :476
...
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.WordWrapInfo", ".ctor(Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer,bool,float,float,float,float,float)");
...
// public WordWrapInfo New(Fuse.Controls.FallbackTextRenderer.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) [static] :476
...
// internal static class WordWrapper :548
// {
static void WordWrapper_build(uType* type)
{
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::FallbackTextRenderer::WordWrapperWord_typeof());
    ::TYPES[8] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::FallbackTextRenderer::WrappedLine_typeof());
}
...
// private static Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WordWrapperWord> GetWords(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, string text) :589
...
// private static Fuse.Controls.FallbackTextRenderer.WordWrapperWord SplitWord(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WrappedLine> wrappedLines, Fuse.Controls.FallbackTextRenderer.WordWrapperWord word, int& lineStartIndex) :616
...
// public static Fuse.Controls.FallbackTextRenderer.WrappedLine[] WrapLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, string text) :550
...
// private static Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WordWrapperWord> GetWords(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, string text) [static] :589
::g::Uno::Collections::List* WordWrapper::GetWords(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo* wrapInfo, uString* text)
{
    ...
    ::g::Uno::Collections::List* ret = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[13/*Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WordWrapperWord>*/]);
...
// private static Fuse.Controls.FallbackTextRenderer.WordWrapperWord SplitWord(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WrappedLine> wrappedLines, Fuse.Controls.FallbackTextRenderer.WordWrapperWord word, int& lineStartIndex) [static] :616
...
// public static Fuse.Controls.FallbackTextRenderer.WrappedLine[] WrapLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, string text) [static] :550
uArray* WordWrapper::WrapLine(::g::Fuse::Controls::FallbackTextRenderer::WordWrapInfo* wrapInfo, uString* text)
{
    ...
    ::g::Uno::Collections::List* ret = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[8/*Uno.Collections.List<Fuse.Controls.FallbackTextRenderer.WrappedLine>*/]);
...
// internal sealed class WordWrapperWord :526
// {
...
// public WordWrapperWord(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) :537
...
// public int get_EndIndex() :535
void WordWrapperWord__get_EndIndex_fn(WordWrapperWord* __this, int* __retval)
{
    *__retval = __this->EndIndex();
}

// public WordWrapperWord New(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) :537
...
// public WordWrapperWord(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) [instance] :537
...
// public int get_EndIndex() [instance] :535
...
// public WordWrapperWord New(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) [static] :537
...
// internal sealed class WrappedLine :655
// {
...
// public WrappedLine(string text, int lineTextStartOffset, float yOffset, float lineWidth) :664
...
// public int BoundsToPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, float p) :689
...
// public float GetXOffset(Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float absoluteZoom) :672
...
// public int get_LineTextEndOffset() :662
void WrappedLine__get_LineTextEndOffset_fn(WrappedLine* __this, int* __retval)
{
    *__retval = __this->LineTextEndOffset();
}

// public WrappedLine New(string text, int lineTextStartOffset, float yOffset, float lineWidth) :664
...
// public float PosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) :715
...
// public WrappedLine(string text, int lineTextStartOffset, float yOffset, float lineWidth) [instance] :664
void WrappedLine::ctor_(uString* text, int lineTextStartOffset, float yOffset, float lineWidth)
{
    uStackFrame __("Fuse.Controls.FallbackTextRenderer.WrappedLine", ".ctor(string,int,float,float)");
    Text = text;
...
// public int BoundsToPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, float p) [instance] :689
...
// public float GetXOffset(Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float absoluteZoom) [instance] :672
...
// public int get_LineTextEndOffset() [instance] :662
...
// public float PosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance] :715
...
// public WrappedLine New(string text, int lineTextStartOffset, float yOffset, float lineWidth) [static] :664
