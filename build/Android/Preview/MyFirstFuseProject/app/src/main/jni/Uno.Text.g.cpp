...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Text\$.uno
// ----------------------------------------------------------------
...
{
    uStackFrame __("Uno.Text.Base64", "GetString(byte[])");
...
{
    uStackFrame __("Uno.Text.Encoding", "get_UTF8()");
...
static void StringBuilder_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        new uFunction("Append", NULL, (void*)StringBuilder__Append_fn, 0, false, StringBuilder_typeof(), 1, ::g::Uno::Char_typeof()),
        new uFunction("Append", NULL, (void*)StringBuilder__Append1_fn, 0, false, StringBuilder_typeof(), 1, ::g::Uno::Char_typeof()->Array()),
        new uFunction("Append", NULL, (void*)StringBuilder__Append2_fn, 0, false, StringBuilder_typeof(), 1, ::g::Uno::String_typeof()),
...
{
    uStackFrame __("Uno.Text.StringBuilder", "get_Length()");
    return _Length;
}
...
{
    uStackFrame __("Uno.Text.StringBuilder", "set_Length(int)");
    _Length = value;
}
...
{
    uStackFrame __("Uno.Text.StringBuilder", "get_MaxCapacity()");
    return 2147483647;
}
...
{
    uStackFrame __("Uno.Text.Utf8", "GetBytes(string)");
...
{
    uStackFrame __("Uno.Text.Utf8", "GetString(byte[])");
...
{
    uStackFrame __("Uno.Text.UTF8Decoder", ".ctor()");
    ctor_();
}
...
{
    ::TYPES[1] = ::g::Uno::Text::Decoder_typeof();
    type->Reflection.SetFunctions(1,
...
{
    uStackFrame __("Uno.Text.UTF8Encoding", "GetDecoder()");
...
{
    uStackFrame __("Uno.Text.UTF8Encoding", ".ctor()");
    ctor_();
}
