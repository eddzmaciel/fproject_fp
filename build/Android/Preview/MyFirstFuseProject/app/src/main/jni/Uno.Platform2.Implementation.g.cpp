...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Platform2\Implementation\$.uno
// ------------------------------------------------------------------------------------
...
{
    uStackFrame __("Uno.Platform2.Implementation.InvokedFromNativeCodeAttribute", ".ctor()");
    ctor_();
}
