...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Primitives\0.33.5\TextControls\FallbackTextEdit\$.uno
// -----------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.DegreeSpan", ".ctor(float,float)");
    _a = a;
    _b = b;
}
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.DegreeSpan", "IsWithinBounds(float)");
    float angle1 = _a;
    float angle2 = _b;
...
static void LineCache_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Controls::FallbackTextEdit::LineCacheLine_typeof());
    ::TYPES[3] = ::g::Uno::Delegate_typeof();
    ::TYPES[4] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Controls::FallbackTextEdit::LineCacheLine_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::FallbackTextEdit::LineCacheLine_typeof());
    type->SetFields(0,
...
// public LineCache(Uno.Action onTextChanged, Uno.Action invalideLayout) :150
...
// public Fuse.Controls.FallbackTextEdit.TextPosition BoundsToTextPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p) :428
...
// private Uno.Collections.List<Fuse.Controls.FallbackTextEdit.LineCacheLine> DecomposeLines(string text) :510
...
// public Fuse.Controls.FallbackTextEdit.TextPosition DeleteSpan(Fuse.Controls.FallbackTextEdit.TextSpan s) :218
...
// public Fuse.Controls.FallbackTextEdit.TextPosition End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) :408
...
// public float2 GetBoundsSize(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) :413
...
// public Fuse.Controls.FallbackTextEdit.TextSpan GetFullTextSpan() :465
...
// public Fuse.Controls.FallbackTextEdit.TextPosition GetLastTextPos() :460
...
// public string GetString(Fuse.Controls.FallbackTextEdit.TextSpan s) :470
...
// public Fuse.Controls.FallbackTextEdit.TextPosition Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) :403
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertChar(Fuse.Controls.FallbackTextEdit.TextPosition p, char c) :158
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertNewline(Fuse.Controls.FallbackTextEdit.TextPosition p) :165
...
// public LineCache New(Uno.Action onTextChanged, Uno.Action invalideLayout) :150
...
// private int NextWordLeft(string str, int startIdx) :293
...
// private int NextWordRight(string str, int startIdx) :340
...
// public float2 TextPosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) :449
...
// public Fuse.Controls.FallbackTextEdit.LineCacheTransform get_Transform() :137
void LineCache__get_Transform_fn(LineCache* __this, uObject** __retval)
{
    *__retval = __this->Transform();
}

// public void set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform value) :138
void LineCache__set_Transform_fn(LineCache* __this, uObject* value)
{
    __this->Transform(value);
}

// public Fuse.Controls.FallbackTextEdit.TextPosition TryBackspace(Fuse.Controls.FallbackTextEdit.TextPosition p) :197
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryDelete(Fuse.Controls.FallbackTextEdit.TextPosition p) :175
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveDown(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) :394
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) :253
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) :279
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordRight(Fuse.Controls.FallbackTextEdit.TextPosition p) :326
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveRight(Fuse.Controls.FallbackTextEdit.TextPosition p) :266
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveUp(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) :385
...
// public LineCache(Uno.Action onTextChanged, Uno.Action invalideLayout) [instance] :150
void LineCache::ctor_(uDelegate* onTextChanged, uDelegate* invalideLayout)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", ".ctor(Uno.Action,Uno.Action)");
    _isTextValid = true;
...
// public Fuse.Controls.FallbackTextEdit.TextPosition BoundsToTextPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p) [instance] :428
...
// private Uno.Collections.List<Fuse.Controls.FallbackTextEdit.LineCacheLine> DecomposeLines(string text) [instance] :510
...
// public Fuse.Controls.FallbackTextEdit.TextPosition DeleteSpan(Fuse.Controls.FallbackTextEdit.TextSpan s) [instance] :218
...
// public Fuse.Controls.FallbackTextEdit.TextPosition End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :408
...
// public float2 GetBoundsSize(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) [instance] :413
...
// public Fuse.Controls.FallbackTextEdit.TextSpan GetFullTextSpan() [instance] :465
...
// public Fuse.Controls.FallbackTextEdit.TextPosition GetLastTextPos() [instance] :460
...
// public string GetString(Fuse.Controls.FallbackTextEdit.TextSpan s) [instance] :470
...
// public Fuse.Controls.FallbackTextEdit.TextPosition Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :403
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertChar(Fuse.Controls.FallbackTextEdit.TextPosition p, char c) [instance] :158
...
// public Fuse.Controls.FallbackTextEdit.TextPosition InsertNewline(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :165
...
// private void InvalidateLayout() [instance] :504
...
// private void InvalidateText([bool noChange]) [instance] :495
...
// public void InvalidateVisual() [instance] :489
...
// public bool get_IsMultiline() [instance] :122
bool LineCache::IsMultiline()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "get_IsMultiline()");
    return _isMultiline;
}

// public void set_IsMultiline(bool value) [instance] :123
void LineCache::IsMultiline(bool value)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "set_IsMultiline(bool)");
...
// private bool IsWordBreaker(char c) [instance] :373
bool LineCache::IsWordBreaker(uChar c)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "IsWordBreaker(char)");
...
// private int NextWordLeft(string str, int startIdx) [instance] :293
...
// private int NextWordRight(string str, int startIdx) [instance] :340
...
uString* LineCache::Text()
{
    ...
    if (!_isTextValid)
    {
        _text = uPtr((::g::Uno::Collections::EnumerableExtensions__First_fn(::TYPES[4/*Uno.Collections.EnumerableExtensions.First<Fuse.Controls.FallbackTextEdit.LineCacheLine>*/], (uObject*)Lines(), &ret37), ret37))->Text();
...
// public float2 TextPosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :449
...
// public Fuse.Controls.FallbackTextEdit.LineCacheTransform get_Transform() [instance] :137
uObject* LineCache::Transform()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", "get_Transform()");
    return _transform;
}

// public void set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform value) [instance] :138
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryBackspace(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :197
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryDelete(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :175
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveDown(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :394
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :253
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordLeft(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :279
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveOneWordRight(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :326
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveRight(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :266
...
// public Fuse.Controls.FallbackTextEdit.TextPosition TryMoveUp(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :385
...
// public LineCache New(Uno.Action onTextChanged, Uno.Action invalideLayout) [static] :150
...
// internal sealed class LineCacheLine :544
// {
static void LineCacheLine_build(uType* type)
{
    ::TYPES[6] = uObject_typeof();
    ::TYPES[7] = ::g::Fuse::Controls::FallbackTextRenderer::WrappedLine_typeof()->Array();
    ::TYPES[8] = ::g::Fuse::Controls::FallbackTextEdit::LineCacheTransform_typeof();
    type->SetFields(0,
        ...
        ::g::Fuse::Controls::FallbackTextRenderer::WrappedLine_typeof()->Array(), offsetof(::g::Fuse::Controls::FallbackTextEdit::LineCacheLine, _wrappedLinesCache), 0);
}
...
// public LineCacheLine(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform) :600
void LineCacheLine__ctor__fn(LineCacheLine* __this, uString* text, uObject* transform)
{
    __this->ctor_(text, transform);
}

// public int Backspace(int p) :618
void LineCacheLine__Backspace_fn(LineCacheLine* __this, int* p, int* __retval)
{
    *__retval = __this->Backspace(*p);
}

// public int BoundsToPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p) :634
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine BoundsToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, float2 p) :657
...
// public void Delete(int p) :613
void LineCacheLine__Delete_fn(LineCacheLine* __this, int* p)
{
    __this->Delete(*p);
}

// public int End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) :629
...
// public float GetTotalHeight(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) :651
...
// public Fuse.Controls.FallbackTextRenderer.WrappedLine[] GetWrappedLines(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) :584
...
// public int Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) :624
...
// public void InsertChar(int p, char c) :606
void LineCacheLine__InsertChar_fn(LineCacheLine* __this, int* p, uChar* c)
{
    __this->InsertChar(*p, *c);
}

// public void Invalidate() :691
void LineCacheLine__Invalidate_fn(LineCacheLine* __this)
{
    __this->Invalidate();
}

// public LineCacheLine New(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform) :600
...
// public float2 PosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, int p) :642
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine PosToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) :677
...
// public string get_Text() :549
void LineCacheLine__get_Text_fn(LineCacheLine* __this, uString** __retval)
{
    *__retval = __this->Text();
}

// public void set_Text(string value) :550
void LineCacheLine__set_Text_fn(LineCacheLine* __this, uString* value)
{
    __this->Text(value);
}

// public Fuse.Controls.FallbackTextEdit.LineCacheTransform get_Transform() :563
void LineCacheLine__get_Transform_fn(LineCacheLine* __this, uObject** __retval)
{
    *__retval = __this->Transform();
}

// public void set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform value) :564
void LineCacheLine__set_Transform_fn(LineCacheLine* __this, uObject* value)
{
    __this->Transform(value);
}

// public string get_VisualText() :573
void LineCacheLine__get_VisualText_fn(LineCacheLine* __this, uString** __retval)
{
    *__retval = __this->VisualText();
}

// public LineCacheLine(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform) [instance] :600
void LineCacheLine::ctor_(uString* text, uObject* transform)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", ".ctor(string,Fuse.Controls.FallbackTextEdit.LineCacheTransform)");
    _text = text;
    _transform = transform;
}

// public int Backspace(int p) [instance] :618
...
// public int BoundsToPos(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, float2 p) [instance] :634
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine BoundsToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, float2 p) [instance] :657
...
// public void Delete(int p) [instance] :613
...
// public int End(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance] :629
...
// public float GetTotalHeight(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) [instance] :651
...
// public Fuse.Controls.FallbackTextRenderer.WrappedLine[] GetWrappedLines(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo) [instance] :584
...
// public int Home(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance] :624
...
// public void InsertChar(int p, char c) [instance] :606
...
// public void Invalidate() [instance] :691
void LineCacheLine::Invalidate()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "Invalidate()");
    _wrappedLinesCache = NULL;
}

// public float2 PosToBounds(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.TextAlignment textAlignment, float boundsWidth, int p) [instance] :642
...
// private Fuse.Controls.FallbackTextRenderer.WrappedLine PosToWrappedLine(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, int p) [instance] :677
...
// public string get_Text() [instance] :549
uString* LineCacheLine::Text()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "get_Text()");
    return _text;
}

// public void set_Text(string value) [instance] :550
...
// public Fuse.Controls.FallbackTextEdit.LineCacheTransform get_Transform() [instance] :563
uObject* LineCacheLine::Transform()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "get_Transform()");
    return _transform;
}

// public void set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform value) [instance] :564
void LineCacheLine::Transform(uObject* value)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "set_Transform(Fuse.Controls.FallbackTextEdit.LineCacheTransform)");
    _transform = value;
    Invalidate();
}

// public string get_VisualText() [instance] :573
uString* LineCacheLine::VisualText()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCacheLine", "get_VisualText()");

    if (_transform != NULL)
        return ::g::Fuse::Controls::FallbackTextEdit::LineCacheTransform::Transform(uInterface(uPtr(_transform), ::TYPES[8/*Fuse.Controls.FallbackTextEdit.LineCacheTransform*/]), _text);

    return _text;
}

// public LineCacheLine New(string text, Fuse.Controls.FallbackTextEdit.LineCacheTransform transform) [static] :600
...
// internal sealed class LineCachePasswordTransform :714
// {
...
// public string Transform(string text) :724
...
// public generated LineCachePasswordTransform() [instance] :714
void LineCachePasswordTransform::ctor_()
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCachePasswordTransform", ".ctor()");
    _reveal = -1;
}

// public bool SetReveal(int r) [instance] :717
bool LineCachePasswordTransform::SetReveal(int r)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCachePasswordTransform", "SetReveal(int)");
    bool b = r != _reveal;
    _reveal = r;
    return b;
}

// public string Transform(string text) [instance] :724
...
// public generated LineCachePasswordTransform New() [static] :714
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.SwipeGestureHelper", ".ctor(float,Fuse.Controls.FallbackTextEdit.DegreeSpan[])");
    _spans = spans;
...
// internal sealed class TextPosition :749
// {
// static TextPosition() :749
...
// public TextPosition(int l, int c) :828
void TextPosition__ctor__fn(TextPosition* __this, int* l, int* c)
{
    __this->ctor_(*l, *c);
}

// public override sealed bool Equals(object obj) :834
...
// public override sealed int GetHashCode() :845
void TextPosition__GetHashCode_fn(TextPosition* __this, int* __retval)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextPosition", "GetHashCode()");
    return *__retval = __this->Line ^ __this->Char, void();
}

// public static Fuse.Controls.FallbackTextEdit.TextPosition Max(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :821
void TextPosition__Max_fn(TextPosition* a, TextPosition* b, TextPosition** __retval)
{
    *__retval = TextPosition::Max(a, b);
}

// public static Fuse.Controls.FallbackTextEdit.TextPosition Min(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :816
void TextPosition__Min_fn(TextPosition* a, TextPosition* b, TextPosition** __retval)
{
    *__retval = TextPosition::Min(a, b);
}

// public TextPosition New(int l, int c) :828
void TextPosition__New1_fn(int* l, int* c, TextPosition** __retval)
{
    *__retval = TextPosition::New1(*l, *c);
}

// public static operator ==(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :753
void TextPosition__op_Equality_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_Equality(a, b);
}

// public static operator >(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :794
void TextPosition__op_GreaterThan_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_GreaterThan(a, b);
}

// public static operator >=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :805
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :767
void TextPosition__op_Inequality_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_Inequality(a, b);
}

// public static operator <(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :772
void TextPosition__op_LessThan_fn(TextPosition* a, TextPosition* b, bool* __retval)
{
    *__retval = TextPosition::op_LessThan(a, b);
}

// public static operator <=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) :783
...
// public TextPosition(int l, int c) [instance] :828
void TextPosition::ctor_(int l, int c)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextPosition", ".ctor(int,int)");
    Line = l;
    Char = c;
}

// public static Fuse.Controls.FallbackTextEdit.TextPosition Max(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :821
...
// public static Fuse.Controls.FallbackTextEdit.TextPosition Min(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :816
...
// public TextPosition New(int l, int c) [static] :828
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :753
...
// public static operator >(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :794
...
// public static operator >=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :805
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :767
...
// public static operator <(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :772
...
// public static operator <=(Fuse.Controls.FallbackTextEdit.TextPosition a, Fuse.Controls.FallbackTextEdit.TextPosition b) [static] :783
...
// internal sealed class TextSpan :851
// {
...
// public TextSpan(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) :886
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) :909
...
// public override sealed bool Equals(object obj) :893
...
// public override sealed int GetHashCode() :904
...
// public static Fuse.Controls.FallbackTextEdit.TextSpan Intersection(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :877
void TextSpan__Intersection_fn(TextSpan* a, TextSpan* b, TextSpan** __retval)
{
    *__retval = TextSpan::Intersection(a, b);
}

// public static bool Intersects(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :872
void TextSpan__Intersects_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::Intersects(a, b);
}

// public TextSpan New(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) :886
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :853
void TextSpan__op_Equality_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::op_Equality(a, b);
}

// public static operator !=(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) :867
void TextSpan__op_Inequality_fn(TextSpan* a, TextSpan* b, bool* __retval)
{
    *__retval = TextSpan::op_Inequality(a, b);
}

// public TextSpan(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) [instance] :886
...
// public bool Contains(Fuse.Controls.FallbackTextEdit.TextPosition p) [instance] :909
...
// public static Fuse.Controls.FallbackTextEdit.TextSpan Intersection(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :877
...
// public static bool Intersects(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :872
...
// public TextSpan New(Fuse.Controls.FallbackTextEdit.TextPosition start, Fuse.Controls.FallbackTextEdit.TextPosition end) [static] :886
...
// public static operator ==(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :853
...
// public static operator !=(Fuse.Controls.FallbackTextEdit.TextSpan a, Fuse.Controls.FallbackTextEdit.TextSpan b) [static] :867
...
// internal sealed class TextWindow :925
// {
static void TextWindow_build(uType* type)
{
    ::TYPES[9] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Elements::Element_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Elements::Element_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Elements::Element_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Elements::Element_type, interface3),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(::g::Fuse::Elements::Element_type, interface4),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(::g::Fuse::Elements::Element_type, interface5),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(::g::Fuse::Elements::Element_type, interface6),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(::g::Fuse::Elements::Element_type, interface7),
...
// public TextWindow(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :929
...
// protected override sealed Fuse.VisualBounds CalcRenderBounds() :945
void TextWindow__CalcRenderBounds_fn(TextWindow* __this, ::g::Fuse::VisualBounds** __retval)
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.TextWindow", "CalcRenderBounds()");
    return *__retval = ::g::Fuse::VisualBounds::Rect(::g::Uno::Float2__New1(0.0f), __this->_textBoundsSize), void();
}

// public void Draw(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Controls.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) :950
...
// public TextWindow New(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :929
...
// protected override sealed void OnDraw(Fuse.DrawContext dc) :967
...
// public TextWindow(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [instance] :929
...
// public void Draw(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Controls.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) [instance] :950
...
// public TextWindow New(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [static] :929
