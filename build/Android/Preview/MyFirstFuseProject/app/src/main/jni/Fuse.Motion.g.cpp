...
// C:\ProgramData\Uno\Packages\Fuse.Motion\0.33.5\$.uno
// ----------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Motion\\0.33.5\\$.uno");
    ...
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::AngularAdapter_typeof();
    ::TYPES[7] = ::g::Fuse::Motion::Simulation::AdapterMultiplier_typeof();
    type->SetPrecalc(
        ::g::Fuse::Motion::Simulation::EasingMotion_typeof()->MakeType(type->T(0)),
        ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(type->T(0)),
        ::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(type->T(0)),
        ::g::Fuse::Motion::Simulation::SmoothSnap_typeof()->MakeType(type->T(0)),
        ::g::Fuse::Motion::Simulation::AngularAdapter_typeof()->MakeType(type->T(0)),
        ::g::Fuse::Motion::Simulation::AdapterMultiplier_typeof()->MakeType(type->T(0)));
    type->SetFields(0,
...
// public Fuse.Motion.MotionUnit get_Unit() :325
void DestinationMotion__get_Unit_fn(DestinationMotion* __this, int* __retval)
{
    *__retval = __this->Unit();
}

// public void set_Unit(Fuse.Motion.MotionUnit value) :326
...
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", ".ctor()");
    _type = 1;
    _easing = 15;
    _duration = 0.5f;
    _durationExp = 0.5f;
...
// internal Fuse.Motion.Simulation.DestinationSimulation<T> Create() [instance] :350
uObject* DestinationMotion::Create()
{
    uType* __types[] = {
        ...
        __type->Precalced(2/*Fuse.Motion.Simulation.ElasticForce<T>*/),
        __type->Precalced(3/*Fuse.Motion.Simulation.SmoothSnap<T>*/),
        __type->Precalced(4/*Fuse.Motion.Simulation.AngularAdapter<T>*/),
        __type->Precalced(5/*Fuse.Motion.Simulation.AdapterMultiplier<T>*/),
    };
    ...
    switch (Type())
    {
        ...
        case 1:
        {
            ::g::Fuse::Motion::Simulation::ElasticForce* q1 = (::g::Fuse::Motion::Simulation::ElasticForce*)::g::Fuse::Motion::Simulation::ElasticForce::CreateUnit(__types[3], effectiveUnit);
            dest = (uObject*)q1;
            break;
        }
        case 2:
        {
            ::g::Fuse::Motion::Simulation::SmoothSnap* q2 = (::g::Fuse::Motion::Simulation::SmoothSnap*)::g::Fuse::Motion::Simulation::SmoothSnap::CreateUnit(__types[4], effectiveUnit);
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"C:\\Program...*/], 397, ::STRINGS[2/*"Create"*/]);
            dest = (uObject*)((::g::Fuse::Motion::Simulation::ElasticForce*)::g::Fuse::Motion::Simulation::ElasticForce::CreateNormalized(__types[3]));
            break;
        }
    }

    if ((Unit() == 2) || (Unit() == 3))
        dest = (uObject*)((::g::Fuse::Motion::Simulation::AngularAdapter*)::g::Fuse::Motion::Simulation::AngularAdapter::New1(__types[5], dest));

    if (multiplier != 1.0f)
        dest = (uObject*)((::g::Fuse::Motion::Simulation::AdapterMultiplier*)::g::Fuse::Motion::Simulation::AdapterMultiplier::New1(__types[6], dest, (double)multiplier));

    return dest;
}

// public float get_Distance() [instance] :342
float DestinationMotion::Distance()
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "get_Distance()");
    return _distance;
}

// public void set_Distance(float value) [instance] :343
void DestinationMotion::Distance(float value)
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "set_Distance(float)");
    _distance = value;
    _hasDistance = true;
}

// public float get_Duration() [instance] :292
float DestinationMotion::Duration()
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "get_Duration()");
    return _duration;
}

// public void set_Duration(float value) [instance] :293
void DestinationMotion::Duration(float value)
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "set_Duration(float)");
    _duration = value;
    _hasDuration = true;
}

// public float get_DurationExp() [instance] :309
float DestinationMotion::DurationExp()
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "get_DurationExp()");
    return _durationExp;
}

// public void set_DurationExp(float value) [instance] :310
void DestinationMotion::DurationExp(float value)
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "set_DurationExp(float)");
    _durationExp = value;
}

// public Fuse.Animations.Easing get_Easing() [instance] :271
int DestinationMotion::Easing()
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "get_Easing()");
    return _easing;
}

// public void set_Easing(Fuse.Animations.Easing value) [instance] :272
void DestinationMotion::Easing(int value)
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "set_Easing(Fuse.Animations.Easing)");
    _easing = value;
...
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "get_Type()");
    return _type;
}
...
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "set_Type(Fuse.Motion.MotionDestinationType)");
...
// public Fuse.Motion.MotionUnit get_Unit() [instance] :325
int DestinationMotion::Unit()
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "get_Unit()");
    return _unit;
}

// public void set_Unit(Fuse.Motion.MotionUnit value) [instance] :326
void DestinationMotion::Unit(int value)
{
    uStackFrame __("Fuse.Motion.DestinationMotion`1", "set_Unit(Fuse.Motion.MotionUnit)");
    _unit = value;
}
...
{
    ::TYPES[8] = ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[9] = ::g::Fuse::Motion::Simulation::BoundedRegion2D_typeof();
    ::TYPES[10] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[11] = ::g::Fuse::Motion::Simulation::Friction_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetFields(0,
        ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof()), offsetof(::g::Fuse::Motion::MotionConfig, _goto), 0,
        ...
        ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof()), offsetof(::g::Fuse::Motion::MotionConfig, _snap), 0);
    type->Reflection.SetFunctions(28,
        new uFunction("get_Goto", NULL, (void*)MotionConfig__get_Goto_fn, 0, false, ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof()), 0),
        ...
        new uFunction("get_Snap", NULL, (void*)MotionConfig__get_Snap_fn, 0, false, ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof()), 0),
...
void MotionConfig__get_GotoEasing_fn(MotionConfig* __this, int* __retval)
{
    *__retval = __this->GotoEasing();
}

// public void set_GotoEasing(Fuse.Animations.Easing value) :60
void MotionConfig__set_GotoEasing_fn(MotionConfig* __this, int* value)
{
...
void MotionConfig__get_SnapEasing_fn(MotionConfig* __this, int* __retval)
{
    *__retval = __this->SnapEasing();
}

// public void set_SnapEasing(Fuse.Animations.Easing value) :104
void MotionConfig__set_SnapEasing_fn(MotionConfig* __this, int* value)
{
...
{
    uStackFrame __("Fuse.Motion.MotionConfig", ".ctor()");
    _goto = ((::g::Fuse::Motion::DestinationMotion*)::g::Fuse::Motion::DestinationMotion::New1(::TYPES[8/*Fuse.Motion.DestinationMotion<float2>*/]));
    _snap = ((::g::Fuse::Motion::DestinationMotion*)::g::Fuse::Motion::DestinationMotion::New1(::TYPES[8/*Fuse.Motion.DestinationMotion<float2>*/]));
...
void MotionConfig::CreateImpl()
{
    ...
    uPtr(_impl)->FrictionSimulation((uObject*)((::g::Fuse::Motion::Simulation::Friction*)::g::Fuse::Motion::Simulation::Friction::CreateUnit(::TYPES[11/*Fuse.Motion.Simulation.Friction<float2>*/], Unit())));
}

// public Fuse.Motion.DestinationMotion<float2> get_Goto() [instance] :46
::g::Fuse::Motion::DestinationMotion* MotionConfig::Goto()
{
    uStackFrame __("Fuse.Motion.MotionConfig", "get_Goto()");
    return _goto;
}
...
void MotionConfig::GotoEasing(int value)
{
...
{
    uStackFrame __("Fuse.Motion.MotionConfig", "get_Overflow()");
    return _overflow;
}
...
{
    uStackFrame __("Fuse.Motion.MotionConfig", "get_OverflowExtent()");
...
{
    uStackFrame __("Fuse.Motion.MotionConfig", "ReleaseSimulation()");
    _impl = NULL;
}
...
{
    uStackFrame __("Fuse.Motion.MotionConfig", "get_Snap()");
    return _snap;
}
...
void MotionConfig::SnapEasing(int value)
{
...
// public enum MotionDestinationType :438
...
static void NavigationMotion_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NavigationMotion__New2_fn, 0, true, NavigationMotion_typeof(), 0));
}
...
uType* NavigationMotion_typeof()
{
    ...
    type->SetBase(::g::Fuse::Motion::MotionConfig_typeof());
...
static void ScrollViewMotion_build(uType* type)
{
    type->SetFields(5);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ScrollViewMotion__New2_fn, 0, true, ScrollViewMotion_typeof(), 0));
}
