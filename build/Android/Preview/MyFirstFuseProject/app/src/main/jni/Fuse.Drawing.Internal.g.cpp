...
// C:\ProgramData\Uno\Packages\Fuse.Drawing\0.33.5\Internal\$.uno
// --------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Drawing.Internal.Float2Buffer", ".ctor()");
    ctor_1(8, 32);
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.Float2Buffer", "Append(double,double)");
...
{
    uStackFrame __("Fuse.Drawing.Internal.Float3Buffer", ".ctor()");
    ctor_1(12, 32);
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.Float3Buffer", "Append(double,double,double)");
...
{
    uStackFrame __("Fuse.Drawing.Internal.FloatBuffer", ".ctor()");
    ctor_1(4, 32);
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.FloatBuffer", "Append(double)");
    Append1((float)x);
}
...
{
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(MultiBuffer__Field_typeof());
    type->SetFields(6,
...
{
    uStackFrame __("Fuse.Drawing.Internal.MultiBuffer", ".ctor()");
...
{
    uStackFrame __("Fuse.Drawing.Internal.MultiBuffer", "AppendEnd()");
    size++;
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.MultiBuffer", "EndAlloc()");
    Init(32);
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.MultiBuffer", "get_Stride()");
    return typeSize;
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.TypedBuffer", ".ctor(int,[int])");
    typeSize = typeSize1;
    size = 0;
    Init(initSize);
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.TypedBuffer", "Clear()");
    size = 0;
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.TypedBuffer", "Count()");
    return size;
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.TypedBuffer", "GetDeviceIndex()");
    return deviceIndex;
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.TypedBuffer", "GetDeviceVertex()");
    return deviceVertex;
}
...
{
    uStackFrame __("Fuse.Drawing.Internal.UShortBuffer", ".ctor()");
    ctor_1(2, 32);
}
