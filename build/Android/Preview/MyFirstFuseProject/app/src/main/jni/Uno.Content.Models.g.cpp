...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Content\Models\$.uno
// --------------------------------------------------------------------------
...
{
    ::TYPES[4] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(ModelNode_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Content::Models::ModelDrawable_typeof());
