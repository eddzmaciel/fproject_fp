...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Time\Calendars\$.uno
// --------------------------------------------------------------------------
...
static void Era_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        Era_typeof(), (uintptr_t)&::g::Uno::Time::Calendars::Era::AnnoHegirae_, uFieldFlagsStatic,
        Era_typeof(), (uintptr_t)&::g::Uno::Time::Calendars::Era::AnnoMartyrum_, uFieldFlagsStatic,
        Era_typeof(), (uintptr_t)&::g::Uno::Time::Calendars::Era::AnnoMundi_, uFieldFlagsStatic,
        Era_typeof(), (uintptr_t)&::g::Uno::Time::Calendars::Era::AnnoPersico_, uFieldFlagsStatic,
        Era_typeof(), (uintptr_t)&::g::Uno::Time::Calendars::Era::BeforeCommon_, uFieldFlagsStatic,
        Era_typeof(), (uintptr_t)&::g::Uno::Time::Calendars::Era::Common_, uFieldFlagsStatic);
    type->Reflection.SetFields(6,
        new uField("AnnoHegirae", 1),
        new uField("AnnoMartyrum", 2),
        new uField("AnnoMundi", 3),
        new uField("AnnoPersico", 4),
        new uField("BeforeCommon", 5),
        new uField("Common", 6));
}
...
{
    uStackFrame __("Uno.Time.Calendars.Era", "ToString()");
...
{
    uStackFrame __("Uno.Time.Calendars.Era", ".ctor(string)");
    _name = name;
}
...
static void GregorianYearMonthDayCalculator_build(uType* type)
{
    ...
    type->SetFields(6,
        ::g::Uno::Int_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::MaxDaysPerMonth_, uFieldFlagsStatic,
        ::g::Uno::Long_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::MaxTotalTicksByMonth_, uFieldFlagsStatic,
        ::g::Uno::Int_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::MinDaysPerMonth_, uFieldFlagsStatic,
        ::g::Uno::Long_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::MinTotalTicksByMonth_, uFieldFlagsStatic,
        ::g::Uno::Int_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::MonthLengths_, uFieldFlagsStatic,
        ::g::Uno::Long_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::MonthStartTicks_, uFieldFlagsStatic,
        ::g::Uno::Int_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::YearStartDays_, uFieldFlagsStatic,
        ::g::Uno::Long_typeof()->Array(), (uintptr_t)&::g::Uno::Time::Calendars::GregorianYearMonthDayCalculator::YearStartTicks_, uFieldFlagsStatic);
}
...
::g::Uno::Time::Calendars::YearMonthDayCalculator_type* GregorianYearMonthDayCalculator_typeof()
{
    ...
    type->SetBase(::g::Uno::Time::Calendars::YearMonthDayCalculator_typeof());
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "CalculateStartOfYearDays(int)");
    int year_ = *year;
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "GetDaysInMonth(int,int)");
    int year_ = *year;
    int month_ = *month;
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "GetInstant(int,int,int)");
    int year_ = *year;
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "GetMonthOfYear(Uno.Time.Instant,int)");
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "GetStartOfYearInTicks(int)");
    int year_ = *year;
    int64_t ret3;
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "GetTicksFromStartOfYearToStartOfMonth(int,int)");
    int year_ = *year;
    int month_ = *month;
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", "IsLeapYear(int)");
    int year_ = *year;
...
{
    uStackFrame __("Uno.Time.Calendars.GregorianYearMonthDayCalculator", ".ctor()");
...
static void TimeOfDayCalculator_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("secondOfMinute");
    ::STRINGS[8] = uString::Const("millisecondOfSecond");
    ::STRINGS[9] = uString::Const("tickOfMillisecond");
}
...
// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) :324
void TimeOfDayCalculator__GetMillisecondOfSecond_fn(::g::Uno::Time::Instant* instant, int* __retval)
{
    *__retval = TimeOfDayCalculator::GetMillisecondOfSecond(*instant);
}

// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) :387
void TimeOfDayCalculator__GetMillisecondOfSecondFromTickOfDay_fn(int64_t* tickOfDay, int* __retval)
{
    *__retval = TimeOfDayCalculator::GetMillisecondOfSecondFromTickOfDay(*tickOfDay);
}
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) :275
void TimeOfDayCalculator__GetTicks1_fn(int* hourOfDay, int* minuteOfHour, int* secondOfMinute, int64_t* __retval)
{
    *__retval = TimeOfDayCalculator::GetTicks1(*hourOfDay, *minuteOfHour, *secondOfMinute);
}

// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) :285
...
{
    *__retval = TimeOfDayCalculator::GetTicks2(*hourOfDay, *minuteOfHour, *secondOfMinute, *millisecondOfSecond, *tickOfMillisecond);
}
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetHourOfDay(Uno.Time.Instant)");
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetHourOfDayFromTickOfDay(long)");
    return (int)(tickOfDay >> 11) / 17578125;
}

// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) [static] :324
int TimeOfDayCalculator::GetMillisecondOfSecond(::g::Uno::Time::Instant instant)
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetMillisecondOfSecond(Uno.Time.Instant)");
    return TimeOfDayCalculator::GetMillisecondOfSecondFromTickOfDay(TimeOfDayCalculator::GetTickOfDay(instant));
}

// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) [static] :387
int TimeOfDayCalculator::GetMillisecondOfSecondFromTickOfDay(int64_t tickOfDay)
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetMillisecondOfSecondFromTickOfDay(long)");
    int64_t milliSecondOfDay = tickOfDay / 10000LL;
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetMinuteOfHour(Uno.Time.Instant)");
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetMinuteOfHourFromTickOfDay(long)");
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetSecondOfMinute(Uno.Time.Instant)");
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetSecondOfMinuteFromTickOfDay(long)");
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetTickOfDay(Uno.Time.Instant)");
...
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetTicks(int,int)");
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) [static] :275
int64_t TimeOfDayCalculator::GetTicks1(int hourOfDay, int minuteOfHour, int secondOfMinute)
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetTicks(int,int,int)");
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[5/*"hourOfDay"*/], hourOfDay, 0, 23);
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[6/*"minuteOfHour"*/], minuteOfHour, 0, 59);
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[7/*"secondOfMin...*/], secondOfMinute, 0, 59);
    return (((int64_t)hourOfDay * 36000000000LL) + ((int64_t)minuteOfHour * 600000000LL)) + ((int64_t)secondOfMinute * 10000000LL);
}

// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) [static] :285
int64_t TimeOfDayCalculator::GetTicks2(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond)
{
    uStackFrame __("Uno.Time.Calendars.TimeOfDayCalculator", "GetTicks(int,int,int,int,int)");
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[5/*"hourOfDay"*/], hourOfDay, 0, 23);
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[6/*"minuteOfHour"*/], minuteOfHour, 0, 59);
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[7/*"secondOfMin...*/], secondOfMinute, 0, 59);
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[8/*"millisecond...*/], millisecondOfSecond, 0, 999);
    ::g::Uno::Time::Preconditions::CheckArgumentRange1(::STRINGS[9/*"tickOfMilli...*/], (int64_t)tickOfMillisecond, 0LL, 9999LL);
    return (((((int64_t)hourOfDay * 36000000000LL) + ((int64_t)minuteOfHour * 600000000LL)) + ((int64_t)secondOfMinute * 10000000LL)) + ((int64_t)millisecondOfSecond * 10000LL)) + (int64_t)tickOfMillisecond;
}
// }
...
{
    uStackFrame __("Uno.Time.Calendars.WeekYearCalculator", ".ctor(Uno.Time.Calendars.YearMonthDayCalculator,int)");
...
{
    ::STRINGS[10] = uString::Const("eras");
    ::STRINGS[11] = uString::Const("year");
    ::STRINGS[12] = uString::Const("monthOfYear");
    ::STRINGS[13] = uString::Const("dayOfMonth");
    ::TYPES[3] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::Calendars::Era_typeof()->Array());
    type->SetFields(0,
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetInstant(int,int,int)");
    int year_ = *year;
    int monthOfYear_ = *monthOfYear;
    int dayOfMonth_ = *dayOfMonth;
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[11/*"year"*/], year_, __this->MinYear(), __this->MaxYear());
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[12/*"monthOfYear"*/], monthOfYear_, 1, __this->GetMaxMonth(year_));
    ::g::Uno::Time::Preconditions::CheckArgumentRange(::STRINGS[13/*"dayOfMonth"*/], dayOfMonth_, 1, __this->GetDaysInMonth(year_, monthOfYear_));
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetStartOfYearInTicks(int)");
    int year_ = *year;
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", ".ctor(int,int,int,long,long,Uno.Time.Calendars.Era[])");
    _minYear = minYear;
    _maxYear = maxYear;
    _monthsInYear = monthsInYear;
    _eras = ((uArray*)::g::Uno::Time::Preconditions::CheckNotNull(::TYPES[3/*Uno.Time.Preconditions.CheckNotNull<Uno.Time.Calendars.Era[]>*/], eras, ::STRINGS[10/*"eras"*/]));
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "get_Eras()");
    return _eras;
}
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetDayOfMonth(Uno.Time.Instant)");
    ::g::Uno::Time::Instant instant_ = instant;
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetDayOfMonth(Uno.Time.Instant,int,int)");
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetMaxMonth(int)");
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetMonthOfYear(Uno.Time.Instant)");
    ::g::Uno::Time::Instant instant_ = instant;
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetTicksInYear(int)");
    int year_ = year;
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetYear(Uno.Time.Instant)");
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetYearMonthDayTicks(int,int,int)");
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "GetYearMonthTicks(int,int)");
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "get_MaxYear()");
    return _maxYear;
}
...
{
    uStackFrame __("Uno.Time.Calendars.YearMonthDayCalculator", "get_MinYear()");
    return _minYear;
}
// }
