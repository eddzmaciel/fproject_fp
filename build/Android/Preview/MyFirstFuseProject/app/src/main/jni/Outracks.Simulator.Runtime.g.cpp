...
// C:\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\Runtime\$.uno
// -----------------------------------------------------------------------------
...
static void Environment_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(Environment_typeof());
    type->SetFields(0,
...
// C:\ProgramData\Uno\Packages\Outracks.Simulator.Reflection.Uno\0.0.0\$.uno
// -------------------------------------------------------------------------
...
static void LazyProperty_build(uType* type)
{
    ...
    type->SetPrecalc(
        ::g::Outracks::Simulator::Runtime::LazyPropertyStorage_typeof()->MakeType(type->T(0)));
    type->SetFields(1,
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", type, (void*)LazyProperty__New1_fn, 0, true, type, 2, ::g::Uno::Func_typeof()->MakeType(uObject_typeof()), ::g::Uno::String_typeof()));
}
...
::g::Uno::UX::Property1_type* LazyProperty_typeof()
{
    ...
    type->SetBase(::g::Uno::UX::Property1_typeof()->MakeType(type->T(0)));
...
{
    uStackFrame __("Outracks.Simulator.Runtime.LazyProperty`1", "get_SupportsOriginSetter()");
...
static void LazyPropertyStorage_build(uType* type)
{
    ...
    ::TYPES[6] = ::g::Uno::WeakReference_typeof()->MakeType(uObject_typeof());
    ::TYPES[7] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetPrecalc(
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(type->T(0))),
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("get_Object", NULL, (void*)LazyPropertyStorage__get_Object_fn, 0, false, ::g::Uno::UX::PropertyObject_typeof(), 0),
...
void LazyPropertyStorage__OnSet_fn(LazyPropertyStorage* __this, void* value, uObject* origin)
{
    ...
    uStackFrame __("Outracks.Simulator.Runtime.LazyPropertyStorage`1", "OnSet(T,Uno.UX.IPropertyListener)");
    __this->_value() = value;
}
...
void LazyPropertyStorage::ctor_(uObject* owner)
{
    ...
    _owner = ((::g::Uno::WeakReference*)::g::Uno::WeakReference::New1(::TYPES[6/*Uno.WeakReference<object>*/], owner));
}
...
::g::Uno::UX::PropertyObject* LazyPropertyStorage::Object()
{
    ...
    return uCast< ::g::Uno::UX::PropertyObject*>(Owner(), ::TYPES[7/*Uno.UX.PropertyObject*/]);
}
...
{
    ObjectPropertyRegistry::Objects_ = ((::g::WeakDictionary*)::g::WeakDictionary::New1(::TYPES[8/*WeakDictionary<object, Uno.Collections.Dictionary<string, object>>*/]));
}

static void ObjectPropertyRegistry_build(uType* type)
{
    ::TYPES[8] = ::g::WeakDictionary_typeof()->MakeType(uObject_typeof(), ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof()));
    ::TYPES[9] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    type->SetFields(0,
...
void ObjectPropertyRegistry::RegisterProperty(uObject* obj, uString* property, uObject* propertyObject)
{
    ...
    if (!(::g::WeakDictionary__TryGetValue_fn(uPtr(ObjectPropertyRegistry::Objects()), obj, (void**)(&properties), &ret3), ret3))
        ::g::WeakDictionary__set_Item_fn(uPtr(ObjectPropertyRegistry::Objects()), obj, properties = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[9/*Uno.Collections.Dictionary<string, object>*/]));
...
{
    ObjectTagRegistry::Objects_ = ((::g::WeakDictionary*)::g::WeakDictionary::New1(::TYPES[10/*WeakDictionary<object, string>*/]));
}
...
static void ObjectTagRegistry_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::WeakDictionary_typeof()->MakeType(uObject_typeof(), ::g::Uno::String_typeof());
    ::TYPES[11] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(uObject_typeof());
    ::TYPES[12] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[13] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(uObject_typeof());
    ::TYPES[14] = ::g::Uno::Exception_typeof();
    ::TYPES[15] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[16] = ::g::Uno::Collections::List_typeof()->MakeType(::g::HashableWeakReference_typeof());
    ::TYPES[17] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::HashableWeakReference_typeof(), ::g::Uno::String_typeof()));
    ::TYPES[18] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::HashableWeakReference_typeof(), ::g::Uno::String_typeof()));
    ::TYPES[19] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::HashableWeakReference_typeof(), ::g::Uno::String_typeof());
    ::TYPES[20] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::HashableWeakReference_typeof());
    type->SetFields(0,
...
uObject* ObjectTagRegistry::GetFirstObjectWithTag(uString* tag)
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(ObjectTagRegistry::GetObjectsWithTag(tag)), ::TYPES[11/*Uno.Collections.IEnumerable<object>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
        uObject* obj = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[13/*Uno.Collections.IEnumerator<object>*/]), &ret5), ret5);
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->ToString(), 1, ::STRINGS[2/*"C:\\Program...*/], 509);
        }
    }
...
uObject* ObjectTagRegistry::GetObjectsWithTag(uString* tag)
{
    ...
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[15/*Uno.Collections.List<object>*/]);
    ::g::Uno::Collections::List* deadKeys = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[16/*Uno.Collections.List<HashableWeakReference>*/]);

    for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr((uObject*)uPtr(ObjectTagRegistry::Objects())->AsEnumerable()), ::TYPES[17/*Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<HashableWeakReference, string>>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong< ::g::HashableWeakReference*>, uStrong<uString*> > kv = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[18/*Uno.Collections.IEnumerator<Uno.Collections.KeyValuePair<HashableWeakReference, string>>*/]), &ret6), ret6);
        uObject* obj = NULL;

        if (uPtr(kv.Key(::TYPES[19/*Uno.Collections.KeyValuePair<HashableWeakReference, string>*/]))->TryGetTarget(&obj))
        {
            if (::g::Uno::String::op_Equality(kv.Value(::TYPES[19/*Uno.Collections.KeyValuePair<HashableWeakReference, string>*/]), tag))
                ::g::Uno::Collections::List__Add_fn(uPtr(list), obj);
        }
        else
            ::g::Uno::Collections::List__Add_fn(uPtr(deadKeys), kv.Key(::TYPES[19/*Uno.Collections.KeyValuePair<HashableWeakReference, string>*/]));
    }

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::HashableWeakReference*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(deadKeys, &ret7), ret7); enum4.MoveNext(::TYPES[20/*Uno.Collections.List<HashableWeakReference>.Enumerator*/]); )
    {
        ::g::HashableWeakReference* deadKey = enum4.Current(::TYPES[20/*Uno.Collections.List<HashableWeakReference>.Enumerator*/]);
...
void ObjectTagRegistry::TryExecuteOnObjectsWithTag(uString* tag, uDelegate* action)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(ObjectTagRegistry::GetObjectsWithTag(tag)), ::TYPES[11/*Uno.Collections.IEnumerable<object>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
        uObject* obj = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[13/*Uno.Collections.IEnumerator<object>*/]), &ret9), ret9);
        ...
        {
            ::g::Uno::Exception* e = __t.Exception;
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->ToString(), 1, ::STRINGS[2/*"C:\\Program...*/], 494);
        }
    }
}
// }
...
static void ScopeClosure_build(uType* type)
{
    ...
    ::TYPES[21] = ::g::Outracks::Simulator::Runtime::IReflection_typeof();
    ::TYPES[22] = uObject_typeof();
    ::TYPES[23] = ::g::Outracks::Simulator::Bytecode::Expression_typeof()->MakeMethod(1, uObject_typeof());
    ::TYPES[24] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::ReadVariable_typeof(), uObject_typeof());
    ::TYPES[25] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Literal_typeof(), uObject_typeof());
    ::TYPES[26] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Lambda_typeof(), uObject_typeof());
    ::TYPES[27] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::MethodGroup_typeof(), uObject_typeof());
    ::TYPES[28] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::IsType_typeof(), uObject_typeof());
    ::TYPES[29] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::LogicalOr_typeof(), uObject_typeof());
    ::TYPES[30] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Instantiate_typeof(), uObject_typeof());
    ::TYPES[31] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::CallLambda_typeof(), uObject_typeof());
    ::TYPES[32] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::CallStaticMethod_typeof(), uObject_typeof());
    ::TYPES[33] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::CallDynamicMethod_typeof(), uObject_typeof());
    ::TYPES[34] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::ReadStaticField_typeof(), uObject_typeof());
    ::TYPES[35] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::ReadProperty_typeof(), uObject_typeof());
    ::TYPES[36] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::WriteProperty_typeof(), uObject_typeof());
    ::TYPES[37] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::AddEventHandler_typeof(), uObject_typeof());
    ::TYPES[38] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::RemoveEventHandler_typeof(), uObject_typeof());
    ::TYPES[39] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[40] = ::g::Uno::Func_typeof()->MakeType(uObject_typeof());
    ::TYPES[41] = ::g::Uno::Func2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Lambda_typeof(), uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[42] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[43] = ::g::Uno::Func2_typeof()->MakeType(uObject_typeof(), uObject_typeof(), uObject_typeof());
    ::TYPES[44] = ::g::Uno::Func3_typeof()->MakeType(uObject_typeof(), uObject_typeof(), uObject_typeof(), uObject_typeof());
    ::TYPES[45] = ::g::Uno::Action_typeof();
    ::TYPES[46] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof());
    ::TYPES[47] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[48] = ::g::Uno::Action3_typeof()->MakeType(uObject_typeof(), uObject_typeof(), uObject_typeof());
    ::TYPES[49] = ::g::Outracks::Simulator::Bytecode::Literal_typeof()->MakeMethod(1, uObject_typeof());
    ::TYPES[50] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BooleanLiteral_typeof(), uObject_typeof());
    ::TYPES[51] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::StringLiteral_typeof(), uObject_typeof());
    ::TYPES[52] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::NumberLiteral_typeof(), uObject_typeof());
    ::TYPES[53] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::EnumLiteral_typeof(), uObject_typeof());
    ::TYPES[54] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BlobLiteral_typeof(), uObject_typeof());
    ::TYPES[55] = ::g::Uno::Bool_typeof();
    ::TYPES[2] = uObject_typeof()->Array();
    ::TYPES[56] = ::g::Uno::Delegate_typeof();
    ::TYPES[1] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Runtime::Environment_typeof());
    ::TYPES[12] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[57] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[58] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[59] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[60] = ::g::Outracks::Simulator::Bytecode::Expression_typeof();
    ::TYPES[61] = ::g::Outracks::Simulator::Bytecode::Return_typeof();
    type->SetFields(0,
...
uObject* ScopeClosure::Evaluate(::g::Outracks::Simulator::Bytecode::AddEventHandler* e)
{
    ...
    ::g::Outracks::Simulator::Runtime::IReflection::AddEventHandler(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(e)->Object), uPtr(e)->Event, Evaluate7(uPtr(e)->Handler));
    return NULL;
}
...
uObject* ScopeClosure::Evaluate2(::g::Outracks::Simulator::Bytecode::BooleanLiteral* e)
{
    ...
    return uBox(::TYPES[55/*bool*/], uPtr(e)->BooleanValue);
}
...
uObject* ScopeClosure::Evaluate3(::g::Outracks::Simulator::Bytecode::CallDynamicMethod* m)
{
    ...
    return ::g::Outracks::Simulator::Runtime::IReflection::CallDynamic(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(m)->Object), uPtr(m)->Method, Evaluate21(uPtr(m)->Arguments));
}
...
uObject* ScopeClosure::Evaluate5(::g::Outracks::Simulator::Bytecode::CallStaticMethod* m)
{
    ...
    return ::g::Outracks::Simulator::Runtime::IReflection::CallStatic(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), uPtr(uPtr(m)->StaticMethod)->TypeName, uPtr(uPtr(m)->StaticMethod)->MemberName, Evaluate21(uPtr(m)->Arguments));
}
...
uObject* ScopeClosure::Evaluate6(::g::Outracks::Simulator::Bytecode::EnumLiteral* i)
{
    ...
    return ::g::Outracks::Simulator::Runtime::IReflection::GetEnumValue(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), uPtr(uPtr(i)->Value)->TypeName, uPtr(uPtr(i)->Value)->MemberName);
}
...
uObject* ScopeClosure::Evaluate7(::g::Outracks::Simulator::Bytecode::Expression* expression)
{
    ...
    uObject* ret5;
    return (::g::Outracks::Simulator::Bytecode::Expression__Match3_fn(uPtr(expression), ::TYPES[23/*Outracks.Simulator.Bytecode.Expression.Match<object>*/], uDelegate::New(::TYPES[24/*Uno.Func<Outracks.Simulator.Bytecode.ReadVariable, object>*/], (void*)ScopeClosure__Evaluate17_fn, this), uDelegate::New(::TYPES[25/*Uno.Func<Outracks.Simulator.Bytecode.Literal, object>*/], (void*)ScopeClosure__Evaluate11_fn, this), uDelegate::New(::TYPES[26/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object>*/], (void*)ScopeClosure__Evaluate10_fn, this), uDelegate::New(::TYPES[27/*Uno.Func<Outracks.Simulator.Bytecode.MethodGroup, object>*/], (void*)ScopeClosure__Evaluate13_fn, this), uDelegate::New(::TYPES[28/*Uno.Func<Outracks.Simulator.Bytecode.IsType, object>*/], (void*)ScopeClosure__Evaluate9_fn, this), uDelegate::New(::TYPES[29/*Uno.Func<Outracks.Simulator.Bytecode.LogicalOr, object>*/], (void*)ScopeClosure__Evaluate12_fn, this), uDelegate::New(::TYPES[30/*Uno.Func<Outracks.Simulator.Bytecode.Instantiate, object>*/], (void*)ScopeClosure__Evaluate8_fn, this), uDelegate::New(::TYPES[31/*Uno.Func<Outracks.Simulator.Bytecode.CallLambda, object>*/], (void*)ScopeClosure__Evaluate4_fn, this), uDelegate::New(::TYPES[32/*Uno.Func<Outracks.Simulator.Bytecode.CallStaticMethod, object>*/], (void*)ScopeClosure__Evaluate5_fn, this), uDelegate::New(::TYPES[33/*Uno.Func<Outracks.Simulator.Bytecode.CallDynamicMethod, object>*/], (void*)ScopeClosure__Evaluate3_fn, this), uDelegate::New(::TYPES[34/*Uno.Func<Outracks.Simulator.Bytecode.ReadStaticField, object>*/], (void*)ScopeClosure__Evaluate16_fn, this), uDelegate::New(::TYPES[35/*Uno.Func<Outracks.Simulator.Bytecode.ReadProperty, object>*/], (void*)ScopeClosure__Evaluate15_fn, this), uDelegate::New(::TYPES[36/*Uno.Func<Outracks.Simulator.Bytecode.WriteProperty, object>*/], (void*)ScopeClosure__Evaluate20_fn, this), uDelegate::New(::TYPES[37/*Uno.Func<Outracks.Simulator.Bytecode.AddEventHandler, object>*/], (void*)ScopeClosure__Evaluate_fn, this), uDelegate::New(::TYPES[38/*Uno.Func<Outracks.Simulator.Bytecode.RemoveEventHandler, object>*/], (void*)ScopeClosure__Evaluate18_fn, this), &ret5), ret5);
}
...
uObject* ScopeClosure::Evaluate8(::g::Outracks::Simulator::Bytecode::Instantiate* i)
{
    ...
    return ::g::Outracks::Simulator::Runtime::IReflection::Instantiate(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), uPtr(i)->Type, Evaluate21(uPtr(i)->Arguments));
}
...
uObject* ScopeClosure::Evaluate9(::g::Outracks::Simulator::Bytecode::IsType* t)
{
    ...
    return uBox(::TYPES[55/*bool*/], uPtr(t)->IncludeSubtypes ? ::g::Outracks::Simulator::Runtime::IReflection::IsSubtype(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(t)->Object), uPtr(t)->Type) : ::g::Outracks::Simulator::Runtime::IReflection::IsType(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(t)->Object), uPtr(t)->Type));
}
...
uObject* ScopeClosure::Evaluate10(::g::Outracks::Simulator::Bytecode::Lambda* p)
{
    ...
    if ((ind3 = uPtr(uPtr(p)->Signature)->ReturnType().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Bytecode::TypeName*> > >(), (&ind3))->HasValue(::TYPES[39/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Bytecode.TypeName>*/]))

        switch (uPtr(uPtr(uPtr(p)->Signature)->Parameters)->Count())
        {
            case 0:
                return uDelegate::New(::TYPES[40/*Uno.Func<object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Func_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
            case 1:
                return uDelegate::New(::TYPES[42/*Uno.Func<object, object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Func1_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
            case 2:
                return uDelegate::New(::TYPES[43/*Uno.Func<object, object, object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Func2_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
            case 3:
                return uDelegate::New(::TYPES[44/*Uno.Func<object, object, object, object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Func3_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
        }
    else
        ...
        {
            case 0:
                return uDelegate::New(::TYPES[45/*Uno.Action*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Action_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
            case 1:
                return uDelegate::New(::TYPES[46/*Uno.Action<object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Action1_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
            case 2:
                return uDelegate::New(::TYPES[47/*Uno.Action<object, object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Action2_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
            case 3:
                return uDelegate::New(::TYPES[48/*Uno.Action<object, object, object>*/], (void*)::g::Outracks::Simulator::Runtime::LambdaClosure__Action3_fn, ::g::Outracks::Simulator::Runtime::LambdaClosure::New1(p, uDelegate::New(::TYPES[41/*Uno.Func<Outracks.Simulator.Bytecode.Lambda, object[], object>*/], (void*)ScopeClosure__Execute1_fn, this)));
        }
...
uObject* ScopeClosure::Evaluate11(::g::Outracks::Simulator::Bytecode::Literal* e)
{
    ...
    uObject* ret6;
    return (::g::Outracks::Simulator::Bytecode::Literal__Match5_fn(uPtr(e), ::TYPES[49/*Outracks.Simulator.Bytecode.Literal.Match<object>*/], uDelegate::New(::TYPES[50/*Uno.Func<Outracks.Simulator.Bytecode.BooleanLiteral, object>*/], (void*)ScopeClosure__Evaluate2_fn, this), uDelegate::New(::TYPES[51/*Uno.Func<Outracks.Simulator.Bytecode.StringLiteral, object>*/], (void*)ScopeClosure__Evaluate19_fn, this), uDelegate::New(::TYPES[52/*Uno.Func<Outracks.Simulator.Bytecode.NumberLiteral, object>*/], (void*)ScopeClosure__Evaluate14_fn, this), uDelegate::New(::TYPES[53/*Uno.Func<Outracks.Simulator.Bytecode.EnumLiteral, object>*/], (void*)ScopeClosure__Evaluate6_fn, this), uDelegate::New(::TYPES[54/*Uno.Func<Outracks.Simulator.Bytecode.BlobLiteral, object>*/], (void*)ScopeClosure__Evaluate1_fn, this), &ret6), ret6);
}
...
uObject* ScopeClosure::Evaluate12(::g::Outracks::Simulator::Bytecode::LogicalOr* o)
{
    ...
    return uBox(::TYPES[55/*bool*/], uUnbox<bool>(::TYPES[55/*bool*/], Evaluate7(uPtr(o)->Left)) || uUnbox<bool>(::TYPES[55/*bool*/], Evaluate7(uPtr(o)->Right)));
}
...
uObject* ScopeClosure::Evaluate15(::g::Outracks::Simulator::Bytecode::ReadProperty* e)
{
    ...
    return ::g::Outracks::Simulator::Runtime::IReflection::GetPropertyValue(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(e)->Object), uPtr(e)->Property);
}
...
uObject* ScopeClosure::Evaluate16(::g::Outracks::Simulator::Bytecode::ReadStaticField* e)
{
    ...
    return ::g::Outracks::Simulator::Runtime::IReflection::GetStaticPropertyOrFieldValue(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), uPtr(uPtr(e)->Field)->TypeName, uPtr(uPtr(e)->Field)->MemberName);
}
...
uObject* ScopeClosure::Evaluate18(::g::Outracks::Simulator::Bytecode::RemoveEventHandler* e)
{
    ...
    ::g::Outracks::Simulator::Runtime::IReflection::RemoveEventHandler(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(e)->Object), uPtr(e)->Event, Evaluate7(uPtr(e)->Handler));
    return NULL;
}
...
uObject* ScopeClosure::Evaluate20(::g::Outracks::Simulator::Bytecode::WriteProperty* p)
{
    ...
    ::g::Outracks::Simulator::Runtime::IReflection::SetPropertyValue(uInterface(uPtr(_reflection), ::TYPES[21/*Outracks.Simulator.Runtime.IReflection*/]), Evaluate7(uPtr(p)->Object), uPtr(p)->Property, Evaluate7(uPtr(p)->Value));
    return NULL;
}
...
uObject* ScopeClosure::Execute(uObject* lambda, uArray* arguments)
{
    ...
    uDelegate* f0 = uAs<uDelegate*>(lambda, ::TYPES[40/*Uno.Func<object>*/]);

    if (::g::Uno::Delegate::op_Inequality(f0, NULL))
        return uPtr(f0)->Invoke();

    uDelegate* f1 = uAs<uDelegate*>(lambda, ::TYPES[42/*Uno.Func<object, object>*/]);

    if (::g::Uno::Delegate::op_Inequality(f1, NULL))
        return uPtr(f1)->Invoke(1, (uObject*)uPtr(arguments)->Strong<uObject*>(0));

    uDelegate* f2 = uAs<uDelegate*>(lambda, ::TYPES[43/*Uno.Func<object, object, object>*/]);
    ...
    uDelegate* f3 = uAs<uDelegate*>(lambda, ::TYPES[44/*Uno.Func<object, object, object, object>*/]);
    ...
    uDelegate* a0 = uAs<uDelegate*>(lambda, ::TYPES[45/*Uno.Action*/]);

    if (::g::Uno::Delegate::op_Inequality(a0, NULL))
        uPtr(a0)->InvokeVoid();

    uDelegate* a1 = uAs<uDelegate*>(lambda, ::TYPES[46/*Uno.Action<object>*/]);

    if (::g::Uno::Delegate::op_Inequality(a1, NULL))
        uPtr(a1)->InvokeVoid(uPtr(arguments)->Strong<uObject*>(0));

    uDelegate* a2 = uAs<uDelegate*>(lambda, ::TYPES[47/*Uno.Action<object, object>*/]);
    ...
    uDelegate* a3 = uAs<uDelegate*>(lambda, ::TYPES[48/*Uno.Action<object, object, object>*/]);
...
uObject* ScopeClosure::Execute1(::g::Outracks::Simulator::Bytecode::Lambda* lambda, uArray* arguments)
{
    ...
    for (uObject* enum1 = (uObject*)uPtr(lambda->LocalVariables)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Outracks::Simulator::Bytecode::BindVariable* b = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[57/*Uno.Collections.IEnumerator<Outracks.Simulator.Bytecode.BindVariable>*/]), &ret9), ret9);
...
uObject* ScopeClosure::Execute2(uObject* statements)
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(statements), ::TYPES[58/*Uno.Collections.IEnumerable<Outracks.Simulator.Bytecode.Statement>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Outracks::Simulator::Bytecode::Statement* statement = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[59/*Uno.Collections.IEnumerator<Outracks.Simulator.Bytecode.Statement>*/]), &ret10), ret10);
        ::g::Outracks::Simulator::Bytecode::Expression* e = uAs< ::g::Outracks::Simulator::Bytecode::Expression*>(statement, ::TYPES[60/*Outracks.Simulator.Bytecode.Expression*/]);

        if (e != NULL)
            Evaluate7(e);

        ::g::Outracks::Simulator::Bytecode::Return* r = uAs< ::g::Outracks::Simulator::Bytecode::Return*>(statement, ::TYPES[61/*Outracks.Simulator.Bytecode.Return*/]);
...
void Selection::Each(uDelegate* action)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Items()), ::TYPES[11/*Uno.Collections.IEnumerable<object>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[12/*Uno.Collections.IEnumerator*/])); )
    {
        uObject* obj = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[13/*Uno.Collections.IEnumerator<object>*/]), &ret3), ret3);
        ...
        {
            ::g::Uno::Exception* e = __t.Exception;
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->ToString(), 1, ::STRINGS[2/*"C:\\Program...*/], 586);
        }
    }
}
