...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Content\Splines\$.uno
// ---------------------------------------------------------------------------
...
// public Key(double time, TData value) :53
void KeyframedSpline__Key__ctor__fn(uTRef __this, uType* __type, double* time, void* value)
{
    uType* __types[] = {
        __type->GetBase(KeyframedSpline__Key_typeof())->T(1),
    };
    uStackFrame __("Uno.Content.Splines.KeyframedSpline`2.Key", ".ctor(double,TData)");
...
// public Key New(double time, TData value) :53
...
// public abstract class KeyframedSpline<TValue, TData> :44
// {
static void KeyframedSpline_build(uType* type)
{
    ...
    type->SetPrecalc(
        ::g::Uno::Collections::List_typeof()->MakeType(KeyframedSpline__Key_typeof()->MakeType(type->T(0), type->T(1))),
        KeyframedSpline__Key_typeof()->MakeType(type->T(0), type->T(1)));
    type->SetFields(0,
        ::g::Uno::Int_typeof(), offsetof(::g::Uno::Content::Splines::KeyframedSpline, cache), 0,
        ::g::Uno::Collections::List_typeof()->MakeType(KeyframedSpline__Key_typeof()->MakeType(type->T(0), type->T(1))), offsetof(::g::Uno::Content::Splines::KeyframedSpline, keys), 0);
...
::g::Uno::Content::Splines::Spline_type* KeyframedSpline_typeof()
{
    ...
    type->SetBase(::g::Uno::Content::Splines::Spline_typeof()->MakeType(type->T(0)));
...
void KeyframedSpline__AddKey_fn(KeyframedSpline* __this, double* time, void* value, int* __retval)
{
    ...
    ::g::Uno::Collections::List__Insert_fn(uPtr(__this->keys), uCRef<int>(i), (KeyframedSpline__Key__New1_fn(__types[1], uCRef(time_), value_, &ret2), ret2));
    return *__retval = i, void();
}

// public void ClearKeys() :138
void KeyframedSpline__ClearKeys_fn(KeyframedSpline* __this)
{
    __this->ClearKeys();
}

// public override sealed double get_End() :80
...
// public TData FindValue(double time) :180
...
// public void FindValues(double time, TData& a, TData& b, float& p) :194
void KeyframedSpline__FindValues_fn(KeyframedSpline* __this, double* time, uTRef a, uTRef b, float* p)
{
    ...
    uT ka(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT kb(__types[1], U_ALLOCA(__types[1]->ValueSize));
    double time_ = *time;
    ...
    if (ka[0/*Time*/].Value<double>() == kb[0/*Time*/].Value<double>())
        ...
        *p = KeyframedSpline::Map(KeyframedSpline_typeof()->MakeType(__types[2], __types[0]), ka[0/*Time*/].Value<double>(), kb[0/*Time*/].Value<double>(), time_);
}

// public void FindValues(double time, TData& a, TData& b, TData& c, TData& d, float& p) :209
void KeyframedSpline__FindValues1_fn(KeyframedSpline* __this, double* time, uTRef a, uTRef b, uTRef c, uTRef d, float* p)
{
    ...
    uT ret14(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT ret15(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT ka(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT kb(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT kc(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT kd(__types[1], U_ALLOCA(__types[1]->ValueSize));
    double time_ = *time;
    int i = __this->FindLeftIndex(time_);
    ...
    if (kb[0/*Time*/].Value<double>() == kc[0/*Time*/].Value<double>())
        ...
        *p = KeyframedSpline::Map(KeyframedSpline_typeof()->MakeType(__types[2], __types[0]), kb[0/*Time*/].Value<double>(), kc[0/*Time*/].Value<double>(), time_);
}

// public double GetTime(int index) :154
void KeyframedSpline__GetTime_fn(KeyframedSpline* __this, int* index, double* __retval)
{
    *__retval = __this->GetTime(*index);
}

// public TData GetValue(int index) :149
...
// public void SetValue(int index, TData value) :159
void KeyframedSpline__SetValue_fn(KeyframedSpline* __this, int* index, void* value)
{
    ...
    uT ret24(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT ret25(__types[1], U_ALLOCA(__types[1]->ValueSize));
    uT value_(__types[0], U_ALLOCA(__types[0]->ValueSize));
    int index_ = *index;
    value_ = value;
    ::g::Uno::Collections::List__set_Item_fn(uPtr(__this->keys), uCRef<int>(index_), (KeyframedSpline__Key__New1_fn(__types[1], uCRef((::g::Uno::Collections::List__get_Item_fn(uPtr(__this->keys), uCRef<int>(index_), &ret25), ret25)[0/*Time*/].Value<double>()), value_, &ret24), ret24));
}

// public override sealed double get_Start() :75
...
// protected KeyframedSpline() [instance] :63
void KeyframedSpline::ctor_1()
{
    uType* __types[] = {
        ...
        __type->GetBase(KeyframedSpline_typeof())->T(0),
        __type->GetBase(KeyframedSpline_typeof())->T(1),
    };
    uStackFrame __("Uno.Content.Splines.KeyframedSpline`2", ".ctor()");
    keys = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(__types[0]));
    ctor_();
}

// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) [instance] :67
...
// public void ClearKeys() [instance] :138
...
// public int FindLeftIndex(double time) [instance] :83
...
// public int FindNearestIndex(double time) [instance] :105
...
// public double GetTime(int index) [instance] :154
...
// public int get_KeyCount() [instance] :146
...
// public void RemoveKey(int index) [instance] :132
...
// public int SetTime(int index, double time) [instance] :164
...
// public static float Map(double a, double b, double t) [static] :185
float KeyframedSpline::Map(uType* __type, double a, double b, double t)
{
    uStackFrame __("Uno.Content.Splines.KeyframedSpline`2", "Map(double,double,double)");
...
// public sealed class LinearSplineFloat :233
// {
static void LinearSplineFloat_build(uType* type)
{
    type->SetFields(2);
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat__New1_fn, 0, true, LinearSplineFloat_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat__New2_fn, 0, true, LinearSplineFloat_typeof(), 1, ::g::Uno::Content::Splines::KeyframedSpline__Key_typeof()->MakeType(::g::Uno::Float_typeof(), ::g::Uno::Float_typeof())->Array()));
}
...
::g::Uno::Content::Splines::Spline_type* LinearSplineFloat_typeof()
{
    ...
    type->SetBase(::g::Uno::Content::Splines::KeyframedSpline_typeof()->MakeType(::g::Uno::Float_typeof(), ::g::Uno::Float_typeof()));
...
// public LinearSplineFloat() [instance] :235
void LinearSplineFloat::ctor_3()
{
    uStackFrame __("Uno.Content.Splines.LinearSplineFloat", ".ctor()");
    ctor_1();
}

// public LinearSplineFloat(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [instance] :239
...
// public LinearSplineFloat New() [static] :235
...
// public LinearSplineFloat New(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [static] :239
...
// public sealed class LinearSplineFloat2 :260
// {
static void LinearSplineFloat2_build(uType* type)
{
    type->SetFields(2);
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat2__New1_fn, 0, true, LinearSplineFloat2_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat2__New2_fn, 0, true, LinearSplineFloat2_typeof(), 1, ::g::Uno::Content::Splines::KeyframedSpline__Key_typeof()->MakeType(::g::Uno::Float2_typeof(), ::g::Uno::Float2_typeof())->Array()));
}
...
::g::Uno::Content::Splines::Spline_type* LinearSplineFloat2_typeof()
{
    ...
    type->SetBase(::g::Uno::Content::Splines::KeyframedSpline_typeof()->MakeType(::g::Uno::Float2_typeof(), ::g::Uno::Float2_typeof()));
...
// public LinearSplineFloat2() [instance] :262
void LinearSplineFloat2::ctor_3()
{
    uStackFrame __("Uno.Content.Splines.LinearSplineFloat2", ".ctor()");
    ctor_1();
}

// public LinearSplineFloat2(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [instance] :266
...
// public LinearSplineFloat2 New() [static] :262
...
// public LinearSplineFloat2 New(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [static] :266
...
static void LinearSplineFloat3_build(uType* type)
{
    type->SetFields(2);
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat3__New1_fn, 0, true, LinearSplineFloat3_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat3__New2_fn, 0, true, LinearSplineFloat3_typeof(), 1, ::g::Uno::Content::Splines::KeyframedSpline__Key_typeof()->MakeType(::g::Uno::Float3_typeof(), ::g::Uno::Float3_typeof())->Array()));
}
...
::g::Uno::Content::Splines::Spline_type* LinearSplineFloat3_typeof()
{
    ...
    type->SetBase(::g::Uno::Content::Splines::KeyframedSpline_typeof()->MakeType(::g::Uno::Float3_typeof(), ::g::Uno::Float3_typeof()));
...
// public LinearSplineFloat3() [instance] :290
void LinearSplineFloat3::ctor_3()
{
    uStackFrame __("Uno.Content.Splines.LinearSplineFloat3", ".ctor()");
    ctor_1();
}

// public LinearSplineFloat3(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [instance] :294
...
// public LinearSplineFloat3 New() [static] :290
...
// public LinearSplineFloat3 New(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [static] :294
...
// public sealed class LinearSplineFloat4 :316
// {
static void LinearSplineFloat4_build(uType* type)
{
    type->SetFields(2);
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat4__New1_fn, 0, true, LinearSplineFloat4_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat4__New2_fn, 0, true, LinearSplineFloat4_typeof(), 1, ::g::Uno::Content::Splines::KeyframedSpline__Key_typeof()->MakeType(::g::Uno::Float4_typeof(), ::g::Uno::Float4_typeof())->Array()));
}
...
::g::Uno::Content::Splines::Spline_type* LinearSplineFloat4_typeof()
{
    ...
    type->SetBase(::g::Uno::Content::Splines::KeyframedSpline_typeof()->MakeType(::g::Uno::Float4_typeof(), ::g::Uno::Float4_typeof()));
...
// public LinearSplineFloat4() [instance] :318
void LinearSplineFloat4::ctor_3()
{
    uStackFrame __("Uno.Content.Splines.LinearSplineFloat4", ".ctor()");
    ctor_1();
}

// public LinearSplineFloat4(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [instance] :322
...
// public LinearSplineFloat4 New() [static] :318
...
// public LinearSplineFloat4 New(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [static] :322
...
// public sealed class LinearSplineFloat4x4 :344
// {
static void LinearSplineFloat4x4_build(uType* type)
{
    type->SetFields(2);
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat4x4__New1_fn, 0, true, LinearSplineFloat4x4_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)LinearSplineFloat4x4__New2_fn, 0, true, LinearSplineFloat4x4_typeof(), 1, ::g::Uno::Content::Splines::KeyframedSpline__Key_typeof()->MakeType(::g::Uno::Float4x4_typeof(), ::g::Uno::Float4x4_typeof())->Array()));
}
...
::g::Uno::Content::Splines::Spline_type* LinearSplineFloat4x4_typeof()
{
    ...
    type->SetBase(::g::Uno::Content::Splines::KeyframedSpline_typeof()->MakeType(::g::Uno::Float4x4_typeof(), ::g::Uno::Float4x4_typeof()));
...
// public LinearSplineFloat4x4() [instance] :346
void LinearSplineFloat4x4::ctor_3()
{
    uStackFrame __("Uno.Content.Splines.LinearSplineFloat4x4", ".ctor()");
    ctor_1();
}

// public LinearSplineFloat4x4(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [instance] :350
...
// public LinearSplineFloat4x4 New() [static] :346
...
// public LinearSplineFloat4x4 New(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [static] :350
...
// public abstract class Spline<T> :370
// {
...
// protected generated Spline() :370
void Spline__ctor__fn(Spline* __this)
{
    __this->ctor_();
}

// public T get_First() :378
void Spline__get_First_fn(Spline* __this, uTRef __retval)
{
    uType* __types[] = {
        __this->__type->GetBase(Spline_typeof())->T(0),
    };
...
// public T Sample(double time) :386
...
// protected generated Spline() [instance] :370
void Spline::ctor_()
{
}
// }
