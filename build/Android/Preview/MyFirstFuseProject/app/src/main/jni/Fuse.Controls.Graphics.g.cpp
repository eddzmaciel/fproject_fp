...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.33.5\Graphics\$.uno
// ---------------------------------------------------------------
...
static void ControlVisual_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ControlVisual_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(ControlVisual_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ControlVisual_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(ControlVisual_type, interface3),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(ControlVisual_type, interface4),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(ControlVisual_type, interface5),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(ControlVisual_type, interface6),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof()), offsetof(ControlVisual_type, interface7));
    type->SetFields(56,
