...
#include <Uno.Compiler.ExportTargetInterop.Foreign.Android.JavaToUnoArray-4cc36c3e.h>
...
void JNICALL callUno_Fuse_App_OnFrameCallback244(JNIEnv *env,jclass clazz,jobject jthis,jdouble currentTime,jdouble deltaTime)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\$.uno
// --------------------------------------------------------------------------------------------------------
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Fuse_App_OnFrameCallback244", (char* const)"(Ljava/lang/Object;DD)V", (void *)&callUno_Fuse_App_OnFrameCallback244},
    };
    int funcCount = 53;
