...
// C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Diagnostics\$.uno
// -----------------------------------------------------------------------
...
void Debug::Assert(bool value, uString* expression, uString* filename, int line, uArray* operands)
{
    ...
    if (!value)
        Debug::EmitLog(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[1/*"Assertion F...*/], expression), ::STRINGS[2/*"' in "*/]), filename), ::STRINGS[3/*"("*/]), uBox<int>(::TYPES[3/*int*/], line)), ::STRINGS[4/*")"*/]), 3);
}
...
{
    ::TYPES[2] = ::g::Uno::Collections::Dictionary_typeof();
    ::TYPES[3] = ::g::Uno::Int_typeof();
    ::TYPES[4] = ::g::Uno::Collections::List_typeof();
    type->SetPrecalc(
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(type->T(0), ::g::Uno::Int_typeof()),
...
{
    ::TYPES[5] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[6] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Diagnostics::ProfileEvent_typeof());
    ::TYPES[7] = ::g::Uno::Diagnostics::IdMap_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
...
void ProfileData::ctor_()
{
    ...
    FunctionIds = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[5/*Uno.Collections.List<string>*/]));
    ProfileEvents = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[6/*Uno.Collections.List<Uno.Diagnostics.ProfileEvent>*/]));
    TypeMap = ((::g::Uno::Diagnostics::IdMap*)::g::Uno::Diagnostics::IdMap::New1(::TYPES[7/*Uno.Diagnostics.IdMap<string>*/], true));
}
