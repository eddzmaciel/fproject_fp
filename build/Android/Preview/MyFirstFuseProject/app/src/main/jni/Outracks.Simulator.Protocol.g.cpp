...
// C:\ProgramData\Uno\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\Messages\$.uno
// --------------------------------------------------------------------------------
...
{
    uStackFrame __("Outracks.Simulator.Protocol.DebugLog", ".ctor(string,string,string)");
    ctor_();
    ClientId = clientId;
...
{
    uStackFrame __("Outracks.Simulator.Protocol.Error", ".ctor(Outracks.Simulator.Protocol.ExceptionInfo)");
    ctor_();
    Exception = exception;
}
...
{
    ::TYPES[0] = ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(ExceptionInfo_typeof());
    ::TYPES[1] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ExceptionInfo_typeof());
    ::TYPES[2] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ExceptionInfo_typeof());
    ::TYPES[3] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ExceptionInfo_typeof());
    ::TYPES[4] = ::g::Uno::Action2_typeof()->MakeType(ExceptionInfo_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Protocol.ExceptionInfo", ".ctor(Outracks.Simulator.Bytecode.TypeName,string,string,Outracks.Simulator.ImmutableList<Outracks.Simulator.Protocol.ExceptionInfo>)");
    Type = type;
    Message = message;
...
{
    uStackFrame __("Outracks.Simulator.Protocol.Execute", ".ctor(Outracks.Simulator.Bytecode.Lambda)");
    ctor_();
    Function = function;
}
...
static void MessageFromClient_build(uType* type)
{
    ...
    ::TYPES[9] = MessageFromClient_typeof()->MakeMethod(1, ::g::Uno::Char_typeof());
    ::TYPES[10] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::RegisterName_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[11] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::DebugLog_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[12] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::UnhandledException_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[13] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::SetSelection_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[14] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::RegisterName_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[15] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::RegisterName_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[16] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::DebugLog_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[17] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::DebugLog_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[18] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::UnhandledException_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[19] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::UnhandledException_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[20] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::SetSelection_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[21] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::SetSelection_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->Reflection.SetFunctions(4,
...
static void MessageToClient_build(uType* type)
{
    ...
    ::TYPES[25] = MessageToClient_typeof()->MakeMethod(1, ::g::Uno::Char_typeof());
    ::TYPES[26] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::Reify_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[27] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::Execute_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[28] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::Error_typeof(), ::g::Uno::Char_typeof());
    ::TYPES[29] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::Reify_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[30] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[31] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::Execute_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[32] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Execute_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[33] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(2, ::g::Outracks::Simulator::Protocol::Error_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[34] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Error_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->Reflection.SetFunctions(4,
...
{
    uStackFrame __("Outracks.Simulator.Protocol.RegisterName", ".ctor(string,string)");
    ctor_();
    ClientId = clientId;
    ClientName = clientName;
}
...
{
    uStackFrame __("Outracks.Simulator.Protocol.Reify", ".ctor(Outracks.Simulator.Bytecode.Lambda)");
    ctor_();
...
{
    uStackFrame __("Outracks.Simulator.Protocol.Reify", "get_BinaryFormat()");
...
{
    uStackFrame __("Outracks.Simulator.Protocol.SetSelection", ".ctor(string)");
    ctor_();
    Tag = tag;
}
...
{
    uStackFrame __("Outracks.Simulator.Protocol.UnhandledException", ".ctor(string,string,string,string,string)");
    ctor_();
    ClientId = clientId;
    ClientName = clientName;
    Message = message;
