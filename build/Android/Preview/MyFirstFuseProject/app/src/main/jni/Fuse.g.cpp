...
// C:\ProgramData\Uno\Packages\FuseCore\0.33.5\$.uno
// -------------------------------------------------
...
void AlternateRoot::Add1()
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(ParentNode())->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), Visual());
}
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.33.5\$.uno
// -----------------------------------------------------
...
int AndroidProperties::GetBuildVersion()
{
    uStackFrame __("Fuse.AndroidProperties", "GetBuildVersion()");
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetBuildVersion242", "()I");
...
// public static int get_BuildVersion() [static] :674
...
// public abstract extern class App :557
// {
...
// public override sealed Uno.Collections.IList<Fuse.Node> get_Children() :585
...
// public override sealed Fuse.Visual get_ChildrenVisual() :590
...
// private void OnFrameCallback(double currentTime, double deltaTime) [instance] :593
...
// private void PropagateBackground() [instance] :651
...
// internal Fuse.Controls.GraphicsView get_RootGraphicsView() [instance] :562
...
// private void StartFrameCallback() [instance] :618
void App::StartFrameCallback()
{
    uStackFrame __("Fuse.App", "StartFrameCallback()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "StartFrameCallback243", "(Ljava/lang/Object;)V");
        uObject* _uthis=this;
...
static void AppBase_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.33.5\\$.uno");
...
// internal sealed class CacheFramebuffer :426
// {
...
// public CacheFramebuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) :525
...
// public CacheFramebuffer New(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) :525
...
// public CacheFramebuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [instance] :525
...
// public CacheFramebuffer New(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [static] :525
...
// private sealed class Node.CallFuncClosure :3639
// {
...
// public CallFuncClosure(Fuse.Scripting.Function func, object arg) :3643
...
// public CallFuncClosure New(Fuse.Scripting.Function func, object arg) :3643
...
// public void Run() :3649
void Node__CallFuncClosure__Run_fn(Node__CallFuncClosure* __this)
{
    __this->Run();
}

// public CallFuncClosure(Fuse.Scripting.Function func, object arg) [instance] :3643
...
// public void Run() [instance] :3649
void Node__CallFuncClosure::Run()
{
    uStackFrame __("Fuse.Node.CallFuncClosure", "Run()");
    uPtr(_func)->Call(uArray::Init<uObject*>(::TYPES[18/*object[]*/], 1, (uObject*)_arg));
}

// public CallFuncClosure New(Fuse.Scripting.Function func, object arg) [static] :3643
...
// public enum Visual.CancelInteractionsType :5306
...
// public sealed class Diagnostic :557
// {
...
// public Diagnostic(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) :592
...
// public Diagnostic New(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) :592
...
// public override sealed string ToString() :603
void Diagnostic__ToString_fn(Diagnostic* __this, uString** __retval)
{
    ...
    if (::g::Uno::String::op_Inequality(__this->FilePath, NULL))
        msg = ::g::Uno::String::op_Addition2(msg, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[14/*"<"*/], __this->FilePath), ::STRINGS[15/*":"*/]), uBox<int>(::TYPES[17/*int*/], __this->LineNumber)), ::STRINGS[16/*">"*/]));

    return *__retval = msg, void();
}

// internal Uno.Diagnostics.DebugMessageType get_UnoType() :569
void Diagnostic__get_UnoType_fn(Diagnostic* __this, int* __retval)
{
    *__retval = __this->UnoType();
}

// public Diagnostic(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) [instance] :592
...
// internal Uno.Diagnostics.DebugMessageType get_UnoType() [instance] :569
...
// public Diagnostic New(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) [static] :592
...
// public delegate void DiagnosticHandler(Fuse.Diagnostic d) :633
...
// public static class Diagnostics :653
// {
...
// public static void Deprecated(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :748
...
// public static generated void add_DiagnosticReported(Fuse.DiagnosticHandler value) :655
void Diagnostics__add_DiagnosticReported_fn(uDelegate* value)
{
    Diagnostics::add_DiagnosticReported(value);
}

// public static generated void remove_DiagnosticReported(Fuse.DiagnosticHandler value) :655
void Diagnostics__remove_DiagnosticReported_fn(uDelegate* value)
{
    Diagnostics::remove_DiagnosticReported(value);
}

// public static void InternalError(string msg, [object obj], [string filePath], [int lineNumber], [string memberName]) :730
...
// public static void PerformanceWarning(string msg, [string filePath], [int lineNumber], [string memberName]) :762
...
// private static void Report(Fuse.Diagnostic d) :657
void Diagnostics__Report_fn(::g::Fuse::Diagnostic* d)
{
    Diagnostics::Report(d);
}

// public static void UnknownException(string msg, Uno.Exception ex, object obj, [string filePath], [int lineNumber], [string memberName]) :741
...
// public static void Unsupported(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :755
...
// public static void UserError(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :680
...
// public static void UserRootError(string expectedType, object actualParent, object obj, [string filePath], [int lineNumber], [string memberName]) :718
...
// public static void UserSuccess(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :691
...
// private static string UserTypeOf(object a) :703
void Diagnostics__UserTypeOf_fn(uObject* a, uString** __retval)
{
    *__retval = Diagnostics::UserTypeOf(a);
}

// public static void UserWarning(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :776
...
// public static void Deprecated(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :748
...
// public static void InternalError(string msg, [object obj], [string filePath], [int lineNumber], [string memberName]) [static] :730
...
// public static void PerformanceWarning(string msg, [string filePath], [int lineNumber], [string memberName]) [static] :762
...
// private static void Report(Fuse.Diagnostic d) [static] :657
...
// public static void UnknownException(string msg, Uno.Exception ex, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :741
...
// public static void Unsupported(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :755
...
// public static void UserError(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :680
...
// public static void UserRootError(string expectedType, object actualParent, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :718
...
// public static void UserSuccess(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :691
...
// private static string UserTypeOf(object a) [static] :703
...
// public static void UserWarning(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :776
...
// public static generated void add_DiagnosticReported(Fuse.DiagnosticHandler value) [static] :655
...
// public static generated void remove_DiagnosticReported(Fuse.DiagnosticHandler value) [static] :655
...
// public enum DiagnosticType :543
...
// public sealed class DrawContext :820
// {
static void DrawContext_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::Graphics::PolygonFace_typeof());
    ::TYPES[30] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::RenderTargetEntry_typeof());
    ::TYPES[31] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::RenderTargetEntry_typeof());
    ::TYPES[32] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Uno::Int4_typeof());
    ::TYPES[33] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::Int4_typeof());
    ::TYPES[34] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::IRenderViewport_typeof());
    ::TYPES[35] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::IRenderViewport_typeof());
...
// internal Fuse.RenderTargetEntry GetRenderTargetEntry() :948
...
// public void PushRenderTargetFrustum(framebuffer fb, Fuse.IFrustum frustum) :994
...
// public void PushRenderTargetViewport(framebuffer fb, Fuse.IRenderViewport viewport) :1000
...
// public void AddFlushListener(Fuse.IFlush f) [instance] :866
...
// private void CheckGLError([string filePath], [int lineNumber], [string memberName]) [instance] :1153
...
// public void Clear(float4 color, [float depth]) [instance] :1018
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[1/*"C:\\Program...*/], 1026, ::STRINGS[24/*"Clear"*/]);
}

// public Uno.Graphics.PolygonFace get_CullFace() [instance] :1139
...
// public void Flush() [instance] :872
...
// public float4x4 GetLocalToClipTransform(Fuse.Visual n) [instance] :843
...
// internal Fuse.RenderTargetEntry GetRenderTargetEntry() [instance] :948
...
// private extern OpenGL.GLFramebufferHandle get_GLFramebuffer() [instance] :930
...
// private extern void set_GLFramebuffer(OpenGL.GLFramebufferHandle value) [instance] :940
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[1/*"C:\\Program...*/], 944, ::STRINGS[32/*"set_GLFrame...*/]);
}

// private int4 get_GLScissor() [instance] :1050
...
// private void set_GLScissor(int4 value) [instance] :1061
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[1/*"C:\\Program...*/], 1067, ::STRINGS[33/*"set_GLScissor"*/]);
}

// public int2 get_GLViewportPixelSize() [instance] :1094
...
// private void set_GLViewportPixelSize(int2 value) [instance] :1105
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[1/*"C:\\Program...*/], 1111, ::STRINGS[34/*"set_GLViewp...*/]);
}

// public float2 get_GLViewportPointSize() [instance] :1118
...
// public generated bool get_IsCaching() [instance] :1133
...
// public generated void set_IsCaching(bool value) [instance] :1133
...
// public void PopCullFace() [instance] :1148
...
// public void PopRenderTarget() [instance] :980
void DrawContext::PopRenderTarget()
{
    uStackFrame __("Fuse.DrawContext", "PopRenderTarget()");
    ::g::Fuse::RenderTargetEntry* ret7;
    Flush();
    ::g::Fuse::RenderTargetEntry* old = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[30/*Uno.Collections.IListExtensions.RemoveLast<Fuse.RenderTargetEntry>*/], (uObject*)_renderTargets, &ret7), ret7);
    _renderTarget = uPtr(old)->RenderTarget;
    GLFramebuffer(uPtr(old)->GLFramebuffer);
    CheckGLError(::STRINGS[1/*"C:\\Program...*/], 988, ::STRINGS[25/*"PopRenderTa...*/]);
    GLViewportPixelSize(old->GLViewportPixelSize);
    GLScissor(old->GLScissor);
}

// public void PopRenderTargetFrustum() [instance] :1006
...
// public void PopRenderTargetViewport() [instance] :1012
...
// public void PopScissor() [instance] :1080
void DrawContext::PopScissor()
{
    uStackFrame __("Fuse.DrawContext", "PopScissor()");
    ::g::Uno::Int4 ret8;
    ::g::Uno::Int4 s = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[32/*Uno.Collections.IListExtensions.RemoveLast<int4>*/], (uObject*)_glScissors, &ret8), ret8);
    GLScissor(s);
}

// public void PopViewport() [instance] :837
void DrawContext::PopViewport()
{
    uStackFrame __("Fuse.DrawContext", "PopViewport()");
    uObject* ret9;
    Flush();
    _viewport = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[34/*Uno.Collections.IListExtensions.RemoveLast<Fuse.IRenderViewport>*/], (uObject*)_viewports, &ret9), ret9);
}

// public void PushCullFace(Uno.Graphics.PolygonFace cf) [instance] :1142
...
// public void PushRenderTarget(framebuffer fb) [instance] :956
...
// public void PushRenderTarget(Uno.Graphics.RenderTarget rt) [instance] :961
...
// private void PushRenderTarget(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glscissor) [instance] :966
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[1/*"C:\\Program...*/], 973, ::STRINGS[26/*"PushRenderT...*/]);
    _renderTarget = rt;
    GLViewportPixelSize(viewportPixelSize);
    GLScissor(glscissor);
}

// public void PushRenderTargetFrustum(framebuffer fb, Fuse.IFrustum frustum) [instance] :994
...
// public void PushRenderTargetViewport(framebuffer fb, Fuse.IRenderViewport viewport) [instance] :1000
...
// public void PushScissor(Uno.Recti scissor) [instance] :1074
...
// public void PushViewport(Fuse.IRenderViewport v) [instance] :830
...
// internal void ReleaseRootbuffer() [instance] :899
void DrawContext::ReleaseRootbuffer()
{
    uStackFrame __("Fuse.DrawContext", "ReleaseRootbuffer()");

    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Unpopped Sc...*/], this, ::STRINGS[1/*"C:\\Program...*/], 904, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Unpopped Cu...*/], this, ::STRINGS[1/*"C:\\Program...*/], 908, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Vi...*/], this, ::STRINGS[1/*"C:\\Program...*/], 912, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"Unpopped Re...*/], this, ::STRINGS[1/*"C:\\Program...*/], 916, ::STRINGS[28/*"ReleaseRoot...*/]);

    uPtr(_renderTargets)->Clear();
}

// public Uno.Graphics.RenderTarget get_RenderTarget() [instance] :924
...
// public Uno.Recti get_Scissor() [instance] :1032
...
// internal void set_Scissor(Uno.Recti value) [instance] :1040
...
// public Fuse.IRenderViewport get_Viewport() [instance] :826
...
// public float get_ViewportPixelsPerPoint() [instance] :1127
...
// public DrawContext New(Fuse.IRenderViewport viewport) [static] :853
...
// internal sealed class DrawHelpers :4648
// {
...
// public generated DrawHelpers() :4648
void DrawHelpers__ctor__fn(DrawHelpers* __this)
{
    __this->ctor_();
}

// internal void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float4x4 transform, float lineWidth, float4 color) :4662
...
// private generated void init_DrawCalls() :4648
void DrawHelpers__init_DrawCalls_fn(DrawHelpers* __this)
{
    __this->init_DrawCalls();
}

// public generated DrawHelpers New() :4648
void DrawHelpers__New1_fn(DrawHelpers** __retval)
{
    *__retval = DrawHelpers::New1();
}

// internal static Fuse.DrawHelpers get_Singelton() :4654
...
// public generated DrawHelpers() [instance] :4648
...
// internal void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float4x4 transform, float lineWidth, float4 color) [instance] :4662
...
// private generated void init_DrawCalls() [instance] :4648
void DrawHelpers::init_DrawCalls()
{
    uStackFrame __("Fuse.DrawHelpers", "init_DrawCalls()");
    uArray* Vertices_311c1aa8_1_1_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[37/*float2[]*/], 5, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 0.0f));
...
// public generated DrawHelpers New() [static] :4648
...
// internal static Fuse.DrawHelpers get_Singelton() [static] :4654
...
// public sealed class FastMatrix :1724
// {
...
// private FastMatrix(Fuse.FastMatrix orig) [instance] :1736
...
// public void AppendFastMatrix(Fuse.FastMatrix fm) [instance] :1903
...
// public void AppendRotation(float zRadians) [instance] :1786
...
// public void AppendRotationQuaternion(float4 q) [instance] :1860
...
// public void AppendScale(float factor) [instance] :1798
...
// public void AppendScale(float3 scale) [instance] :1854
...
// public void AppendShear(float xRadians, float yRadians) [instance] :1816
...
// public void AppendTranslation(float x, float y, float z) [instance] :1762
...
// public void AppendTranslation(float3 offset) [instance] :1866
...
// public Fuse.FastMatrix Copy() [instance] :1744
...
// public void Invert() [instance] :1840
...
// public float4x4 get_Matrix() [instance] :1727
...
// public Fuse.FastMatrix Mul(Fuse.FastMatrix m) [instance] :1829
...
// public void PrependFastMatrix(Fuse.FastMatrix fm) [instance] :1888
...
// public void PrependRotation(float zRadians) [instance] :1792
...
// public void PrependRotationQuaternion(float4 q) [instance] :1877
...
// public void PrependScale(float factor) [instance] :1804
...
// public void PrependScale(float3 scale) [instance] :1871
...
// public void PrependShear(float xRadians, float yRadians) [instance] :1810
...
// public void PrependTranslation(float x, float y, float z) [instance] :1774
...
// public void PrependTranslation(float3 offset) [instance] :1883
...
// public void ResetIdentity() [instance] :1749
...
// private void SimpleTranslation(float x, float y, float z) [instance] :1822
...
// public static Fuse.FastMatrix FromFloat4x4(float4x4 m) [static] :1754
...
// public static Fuse.FastMatrix Identity() [static] :1742
...
// private FastMatrix New() [static] :1731
...
// private FastMatrix New(Fuse.FastMatrix orig) [static] :1736
...
// internal enum FastProperty1 :4784
...
// internal class FastProperty1Link :4826
// {
...
// public FastProperty1Link(Fuse.FastProperty1 p) :4831
void FastProperty1Link__ctor__fn(FastProperty1Link* __this, int* p)
{
    __this->ctor_(*p);
}

// public FastProperty1Link New(Fuse.FastProperty1 p) :4831
void FastProperty1Link__New1_fn(int* p, FastProperty1Link** __retval)
{
    *__retval = FastProperty1Link::New1(*p);
}

// public FastProperty1Link(Fuse.FastProperty1 p) [instance] :4831
...
// public FastProperty1Link New(Fuse.FastProperty1 p) [static] :4831
...
// internal sealed class FastProperty1Link<T> :4837
// {
...
// public FastProperty1Link(Fuse.FastProperty1 p, T value) :4840
...
// public FastProperty1Link New(Fuse.FastProperty1 p, T value) :4840
...
// internal enum FastProperty2 :4957
...
// internal class FastProperty2Link :4979
// {
...
// public FastProperty2Link(Fuse.FastProperty2 p) :4984
void FastProperty2Link__ctor__fn(FastProperty2Link* __this, int* p)
{
    __this->ctor_(*p);
}

// public FastProperty2Link New(Fuse.FastProperty2 p) :4984
void FastProperty2Link__New1_fn(int* p, FastProperty2Link** __retval)
{
    *__retval = FastProperty2Link::New1(*p);
}

// public FastProperty2Link(Fuse.FastProperty2 p) [instance] :4984
...
// public FastProperty2Link New(Fuse.FastProperty2 p) [static] :4984
...
// internal sealed class FastProperty2Link<T> :4990
// {
...
// public FastProperty2Link(Fuse.FastProperty2 p, T value) :4993
...
// public FastProperty2Link New(Fuse.FastProperty2 p, T value) :4993
...
// internal sealed class FixedViewport :2683
// {
...
// public FixedViewport(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) :2722
...
// public FixedViewport New(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) :2722
...
// public float4x4 get_ProjectionTransform() :2696
...
// public float4x4 get_ProjectionTransformInverse() :2698
...
// public float4x4 get_ViewProjectionTransformInverse() :2702
...
// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :2715
...
// public FixedViewport(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) [instance] :2722
...
// public float2 get_PixelSize() [instance] :2691
...
// public float get_PixelsPerPoint() [instance] :2686
...
// public Uno.Geometry.Ray PointToWorldRay(float2 pointPos) [instance] :2711
...
// public float4x4 get_ProjectionTransform() [instance] :2696
...
// public float4x4 get_ProjectionTransformInverse() [instance] :2698
...
// public float2 get_Size() [instance] :2688
...
// public float3 get_ViewOrigin() [instance] :2708
...
// public float4x4 get_ViewProjectionTransform() [instance] :2700
...
// public float4x4 get_ViewProjectionTransformInverse() [instance] :2702
...
// public float2 get_ViewRange() [instance] :2709
...
// public float4x4 get_ViewTransform() [instance] :2704
...
// public float4x4 get_ViewTransformInverse() [instance] :2706
...
// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [instance] :2715
...
// public FixedViewport New(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) [static] :2722
...
// private enum LayoutParams.Flags :2781
...
static void Font_build(uType* type)
{
    ...
    ::TYPES[41] = ::g::Uno::UX::FileSource_typeof();
    type->SetFields(0,
...
// public Font(Uno.UX.FileSource file) [instance] :1997
...
// internal Uno.UX.FileSource get_File() [instance] :1953
...
// internal Uno.Content.Fonts.FontFace get_FontFace() [instance] :1965
...
// private Uno.Content.Fonts.FontFace Load() [instance] :1981
...
// public Font New(Uno.UX.FileSource file) [static] :1997
...
// public static Fuse.Font get_PlatformDefault() [static] :2009
Font* Font::PlatformDefault()
{
    ...
    if (Font::_fallback() == NULL)
        Font::_fallback() = Font::New1(::g::Uno::UX::BundleFileSource::New1(::g::FuseCore_bundle::RobotoRegular36f9075e()));

    return Font::_fallback();
}

// public static float get_PlatformDefaultSize() [static] :2021
...
// public static float4 get_PlatformDefaultTextColor() [static] :2031
...
// public static class FramebufferPool :2052
// {
...
// private static void EnsurePool() :2056
void FramebufferPool__EnsurePool_fn()
{
    FramebufferPool::EnsurePool();
}

// internal static int get_Frame() :2088
void FramebufferPool__get_Frame_fn(int* __retval)
{
    *__retval = FramebufferPool::Frame();
}

// public static framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) :2074
...
// public static framebuffer Lock(int2 size, Uno.Graphics.Format format, bool depth) :2070
...
// private static void EnsurePool() [static] :2056
...
// public static framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) [static] :2074
...
// public static framebuffer Lock(int2 size, Uno.Graphics.Format format, bool depth) [static] :2070
...
// internal static void Register(Fuse.CacheFramebuffer cfb) [static] :2058
...
// public static void Release(framebuffer fb) [static] :2080
...
// internal static void UnRegister(Fuse.CacheFramebuffer cfb) [static] :2064
...
// internal static int get_Frame() [static] :2088
...
// internal sealed class FramebufferPoolImpl :2097
// {
static void FramebufferPoolImpl_build(uType* type)
{
    ...
    ::TYPES[42] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof());
    ::TYPES[43] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[44] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof());
    ::TYPES[45] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof());
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[46] = ::g::Fuse::Resources::ISoftDisposable_typeof();
    ::TYPES[47] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof());
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[12] = uObject_typeof();
    type->SetInterfaces(
...
// public FramebufferPoolImpl() :2099
void FramebufferPoolImpl__ctor__fn(FramebufferPoolImpl* __this)
{
    __this->ctor_();
}

// private void CollectCacheFramebuffers() :2186
void FramebufferPoolImpl__CollectCacheFramebuffers_fn(FramebufferPoolImpl* __this)
{
    __this->CollectCacheFramebuffers();
}

// private framebuffer FindBuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) :2117
...
// private void Fuse.Resources.ISoftDisposable.SoftDispose() :2218
...
// internal framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) :2240
...
// public FramebufferPoolImpl New() :2099
void FramebufferPoolImpl__New1_fn(FramebufferPoolImpl** __retval)
{
    *__retval = FramebufferPoolImpl::New1();
}

// internal void Register(Fuse.CacheFramebuffer cfb) :2158
void FramebufferPoolImpl__Register_fn(FramebufferPoolImpl* __this, ::g::Fuse::CacheFramebuffer* cfb)
{
    __this->Register(cfb);
}

// internal void Release(framebuffer fb) :2248
void FramebufferPoolImpl__Release_fn(FramebufferPoolImpl* __this, ::g::Uno::Graphics::Framebuffer* fb)
{
    __this->Release(fb);
}

// internal void UnRegister(Fuse.CacheFramebuffer cfb) :2179
void FramebufferPoolImpl__UnRegister_fn(FramebufferPoolImpl* __this, ::g::Fuse::CacheFramebuffer* cfb)
{
    __this->UnRegister(cfb);
}

// public void Update() :2258
void FramebufferPoolImpl__Update_fn(FramebufferPoolImpl* __this)
{
    __this->Update();
}

// public FramebufferPoolImpl() [instance] :2099
void FramebufferPoolImpl::ctor_()
{
    uStackFrame __("Fuse.FramebufferPoolImpl", ".ctor()");
    framebufferPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[42/*Uno.Collections.List<framebuffer>*/]));
    lastFrameUsed = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[43/*Uno.Collections.Dictionary<framebuffer, int>*/]));
    lockedFramebuffers = ((::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[44/*Uno.Collections.HashSet<framebuffer>*/]));
    cacheFramebuffers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[45/*Uno.Collections.List<Fuse.CacheFramebuffer>*/]));
...
// private void CollectCacheFramebuffers() [instance] :2186
void FramebufferPoolImpl::CollectCacheFramebuffers()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::CacheFramebuffer*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(cacheFramebuffers), &ret3), ret3); enum1.MoveNext(::TYPES[47/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]); )
    {
        ::g::Fuse::CacheFramebuffer* cfb = enum1.Current(::TYPES[47/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]);
...
// private framebuffer FindBuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [instance] :2117
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[35/*"Attempted t...*/], uBox<int>(::TYPES[17/*int*/], width)), ::STRINGS[36/*"x"*/]), uBox<int>(::TYPES[17/*int*/], height)), ::STRINGS[37/*" framebuffe...*/]), uBox<int>(::TYPES[17/*int*/], maxSize)), ::STRINGS[36/*"x"*/]), uBox<int>(::TYPES[17/*int*/], maxSize))));
...
// internal framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) [instance] :2240
...
// internal void Register(Fuse.CacheFramebuffer cfb) [instance] :2158
...
// internal void Release(framebuffer fb) [instance] :2248
...
// internal void UnRegister(Fuse.CacheFramebuffer cfb) [instance] :2179
...
// public void Update() [instance] :2258
...
// public FramebufferPoolImpl New() [static] :2099
...
// internal sealed class FrustumViewport :2601
// {
...
// public generated FrustumViewport() :2601
void FrustumViewport__ctor__fn(FrustumViewport* __this)
{
    __this->ctor_();
}

// private float4x4 GetClipToVisualSpace(float2 size) :2621
...
// public float4x4 GetFlatWorldToVisualTransform(float2 size) :2631
...
// public static float2 LocalPlaneIntersection(Uno.Geometry.Ray local) :2674
...
// public generated FrustumViewport New() :2601
void FrustumViewport__New1_fn(FrustumViewport** __retval)
{
    *__retval = FrustumViewport::New1();
}

// public static Uno.Geometry.Ray PointToWorldRay(Fuse.IViewport viewport, float4x4 viewProjectionInverse, float2 pointPos) :2645
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum) :2610
void FrustumViewport__Update_fn(FrustumViewport* __this, uObject* viewport, uObject* frustum)
{
    __this->Update(viewport, frustum);
}

// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum, Fuse.Visual where) :2638
...
// public static Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport viewport, Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :2660
...
// public generated FrustumViewport() [instance] :2601
void FrustumViewport::ctor_()
{
}

// private float4x4 GetClipToVisualSpace(float2 size) [instance] :2621
...
// public float4x4 GetFlatWorldToVisualTransform(float2 size) [instance] :2631
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum) [instance] :2610
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum, Fuse.Visual where) [instance] :2638
...
// public static float2 LocalPlaneIntersection(Uno.Geometry.Ray local) [static] :2674
...
// public generated FrustumViewport New() [static] :2601
...
// public static Uno.Geometry.Ray PointToWorldRay(Fuse.IViewport viewport, float4x4 viewProjectionInverse, float2 pointPos) [static] :2645
...
// public static Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport viewport, Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [static] :2660
...
// public static class GraphicsWorker :2323
// {
static void GraphicsWorker_build(uType* type)
{
    ::TYPES[8] = ::g::Uno::EventHandler_typeof();
    ::TYPES[48] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[14] = ::g::Uno::Action_typeof();
    type->SetFields(0,
...
// public static void Dispatch(Uno.Action a) [static] :2325
...
// private static void OnWindowClosed(object sender, Uno.EventArgs args) [static] :2366
...
// private static void Run() [static] :2372
...
// private static void Start() [static] :2347
void GraphicsWorker::Start()
{
    ...
    GraphicsWorker::_work_ = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[48/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
...
// private sealed class TranslationModes.HeightMode :9387
// {
...
// public generated HeightMode() :9387
void TranslationModes__HeightMode__ctor_1_fn(TranslationModes__HeightMode* __this)
{
    __this->ctor_1();
}

// public override sealed float3 GetAbsVector(Fuse.Translation t) :9389
...
// public generated HeightMode New() :9387
...
// public generated HeightMode() [instance] :9387
...
// public generated HeightMode New() [static] :9387
...
// public delegate void HitTestCallback(Fuse.HitTestResult result) :2407
...
// public sealed class HitTestContext :2420
// {
...
// public HitTestContext(float2 windowPoint, Fuse.HitTestCallback callback) :2482
...
// public Fuse.HitTestCallback get_Callback() :2457
...
// public Uno.Geometry.Ray PushWorldRay(Uno.Geometry.Ray n) :2442
...
// public Fuse.HitTestCallback get_Callback() [instance] :2457
...
// public void Hit(Fuse.Visual obj) [instance] :2460
...
// public void Hit(Fuse.Visual obj, float hitDistance) [instance] :2470
...
// public float2 get_LocalPoint() [instance] :2425
...
// public void PopLocalPoint(float2 lp) [instance] :2434
...
// public void PopWorldRay(Uno.Geometry.Ray o) [instance] :2449
...
// public float2 PushLocalPoint(float2 lp) [instance] :2427
...
// public Uno.Geometry.Ray PushWorldRay(Uno.Geometry.Ray n) [instance] :2442
...
// public generated float2 get_WindowPoint() [instance] :2422
...
// private generated void set_WindowPoint(float2 value) [instance] :2422
...
// public Uno.Geometry.Ray get_WorldRay() [instance] :2440
...
// public HitTestContext New(float2 windowPoint, Fuse.HitTestCallback callback) [static] :2482
...
// private sealed class Visual.HitTestRecord :5183
// {
...
// public generated HitTestRecord() :5183
void Visual__HitTestRecord__ctor__fn(Visual__HitTestRecord* __this)
{
    __this->ctor_();
}

// public void HitTestCallback(Fuse.HitTestResult result) :5186
...
// public generated HitTestRecord New() :5183
void Visual__HitTestRecord__New1_fn(Visual__HitTestRecord** __retval)
{
    *__retval = Visual__HitTestRecord::New1();
}

// public generated HitTestRecord() [instance] :5183
void Visual__HitTestRecord::ctor_()
{
}

// public void HitTestCallback(Fuse.HitTestResult result) [instance] :5186
...
// public generated HitTestRecord New() [static] :5183
...
// public sealed class HitTestResult :2411
// {
...
// internal generated void set_HasHitDistance(bool value) [instance] :2413
...
// public generated float get_HitDistance() [instance] :2414
...
// internal generated void set_HitDistance(float value) [instance] :2414
...
// public generated Fuse.Visual get_HitObject() [instance] :2415
...
// internal generated void set_HitObject(Fuse.Visual value) [instance] :2415
...
// public generated HitTestResult New() [static] :2411
...
// internal enum Visual.HitTestTransformMode :5114
...
// public abstract interface IActualPlacement :9305
// {
...
// public abstract interface IBeginRemoveVisualListener :4266
// {
...
// public abstract interface ICommonViewport :2523
// {
...
// private sealed class ScalingModes.IdentityMode :8457
// {
...
// public generated IdentityMode() :8457
void ScalingModes__IdentityMode__ctor__fn(ScalingModes__IdentityMode* __this)
{
    __this->ctor_();
}

// public float3 GetScaleVector(Fuse.Scaling t) :8459
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :8462
...
// public generated IdentityMode() [instance] :8457
void ScalingModes__IdentityMode::ctor_()
{
}

// public float3 GetScaleVector(Fuse.Scaling t) [instance] :8459
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :8461
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :8462
void ScalingModes__IdentityMode::Unsubscribe(uObject* transform, uObject* sub)
{
}

// public generated IdentityMode New() [static] :8457
...
// public abstract interface IFlush :798
// {
...
// public abstract interface IFrustum :2504
// {
...
// public abstract interface INameListener :8597
// {
...
// internal sealed class InheritViewport :2731
// {
...
// public InheritViewport(Fuse.IRenderViewport baseView, Fuse.FrustumViewport childView, Fuse.Visual child) :2737
...
// public InheritViewport New(Fuse.IRenderViewport baseView, Fuse.FrustumViewport childView, Fuse.Visual child) :2737
...
// public float2 get_PixelSize() [instance] :2748
...
// public float get_PixelsPerPoint() [instance] :2743
...
// public float4x4 get_ProjectionTransform() [instance] :2750
...
// public float2 get_Size() [instance] :2746
...
// public float3 get_ViewOrigin() [instance] :2760
...
// public float4x4 get_ViewProjectionTransform() [instance] :2753
...
// public float2 get_ViewRange() [instance] :2761
...
// public float4x4 get_ViewTransform() [instance] :2759
...
// public InheritViewport New(Fuse.IRenderViewport baseView, Fuse.FrustumViewport childView, Fuse.Visual child) [static] :2737
...
// private struct Visual.InteractionItem :5260
// {
...
// public enum InvalidateLayoutReason :5626
...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.33.5\Processing\$.uno
// -----------------------------------------------------------------
...
// public abstract interface IParentObserver :4361
// {
...
// public abstract interface IRenderViewport :2551
// {
...
// public abstract interface IScalingMode :8450
// {
...
// public abstract interface ITemplateObserver :6738
// {
...
// public abstract interface ITransformMode :9137
// {
...
// public abstract interface ITransformRelative :9127
// {
...
// public abstract interface ITranslationMode :9312
// {
...
// public abstract interface IViewport :2581
// {
...
// internal sealed class KeyboardBootstrapper :8193
// {
...
// public generated KeyboardBootstrapper() :8193
void KeyboardBootstrapper__ctor__fn(KeyboardBootstrapper* __this)
{
    __this->ctor_();
}

// public generated KeyboardBootstrapper New() :8193
void KeyboardBootstrapper__New1_fn(KeyboardBootstrapper** __retval)
{
    *__retval = KeyboardBootstrapper::New1();
}

// public static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) :8195
...
// public static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) :8212
...
// public static void OnTextInput(object sender, Uno.Platform.TextInputEventArgs args) :8224
...
// public generated KeyboardBootstrapper() [instance] :8193
void KeyboardBootstrapper::ctor_()
{
}

// public generated KeyboardBootstrapper New() [static] :8193
...
// public static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) [static] :8195
...
// public static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) [static] :8212
...
// public static void OnTextInput(object sender, Uno.Platform.TextInputEventArgs args) [static] :8224
...
// public enum LayoutDependent :5634
...
// public struct LayoutParams :2779
// {
static void LayoutParams_build(uType* type)
{
    ::TYPES[49] = LayoutParams__Flags_typeof();
    ::TYPES[17] = ::g::Uno::Int_typeof();
    type->SetFields(0,
...
// public void BoxConstrain(Fuse.LayoutParams o) :3051
void LayoutParams__BoxConstrain_fn(LayoutParams* __this, LayoutParams* o)
{
    __this->BoxConstrain(*o);
}

// public void ConstrainMax(float2 max, [bool hasMaxX], [bool hasMaxY]) :3008
...
// private float2 PointConstrain(float2 p, bool knowX, bool knowY) :3066
...
// public void ConstrainMax(float2 max, [bool hasMaxX], [bool hasMaxY]) [instance] :3008
...
// public void ConstrainMaxX(float max) [instance] :2990
...
// public void ConstrainMaxY(float max) [instance] :2999
...
// public void ConstrainMin(float2 min, [bool hasMinX], [bool hasMinY]) [instance] :3037
...
// public void ConstrainMinX(float min) [instance] :3019
...
// public void ConstrainMinY(float min) [instance] :3028
...
// public void Copy(Fuse.LayoutParams o) [instance] :2872
...
// public Fuse.LayoutParams DeriveClone() [instance] :2855
...
// public float2 GetAvailableSize() [instance] :3103
...
// public bool get_HasMaxSize() [instance] :2819
...
// public bool get_HasMaxX() [instance] :2817
...
// public bool get_HasMaxY() [instance] :2818
...
// public bool get_HasMinSize() [instance] :2823
...
// public bool get_HasMinX() [instance] :2821
...
// public bool get_HasMinY() [instance] :2822
...
// public bool get_HasRelativeX() [instance] :2827
...
// public bool get_HasRelativeY() [instance] :2836
...
// public bool get_HasSize() [instance] :2813
...
// public bool get_HasX() [instance] :2811
...
// public bool get_HasY() [instance] :2812
...
// public bool IsCompatible(Fuse.LayoutParams nlp) [instance] :3179
...
// public float2 get_MaxSize() [instance] :3112
...
// public float get_MaxX() [instance] :3113
...
// public float get_MaxY() [instance] :3114
...
// public float2 get_MinSize() [instance] :3116
...
// public float get_MinX() [instance] :3117
...
// public float get_MinY() [instance] :3118
...
// public float2 PointConstrain(float2 p) [instance] :3061
...
// private float2 PointConstrain(float2 p, bool knowX, bool knowY) [instance] :3066
...
// public float2 get_RelativeSize() [instance] :3120
...
// public float get_RelativeX() [instance] :3123
...
// public float get_RelativeY() [instance] :3132
...
// public void RemoveSize(float2 size) [instance] :2918
...
// public void RemoveSize(float4 size) [instance] :2925
...
// public void Reset() [instance] :2866
...
// public void RetainMaxXY(bool x, bool y) [instance] :2944
...
// public void RetainXY(bool x, bool y) [instance] :2930
...
// private void SetFlag(Fuse.LayoutParams.Flags g, bool val) [instance] :2803
...
// public void SetRelativeSize(float2 sz, bool hasX, bool hasY) [instance] :2981
...
// public void SetSize(float2 xy, [bool hasX], [bool hasY]) [instance] :2958
...
// public void SetX(float x) [instance] :2969
...
// public void SetY(float y) [instance] :2975
...
// public float2 get_Size() [instance] :3108
...
// public bool get_Temporary() [instance] :2815
...
// public Fuse.LayoutParams TrueClone() [instance] :2844
...
// public float get_X() [instance] :3109
...
// public float get_Y() [instance] :3110
...
// public static Fuse.LayoutParams Create(float2 size) [static] :2881
...
// public static Fuse.LayoutParams CreateEmpty() [static] :2910
...
// public static Fuse.LayoutParams CreateTemporary(float2 size) [static] :2890
...
// public static Fuse.LayoutParams CreateXY(float2 size, bool hasX, bool hasY) [static] :2900
...
// public static class LayoutPriority :9543
// {
// static LayoutPriority() :9543
...
// private sealed class TranslationModes.LocalMode :9319
// {
...
// public generated LocalMode() :9319
void TranslationModes__LocalMode__ctor__fn(TranslationModes__LocalMode* __this)
{
    __this->ctor_();
}

// public float3 GetAbsVector(Fuse.Translation t) :9321
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :9322
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :9323
void TranslationModes__LocalMode::Unsubscribe(uObject* transform, uObject* sub)
{
}

// public generated LocalMode New() [static] :9319
...
// public enum MarginBoxDependent :5646
...
// internal sealed extern class MobileBootstrapping :3215
// {
static void MobileBootstrapping_build(uType* type)
{
    ::TYPES[7] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    ::TYPES[8] = ::g::Uno::EventHandler_typeof();
    ::TYPES[50] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    type->SetFields(0,
...
// internal static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) :3253
...
// private static void OnReceivedLowMemoryWarning(object sender, Uno.EventArgs args) :3284
...
// private static void OnStarted(Uno.Platform2.ApplicationState state) :3258
void MobileBootstrapping__OnStarted_fn(int* state)
{
    MobileBootstrapping::OnStarted(*state);
}

// private static void OnTerminating(Uno.Platform2.ApplicationState state) :3237
...
// public generated MobileBootstrapping() [instance] :3215
void MobileBootstrapping::ctor_()
{
}

// public static void Init() [static] :3218
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[50/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[50/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[50/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[50/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyReleased_fn));
}

// public generated MobileBootstrapping New() [static] :3215
...
// private static void OnEnterBackground(Uno.Platform2.ApplicationState state) [static] :3280
void MobileBootstrapping::OnEnterBackground(int state)
{
}

// private static void OnEnterForeground(Uno.Platform2.ApplicationState state) [static] :3263
...
// private static void OnEnterInteractive(Uno.Platform2.ApplicationState state) [static] :3268
...
// private static void OnExitInteractive(Uno.Platform2.ApplicationState state) [static] :3274
...
// internal static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) [static] :3248
...
// internal static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) [static] :3253
...
// private static void OnReceivedLowMemoryWarning(object sender, Uno.EventArgs args) [static] :3284
void MobileBootstrapping::OnReceivedLowMemoryWarning(uObject* sender, ::g::Uno::EventArgs* args)
{
}

// private static void OnStarted(Uno.Platform2.ApplicationState state) [static] :3258
...
// private static void OnTerminating(Uno.Platform2.ApplicationState state) [static] :3237
...
// public static class NameRegistry :8603
// {
// static NameRegistry() :8603
...
{
    ::TYPES[51] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof()));
    ::TYPES[52] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), ::g::Uno::UX::Selector_typeof());
    ::TYPES[53] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof()));
    ::TYPES[54] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof());
    ::TYPES[55] = ::g::Fuse::INameListener_typeof();
    ::TYPES[56] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof()));
    ::TYPES[57] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetFields(0,
...
// private static void NotifyNameChanged(Fuse.Node obj, Uno.UX.Selector name) :8686
void NameRegistry__NotifyNameChanged_fn(::g::Fuse::Node* obj, ::g::Uno::UX::Selector* name)
{
    NameRegistry::NotifyNameChanged(obj, *name);
}

// public static void RemoveListener(Fuse.INameListener listener) :8674
void NameRegistry__RemoveListener_fn(uObject* listener)
{
    NameRegistry::RemoveListener(listener);
}

// public static void SetName(Fuse.Node obj, Uno.UX.Selector name) :8609
...
// public static void AddListener(Uno.UX.Selector name, Fuse.INameListener listener) [static] :8664
void NameRegistry::AddListener(::g::Uno::UX::Selector name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[54/*Uno.Collections.List<Fuse.INameListener>*/]));
...
// public static void ClearName(Fuse.Node obj) [static] :8657
...
// public static Uno.UX.Selector GetName(Fuse.Node obj) [static] :8651
...
// internal static Uno.Collections.List<Fuse.Node> GetObjectsWithName(Uno.UX.Selector name) [static] :8644
...
// private static void NotifyNameChanged(Fuse.Node obj, Uno.UX.Selector name) [static] :8686
...
// public static void RemoveListener(Fuse.INameListener listener) [static] :8674
void NameRegistry::RemoveListener(uObject* listener)
{
    ...
    for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(NameRegistry::_listeners())->Values()), &ret14), ret14); enum1.MoveNext(::TYPES[56/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* list = enum1.Current(::TYPES[56/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]);
...
// public static void SetName(Fuse.Node obj, Uno.UX.Selector name) [static] :8609
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), &ret24), ret24))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[57/*Uno.Collections.List<Fuse.Node>*/]));
...
// public interfacemodifiers class Node :3314
// {
// static Node() :3631
static void Node__cctor__fn(uType* __type)
{
    Node::_emptyBindings_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[59/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Binding>*/], uArray::New(::TYPES[60/*Fuse.Binding[]*/], 0)));
    ::g::Fuse::Scripting::ScriptClass::Register(Node_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[62/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[64/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[40/*"_findData"*/], uDelegate::New(::TYPES[65/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___findData_fn), 2), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[41/*"findData"*/], 1, ::STRINGS[42/*"function(ke...*/])));
}

static void Node_build(uType* type)
{
    ::STRINGS[40] = uString::Const("_findData");
    ::STRINGS[41] = uString::Const("findData");
    ::STRINGS[42] = uString::Const("function(key) { var res = Observable(); this._findData(function(data) { res.value = data; }, key); return res.inner().notNull(); }");
    ::STRINGS[43] = uString::Const("Incomplete or duplicate rooting: ");
    ::STRINGS[44] = uString::Const("/");
    ::STRINGS[45] = uString::Const("Node is already rooted with a different parent");
    ::STRINGS[46] = uString::Const("Invalid RootStage post rooting: ");
    ::STRINGS[47] = uString::Const("  ");
    ::STRINGS[48] = uString::Const("Incomplete or duplicate unrooting: ");
    ::TYPES[58] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[59] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[60] = ::g::Fuse::Binding_typeof()->Array();
    ::TYPES[61] = ::g::Uno::Type_typeof();
    ::TYPES[62] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[63] = ::g::Fuse::Scripting::ScriptMember_typeof();
    ::TYPES[64] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(Node_typeof());
    ::TYPES[65] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), Node_typeof(), uObject_typeof()->Array());
    ::TYPES[66] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[67] = ::g::Uno::String_typeof();
    ::TYPES[68] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[69] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[12] = uObject_typeof();
    ::TYPES[70] = ::g::Fuse::Binding_typeof();
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[71] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[10] = ::g::Uno::Action1_typeof()->MakeType(Node_typeof());
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[72] = ::g::Fuse::Scripting::IObject_typeof();
    ::TYPES[73] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[74] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[8] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(20,
        ...
        new uFunction("GetLocalData", NULL, (void*)Node__GetLocalData_fn, 0, false, uObject_typeof()->Array(), 0),
...
Node_type* Node_typeof()
{
    ...
    type->fp_AppendLocalData = Node__AppendLocalData_fn;
...
// protected generated Node() :3314
void Node__ctor_1_fn(Node* __this)
{
    __this->ctor_1();
}

// private static void _findData(Fuse.Scripting.Context c, Fuse.Node n, object[] args) :3664
void Node___findData_fn(::g::Fuse::Scripting::Context* c, Node* n, uArray* args)
{
    Node::_findData(c, n, args);
}

// public void Add(Fuse.Binding item) :3468
void Node__Add_fn(Node* __this, ::g::Fuse::Binding* item)
{
    __this->Add(item);
}

// protected internal virtual void AppendLocalData(Uno.Collections.List<object> result) :3577
void Node__AppendLocalData_fn(Node* __this, ::g::Uno::Collections::List* result)
{
    uStackFrame __("Fuse.Node", "AppendLocalData(Uno.Collections.List<object>)");

    if (__this->ContextParent() != NULL)
        uPtr(__this->ContextParent())->GetImplicitDataForChild(__this, result);
}

// private Fuse.Binding get_Binding() :3416
void Node__get_Binding_fn(Node* __this, ::g::Fuse::Binding** __retval)
{
    *__retval = __this->Binding();
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() :3417
void Node__get_BindingList_fn(Node* __this, ::g::Uno::Collections::List** __retval)
{
    *__retval = __this->BindingList();
}

// public Uno.Collections.IList<Fuse.Binding> get_Bindings() :3412
void Node__get_Bindings_fn(Node* __this, uObject** __retval)
{
    *__retval = __this->Bindings();
}

// public Fuse.Node get_ContextParent() :3357
void Node__get_ContextParent_fn(Node* __this, Node** __retval)
{
    *__retval = __this->ContextParent();
}

// public generated void add_DataContextChanged(Uno.EventHandler value) :3614
void Node__add_DataContextChanged_fn(Node* __this, uDelegate* value)
{
    __this->add_DataContextChanged(value);
}

// public generated void remove_DataContextChanged(Uno.EventHandler value) :3614
void Node__remove_DataContextChanged_fn(Node* __this, uDelegate* value)
{
    __this->remove_DataContextChanged(value);
}

// private int DistanceTo(Fuse.Node obj, int reference) :3765
void Node__DistanceTo_fn(Node* __this, Node* obj, int* reference, int* __retval)
{
    *__retval = __this->DistanceTo(obj, *reference);
}

// public Fuse.Node FindNodeByName(Uno.UX.Selector name, [Uno.Predicate<Fuse.Node> acceptor]) :3740
...
// private Fuse.Scripting.Context Fuse.Scripting.IScriptObject.get_ScriptContext() :3326
...
// private object Fuse.Scripting.IScriptObject.get_ScriptObject() :3321
...
// private void Fuse.Scripting.IScriptObject.SetScriptObject(object obj, Fuse.Scripting.Context context) :3329
...
// protected virtual void OnRooted() :3869
...
// protected virtual void OnUnrooted() :3899
...
// private static object TryFindData(object obj, string key) :3693
void Node__TryFindData_fn(uObject* obj, uString* key, uObject** __retval)
{
    *__retval = Node::TryFindData(obj, key);
}

// public virtual bool TryGetResource(string key, Uno.Predicate<object> acceptor, object& resource) :3367
...
// private void Uno.Collections.ICollection<Fuse.Binding>.Clear() :3462
...
// private bool Uno.Collections.ICollection<Fuse.Binding>.Contains(Fuse.Binding item) :3487
...
// private int Uno.Collections.ICollection<Fuse.Binding>.get_Count() :3497
void Node__UnoCollectionsICollectionFuseBindingget_Count_fn(Node* __this, int* __retval)
{
    ...
    if (uIs((uObject*)__this->_bindings, ::TYPES[70/*Fuse.Binding*/]))
        return *__retval = 1, void();

    return *__retval = uPtr(__this->BindingList())->Count(), void();
}

// private Uno.Collections.IEnumerator<Fuse.Binding> Uno.Collections.IEnumerable<Fuse.Binding>.GetEnumerator() :3555
void Node__UnoCollectionsIEnumerableFuseBindingGetEnumerator_fn(Node* __this, uObject** __retval)
{
    ...
    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[70/*Fuse.Binding*/]), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->BindingList()), &ret9), ret9)), void();
}

// private Fuse.Binding Uno.Collections.IList<Fuse.Binding>.get_Item(int index) :3536
...
// private void Uno.Collections.IList<Fuse.Binding>.RemoveAt(int index) :3517
...
// protected generated Node() [instance] :3314
void Node::ctor_1()
{
...
// public void Add(Fuse.Binding item) [instance] :3468
void Node::Add(::g::Fuse::Binding* item)
{
    ...
    if (_bindings == NULL)
        _bindings = item;
    else if (uIs((uObject*)_bindings, ::TYPES[70/*Fuse.Binding*/]))
...
// private Fuse.Binding get_Binding() [instance] :3416
::g::Fuse::Binding* Node::Binding()
{
    uStackFrame __("Fuse.Node", "get_Binding()");
    return uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[70/*Fuse.Binding*/]);
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() [instance] :3417
::g::Uno::Collections::List* Node::BindingList()
{
    uStackFrame __("Fuse.Node", "get_BindingList()");
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[71/*Uno.Collections.List<Fuse.Binding>*/]);
}

// public Uno.Collections.IList<Fuse.Binding> get_Bindings() [instance] :3412
...
// public Fuse.Node get_ContextParent() [instance] :3357
...
// public generated void add_DataContextChanged(Uno.EventHandler value) [instance] :3614
void Node::add_DataContextChanged(uDelegate* value)
{
    uStackFrame __("Fuse.Node", "add_DataContextChanged(Uno.EventHandler)");
    DataContextChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(DataContextChanged1, value), ::TYPES[8/*Uno.EventHandler*/]);
}

// public generated void remove_DataContextChanged(Uno.EventHandler value) [instance] :3614
void Node::remove_DataContextChanged(uDelegate* value)
{
    uStackFrame __("Fuse.Node", "remove_DataContextChanged(Uno.EventHandler)");
    DataContextChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(DataContextChanged1, value), ::TYPES[8/*Uno.EventHandler*/]);
}

// private int DistanceTo(Fuse.Node obj, int reference) [instance] :3765
...
// public Fuse.Node FindNodeByName(Uno.UX.Selector name, [Uno.Predicate<Fuse.Node> acceptor]) [instance] :3740
...
// public object GetFirstData() [instance] :3590
uObject* Node::GetFirstData()
{
    uStackFrame __("Fuse.Node", "GetFirstData()");
    uObject* ret5;
    Node* n = this;
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<object>*/]);

    while (n != NULL)
    {
        uPtr(n)->AppendLocalData(list);
...
// public object[] GetLocalData() [instance] :3583
uArray* Node::GetLocalData()
{
    uStackFrame __("Fuse.Node", "GetLocalData()");
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<object>*/]);
    AppendLocalData(list);
    return (uArray*)list->ToArray();
}

// private bool HasInSubtree(Fuse.Node c) [instance] :3781
...
// public void Insert(int index, Fuse.Binding item) [instance] :3505
void Node::Insert(int index, ::g::Fuse::Binding* item)
{
    ...
    {
        if (uIs((uObject*)_bindings, ::TYPES[70/*Fuse.Binding*/]))
...
// internal bool get_IsPreservedRootFrame() [instance] :3927
...
// public bool get_IsRootingCompleted() [instance] :3826
...
// public bool get_IsRootingStarted() [instance] :3821
...
// internal bool get_IsUnrooting() [instance] :3828
...
// private void IterPreserveRootFrame(Fuse.Node n) [instance] :3942
...
// private void MakeBindingList(Fuse.Binding newItem) [instance] :3419
void Node::MakeBindingList(::g::Fuse::Binding* newItem)
{
    uStackFrame __("Fuse.Node", "MakeBindingList(Fuse.Binding)");
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[71/*Uno.Collections.List<Fuse.Binding>*/]);
    ::g::Fuse::Binding* oldItem = uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[70/*Fuse.Binding*/]);
...
// public Uno.UX.Selector get_Name() [instance] :3718
...
// public void set_Name(Uno.UX.Selector value) [instance] :3719
...
// public void OnDataContextChanged() [instance] :3603
...
// public Fuse.Visual get_Parent() [instance] :3349
...
// internal void PreserveRootFrame() [instance] :3937
...
// public Fuse.Properties get_Properties() [instance] :3339
...
// public bool Remove(Fuse.Binding item) [instance] :3477
bool Node::Remove(::g::Fuse::Binding* item)
{
    ...
    if ((_bindings == NULL) || uIs((uObject*)_bindings, ::TYPES[70/*Fuse.Binding*/]))
        return false;

    return (::g::Uno::Collections::List__Remove_fn(uPtr(BindingList()), item, &ret6), ret6);
}

// private void Root(Fuse.Binding b) [instance] :3428
...
// private void RootBindings() [instance] :3438
...
// internal generated void add_RootingCompleted(Uno.Action value) [instance] :3864
...
// internal generated void remove_RootingCompleted(Uno.Action value) [instance] :3864
...
// internal void RootInternal(Fuse.Visual parent) [instance] :3830
void Node::RootInternal(::g::Fuse::Visual* parent)
{
    uStackFrame __("Fuse.Node", "RootInternal(Fuse.Visual)");

    if (_rootStage != 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[43/*"Incomplete ...*/], this), ::STRINGS[44/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));

    if (_parent != NULL)
    {
        if (_parent != parent)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[45/*"Node is alr...*/]));
        else
            return;
    }
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[46/*"Invalid Roo...*/], this), ::STRINGS[44/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
}

// public string SubtreeToString() [instance] :3381
...
// private void Unroot(Fuse.Binding b) [instance] :3433
...
// private void UnrootBindings() [instance] :3450
...
// internal generated void add_Unrooted(Uno.Action value) [instance] :3874
...
// internal generated void remove_Unrooted(Uno.Action value) [instance] :3874
...
// internal void UnrootInternal() [instance] :3876
void Node::UnrootInternal()
{
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[48/*"Incomplete ...*/], this), ::STRINGS[44/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
...
// private static void _findData(Fuse.Scripting.Context c, Fuse.Node n, object[] args) [static] :3664
void Node::_findData(::g::Fuse::Scripting::Context* c, Node* n, uArray* args)
{
    ...
    Node_typeof()->Init();
    uObject* ret2;
    ::g::Fuse::Scripting::Function* callback = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[66/*Fuse.Scripting.Function*/]);
    uString* key = uAs<uString*>(args->Strong<uObject*>(1), ::TYPES[67/*string*/]);
    ...
    while (n != NULL)
    {
        ...
        if (uPtr(list)->Count() > 0)
        {
            for (int i = 0; i < uPtr(list)->Count(); i++)
            {
                ...
                if (res != NULL)
                {
                    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(c)->Dispatcher()), ::TYPES[69/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Node__CallFuncClosure__Run_fn, Node__CallFuncClosure::New1(callback, res)));
                    return;
                }
            }
...
// internal static void Relate(Fuse.Visual parent, Fuse.Node child) [static] :3904
...
// private static object TryFindData(object obj, string key) [static] :3693
uObject* Node::TryFindData(uObject* obj, uString* key)
{
    uStackFrame __("Fuse.Node", "TryFindData(object,string)");
    Node_typeof()->Init();
    uObject* om = uAs<uObject*>(obj, ::TYPES[72/*Fuse.Scripting.IObject*/]);

    if ((om != NULL) && ::g::Fuse::Scripting::IObject::ContainsKey(uInterface(uPtr(om), ::TYPES[72/*Fuse.Scripting.IObject*/]), key))
        return ::g::Fuse::Scripting::IObject::Item(uInterface(uPtr(om), ::TYPES[72/*Fuse.Scripting.IObject*/]), key);

    return NULL;
}

// internal static void Unrelate(Fuse.Visual parent, Fuse.Node child) [static] :3912
...
// public sealed class OrthographicFrustum :7313
// {
...
// public generated OrthographicFrustum() :7313
void OrthographicFrustum__ctor__fn(OrthographicFrustum* __this)
{
    __this->ctor_();
}

// public float2 GetDepthRange(Fuse.ICommonViewport viewport) :7385
...
// public float4x4 GetProjectionTransform(Fuse.ICommonViewport viewport) :7354
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) :7367
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) :7359
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) :7372
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) :7380
...
// public float4x4 get_LocalFromWorld() :7346
...
// public void set_LocalFromWorld(float4x4 value) :7347
...
// private float4x4 MatrixProjection(float2 viewSize) :7404
...
// private float4x4 MatrixProjectionInverse(float2 viewSize) :7409
...
// private float4x4 MatrixView(float2 origin, float2 viewSize) :7390
...
// private float4x4 MatrixViewInverse(float2 origin, float2 viewSize) :7397
...
// public float2 GetDepthRange(Fuse.ICommonViewport viewport) [instance] :7385
...
// public float4x4 GetProjectionTransform(Fuse.ICommonViewport viewport) [instance] :7354
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) [instance] :7367
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) [instance] :7359
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) [instance] :7372
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) [instance] :7380
...
// public float4x4 get_LocalFromWorld() [instance] :7346
...
// public void set_LocalFromWorld(float4x4 value) [instance] :7347
...
// private float4x4 MatrixProjection(float2 viewSize) [instance] :7404
...
// private float4x4 MatrixProjectionInverse(float2 viewSize) [instance] :7409
...
// private float4x4 MatrixView(float2 origin, float2 viewSize) [instance] :7390
...
// private float4x4 MatrixViewInverse(float2 origin, float2 viewSize) [instance] :7397
...
// public float2 get_Origin() [instance] :7319
...
// public void set_Origin(float2 value) [instance] :7320
...
// public float2 get_Size() [instance] :7331
...
// public void set_Size(float2 value) [instance] :7335
...
// public generated OrthographicFrustum New() [static] :7313
...
// private sealed class Visual.ParameterProperty :6350
// {
// static ParameterProperty() :6350
static void Visual__ParameterProperty__cctor__fn(uType* __type)
{
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[49/*"Parameter"*/]);
}

static void Visual__ParameterProperty_build(uType* type)
{
    ::STRINGS[49] = uString::Const("Parameter");
    ::TYPES[75] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(1,
...
// public ParameterProperty New(Fuse.Visual visual) :6358
...
// public override sealed Uno.UX.PropertyObject get_Object() :6353
...
// public override sealed void Set(string value, Uno.UX.IPropertyListener origin) :6356
...
// public override sealed bool get_SupportsOriginSetter() :6354
...
// public ParameterProperty(Fuse.Visual visual) [instance] :6358
...
// public ParameterProperty New(Fuse.Visual visual) [static] :6358
...
// private sealed class TranslationModes.ParentSizeMode :9342
// {
static void TranslationModes__ParentSizeMode_build(uType* type)
{
    ::TYPES[0] = ::g::Fuse::Node_typeof();
    ::TYPES[76] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[77] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[78] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[12] = uObject_typeof();
    type->SetInterfaces(
...
// public generated ParentSizeMode New() :9342
...
// public object Subscribe(Fuse.ITransformRelative transform) :9345
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :9352
...
// public generated ParentSizeMode() [instance] :9342
void TranslationModes__ParentSizeMode::ctor_()
{
}

// public float3 GetAbsVector(Fuse.Translation t) [instance] :9344
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :9345
uObject* TranslationModes__ParentSizeMode::Subscribe(uObject* transform)
{
    ...
    uObject* n = uAs<uObject*>(uPtr(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[77/*Fuse.ITransformRelative*/])))->Parent(), ::TYPES[76/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[76/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[78/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[77/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return n;
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :9352
void TranslationModes__ParentSizeMode::Unsubscribe(uObject* transform, uObject* sub)
{
    ...
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[76/*Fuse.IActualPlacement*/])), ::TYPES[76/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[78/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[77/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}

// public generated ParentSizeMode New() [static] :9342
...
// public sealed class PendingRemoveVisual :4220
// {
...
// internal PendingRemoveVisual(Fuse.Visual child, Fuse.Visual parent, Uno.Action then) :4227
...
// public void AddSubscriber() [instance] :4235
...
// public generated Fuse.Visual get_Child() [instance] :4223
...
// private generated void set_Child(Fuse.Visual value) [instance] :4223
...
// public bool get_HasSubscribers() [instance] :4251
...
// public generated Fuse.Visual get_Parent() [instance] :4222
...
// private generated void set_Parent(Fuse.Visual value) [instance] :4222
...
// public void Remove() [instance] :4255
...
// public void RemoveSubscriber() [instance] :4240
...
// internal PendingRemoveVisual New(Fuse.Visual child, Fuse.Visual parent, Uno.Action then) [static] :4227
...
// public sealed class PerspectiveFrustum :7426
// {
...
// public generated void set_Distance(float value) [instance] :7428
...
// public float2 GetDepthRange(Fuse.ICommonViewport viewport) [instance] :7462
...
// public float4x4 GetProjectionTransform(Fuse.ICommonViewport viewport) [instance] :7432
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) [instance] :7443
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) [instance] :7438
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) [instance] :7450
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) [instance] :7455
...
// public generated PerspectiveFrustum New() [static] :7426
...
// public sealed class PlacedArgs :9278
// {
...
// internal PlacedArgs(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) :9286
...
// public object get_DefaultValue() [instance] :9299
...
// public generated bool get_HasPrev() [instance] :9280
...
// private generated void set_HasPrev(bool value) [instance] :9280
...
// public generated float2 get_NewPosition() [instance] :9284
...
// private generated void set_NewPosition(float2 value) [instance] :9284
...
// public generated float2 get_NewSize() [instance] :9283
...
// private generated void set_NewSize(float2 value) [instance] :9283
...
// public generated float2 get_PrevPosition() [instance] :9281
...
// private generated void set_PrevPosition(float2 value) [instance] :9281
...
// public generated float2 get_PrevSize() [instance] :9282
...
// private generated void set_PrevSize(float2 value) [instance] :9282
...
// public void Serialize(Fuse.Scripting.IEventSerializer serializer) [instance] :9296
void PlacedArgs::Serialize(uObject* serializer)
{
}

// internal PlacedArgs New(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) [static] :9286
...
// public delegate void PlacedHandler(object sender, Fuse.PlacedArgs args) :9303
...
// public sealed class Properties :7909
// {
// static Properties() :7909
...
// public static Fuse.PropertyHandle CreateHandle() :7915
void Properties__CreateHandle_fn(::g::Fuse::PropertyHandle** __retval)
{
    *__retval = Properties::CreateHandle();
}

// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object[]> action, object[] state) :8026
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object> action, object state) :8009
...
// public void RemoveFromList(Fuse.PropertyHandle handle, object val) :7978
...
// public generated Properties() [instance] :7909
void Properties::ctor_()
{
}

// public void AddToList(Fuse.PropertyHandle handle, object val) [instance] :7960
...
// public void Clear(Fuse.PropertyHandle handle) [instance] :8043
...
// private void Clear(Fuse.PropertyHandle handle, object val, bool all) [instance] :8050
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object[]> action, object[] state) [instance] :8026
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object> action, object state) [instance] :8009
...
// public object Get(Fuse.PropertyHandle handle) [instance] :7920
...
// public bool Has(Fuse.PropertyHandle handle) [instance] :7935
...
// public void RemoveAllFromList(Fuse.PropertyHandle handle, object val) [instance] :7983
...
// public void RemoveFromList(Fuse.PropertyHandle handle, object val) [instance] :7978
...
// public void Set(Fuse.PropertyHandle handle, object val) [instance] :7942
...
// public bool TryGet(Fuse.PropertyHandle handle, object& val) [instance] :7927
...
// public static Fuse.PropertyHandle CreateHandle() [static] :7915
...
// public generated Properties New() [static] :7909
...
// public sealed class PropertyHandle :7904
// {
...
// public enum PropertyState :6120
...
// public abstract class RelativeTransform<TransformMode> :9167
// {
static void RelativeTransform_build(uType* type)
{
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[79] = ::g::Fuse::ITransformMode_typeof();
    ::TYPES[77] = ::g::Fuse::ITransformRelative_typeof();
    type->SetInterfaces(
...
// private Fuse.Visual Fuse.ITransformRelative.get_RelativeNode() :9205
...
// private Fuse.Visual Fuse.ITransformRelative.get_Target() :9204
...
// protected override sealed void OnRooted() :9208
...
// private void CheckSubscription(bool fromRooted) [instance] :9246
void RelativeTransform::CheckSubscription(bool fromRooted)
{
    ...
    if ((RelativeNode() != NULL) && !uPtr(RelativeNode())->IsRootingStarted())
    {
        ...
        uPtr(_waitRootingCompleted)->add_RootingCompleted(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)RelativeTransform__OnRootingCompleted_fn, this));
        return;
    }

    ClearSubscription();
    _subscription = ::g::Fuse::ITransformMode::Subscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[79/*Fuse.ITransformMode*/])), ::TYPES[79/*Fuse.ITransformMode*/]), (uObject*)this);
    OnMatrixChanged(NULL, NULL);
}

// private void ClearRootingCompleted() [instance] :9232
void RelativeTransform::ClearRootingCompleted()
{
    ...
    {
        uPtr(_waitRootingCompleted)->remove_RootingCompleted(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)RelativeTransform__OnRootingCompleted_fn, this));
        _waitRootingCompleted = NULL;
    }
}

// private void ClearSubscription() [instance] :9221
void RelativeTransform::ClearSubscription()
{
    ...
    {
        ::g::Fuse::ITransformMode::Unsubscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[79/*Fuse.ITransformMode*/])), ::TYPES[79/*Fuse.ITransformMode*/]), (uObject*)this, _subscription);
        _subscription = NULL;
    }
}

// private void OnRootingCompleted() [instance] :9240
...
// public Fuse.Visual get_RelativeNode() [instance] :9173
...
// public void set_RelativeNode(Fuse.Visual value) [instance] :9174
...
// public TransformMode get_RelativeTo() [instance] :9187
...
// public void set_RelativeTo(TransformMode value) [instance] :9188
...
// internal sealed class RenderTargetEntry :803
// {
...
// public extern RenderTargetEntry(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) :810
...
// public extern RenderTargetEntry New(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) :810
...
// public extern RenderTargetEntry(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) [instance] :810
...
// public extern RenderTargetEntry New(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) [static] :810
...
// private sealed class Diagnostics.ReportAction :664
// {
...
void Diagnostics__ReportAction::Post()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(::g::Fuse::Diagnostics::DiagnosticReported1_, NULL))
        ...
        ::g::Uno::Diagnostics::Debug::Log4(uPtr(Diagnostic)->ToString(), uPtr(Diagnostic)->UnoType());
}

// public generated ReportAction New() [static] :664
...
// public sealed class RequestBringIntoViewArgs :5658
// {
...
// public RequestBringIntoViewArgs(Fuse.Visual elm) :5661
void RequestBringIntoViewArgs__ctor_1_fn(RequestBringIntoViewArgs* __this, ::g::Fuse::Visual* elm)
{
    __this->ctor_1(elm);
}

// public RequestBringIntoViewArgs New(Fuse.Visual elm) :5661
...
// public generated Fuse.Visual get_Visual() [instance] :5660
...
// private generated void set_Visual(Fuse.Visual value) [instance] :5660
...
// public RequestBringIntoViewArgs New(Fuse.Visual elm) [static] :5661
...
// public delegate void RequestBringIntoViewHandler(object sender, Fuse.RequestBringIntoViewArgs args) :5667
...
// public sealed class RequiresRootedException :6814
// {
...
// public class RootViewport :8237
// {
static void RootViewport_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    ::TYPES[80] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[4] = ::g::Uno::Exception_typeof();
    ::TYPES[36] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[81] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetInterfaces(
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) :8243
...
// public override sealed void Draw(Fuse.DrawContext dc) :8268
void RootViewport__Draw_fn(RootViewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), ::TYPES[5/*Fuse.Visual*/]);
        uPtr(v)->Draw(dc);
    }
}

// private void EstablishSize() :8320
void RootViewport__EstablishSize_fn(RootViewport* __this)
{
    __this->EstablishSize();
}

// private extern void EstablishSizeInternals() :8382
void RootViewport__EstablishSizeInternals_fn(RootViewport* __this)
{
    __this->EstablishSizeInternals();
}

// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) :8243
...
// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :8434
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) [instance] :8243
...
// private void EstablishSize() [instance] :8320
...
// private extern void EstablishSizeInternals() [instance] :8382
...
// private void OnGotFocus(object sender, Uno.EventArgs args) [instance] :8277
...
// private void OnLostFocus(object sender, Uno.EventArgs args) [instance] :8289
...
// internal void OnResized(object s, object a) [instance] :8301
...
// public float2 get_PixelSize() [instance] :8413
...
// internal float get_PixelsPerOSPoint() [instance] :8395
...
// public float get_PixelsPerPoint() [instance] :8400
...
// public Uno.Geometry.Ray PointToWorldRay(float2 pixelPos) [instance] :8430
...
// public float4x4 get_ProjectionTransform() [instance] :8417
...
// public float4x4 get_ProjectionTransformInverse() [instance] :8419
...
// public generated void add_Resized(Uno.Action<float2> value) [instance] :8241
void RootViewport::add_Resized(uDelegate* value)
{
    uStackFrame __("Fuse.RootViewport", "add_Resized(Uno.Action<float2>)");
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Resized1, value), ::TYPES[81/*Uno.Action<float2>*/]);
}

// public generated void remove_Resized(Uno.Action<float2> value) [instance] :8241
void RootViewport::remove_Resized(uDelegate* value)
{
    uStackFrame __("Fuse.RootViewport", "remove_Resized(Uno.Action<float2>)");
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Resized1, value), ::TYPES[81/*Uno.Action<float2>*/]);
}

// public float2 get_Size() [instance] :8407
...
// public float3 get_ViewOrigin() [instance] :8428
...
// public float4x4 get_ViewProjectionTransform() [instance] :8421
...
// public float4x4 get_ViewProjectionTransformInverse() [instance] :8423
...
// public float2 get_ViewRange() [instance] :8429
...
// public float4x4 get_ViewTransform() [instance] :8427
...
// public float4x4 get_ViewTransformInverse() [instance] :8425
...
// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [instance] :8434
...
// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) [static] :8243
...
// public sealed class Rotation :8928
// {
...
// public generated Rotation() :8928
void Rotation__ctor_3_fn(Rotation* __this)
{
    __this->ctor_3();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9027
...
// public generated Rotation New() :8928
void Rotation__New2_fn(Rotation** __retval)
{
    *__retval = Rotation::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9033
...
// public generated Rotation() [instance] :8928
...
// public float get_Degrees() [instance] :8966
...
// public void set_Degrees(float value) [instance] :8967
...
// public float get_DegreesX() [instance] :9006
...
// public void set_DegreesX(float value) [instance] :9007
...
// public float get_DegreesY() [instance] :8992
...
// public void set_DegreesY(float value) [instance] :8993
...
// public float get_DegreesZ() [instance] :8975
...
// public void set_DegreesZ(float value) [instance] :8976
...
// public float3 get_EulerAngle() [instance] :8934
...
// public void set_EulerAngle(float3 value) [instance] :8935
...
// public float3 get_EulerAngleDegrees() [instance] :8948
...
// public void set_EulerAngleDegrees(float3 value) [instance] :8949
...
// private bool get_HasRotation() [instance] :9020
...
// public generated Rotation New() [static] :8928
...
// public sealed class Scaling :8487
// {
static void Scaling_build(uType* type)
{
    ::TYPES[82] = ::g::Fuse::IScalingMode_typeof();
    type->SetInterfaces(
...
// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :8566
...
// private float3 get_EffectiveVector() [instance] :8553
::g::Uno::Float3 Scaling::EffectiveVector()
{
    uStackFrame __("Fuse.Scaling", "get_EffectiveVector()");
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[82/*Fuse.IScalingMode*/]), this);
}

// public float get_Factor() [instance] :8500
...
// public void set_Factor(float value) [instance] :8501
...
// private bool IsIdentity(float3 v) [instance] :8559
...
// public float3 get_Vector() [instance] :8519
...
// public void set_Vector(float3 value) [instance] :8520
...
// public float get_X() [instance] :8533
float Scaling::X()
{
...
// public void set_X(float value) [instance] :8534
...
// public float get_Y() [instance] :8540
float Scaling::Y()
{
...
// public void set_Y(float value) [instance] :8541
...
// public float get_Z() [instance] :8547
float Scaling::Z()
{
...
// public void set_Z(float value) [instance] :8548
...
// public Scaling New() [static] :8489
...
// public static class ScalingModes :8455
// {
// static ScalingModes() :8455
...
// public sealed class Shear :9051
// {
...
// public generated Shear() :9051
void Shear__ctor_3_fn(Shear* __this)
{
    __this->ctor_3();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9109
...
// public generated Shear New() :9051
void Shear__New2_fn(Shear** __retval)
{
    *__retval = Shear::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9115
...
// public float2 get_Degrees() [instance] :9101
...
// public void set_Degrees(float2 value) [instance] :9102
...
// public float get_DegreesX() [instance] :9071
...
// public void set_DegreesX(float value) [instance] :9072
...
// public float get_DegreesY() [instance] :9086
...
// public void set_DegreesY(float value) [instance] :9087
...
// public float2 get_Vector() [instance] :9057
...
// public void set_Vector(float2 value) [instance] :9058
...
// public generated Shear New() [static] :9051
Shear* Shear::New2()
{
...
// private class TranslationModes.SizeMode :9326
// {
...
// public generated SizeMode() :9326
void TranslationModes__SizeMode__ctor__fn(TranslationModes__SizeMode* __this)
{
    __this->ctor_();
}

// public virtual float3 GetAbsVector(Fuse.Translation t) :9328
...
uObject* TranslationModes__SizeMode::Subscribe(uObject* transform)
{
    ...
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[77/*Fuse.ITransformRelative*/])), ::TYPES[76/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[76/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[78/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[77/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return ::g::Fuse::ITransformRelative::RelativeNode(uInterface(transform, ::TYPES[77/*Fuse.ITransformRelative*/]));
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :9336
...
// public generated SizeMode New() [static] :9326
...
// internal sealed class Stage :9583
// {
static void Stage_build(uType* type)
{
    ::TYPES[83] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof());
    ::TYPES[84] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateAction_typeof());
    type->SetFields(0,
...
// public Stage(Fuse.UpdateStage _updateStage) :9596
void Stage__ctor__fn(Stage* __this, int* _updateStage)
{
    __this->ctor_(*_updateStage);
}

// public void AddDeferredAction(Uno.Action pu, [int priority]) :9620
void Stage__AddDeferredAction_fn(Stage* __this, uDelegate* pu, int* priority)
{
    __this->AddDeferredAction(pu, *priority);
}

// public void Insert(Uno.Collections.List<Fuse.UpdateListener> list, Fuse.UpdateListener us) :9602
void Stage__Insert_fn(Stage* __this, ::g::Uno::Collections::List* list, ::g::Fuse::UpdateListener* us)
{
    __this->Insert(list, us);
}

// public Stage New(Fuse.UpdateStage _updateStage) :9596
void Stage__New1_fn(int* _updateStage, Stage** __retval)
{
    *__retval = Stage::New1(*_updateStage);
}

// public void ResetDeferredActions() :9631
void Stage__ResetDeferredActions_fn(Stage* __this)
{
    __this->ResetDeferredActions();
}

// public Stage(Fuse.UpdateStage _updateStage) [instance] :9596
void Stage::ctor_(int _updateStage)
{
    uStackFrame __("Fuse.Stage", ".ctor(Fuse.UpdateStage)");
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[83/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[83/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[83/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    PhaseDeferredActions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[84/*Uno.Collections.List<Fuse.UpdateAction>*/]));
    PhaseDeferredActionsAt = -1;
    UpdateStage = _updateStage;
}

// public void AddDeferredAction(Uno.Action pu, [int priority]) [instance] :9620
...
// public void Insert(Uno.Collections.List<Fuse.UpdateListener> list, Fuse.UpdateListener us) [instance] :9602
...
// public void ResetDeferredActions() [instance] :9631
...
// public Stage New(Fuse.UpdateStage _updateStage) [static] :9596
...
// internal static void Init(double start) [static] :8814
...
// internal static void Set(double current) [static] :8823
...
// public static double get_FrameInterval() [static] :8848
...
// public static float get_FrameIntervalFloat() [static] :8860
...
// public static double get_FrameTime() [static] :8841
...
// public static double get_FrameTimeBase() [static] :8854
...
// public sealed class Timer :8741
// {
...
// private void Start() [instance] :8757
void Timer::Start()
{
...
// private void Stop() [instance] :8764
void Timer::Stop()
{
...
// private void Update() [instance] :8770
void Timer::Update()
{
...
// private Timer New(double interval, Uno.Action callback) [static] :8749
...
// public static void Wait(double duration, Uno.Action callback) [static] :8791
...
// public sealed class Toast :8106
// {
// static Toast() :8106
static void Toast__cctor__fn(uType* __type)
{
    Toast::_queue_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[85/*Uno.Collections.List<Fuse.Toast>*/]));
}

static void Toast_build(uType* type)
{
    ::TYPES[85] = ::g::Uno::Collections::List_typeof()->MakeType(Toast_typeof());
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[0] = ::g::Fuse::Node_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[80] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
...
// private Toast(Fuse.Visual visual, double duration) [instance] :8114
...
// public void Dismiss() [instance] :8145
void Toast::Dismiss()
{
    ...
    {
        if ((::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(::g::Fuse::AppBase::Current1())->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), _visual, &ret4), ret4))
        {
            Toast::_ongoing() = NULL;
...
// private static void DispatchNext() [static] :8120
void Toast::DispatchNext()
{
    ...
    ::g::Uno::Collections::IList::Insert_ex(uInterface(uPtr(uPtr(::g::Fuse::AppBase::Current1())->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(0), uPtr(Toast::_ongoing())->_visual);
...
// private Toast New(Fuse.Visual visual, double duration) [static] :8114
...
// public static void OnUnrooted(Fuse.Visual toast) [static] :8139
...
// public static Fuse.Toast Post(Fuse.Visual visual, [double duration]) [static] :8167
...
// public abstract class Transform :8891
// {
static void Transform_build(uType* type)
{
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[86] = ::g::Uno::Action1_typeof()->MakeType(Transform_typeof());
    type->SetInterfaces(
...
// internal Transform() :8911
void Transform__ctor_2_fn(Transform* __this)
{
    __this->ctor_2();
}

// internal generated void add_MatrixChanged(Uno.Action<Fuse.Transform> value) :8896
void Transform__add_MatrixChanged_fn(Transform* __this, uDelegate* value)
{
    __this->add_MatrixChanged(value);
}

// internal generated void remove_MatrixChanged(Uno.Action<Fuse.Transform> value) :8896
void Transform__remove_MatrixChanged_fn(Transform* __this, uDelegate* value)
{
    __this->remove_MatrixChanged(value);
}

// protected void OnMatrixChanged([object igoreSender], [object ignoreArgs]) :8898
...
// internal Transform() [instance] :8911
...
// internal generated void add_MatrixChanged(Uno.Action<Fuse.Transform> value) [instance] :8896
void Transform::add_MatrixChanged(uDelegate* value)
{
    ...
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[86/*Uno.Action<Fuse.Transform>*/]);
}

// internal generated void remove_MatrixChanged(Uno.Action<Fuse.Transform> value) [instance] :8896
void Transform::remove_MatrixChanged(uDelegate* value)
{
    ...
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[86/*Uno.Action<Fuse.Transform>*/]);
}

// protected void OnMatrixChanged([object igoreSender], [object ignoreArgs]) [instance] :8898
...
// public sealed class Translation :9400
// {
static void Translation_build(uType* type)
{
    ::TYPES[87] = ::g::Fuse::ITranslationMode_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::RelativeTransform_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::RelativeTransform_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::RelativeTransform_type, interface2),
...
// public Translation() :9402
void Translation__ctor_4_fn(Translation* __this)
{
    __this->ctor_4();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9501
void Translation__AppendTo_fn(Translation* __this, ::g::Fuse::FastMatrix* m, float* weight)
{
    ...
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[87/*Fuse.ITranslationMode*/]), __this), weight_);
    uPtr(m)->AppendTranslation(v.X, v.Y, v.Z);
}

// public override sealed bool get_IsFlat() :9515
...
// public Translation New() :9402
void Translation__New2_fn(Translation** __retval)
{
    *__retval = Translation::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9507
...
// public float3 get_Vector() [instance] :9487
...
// public void set_Vector(float3 value) [instance] :9488
...
// public float get_X() [instance] :9414
float Translation::X()
{
...
// public void set_X(float value) [instance] :9415
...
// public float2 get_XY() [instance] :9432
...
// public void set_XY(float2 value) [instance] :9433
...
// public float get_Y() [instance] :9452
float Translation::Y()
{
...
// public void set_Y(float value) [instance] :9453
...
// public float get_Z() [instance] :9471
float Translation::Z()
{
...
// public void set_Z(float value) [instance] :9472
...
// public Translation New() [static] :9402
...
// public static class TranslationModes :9317
// {
// static TranslationModes() :9317
...
// private static float3 SizeOf(Fuse.Node node) :9359
...
// private static float3 SizeOf(Fuse.Node node) [static] :9359
::g::Uno::Float3 TranslationModes::SizeOf(::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[76/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return ::g::Uno::Float3__New1(0.0f);

    return ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[76/*Fuse.IActualPlacement*/]));
}
// }
...
// internal struct UpdateAction :9577
// {
...
// internal sealed class UpdateDispatcher :9638
// {
...
// public generated UpdateDispatcher New() [static] :9638
...
// internal sealed class UpdateListener :9555
// {
static void UpdateListener_build(uType* type)
{
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[88] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
...
void UpdateListener::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[88/*Fuse.IUpdateListener*/]));
}

// public generated UpdateListener New() [static] :9555
...
// public static class UpdateManager :9646
// {
// static UpdateManager() :9653
static void UpdateManager__cctor__fn(uType* __type)
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[89/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[90/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[90/*Uno.Collections.List<Uno.Action>*/]));
...
{
    ::STRINGS[50] = uString::Const("Unexpected exception");
    ::STRINGS[51] = uString::Const("no Action found to remove");
    ::STRINGS[52] = uString::Const("no OnceAction found to remove");
    ::TYPES[89] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof());
    ::TYPES[90] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[69] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[91] = ::g::Fuse::UpdateStage_typeof();
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[92] = ::g::Uno::IDisposable_typeof();
    ::TYPES[4] = ::g::Uno::Exception_typeof();
    ::TYPES[93] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[12] = uObject_typeof();
    type->SetFields(0,
...
// public static void AddAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) :9673
void UpdateManager__AddAction_fn(uObject* pu, int* stage)
{
    UpdateManager::AddAction(pu, *stage);
}

// public static void AddAction(Uno.Action pu, [Fuse.UpdateStage stage]) :9662
void UpdateManager__AddAction1_fn(uDelegate* pu, int* stage)
{
    UpdateManager::AddAction1(pu, *stage);
}

// public static void AddDeferredAction(Uno.Action pu, [Fuse.UpdateStage stage], [int priority]) :9764
...
// public static void RemoveOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) :9724
void UpdateManager__RemoveOnceAction_fn(uDelegate* pu, int* stage)
{
    UpdateManager::RemoveOnceAction(pu, *stage);
}

// public static void Update() :9782
void UpdateManager__Update_fn()
{
    UpdateManager::Update();
}

// private static void Update(Fuse.Stage stage) :9801
...
// public static void AddAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) [static] :9673
...
// public static void AddAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9662
...
// public static void AddDeferredAction(Uno.Action pu, [Fuse.UpdateStage stage], [int priority]) [static] :9764
...
// public static void AddDeferredAction(Uno.Action pu, int priority) [static] :9771
...
// public static void AddOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9717
...
// private static void CheckExceptions(Uno.Collections.List<Uno.Exception> exs) [static] :9923
void UpdateManager::CheckExceptions(::g::Uno::Collections::List* exs)
{
    ...
    {
        if (uPtr(exs)->Count() == 1)
            U_THROW(::g::Uno::Exception::New3(::STRINGS[50/*"Unexpected ...*/], (::g::Uno::Collections::List__get_Item_fn(uPtr(exs), uCRef<int>(0), &ret6), ret6)));
        else
            U_THROW(::g::Uno::AggregateException::New7((uArray*)uPtr(exs)->ToArray()));
    }
}

// public static void IncreaseFrameIndex() [static] :9776
...
// public static void PerformNextFrame(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9734
...
// public static void PostAction(Uno.Action pu) [static] :9748
void UpdateManager::PostAction(uDelegate* pu)
{
...

    {
        ...
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr(lg), ::TYPES[92/*Uno.IDisposable*/]));
        };
...
// private static void ProcessPostActions() [static] :9887
    ...
    while (true)
    {
        ...
        for (int i = 0; i < uPtr(a)->Count(); ++i)
            ...
            catch (const uThrowable& __t)
            {
                ...
                if (_exceptions == NULL)
                    _exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[93/*Uno.Collections.List<Uno.Exception>*/]);
...
// public static void RemoveAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) [static] :9709
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[51/*"no Action f...*/]));

    uPtr(s)->HasListenersRemoved = true;
}

// public static void RemoveAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9701
...
// private static bool RemoveFrom(Uno.Collections.List<Fuse.UpdateListener> list, Uno.Action action, Fuse.IUpdateListener update) [static] :9683
...
// public static void RemoveOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9724
void UpdateManager::RemoveOnceAction(uDelegate* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Onces, pu, NULL))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[52/*"no OnceActi...*/]));
}

// public static void Update() [static] :9782
...
// private static void Update(Fuse.Stage stage) [static] :9801
...
// public static int get_FrameIndex() [static] :9937
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(UserEvent_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[62/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[94/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[53/*"raise"*/], uDelegate::New(::TYPES[95/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[53] = uString::Const("raise");
    ::STRINGS[54] = uString::Const("UserEvent requires a Name");
    ::STRINGS[55] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.33.5\\$.uno");
    ::STRINGS[56] = uString::Const("OnRooted");
    ::STRINGS[57] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[58] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[59] = uString::Const("Trying to Raise on unrooted UserEvent");
    ::STRINGS[60] = uString::Const("Raise");
    ::STRINGS[61] = uString::Const("Unknown event: ");
    ::STRINGS[62] = uString::Const("RaiseEvent");
    ::TYPES[61] = ::g::Uno::Type_typeof();
    ::TYPES[62] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[63] = ::g::Fuse::Scripting::ScriptMember_typeof();
    ::TYPES[94] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(UserEvent_typeof());
    ::TYPES[95] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), UserEvent_typeof(), uObject_typeof()->Array());
    ::TYPES[12] = uObject_typeof();
    ::TYPES[96] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[97] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[0] = ::g::Fuse::Node_typeof();
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[80] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"UserEvent r...*/], __this, ::STRINGS[55/*"C:\\Program...*/], 482, ::STRINGS[56/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[59/*"Trying to R...*/], this, ::STRINGS[55/*"C:\\Program...*/], 529, ::STRINGS[60/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[57/*"Raise must ...*/], n, ::STRINGS[55/*"C:\\Program...*/], 326, ::STRINGS[53/*"raise"*/]);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[96/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[58/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[55/*"C:\\Program...*/], 333, ::STRINGS[53/*"raise"*/]);
        return;
    }

    uArray* keys = uPtr(so)->Keys();
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[97/*Uno.Collections.Dictionary<string, object>*/]);
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[61/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[55/*"C:\\Program...*/], 542, ::STRINGS[62/*"RaiseEvent"*/]);
        return;
    }
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(at, ::TYPES[5/*Fuse.Visual*/]);
        ...
        if (v != NULL)
            ...
            {
                UserEvent* ue = uAs<UserEvent*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), UserEvent_typeof());
...
{
    ::STRINGS[63] = uString::Const("name");
    ::TYPES[98] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    ::TYPES[99] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[100] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[63/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));

    if (__this->Args() != NULL)

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->Args()), &ret3), ret3); enum1.MoveNext(::TYPES[99/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > m = enum1.Current(::TYPES[99/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[98/*Fuse.Scripting.IEventSerializer*/]), m.Key(::TYPES[100/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[100/*Uno.Collections.KeyValuePair<string, object>*/]));
        }
}
...
{
    UserEventDispatch::_userEvents_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[101/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/]));
}

static void UserEventDispatch_build(uType* type)
{
    ::TYPES[101] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), UserEventDispatch_typeof());
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[12] = uObject_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[102] = ::g::Fuse::UserEventHandler_typeof();
    type->SetFields(0,
...
void UserEventDispatch::add_Raised(uDelegate* value)
{
    ...
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[102/*Fuse.UserEventHandler*/]);
}
...
void UserEventDispatch::remove_Raised(uDelegate* value)
{
    ...
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[102/*Fuse.UserEventHandler*/]);
}
...
// public interfacemodifiers class Visual :4271
// {
// static Visual() :6342
static void Visual__cctor_1_fn(uType* __type)
{
    Visual::_emptyChildren_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[104/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Node>*/], uArray::New(::TYPES[105/*Fuse.Node[]*/], 0)));
    ...
    Visual::ParameterName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[49/*"Parameter"*/]);
    Visual::_worldTransformInvalidatedHandle_ = ::g::Fuse::Properties::CreateHandle();
    ::g::Fuse::Scripting::ScriptClass::Register(Visual_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[62/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[106/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[49/*"Parameter"*/], uDelegate::New(::TYPES[107/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[64/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[108/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[65/*"onParameter...*/], uDelegate::New(::TYPES[109/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[108/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[66/*"bringIntoView"*/], uDelegate::New(::TYPES[109/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[49] = uString::Const("Parameter");
    ::STRINGS[64] = uString::Const(".notNull().parseJson()");
    ::STRINGS[65] = uString::Const("onParameterChanged");
    ::STRINGS[66] = uString::Const("bringIntoView");
    ::STRINGS[67] = uString::Const("index");
    ::STRINGS[68] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[69] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[103] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[104] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[105] = ::g::Fuse::Node_typeof()->Array();
    ::TYPES[61] = ::g::Uno::Type_typeof();
    ::TYPES[62] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[63] = ::g::Fuse::Scripting::ScriptMember_typeof();
    ::TYPES[106] = ::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(Visual_typeof(), ::g::Uno::String_typeof());
    ::TYPES[107] = ::g::Uno::Func1_typeof()->MakeType(Visual_typeof(), ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()));
    ::TYPES[108] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(Visual_typeof());
    ::TYPES[109] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), Visual_typeof(), uObject_typeof()->Array());
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[110] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::Function_typeof());
    ::TYPES[111] = ::g::Fuse::Scripting::IScriptObject_typeof();
    ::TYPES[18] = uObject_typeof()->Array();
    ::TYPES[112] = ::g::Fuse::IDataProvider_typeof();
    ::TYPES[80] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[17] = ::g::Uno::Int_typeof();
    ::TYPES[113] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[114] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[0] = ::g::Fuse::Node_typeof();
    ::TYPES[11] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(Visual_typeof());
    ::TYPES[115] = ::g::Fuse::Transform_typeof();
    ::TYPES[68] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[116] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[117] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[118] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(uObject_typeof());
    ::TYPES[12] = uObject_typeof();
    ::TYPES[119] = ::g::Uno::Comparison_typeof()->MakeType(Visual_typeof());
    ::TYPES[120] = ::g::Fuse::FastProperty1Link1_typeof();
    ::TYPES[121] = ::g::Fuse::FastProperty2Link1_typeof();
    ::TYPES[122] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[123] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[13] = ::g::Fuse::IViewport_typeof();
    ::TYPES[124] = ::g::Fuse::HitTestCallback_typeof();
    ::TYPES[125] = ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[126] = ::g::Uno::Collections::HashSet_typeof()->MakeType(Visual_typeof());
    ::TYPES[127] = ::g::Fuse::FastProperty1Link_typeof();
    ::TYPES[128] = ::g::Fuse::FastProperty2Link_typeof();
    ::TYPES[8] = ::g::Uno::EventHandler_typeof();
    ::TYPES[129] = ::g::Uno::EventArgs_typeof();
    ::TYPES[57] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[130] = ::g::Fuse::IBeginRemoveVisualListener_typeof();
    ::TYPES[131] = ::g::Fuse::IParentObserver_typeof();
    ::TYPES[66] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[132] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[133] = ::g::Fuse::ITemplateObserver_typeof();
    ::TYPES[86] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[36] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[134] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[135] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[136] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[137] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[138] = ::g::Fuse::Layer_typeof();
    ::TYPES[139] = ::g::Fuse::LayoutRole_typeof();
    ::TYPES[140] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[141] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[142] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[143] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[6] = ::g::Uno::Collections::List_typeof()->MakeType(Visual_typeof());
    ::TYPES[144] = ::g::Fuse::RequestBringIntoViewHandler_typeof();
    type->SetInterfaces(
...
Visual_type* Visual_typeof()
{
    ...
    type->fp_AppendLocalData = (void(*)(::g::Fuse::Node*, ::g::Uno::Collections::List*))Visual__AppendLocalData_fn;
...
// private void AddParameterChangedListener(Fuse.Scripting.Function func) :6290
...
// internal void AdjustMarginBoxPosition(float2 position) :6050
void Visual__AdjustMarginBoxPosition_fn(Visual* __this, ::g::Uno::Float2* position)
{
    __this->AdjustMarginBoxPosition(*position);
}

// protected internal override sealed void AppendLocalData(Uno.Collections.List<object> result) :6900
void Visual__AppendLocalData_fn(Visual* __this, ::g::Uno::Collections::List* result)
{
    uStackFrame __("Fuse.Visual", "AppendLocalData(Uno.Collections.List<object>)");
    ::g::Fuse::Node* ret9;
    ...
    {
        uObject* dp = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret9), ret9), ::TYPES[112/*Fuse.IDataProvider*/]);

        if (dp != NULL)
        {
            uObject* data = ::g::Fuse::IDataProvider::Data(uInterface(uPtr(dp), ::TYPES[112/*Fuse.IDataProvider*/]));
    ...
    ::g::Fuse::Node__AppendLocalData_fn(__this, result);
}

// internal bool get_AreChildrenFlat() :5494
void Visual__get_AreChildrenFlat_fn(Visual* __this, bool* __retval)
{
    *__retval = __this->AreChildrenFlat();
}

// public float2 ArrangeMarginBox(float2 position, Fuse.LayoutParams lp) :6017
...
// internal virtual bool CalcIsLocalFlat() :5469
void Visual__CalcIsLocalFlat_fn(Visual* __this, bool* __retval)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret15), ret15), ::TYPES[115/*Fuse.Transform*/]);
...
// internal Fuse.VisualBounds CalcRenderBoundsInParentSpace() :6722
...
// protected void DrawLocalSelectionRect(Fuse.DrawContext dc, Uno.Rect rect) :4701
...
// public virtual void DrawSelection(Fuse.DrawContext dc) :4711
...
// internal T Get<T>(Fuse.FastProperty2 p, T defaultValue) :5005
...
// public Fuse.Visual GetHitWindowPoint(float2 windowPoint) :5172
...
// public virtual float2 GetMarginSize(Fuse.LayoutParams lp) :5719
...
// public T GetNearestAncestorOfType<T>() :6981
...
// protected virtual Fuse.VisualBounds get_HitTestChildrenBounds() :5237
...
// protected virtual Fuse.VisualBounds get_HitTestLocalBounds() :5229
...
// internal virtual Fuse.Visual.HitTestTransformMode get_HitTestTransform() :5122
...
// private void Insert<T>(Fuse.FastProperty2 p, T value) :5056
void Visual__Insert3_fn(Visual* __this, uType* __type, int* p, void* value)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[121/*Fuse.FastProperty2Link`1*/]->MakeType(__type->U(0)),
    };
    uStackFrame __("Fuse.Visual", "Insert`1(Fuse.FastProperty2,T)");
    ::g::Fuse::FastProperty2Link1* ret29;
    int p_ = *p;
    ::g::Fuse::FastProperty2Link1* nl = (::g::Fuse::FastProperty2Link1__New2_fn(__types[1], uCRef<int>(p_), value, &ret29), ret29);
...
// internal Fuse.FastMatrix get_InternLocalTransformInternal() :6569
...
// protected virtual Fuse.LayoutDependent IsMarginBoxDependent(Fuse.Visual child) :5830
...
// public virtual Fuse.VisualBounds get_LocalRenderBounds() :6690
...
// public float2 LocalToParent(float2 localPoint) :6997
...
void Visual__OnChildAdded_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret31), ret31);
            uObject* obs = uAs<uObject*>(n, ::TYPES[131/*Fuse.IParentObserver*/]);

            if ((obs != NULL) && uPtr(n)->IsRootingCompleted())
                ::g::Fuse::IParentObserver::OnChildAddedWhileRooted(uInterface(uPtr(obs), ::TYPES[131/*Fuse.IParentObserver*/]), elm);
        }

    if (uIs(elm, ::TYPES[131/*Fuse.IParentObserver*/]))
        __this->_observerCount++;
}

// protected virtual void OnChildRemoved(Fuse.Node elm) :4441
void Visual__OnChildRemoved_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret32), ret32);
            uObject* obs = uAs<uObject*>(n, ::TYPES[131/*Fuse.IParentObserver*/]);

            if ((obs != NULL) && uPtr(n)->IsRootingCompleted())
                ::g::Fuse::IParentObserver::OnChildRemovedWhileRooted(uInterface(uPtr(obs), ::TYPES[131/*Fuse.IParentObserver*/]), elm);
        }
...
// protected virtual void OnHitTest(Fuse.HitTestContext htc) :5162
...
// protected virtual void OnInvalidateVisual() :7050
void Visual__OnInvalidateVisual_fn(Visual* __this)
{
}

// protected virtual void OnInvalidateVisualComposition() :7069
void Visual__OnInvalidateVisualComposition_fn(Visual* __this)
{
}

// protected virtual void OnInvalidateWorldTransform() :6507
...
void Visual__OnRooted_fn(Visual* __this)
{
    ...
    {
        uArray* children = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[132/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], __this->Children());
...
// internal virtual Fuse.FastMatrix get_ParentWorldTransformInternal() :6557
...
// internal void Set<T>(Fuse.FastProperty2 p, T value, T defaultValue) :5011
...
void Visual__SubtreeToString1_fn(Visual* __this, ::g::Uno::Text::StringBuilder* sb, int* indent)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret42), ret42))->SubtreeToString1(sb, indent_ + 1);
}

// public Uno.Collections.IList<Uno.UX.Template> get_Templates() :6772
void Visual__get_Templates_fn(Visual* __this, uObject** __retval)
{
    *__retval = __this->Templates();
}

// public override sealed bool TryGetResource(string key, Uno.Predicate<object> acceptor, object& resource) :6208
void Visual__TryGetResource_fn(Visual* __this, uString* key, uDelegate* acceptor, uObject** resource, bool* __retval)
{
    ...
    if (__this->HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[135/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[136/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret43), ret43);
...
// private void Uno.Collections.ICollection<Fuse.Node>.Clear() :4511
...
// private bool Uno.Collections.ICollection<Fuse.Node>.Contains(Fuse.Node item) :4554
...
// private int Uno.Collections.ICollection<Fuse.Node>.get_Count() :4564
void Visual__UnoCollectionsICollectionFuseNodeget_Count_fn(Visual* __this, int* __retval)
{
    ...
    if (uIs((uObject*)__this->_children, ::TYPES[0/*Fuse.Node*/]))
        return *__retval = 1, void();

    return *__retval = uPtr(__this->NodeList())->Count(), void();
}

// private Uno.Collections.IEnumerator<Fuse.Node> Uno.Collections.IEnumerable<Fuse.Node>.GetEnumerator() :4630
void Visual__UnoCollectionsIEnumerableFuseNodeGetEnumerator_fn(Visual* __this, uObject** __retval)
{
    ...
    if (__this->_children == NULL)
        return *__retval = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Visual::_emptyChildren()), ::TYPES[103/*Uno.Collections.IEnumerable<Fuse.Node>*/])), void();

    if (uIs((uObject*)__this->_children, ::TYPES[0/*Fuse.Node*/]))
        __this->MakeNodeList(NULL);

    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[0/*Fuse.Node*/]), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->NodeList()), &ret47), ret47)), void();
}

// private Fuse.Node Uno.Collections.IList<Fuse.Node>.get_Item(int index) :4611
...
// private void Uno.Collections.IList<Fuse.Node>.RemoveAt(int index) :4590
...
void Visual__VisitSubtree_fn(Visual* __this, uDelegate* action)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret51), ret51))->VisitSubtree(action);
}

// public virtual Fuse.VisualContext get_VisualContext() :6852
...
// public float2 WindowToLocal(float2 windowCoord) :6672
...
// public void add_WorldTransformInvalidated(Uno.EventHandler value) :6503
void Visual__add_WorldTransformInvalidated_fn(Visual* __this, uDelegate* value)
{
    __this->add_WorldTransformInvalidated(value);
}

// public void remove_WorldTransformInvalidated(Uno.EventHandler value) :6504
...
// protected generated Visual() [instance] :4271
void Visual::ctor_2()
{
...
// private bool get__areChildrenFlat() [instance] :5487
...
// private void set__areChildrenFlat(bool value) [instance] :5488
...
// private bool get__areChildrenFlatCached() [instance] :5481
...
// private void set__areChildrenFlatCached(bool value) [instance] :5482
...
// private bool get__isLocalFlat() [instance] :5451
...
// private void set__isLocalFlat(bool value) [instance] :5452
...
// private bool get__isLocalFlatCached() [instance] :5446
...
// private void set__isLocalFlatCached(bool value) [instance] :5447
...
// public float get_AbsoluteZoom() [instance] :5876
...
// public void Add(Fuse.Node item) [instance] :4527
...
// public void AddDrawCost(double cost) [instance] :6880
...
// private void AddEventHandler(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne, object handler) [instance] :4762
...
// private void AddParameterChangedListener(Fuse.Scripting.Function func) [instance] :6290
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    ...
    if (_parameterListeners == NULL)
        _parameterListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[110/*Uno.Collections.List<Fuse.Scripting.Function>*/]));

    ::g::Uno::Collections::List__Add_fn(uPtr(_parameterListeners), func);

    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        uObject* so = uAs<uObject*>(this, ::TYPES[111/*Fuse.Scripting.IScriptObject*/]);

        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[18/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[111/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter)));
    }
}

// internal void AdjustMarginBoxPosition(float2 position) [instance] :6050
...
// internal bool get_AreChildrenFlat() [instance] :5494
...
// public float2 ArrangeMarginBox(float2 position, Fuse.LayoutParams lp) [instance] :6017
...
// public void BeginInteraction(object id, Uno.Action cancelled) [instance] :5279
void Visual::BeginInteraction(uObject* id, uDelegate* cancelled)
{
    ...
    if (_interactions == NULL)
        _interactions = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[114/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>*/]));
...
// public void BeginRemoveChild(Fuse.Node n, [Uno.Action then]) [instance] :4307
...
// public void BeginRemoveVisual(Fuse.Visual child, [Uno.Action then]) [instance] :4274
...
// public void BringIntoView() [instance] :6082
...
// public void BringToFront(Fuse.Visual item) [instance] :7172
void Visual::BringToFront(Visual* item)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(ZOrder()), &ret14), ret14); enum4.MoveNext(::TYPES[11/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        Visual* c = enum4.Current(::TYPES[11/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]);
...
// internal Fuse.VisualBounds CalcRenderBoundsInParentSpace() [instance] :6722
...
// private Fuse.FastMatrix CalcWorldTransform() [instance] :6598
...
// public void CancelInteractions([Fuse.Visual.CancelInteractionsType how]) [instance] :5311
void Visual::CancelInteractions(int how)
{
    ...
    if (_interactions != NULL)
    {
        ::g::Uno::Collections::List* ids = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<object>*/]);

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uObject*>, Visual__InteractionItem> enum2 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(_interactions), &ret16), ret16); enum2.MoveNext(::TYPES[116/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uObject*>, Visual__InteractionItem> i = enum2.Current(::TYPES[116/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]);
            ::g::Uno::Collections::List__Add_fn(uPtr(ids), i.Key(::TYPES[117/*Uno.Collections.KeyValuePair<object, Fuse.Visual.InteractionItem>*/]));
        }

        for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(ids, &ret17), ret17); enum3.MoveNext(::TYPES[118/*Uno.Collections.List<object>.Enumerator*/]); )
        {
...
// internal void CancelPendingRemove() [instance] :4329
...
// public Uno.Collections.IList<Fuse.Node> get_Children() [instance] :4420
...
// private void Clear(Fuse.FastProperty1 p) [instance] :4872
...
// private void Clear(Fuse.FastProperty2 p) [instance] :5024
...
// internal void ClearBit(Fuse.FastProperty1 p) [instance] :4888
...
// internal void ClearBit(Fuse.FastProperty2 p) [instance] :5040
...
// private void ClearBit(Fuse.Visual.VisualBits nb) [instance] :4749
...
// internal void ConcludePendingRemove() [instance] :4337
...
// public double get_DrawCost() [instance] :6878
...
// private void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float lineWidth, float4 color, float4x4 localToClipTransform) [instance] :4696
...
// protected void DrawLocalSelectionRect(Fuse.DrawContext dc, Uno.Rect rect) [instance] :4701
...
// private void EmitZOrderChanged() [instance] :7286
...
// public void EndInteraction(object id) [instance] :5288
...
// internal void EnsureSortedZOrder() [instance] :7241
void Visual::EnsureSortedZOrder()
{
    ...
    EnsureZOrder();
    uPtr(ZOrder())->Sort(uDelegate::New(::TYPES[119/*Uno.Comparison<Fuse.Visual>*/], (void*)Visual__ZOrderComparator_fn, this));
    _sortedZOrder = true;
}

// private void EnsureZOrder() [instance] :7251
...
// private Fuse.FastProperty1Link<T> Find<T>(Fuse.FastProperty1 p) [instance] :4935
...
// private Fuse.FastProperty2Link<T> Find<T>(Fuse.FastProperty2 p) [instance] :5087
...
// public T FindByType<T>() [instance] :6975
...
// private Fuse.FastProperty1Link FindPrevious(Fuse.FastProperty1 p) [instance] :4922
...
// private Fuse.FastProperty2Link FindPrevious(Fuse.FastProperty2 p) [instance] :5074
...
// public Uno.UX.Template FindTemplate(string key) [instance] :6790
::g::Uno::UX::Template* Visual::FindTemplate(uString* key)
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_templates), ::TYPES[122/*Uno.Collections.ICollection<Uno.UX.Template>*/])); (i--) > 0; )
    {
        ::g::Uno::UX::Template* t = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_templates), ::TYPES[123/*Uno.Collections.IList<Uno.UX.Template>*/]), uCRef<int>(i), &ret22), ret22);
...
// public Fuse.IViewport FindViewport() [instance] :7003
...
// public T FirstChild<T>() [instance] :4391
::g::Fuse::Node* Visual::FirstChild(uType* __type)
{
    ...
    {
        ::g::Fuse::Node* c = uAs< ::g::Fuse::Node*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret23), ret23), __types[0]);
...
// public Fuse.Visual get_FirstVisualChild() [instance] :7097
Visual* Visual::FirstVisualChild()
{
    ...
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret52), ret52), Visual_typeof());
...
// public Fuse.Visual GetHitWindowPoint(float2 windowPoint) [instance] :5172
Visual* Visual::GetHitWindowPoint(::g::Uno::Float2 windowPoint)
{
    ...
    ::g::Fuse::HitTestContext* htc = ::g::Fuse::HitTestContext::New1(windowPoint, uDelegate::New(::TYPES[124/*Fuse.HitTestCallback*/], (void*)Visual__HitTestRecord__HitTestCallback_fn, htr));
...
// public T GetNearestAncestorOfType<T>() [instance] :6981
...
// public float4x4 GetTransformTo(Fuse.Visual other) [instance] :6610
::g::Uno::Float4x4 Visual::GetTransformTo(Visual* other)
{
    uStackFrame __("Fuse.Visual", "GetTransformTo(Fuse.Visual)");
    bool ret24;
    bool ret25;
    ::g::Uno::Collections::HashSet* parents = (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[126/*Uno.Collections.HashSet<Fuse.Visual>*/]);
    Visual* q = this;
...
// private float4x4 GetTransformToAncestor(Fuse.Visual ancestor) [instance] :6639
...
// public Fuse.Visual GetVisualChild(int index) [instance] :7110
Visual* Visual::GetVisualChild(int index)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret26), ret26), Visual_typeof());
...
// public Fuse.Visual GetZOrderChild(int index) [instance] :7151
...
// internal bool HasBit(Fuse.FastProperty1 p) [instance] :4883
...
// internal bool HasBit(Fuse.FastProperty2 p) [instance] :5035
...
// private bool HasBit(Fuse.Visual.VisualBits nb) [instance] :4747
...
// public bool get_HasChildren() [instance] :4373
bool Visual::HasChildren()
{
    ...
    if (uIs((uObject*)_children, ::TYPES[0/*Fuse.Node*/]))
        return true;

    ::g::Uno::Collections::List* list = uAs< ::g::Uno::Collections::List*>(_children, ::TYPES[57/*Uno.Collections.List<Fuse.Node>*/]);
    return uPtr(list)->Count() > 0;
}

// private bool get_HasExplicitTransforms() [instance] :6442
...
// private bool get_HasMarginBox() [instance] :5995
...
// public bool get_HasPendingRemove() [instance] :4346
...
// private bool get_HasResources() [instance] :6232
...
// public bool get_HasVisualChildren() [instance] :7093
...
// public void HitTest(Fuse.HitTestContext htc) [instance] :5130
void Visual::HitTest(::g::Fuse::HitTestContext* htc)
{
    ...
    else
    {
        ...
        ::g::Uno::Geometry::Ray local = ::g::Fuse::IViewport::WorldToLocalRay(uInterface(uPtr(Viewport()), ::TYPES[13/*Fuse.IViewport*/]), Viewport(), world, this);
...
// protected float2 IfSnap(float2 p) [instance] :5843
...
// protected float2 IfSnapDown(float2 p) [instance] :5868
...
// protected float2 IfSnapUp(float2 p) [instance] :5848
...
// public void Insert(int index, Fuse.Node item) [instance] :4572
void Visual::Insert1(int index, ::g::Fuse::Node* item)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[67/*"index"*/]));
...
// internal Fuse.FastMatrix get_InternLocalTransformInternal() [instance] :6569
...
// internal float2 InternSnap(float2 p) [instance] :5836
...
// internal float2 InternSnapUp(float2 p) [instance] :5855
...
// internal void InvalidateFlat() [instance] :5433
...
// protected void InvalidateHitTestBounds() [instance] :5193
...
// public void InvalidateLayout([Fuse.InvalidateLayoutReason reason]) [instance] :5749
void Visual::InvalidateLayout(int reason)
{
    ...
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[68/*"Layout was ...*/]));
...
// protected void InvalidateRenderBounds() [instance] :6701
...
// public void InvalidateVisual() [instance] :7038
...
// public void InvalidateVisualComposition() [instance] :7058
...
// private void InvalidateWorldTransform() [instance] :6488
...
// private void InvalidateZOrder() [instance] :7292
...
// private void InvokeEventHandler(object obj, object args) [instance] :4756
void Visual::InvokeEventHandler(uObject* obj, uObject* args)
{
    uStackFrame __("Fuse.Visual", "InvokeEventHandler(object,object)");
    uPtr(uCast<uDelegate*>(obj, ::TYPES[8/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[129/*Uno.EventArgs*/]));
}

// public bool get_IsContextEnabled() [instance] :5395
...
// public void add_IsContextEnabledChanged(Uno.EventHandler value) [instance] :5359
...
// public void remove_IsContextEnabledChanged(Uno.EventHandler value) [instance] :5360
...
// public bool get_IsEnabled() [instance] :5374
...
// public void set_IsEnabled(bool value) [instance] :5375
...
// internal bool get_IsFlat() [instance] :5519
bool Visual::IsFlat()
{
...
// public bool get_IsInteracting() [instance] :5272
...
// public generated void add_IsInteractingChanged(Uno.EventHandler value) [instance] :5269
...
// public generated void remove_IsInteractingChanged(Uno.EventHandler value) [instance] :5269
...
// internal bool get_IsLocalFlat() [instance] :5458
...
// public bool get_IsVisible() [instance] :5551
...
// public void add_IsVisibleChanged(Uno.EventHandler value) [instance] :5540
...
// public void remove_IsVisibleChanged(Uno.EventHandler value) [instance] :5541
...
// public Fuse.Visual get_LastVisualChild() [instance] :7129
Visual* Visual::LastVisualChild()
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); (i--) > 0; )
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret53), ret53), Visual_typeof());
...
// public Fuse.Layer get_Layer() [instance] :5678
int Visual::Layer()
{
    ...
    if (uPtr(Properties())->TryGet(Visual::_layerProperty(), &v))
        return uUnbox<int>(::TYPES[138/*Fuse.Layer*/], v);

    return 1;
}

// public void set_Layer(Fuse.Layer value) [instance] :5685
void Visual::Layer(int value)
{
    uStackFrame __("Fuse.Visual", "set_Layer(Fuse.Layer)");
    uPtr(Properties())->Set(Visual::_layerProperty(), uBox<int>(::TYPES[138/*Fuse.Layer*/], value));
    InvalidateLayout(2);
}

// public Fuse.LayoutRole get_LayoutRole() [instance] :5700
int Visual::LayoutRole()
{
    ...
    if (uPtr(Properties())->TryGet(Visual::_layoutRoleProperty(), &v))
        return uUnbox<int>(::TYPES[139/*Fuse.LayoutRole*/], v);
...
// public void set_LayoutRole(Fuse.LayoutRole value) [instance] :5712
void Visual::LayoutRole(int value)
{
    uStackFrame __("Fuse.Visual", "set_LayoutRole(Fuse.LayoutRole)");
    uPtr(Properties())->Set(Visual::_layoutRoleProperty(), uBox<int>(::TYPES[139/*Fuse.LayoutRole*/], value));
    InvalidateLayout(2);
}

// public float2 LocalToParent(float2 localPoint) [instance] :6997
...
// public float4x4 get_LocalTransform() [instance] :6563
...
// protected Fuse.FastMatrix get_LocalTransformInternal() [instance] :6573
...
// protected float4x4 get_LocalTransformInverse() [instance] :6587
...
// private void MakeNodeList(Fuse.Node newItem) [instance] :4462
void Visual::MakeNodeList(::g::Fuse::Node* newItem)
{
    uStackFrame __("Fuse.Visual", "MakeNodeList(Fuse.Node)");
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[57/*Uno.Collections.List<Fuse.Node>*/]);
    ::g::Fuse::Node* oldItem = uAs< ::g::Fuse::Node*>(_children, ::TYPES[0/*Fuse.Node*/]);
...
// internal float2 get_MarginBoxPosition() [instance] :6048
...
// private Fuse.Node get_Node() [instance] :4459
::g::Fuse::Node* Visual::Node()
{
    uStackFrame __("Fuse.Visual", "get_Node()");
    return uAs< ::g::Fuse::Node*>(_children, ::TYPES[0/*Fuse.Node*/]);
}

// private Uno.Collections.List<Fuse.Node> get_NodeList() [instance] :4460
::g::Uno::Collections::List* Visual::NodeList()
{
    uStackFrame __("Fuse.Visual", "get_NodeList()");
    return uAs< ::g::Uno::Collections::List*>(_children, ::TYPES[57/*Uno.Collections.List<Fuse.Node>*/]);
}

// private void OnAdded(Fuse.Node b) [instance] :4471
void Visual::OnAdded(::g::Fuse::Node* b)
{
    ...
    ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>(b, ::TYPES[115/*Fuse.Transform*/]);
...
// protected void OnBeginRemoveVisual(Fuse.PendingRemoveVisual args) [instance] :4318
void Visual::OnBeginRemoveVisual(::g::Fuse::PendingRemoveVisual* args)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        uObject* rvl = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret30), ret30), ::TYPES[130/*Fuse.IBeginRemoveVisualListener*/]);

        if (rvl != NULL)
            ::g::Fuse::IBeginRemoveVisualListener::OnBeginRemoveVisual(uInterface(uPtr(rvl), ::TYPES[130/*Fuse.IBeginRemoveVisualListener*/]), args);
    }
}

// protected internal void OnBringIntoView(Fuse.Visual elm) [instance] :6073
...
// private void OnInteractionsChanged() [instance] :5300
...
// private void OnInvalidateChildZOffset(Fuse.Visual child) [instance] :7260
...
// protected void OnIsContextEnabledChanged() [instance] :5412
...
// public void OnIsSelectedChanged(bool isSelected) [instance] :6871
void Visual::OnIsSelectedChanged(bool isSelected)
{
}

// protected void OnLocalVisibleChanged() [instance] :5560
...
// private void OnMatrixChanged(Fuse.Transform t) [instance] :6474
...
// private void OnParameterChanged() [instance] :6307
void Visual::OnParameterChanged()
{
    ...
    if (_parameterListeners != NULL)
    {
        ...
        if (so != NULL)
        {
            uObject* param = uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[111/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter);

            for (int i = 0; i < uPtr(_parameterListeners)->Count(); i++)
                uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_parameterListeners), uCRef<int>(i), &ret34), ret34))->Call(uArray::Init<uObject*>(::TYPES[18/*object[]*/], 1, param));
        }
    }
...
// private void OnRemoved(Fuse.Node b) [instance] :4483
...
// private void OnResourceChanged(Uno.UX.Resource res) [instance] :6235
...
// private void OnTemplatesChanged(Uno.UX.Template t) [instance] :6778
void Visual::OnTemplatesChanged(::g::Uno::UX::Template* t)
{
    ...
    if (IsRootingCompleted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            uObject* to = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret35), ret35), ::TYPES[133/*Fuse.ITemplateObserver*/]);

            if (to != NULL)
                ::g::Fuse::ITemplateObserver::OnTemplatesChangedWileRooted(uInterface(uPtr(to), ::TYPES[133/*Fuse.ITemplateObserver*/]));
        }
}

// private void OnTransformAdded(Fuse.Transform t) [instance] :6460
void Visual::OnTransformAdded(::g::Fuse::Transform* t)
{
    uStackFrame __("Fuse.Visual", "OnTransformAdded(Fuse.Transform)");
    _transformCount++;
    uPtr(t)->add_MatrixChanged(uDelegate::New(::TYPES[86/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}

// private void OnTransformRemoved(Fuse.Transform t) [instance] :6467
void Visual::OnTransformRemoved(::g::Fuse::Transform* t)
{
    uStackFrame __("Fuse.Visual", "OnTransformRemoved(Fuse.Transform)");
    _transformCount--;
    uPtr(t)->remove_MatrixChanged(uDelegate::New(::TYPES[86/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}

// private void OnVisualAdded(Fuse.Visual v) [instance] :4495
...
// private void OnVisualRemoved(Fuse.Visual v) [instance] :4503
...
// public string get_Parameter() [instance] :6277
...
// public void set_Parameter(string value) [instance] :6278
...
// public float2 ParentToLocal(float2 parentPoint) [instance] :6992
...
// protected void PerformLayout() [instance] :5924
...
// protected void PerformLayout(float2 clientSize) [instance] :5932
...
// private void PrependExplicitTransforms(Fuse.FastMatrix m) [instance] :6658
void Visual::PrependExplicitTransforms(::g::Fuse::FastMatrix* m)
{
    ...
    if (HasExplicitTransforms())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret37), ret37), ::TYPES[115/*Fuse.Transform*/]);
...
// private void PrependLocalTransform(Fuse.FastMatrix m) [instance] :6652
...
// private void RaiseEvent(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne) [instance] :4751
void Visual::RaiseEvent(::g::Fuse::PropertyHandle* ph, int ne)
{
    ...
    if (HasBit2(ne))
        uPtr(Properties())->ForeachInList1(ph, uDelegate::New(::TYPES[134/*Uno.Action<object, object>*/], (void*)Visual__InvokeEventHandler_fn, this), ::g::Uno::EventArgs::Empty());
}

// private void RearrangeMarginBox() [instance] :5997
void Visual::RearrangeMarginBox()
{
    uStackFrame __("Fuse.Visual", "RearrangeMarginBox()");

    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[69/*"Invalid cal...*/]));

    ArrangeMarginBox(_ambPosition, _ambLayoutParams);
}

// public bool Remove(Fuse.Node item) [instance] :4532
bool Visual::Remove1(::g::Fuse::Node* item)
{
    ...
    else if ((_children == NULL) || uIs((uObject*)_children, ::TYPES[0/*Fuse.Node*/]))
        r = false;
    else
...
// public void RemoveAllChildren<T>() [instance] :4401
void Visual::RemoveAllChildren(uType* __type)
{
    ...
    while (i >= 0)
    {
        if (uIs((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret39), ret39), __types[0]))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), i);
...
// public void RemoveDrawCost(double cost) [instance] :6890
...
// private void RemoveEventHandler(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne, object handler) [instance] :4768
...
// public generated void add_RequestBringIntoView(Fuse.RequestBringIntoViewHandler value) [instance] :6071
void Visual::add_RequestBringIntoView(uDelegate* value)
{
    ...
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RequestBringIntoView1, value), ::TYPES[144/*Fuse.RequestBringIntoViewHandler*/]);
}

// public generated void remove_RequestBringIntoView(Fuse.RequestBringIntoViewHandler value) [instance] :6071
void Visual::remove_RequestBringIntoView(uDelegate* value)
{
    ...
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RequestBringIntoView1, value), ::TYPES[144/*Fuse.RequestBringIntoViewHandler*/]);
}

// private void ResetParameterListeners() [instance] :6322
...
// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :6180
uObject* Visual::Resources()
{
    ...
    {
        SetBit4(1);
        uPtr(Properties())->Set(Visual::_resourcesHandle(), (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[140/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[141/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[141/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this)));
    }

    return (uObject*)uPtr(Properties())->Get(Visual::_resourcesHandle());
}

// public void SendToBack(Fuse.Visual item) [instance] :7193
void Visual::SendToBack(Visual* item)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<Visual*> > enum5 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(ZOrder()), &ret40), ret40); enum5.MoveNext(::TYPES[11/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
...
// internal void SetBit(Fuse.FastProperty1 p) [instance] :4893
...
// internal void SetBit(Fuse.FastProperty1 p, bool value) [instance] :4898
...
// internal void SetBit(Fuse.FastProperty2 p) [instance] :5045
...
// internal void SetBit(Fuse.FastProperty2 p, bool value) [instance] :5050
...
// private void SetBit(Fuse.Visual.VisualBits nb) [instance] :4748
...
// public void SetResource(string key, object value) [instance] :6191
void Visual::SetResource(uString* key, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[135/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); ++i)
    {
        ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[136/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret41), ret41);

        if (::g::Uno::String::op_Equality(uPtr(r)->Key(), key))
        {
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(resources), ::TYPES[136/*Uno.Collections.IList<Uno.UX.Resource>*/]), i);
            break;
        }
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(resources), ::TYPES[135/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), ::g::Uno::UX::Resource::New1(key, value));
}

// protected float2 Snap(float2 p) [instance] :5837
...
// protected float2 SnapDown(float2 p) [instance] :5862
...
// public bool get_SnapToPixels() [instance] :5890
...
// public void set_SnapToPixels(bool value) [instance] :5894
...
// protected float2 SnapUp(float2 p) [instance] :5856
...
// private void SoftInvalidateZOrder([bool force]) [instance] :7270
...
// public Uno.Collections.IList<Uno.UX.Template> get_Templates() [instance] :6772
uObject* Visual::Templates()
{
    uStackFrame __("Fuse.Visual", "get_Templates()");
    uObject* ind7 = _templates;
    return (ind7 != NULL) ? ind7 : (uObject*)(_templates = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[142/*Uno.Collections.ObservableList<Uno.UX.Template>*/], uDelegate::New(::TYPES[143/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[143/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this))));
}

// private void UpdateContextSnapToPixelsCache() [instance] :5906
void Visual::UpdateContextSnapToPixelsCache()
{
    ...
    if (newValue != SnapToPixels())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret49), ret49), Visual_typeof());
...
// private void UpdateIsContextEnabledCache() [instance] :5398
...
// private void UpdateIsVisibleCache() [instance] :5565
...
// private void UpdateLayout() [instance] :5966
void Visual::UpdateLayout()
{
    ...
    switch (_layoutDirty)
    {
        ...
        case 1:
        {
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret50), ret50), Visual_typeof());
...
// public int get_ValidFrameCount() [instance] :7075
...
// public Fuse.IViewport get_Viewport() [instance] :7019
...
// public float2 WindowToLocal(float2 windowCoord) [instance] :6672
::g::Uno::Float2 Visual::WindowToLocal(::g::Uno::Float2 windowCoord)
{
    ...
    {
        ::g::Uno::Geometry::Ray world = ::g::Fuse::IViewport::PointToWorldRay(uInterface(uPtr(Viewport()), ::TYPES[13/*Fuse.IViewport*/]), windowCoord);
        ::g::Uno::Geometry::Ray local = ::g::Fuse::IViewport::WorldToLocalRay(uInterface(uPtr(Viewport()), ::TYPES[13/*Fuse.IViewport*/]), Viewport(), world, this);
        return ::g::Fuse::FrustumViewport::LocalPlaneIntersection(local);
    }
}

// public float3 get_WorldPosition() [instance] :6536
...
// public float4x4 get_WorldTransform() [instance] :6528
...
// private Fuse.FastMatrix get_WorldTransformInternal() [instance] :6547
...
// public void add_WorldTransformInvalidated(Uno.EventHandler value) [instance] :6503
...
// public void remove_WorldTransformInvalidated(Uno.EventHandler value) [instance] :6504
...
// public float4x4 get_WorldTransformInverse() [instance] :6515
...
// public float get_ZOffset() [instance] :6101
...
// public void set_ZOffset(float value) [instance] :6102
...
// internal Uno.Collections.List<Fuse.Visual> get_ZOrder() [instance] :7159
...
// internal generated void add_ZOrderChanged(Uno.EventHandler value) [instance] :7265
...
// internal generated void remove_ZOrderChanged(Uno.EventHandler value) [instance] :7265
...
// public int get_ZOrderChildCount() [instance] :7144
...
// private int ZOrderComparator(Fuse.Visual a, Fuse.Visual b) [instance] :7211
...
// private static void AssignZOrder(Uno.Collections.IList<Fuse.Node> nodes) [static] :7222
void Visual::AssignZOrder(uObject* nodes)
{
    uStackFrame __("Fuse.Visual", "AssignZOrder(Uno.Collections.IList<Fuse.Node>)");
    Visual_typeof()->Init();
    ::g::Fuse::Node* ret10;
    uArray* current = uArray::Init<int>(::TYPES[113/*int[]*/], 3, 0, 0, 0);

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* visual = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[80/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret10), ret10), Visual_typeof());
...
// private static void bringIntoView(Fuse.Scripting.Context c, Fuse.Visual n, object[] args) [static] :6374
...
// private static Uno.UX.Property<string> getParameterProperty(Fuse.Visual v) [static] :6362
...
// private static void onParameterChanged(Fuse.Scripting.Context c, Fuse.Visual v, object[] args) [static] :6400
void Visual::onParameterChanged(::g::Fuse::Scripting::Context* c, Visual* v, uArray* args)
{
    ...
    Visual_typeof()->Init();
    uPtr(v)->AddParameterChangedListener(uCast< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[66/*Fuse.Scripting.Function*/]));
}
// }
...
// private enum Visual.VisualBits :4732
...
// public sealed class VisualBounds :3968
// {
// static VisualBounds() :3968
...
// public Fuse.VisualBounds IntersectXY(Fuse.VisualBounds nb) :4136
...
// public Fuse.VisualBounds MergeChild(Fuse.Visual child, Fuse.VisualBounds nb) :4155
...
// public Fuse.VisualBounds TransformFlatten(float4x4 matrix) :4101
...
// public Fuse.VisualBounds Translate(float3 offset) :4079
...
// private VisualBounds() [instance] :3970
void VisualBounds::ctor_()
{
}

// public Fuse.VisualBounds AddPoint(float2 pt) [instance] :4046
...
// public Fuse.VisualBounds AddPoint(float3 pt) [instance] :4041
...
// public Fuse.VisualBounds AddRect(float2 mn, float2 mx) [instance] :4051
...
// public Fuse.VisualBounds AddRect(Uno.Rect r) [instance] :4056
...
// public float3 get_AxisMax() [instance] :4028
...
// public float3 get_AxisMin() [instance] :4027
...
// public bool ContainsPoint(float2 pt) [instance] :4160
...
// public Uno.Rect get_FlatRect() [instance] :4033
...
// public Fuse.VisualBounds InflateXY(float padding) [instance] :4064
...
// public bool IntersectsRay(Uno.Geometry.Ray ray) [instance] :4172
...
// public Fuse.VisualBounds IntersectXY(Fuse.VisualBounds nb) [instance] :4136
...
// public bool get_IsEmpty() [instance] :3980
...
// public bool get_IsFlat() [instance] :4038
...
// public bool get_IsInfinite() [instance] :3991
...
// public Fuse.VisualBounds Merge(Fuse.VisualBounds nb, [Fuse.FastMatrix trans]) [instance] :4112
...
// public Fuse.VisualBounds MergeChild(Fuse.Visual child, Fuse.VisualBounds nb) [instance] :4155
...
// public float3 get_Size() [instance] :4029
...
// public Fuse.VisualBounds Transform(float4x4 matrix) [instance] :4091
...
// public Fuse.VisualBounds TransformFlatten(float4x4 matrix) [instance] :4101
...
// public Fuse.VisualBounds Translate(float3 offset) [instance] :4079
...
// public static Fuse.VisualBounds Box(Uno.Geometry.Box a) [static] :4018
...
// public static Uno.Geometry.Box BoxTransform(Uno.Geometry.Box box, float4x4 transform) [static] :4194
...
// private VisualBounds New() [static] :3970
...
// public static Fuse.VisualBounds Point(float3 pt) [static] :3994
...
// public static Fuse.VisualBounds Rect(float2 a, float2 b) [static] :4013
...
// public static Fuse.VisualBounds Rect(float3 a, float3 b) [static] :4005
...
// public static Fuse.VisualBounds get_Empty() [static] :3975
...
// public static Fuse.VisualBounds get_Infinite() [static] :3986
...
// public enum VisualContext :6816
...
// public abstract class VisualEvent<THandler, TArgs> :1574
// {
static void VisualEvent_build(uType* type)
{
    ::STRINGS[70] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.33.5\\$.uno");
    ::TYPES[145] = ::g::Uno::Collections::List_typeof();
    ::TYPES[12] = uObject_typeof();
    ::TYPES[4] = ::g::Uno::Exception_typeof();
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    ::TYPES[146] = ::g::Fuse::VisualEventArgs_typeof();
    ::TYPES[147] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array());
    ::TYPES[18] = uObject_typeof()->Array();
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[148] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetPrecalc(
...
// protected generated VisualEvent() :1574
void VisualEvent__ctor__fn(VisualEvent* __this)
{
    __this->ctor_();
}

// public void AddGlobalHandler(THandler handler) :1589
...
// public void AddHandler(Fuse.Visual visual, THandler handler) :1578
...
// private void InvokeGlobalHandlers(Fuse.Visual visual, TArgs args) :1599
...
// private void InvokeInternal(THandler handler, object sender, TArgs args) :1676
...
// private void OnRaise(object target, object[] args) :1659
void VisualEvent__OnRaise_fn(VisualEvent* __this, uObject* target, uArray* args)
{
    __this->OnRaise(target, args);
}

// private void OnRaiseEnabled(object target, object[] args) :1667
void VisualEvent__OnRaiseEnabled_fn(VisualEvent* __this, uObject* target, uArray* args)
{
    __this->OnRaiseEnabled(target, args);
}

// private void Raise(TArgs args, Fuse.VisualEventMode type, bool bubble, [Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction]) :1624
...
// public void RaiseWithBubble(TArgs args, [Fuse.VisualEventMode type]) :1608
...
// internal void RaiseWithBubble(TArgs args, Fuse.VisualEventMode type, Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction) :1613
...
// public void RaiseWithoutBubble(TArgs args, [Fuse.VisualEventMode type]) :1619
...
// public void RemoveGlobalHandler(THandler handler) :1594
...
// public void RemoveHandler(Fuse.Visual visual, THandler handler) :1583
...
// protected generated VisualEvent() [instance] :1574
...
// private void InvokeGlobalHandlers(Fuse.Visual visual, TArgs args) [instance] :1599
...
// private void OnRaise(object target, object[] args) [instance] :1659
...
// private void OnRaiseEnabled(object target, object[] args) [instance] :1667
...
// private void Raise(TArgs args, Fuse.VisualEventMode type, bool bubble, [Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction]) [instance] :1624
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[147/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[147/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[70/*"Invalid Rai...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 1636);
            return;
        }
    }
    ...
    for (int i = 0; i < uPtr(list)->Count(); ++i)
        uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret2), ret2))->Properties())->ForeachInList(_handle, handler, uArray::Init<uObject*>(::TYPES[18/*object[]*/], 2, (::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret3), ret3), args));
...
// public void RaiseWithBubble(TArgs args, [Fuse.VisualEventMode type]) [instance] :1608
...
// internal void RaiseWithBubble(TArgs args, Fuse.VisualEventMode type, Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction) [instance] :1613
...
// public void RaiseWithoutBubble(TArgs args, [Fuse.VisualEventMode type]) [instance] :1619
...
// public class VisualEventArgs :1692
// {
...
// public VisualEventArgs(Fuse.Visual visual) :1698
void VisualEventArgs__ctor_1_fn(VisualEventArgs* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_1(visual);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :1703
...
// public generated bool get_IsHandled() [instance] :1694
...
// public generated void set_IsHandled(bool value) [instance] :1694
...
// public generated Fuse.Visual get_Visual() [instance] :1696
...
// private generated void set_Visual(Fuse.Visual value) [instance] :1696
...
// public VisualEventArgs New(Fuse.Visual visual) [static] :1698
...
// public delegate void VisualEventHandler(object sender, Fuse.VisualEventArgs args) :1713
...
// public enum VisualEventMode :1539
...
// internal static class VisualListCache :1552
// {
// static VisualListCache() :1552
...
{
    ::TYPES[149] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof()));
    ::TYPES[6] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetFields(0,
...
// public static Uno.Collections.List<Fuse.Visual> Acquire() :1556
void VisualListCache__Acquire_fn(::g::Uno::Collections::List** __retval)
{
    *__retval = VisualListCache::Acquire();
}

// public static void Release(Uno.Collections.List<Fuse.Visual> list) :1567
...
// public static Uno.Collections.List<Fuse.Visual> Acquire() [static] :1556
...
// public static void Release(Uno.Collections.List<Fuse.Visual> list) [static] :1567
...
// private sealed class TranslationModes.WidthMode :9379
// {
...
// public generated WidthMode() :9379
void TranslationModes__WidthMode__ctor_1_fn(TranslationModes__WidthMode* __this)
{
    __this->ctor_1();
}

// public override sealed float3 GetAbsVector(Fuse.Translation t) :9381
...
// public generated WidthMode New() [static] :9379
