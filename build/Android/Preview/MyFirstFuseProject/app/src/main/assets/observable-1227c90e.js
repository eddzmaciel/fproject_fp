...
Observable.prototype.onValueChanged = function(module, callback)
{
	...
	var subscriber = function(obs, cmd, value) { 
		...
		{
			if (obs.length > 0) callback(obs.value);
		}
	};
...
Observable.prototype.replaceAt = function(index, value)
{
	...
	this._queueMessage(this, "newAt", index, value);
}
...
Observable.prototype.tryRemove = function(x)
{
	...
	if (i != -1)
	{
		...
		this._queueMessage(this, "removeAt", i);
		return true;
	}
	else
	{
...
Observable.prototype.removeAt = function(index)
{
	...
	this._queueMessage(this, "removeAt", index);
}
...
Observable.prototype._queueMessage = function() 
{
	...
	for (var i = 0; i < this._subscribers.length; i++) {
		PostMessage(this._subscribers[i], args);
	}
...
Observable.prototype.map = function(f)
{
	...
	return Observe(this, function(src, op, p1, p2)
	{
		...
		else
		{
			...
			// The "removeAt" and "insertAt" cases are handled here
