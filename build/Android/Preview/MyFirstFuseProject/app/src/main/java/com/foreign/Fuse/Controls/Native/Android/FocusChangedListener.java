...
public class FocusChangedListener
{
    ...
    public static void ClearListener43(final Object viewHandle)
    {
        ((android.view.View)viewHandle).setOnFocusChangeListener(null);
    }
    
    public static Object Create44(final Object _this)
    {
        android.view.View.OnFocusChangeListener listener = new android.view.View.OnFocusChangeListener() {
        	public void onFocusChange(android.view.View view, boolean hasFocus) {
        		ExternedBlockHost.callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange45(_this,hasFocus);
        	}
        };
        return listener;
    }
    
    public static void SetListener46(final Object viewHandle,final Object listenerHandle)
    {
