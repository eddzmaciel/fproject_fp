...
public class TextEditRenderer
{
    ...
    public static void CopyState119(final Object container,final Object sourceHandle,final Object targetHandle)
    {
    ...
    public static Object CreateContainer120()
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.myfirstfuseproject.MyFirstFuseProject.GetRootActivity());
    ...
    public static Object CreateTextEdit121()
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.myfirstfuseproject.MyFirstFuseProject.GetRootActivity());
