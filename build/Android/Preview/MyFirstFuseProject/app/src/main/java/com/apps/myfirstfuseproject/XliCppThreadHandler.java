...
public class XliCppThreadHandler extends Handler {
	...
	private void handleRepeating(Message msg)
	{
		if (msg.arg1 == xliCallbackIndex) {
            com.apps.myfirstfuseproject.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1); // {TODO} this should own callback
			...
			com.apps.myfirstfuseproject.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1);
