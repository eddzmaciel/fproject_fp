...
public class MyFirstFuseProject extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    {
    	MyFirstFuseProject activity = _appState.CurrentActivity;
