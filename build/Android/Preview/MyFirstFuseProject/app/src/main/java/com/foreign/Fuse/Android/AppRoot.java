...
public class AppRoot
{
    ...
    public static void ClearRootView209(final Object handle)
    {
        ((android.widget.RelativeLayout)handle).removeAllViews();
    }
    
    public static Object CreateRootView210()
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(com.apps.myfirstfuseproject.MyFirstFuseProject.GetRootActivity()) {
        		...
        		public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        			...
        			ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__211(motionEvent,UnoHelper.GetUnoObjectRef(motionEvent));
    ...
    public static void SetChildSize1212(final Object handle,final int w,final int h)
    {
    ...
    public static void SetRootView213(final Object handle,final Object rootHandle)
    {
