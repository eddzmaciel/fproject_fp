...
public final class Activity
{
    ...
    {
        return com.apps.myfirstfuseproject.MyFirstFuseProject.GetRootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.myfirstfuseproject.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.myfirstfuseproject.MyFirstFuseProject activity = (com.apps.myfirstfuseproject.MyFirstFuseProject)getRootActivity();
