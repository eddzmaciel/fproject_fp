// This file was generated based on C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Backends\CPlusPlus\Uno\_config.h.
...
#if defined(DEBUG_DUMPS) && !defined(DEBUG_ARC)
#define DEBUG_ARC 0
#endif
...
// Stack alloc
#if MSVC
#define U_ALLOCA(SIZE) _malloca(SIZE)
#else
#include <alloca.h>
