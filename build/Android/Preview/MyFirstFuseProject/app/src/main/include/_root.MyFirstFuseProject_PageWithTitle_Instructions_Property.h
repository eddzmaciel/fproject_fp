...
namespace g{struct MyFirstFuseProject_PageWithTitle_Instructions_Property;}
...
struct MyFirstFuseProject_PageWithTitle_Instructions_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::PageWithTitle*> _obj;

    void ctor_2(::g::PageWithTitle* obj, ::g::Uno::UX::Selector name);
    static MyFirstFuseProject_PageWithTitle_Instructions_Property* New1(::g::PageWithTitle* obj, ::g::Uno::UX::Selector name);
};
// }
