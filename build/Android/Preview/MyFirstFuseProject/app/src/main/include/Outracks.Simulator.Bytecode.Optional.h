// This file was generated based on C:\ProgramData\Uno\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\Common\$.uno.
...
template<class T>
void Optional::Write(uType* __type, ::g::Uno::IO::BinaryWriter* writer, ::g::Outracks::Simulator::Bytecode::Optional1<T> optional, uDelegate* writeSome) { Optional__Write_fn(__type, writer, uConstrain(::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(__type->U(0)), optional), writeSome); }
template<class T>
void Optional::Write1(uType* __type, ::g::Uno::IO::BinaryWriter* writer, ::g::Outracks::Simulator::Bytecode::Optional1<T> optional, uDelegate* writeSome) { Optional__Write1_fn(__type, writer, uConstrain(::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(__type->U(0)), optional), writeSome); }
template<class T>
void Optional::Write2(uType* __type, ::g::Uno::IO::BinaryWriter* writer, ::g::Outracks::Simulator::Bytecode::Optional1<T> optional, uDelegate* writeSome) { Optional__Write2_fn(__type, writer, uConstrain(::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(__type->U(0)), optional), writeSome); }
// }
