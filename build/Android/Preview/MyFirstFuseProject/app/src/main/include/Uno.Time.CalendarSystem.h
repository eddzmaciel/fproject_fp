// This file was generated based on C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Time\$.uno.
...
struct CalendarSystem : uObject
{
    ...
    ::g::Uno::Time::Instant GetInstant1(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute);
    ::g::Uno::Time::Instant GetInstant2(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond);
    int GetMillisecondOfSecond(::g::Uno::Time::Instant instant);
