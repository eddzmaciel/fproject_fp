// This file was generated based on C:\ProgramData\Uno\Packages\Fuse.Controls.Primitives\0.33.5\TextControls\FallbackTextEdit\$.uno.
...
struct LineCache : uObject
{
    ...
    void ctor_(uDelegate* onTextChanged, uDelegate* invalideLayout);
    ...
    static LineCache* New1(uDelegate* onTextChanged, uDelegate* invalideLayout);
};
// }
