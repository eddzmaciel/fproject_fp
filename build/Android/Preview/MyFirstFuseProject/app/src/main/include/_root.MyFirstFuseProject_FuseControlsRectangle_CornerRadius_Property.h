...
namespace g{struct MyFirstFuseProject_FuseControlsRectangle_CornerRadius_Property;}
...
struct MyFirstFuseProject_FuseControlsRectangle_CornerRadius_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::Rectangle*> _obj;

    void ctor_2(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector name);
    static MyFirstFuseProject_FuseControlsRectangle_CornerRadius_Property* New1(::g::Fuse::Controls::Rectangle* obj, ::g::Uno::UX::Selector name);
};
// }
