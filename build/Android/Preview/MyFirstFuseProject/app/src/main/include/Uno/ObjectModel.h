// This file was generated based on C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Backends\CPlusPlus\Uno\ObjectModel.h.
...
struct uType : uObject
{
    ...
    bool IsClosed();
    uType* GetBase(uType* def);
    uType* GetVirtual(uType* method);
    uType* MakeGeneric(size_t count, uType** args);
    uType* MakeMethod(size_t count, uType* first, ...);
