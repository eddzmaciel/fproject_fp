// This file was generated based on C:\ProgramData\Uno\Packages\Fuse.Motion\0.33.5\Simulation\$.uno.
...
struct EasingMotion : uObject
{
    ...
    float _durationExp;
    int _easing;
    uStrong<uDelegate*> _easingFunc;
    bool _isDirty;
    bool _isLocked;
    bool _isStatic;
    float _nominalDistance;
    uTField _position() { return __type->Field(this, 10); }
    double _progress;
    double _progressSpeed;
    uTField _source() { return __type->Field(this, 13); }
    uTField _transitionPosition() { return __type->Field(this, 14); }
    double _transitionRemain;
    double _transitionTime;
    uTField _transitionVelocity() { return __type->Field(this, 17); }
    uTField _velocity() { return __type->Field(this, 18); }
