// This file was generated based on C:\ProgramData\Uno\Packages\FuseCore\0.33.5\Internal\$.uno.
...
struct Blender_type : uType
{
    ...
    void(*fp_get_One)(::g::Fuse::Internal::Blender*, uTRef);
...
struct Blender : uObject
{
    ...
    template<class T>
    T One() { T __retval; return (((Blender_type*)__type)->fp_get_One)(this, &__retval), __retval; }
    void get_One_ex(uTRef __retval) { (((Blender_type*)__type)->fp_get_One)(this, __retval); }
    template<class T>
