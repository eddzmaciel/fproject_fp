// This file was generated based on C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\Collections\$.uno.
...
struct Dictionary : uObject
{
    ...
    void ctor_();
    void ctor_1(uObject* dictionary);
    ...
    static Dictionary* New2(uType* __type, uObject* dictionary);
};
