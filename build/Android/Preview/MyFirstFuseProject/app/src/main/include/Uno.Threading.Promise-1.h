// This file was generated based on C:\ProgramData\Uno\Packages\Uno.Threading\0.33.1\$.uno.
...
struct Promise : ::g::Uno::Threading::Future1
{
    ...
    template<class T>
    static Promise* New2(uType* __type, T result) { Promise* __retval; return Promise__New2_fn(__type, uConstrain(__type->GetBase(Promise_typeof())->T(0), result), &__retval), __retval; }
    static Promise* New3(uType* __type, uObject* dispatcher);
    template<class T>
    static Promise* New4(uType* __type, uObject* dispatcher, T result) { Promise* __retval; return Promise__New4_fn(__type, dispatcher, uConstrain(__type->GetBase(Promise_typeof())->T(0), result), &__retval), __retval; }
