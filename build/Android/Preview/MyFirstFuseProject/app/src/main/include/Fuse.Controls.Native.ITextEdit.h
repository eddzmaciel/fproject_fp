...
struct ITextEdit
{
    ...
    void(*fp_set_IsMultiline)(uObject*, bool*);
    ...
    static void IsMultiline(const uInterface& __this, bool value) { __this.VTable<ITextEdit>()->fp_set_IsMultiline(__this, &value); }
