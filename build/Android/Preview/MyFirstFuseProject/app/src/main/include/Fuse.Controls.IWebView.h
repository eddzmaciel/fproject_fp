// This file was generated based on C:\ProgramData\Uno\Packages\Fuse.Controls.WebView\0.33.5\$.uno.
...
struct IWebView
{
    ...
    void(*fp_get_DocumentTitle)(uObject*, uString**);
    ...
    static uString* DocumentTitle(const uInterface& __this) { uString* __retval; return __this.VTable<IWebView>()->fp_get_DocumentTitle(__this, &__retval), __retval; }
