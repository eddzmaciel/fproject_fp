...
namespace g{struct OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property;}
...
struct OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Triggers::WhileTrue*> _obj;

    void ctor_2(::g::Fuse::Triggers::WhileTrue* obj, ::g::Uno::UX::Selector name);
    static OutracksSimulatorClientUno_FuseTriggersWhileTrue_Value_Property* New1(::g::Fuse::Triggers::WhileTrue* obj, ::g::Uno::UX::Selector name);
};
// }
