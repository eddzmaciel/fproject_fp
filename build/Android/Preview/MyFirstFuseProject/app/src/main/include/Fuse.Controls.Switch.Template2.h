...
// public partial sealed class Switch.Template2 :559
// {
...
struct Switch__Template2 : ::g::Uno::UX::Template
{
    ...
    uStrong< ::g::Fuse::Controls::Switch*> __parentInstance1;

    void ctor_1(::g::Fuse::Controls::Switch* parent, ::g::Fuse::Controls::Switch* parentInstance);
    static Switch__Template2* New2(::g::Fuse::Controls::Switch* parent, ::g::Fuse::Controls::Switch* parentInstance);
};
// }
