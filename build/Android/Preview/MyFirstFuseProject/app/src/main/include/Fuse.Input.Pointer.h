// This file was generated based on C:\ProgramData\Uno\Packages\FuseCore\0.33.5\Input\$.uno.
...
struct Pointer : uObject
{
    ...
    static ::g::Fuse::Input::PointerMovedArgs* RaiseMoved(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data);
    static ::g::Fuse::Input::PointerPressedArgs* RaisePressed(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data);
    static ::g::Fuse::Input::PointerReleasedArgs* RaiseReleased(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data);
    static ::g::Fuse::Input::PointerWheelMovedArgs* RaiseWheelMoved(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data);
