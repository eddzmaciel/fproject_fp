// This file was generated based on C:\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\.uno\$.uno.
...
namespace g{struct OutracksSimulatorClientUno_OutracksSimulatorErrorToast_FillColor_Property;}
...
struct OutracksSimulatorClientUno_OutracksSimulatorErrorToast_FillColor_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Outracks::Simulator::ErrorToast*> _obj;

    void ctor_2(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector name);
    static OutracksSimulatorClientUno_OutracksSimulatorErrorToast_FillColor_Property* New1(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector name);
};
// }
