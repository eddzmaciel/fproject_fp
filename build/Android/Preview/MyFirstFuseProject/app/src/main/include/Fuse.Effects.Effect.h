// This file was generated based on C:\ProgramData\Uno\Packages\Fuse.Elements\0.33.5\Effects\$.uno.
...
struct Effect : ::g::Uno::UX::PropertyObject
{
    int _effectType;
    bool _isRooted;
