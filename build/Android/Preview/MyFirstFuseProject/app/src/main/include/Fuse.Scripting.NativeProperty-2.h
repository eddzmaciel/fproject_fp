// This file was generated based on C:\ProgramData\Uno\Packages\Fuse.Scripting\0.33.5\$.uno.
...
struct NativeProperty : ::g::Fuse::Scripting::NativeMember
{
    ...
    static NativeProperty* New1(uType* __type, uString* name);
    static NativeProperty* New2(uType* __type, uString* name, uDelegate* getHandler, uDelegate* setHandler, uDelegate* valueConverter);
    template<class TJSValue>
    static NativeProperty* New3(uType* __type, uString* name, TJSValue value) { NativeProperty* __retval; return NativeProperty__New3_fn(__type, name, uConstrain(__type->GetBase(NativeProperty_typeof())->T(1), value), &__retval), __retval; }
    template<class TJSValue>
