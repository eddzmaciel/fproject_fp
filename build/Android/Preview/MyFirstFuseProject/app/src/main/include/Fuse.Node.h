...
struct Node_type : uType
{
    ...
    void(*fp_AppendLocalData)(::g::Fuse::Node*, ::g::Uno::Collections::List*);
...
struct Node : ::g::Uno::UX::PropertyObject
{
    ...
    void AppendLocalData(::g::Uno::Collections::List* result) { (((Node_type*)__type)->fp_AppendLocalData)(this, result); }
    ...
    static void AppendLocalData(Node* __this, ::g::Uno::Collections::List* result) { Node__AppendLocalData_fn(__this, result); }
