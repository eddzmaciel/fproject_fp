...
namespace g{struct OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property;}
...
struct OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Outracks::Simulator::ErrorToast*> _obj;

    void ctor_2(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector name);
    static OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Opacity_Property* New1(::g::Outracks::Simulator::ErrorToast* obj, ::g::Uno::UX::Selector name);
};
// }
