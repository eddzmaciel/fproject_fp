...
{
    ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall _draw_4071f44d;
    static uSStrong<ElementDraw*> Impl_;
    static uSStrong<ElementDraw*>& Impl() { return ElementDraw_typeof()->Init(), Impl_; }
    ::g::Uno::Float4x4 Rectangle_LocalTransform_4071f44d_3_9_2;
    ::g::Uno::Float4x4 Rectangle_LocalTransform_4071f44d_3_9_3;
    uStrong< ::g::Uno::Graphics::VertexBuffer*> Rectangle_VertexData_4071f44d_6_2_1;
