// This file was generated based on C:\ProgramData\Uno\Packages\UnoCore\0.33.1\Source\Uno\UX\$.uno.
...
struct ValueChangedArgs : ::g::Uno::EventArgs
{
    ...
    template<class T>
    static ValueChangedArgs* New2(uType* __type, T value) { ValueChangedArgs* __retval; return ValueChangedArgs__New2_fn(__type, uConstrain(__type->GetBase(ValueChangedArgs_typeof())->T(0), value), &__retval), __retval; }
};
// }
