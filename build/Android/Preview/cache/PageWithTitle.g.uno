...
public partial class PageWithTitle: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp_Value_inst = new MyFirstFuseProject_FuseControlsText_Value_Property(temp, __selector0);
        this_Title_inst = new MyFirstFuseProject_PageWithTitle_Title_Property(this, __selector1);
        temp_TextColor_inst = new MyFirstFuseProject_FuseControlsText_TextColor_Property(temp, __selector2);
        this_HeaderTextColor_inst = new MyFirstFuseProject_PageWithTitle_HeaderTextColor_Property(this, __selector3);
        var temp1 = new Fuse.Controls.Panel();
        temp1_Color_inst = new MyFirstFuseProject_FuseControlsPanel_Color_Property(temp1, __selector4);
        this_HeaderColor_inst = new MyFirstFuseProject_PageWithTitle_HeaderColor_Property(this, __selector5);
        var temp2 = new Fuse.Controls.Text();
        temp2_Value_inst = new MyFirstFuseProject_FuseControlsText_Value_Property(temp2, __selector0);
        this_Instructions_inst = new MyFirstFuseProject_PageWithTitle_Instructions_Property(this, __selector6);
        ...
        var temp11 = new Fuse.Controls.PropertyBinding<string>(temp2_Value_inst, this_Instructions_inst);
